...
#ifndef _CODEGEN_DRIVER_BASE_SENSORLEVELS_H_
#define _CODEGEN_DRIVER_BASE_SENSORLEVELS_H_
...
PREDECLARE_BSON(driver_base::SensorLevels); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(driver_base::SensorLevels); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1748765326U;
        ...
        static const unsigned int DATA_VERSION = 3369861353U;
        ...
        */
        ...
        static const std::string versionMD5() { return "b63cbb2b59d9b4b402834826f5769d0c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb63cbb2b59d9b4b4ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x02834826f5769d0cULL;
...
namespace rframe
{
    template <> class CodeGenTraits<driver_base::SensorLevels>
    {
    public:
        static bool flat() {return driver_base::SensorLevels::dataTypeFlat(); };
        static std::string sourceXML() {return driver_base::SensorLevels::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const driver_base::SensorLevels & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const driver_base::SensorLevels & value);

#endif  //  _DRIVER_BASE_SENSORLEVELS_H_
