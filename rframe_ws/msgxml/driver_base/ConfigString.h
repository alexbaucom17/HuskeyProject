...
#ifndef _CODEGEN_DRIVER_BASE_CONFIGSTRING_H_
#define _CODEGEN_DRIVER_BASE_CONFIGSTRING_H_
...
PREDECLARE_BSON(driver_base::ConfigString); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(driver_base::ConfigString); // see Common.h, macro used for a cleaner header

namespace driver_base
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ConfigString & inobj);   
    ...
    */
    ...
    public: 
        ...
        ConfigString();
        /** copy constructor */
        ConfigString(const ConfigString & inobj);
        /** destructor */
        ~ConfigString();

        /** allocator, convenience function for bind */
        static ConfigString * New();
        ...
        static const unsigned int ID = 1748765324U;
        ...
        static const unsigned int DATA_VERSION = 2863405389U;
        ...
        //        static const char * dataTypeName() { return "ConfigString"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c6df22c4f89c4503e4fd8518b6210bbd"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc6df22c4f89c4503ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe4fd8518b6210bbdULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ConfigString * copy() { return new ConfigString(*this); };

        /** assignment operator(s) */
        ConfigString & operator=(const ConfigString & inobj);
        /** equality operator */
        bool operator==(const ConfigString & inobj) const;
        /** inequality operator */
        bool operator!=(const ConfigString & inobj) const;
        /** less than operator */
        bool operator<(const ConfigString & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ConfigString & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<driver_base::ConfigString>
    {
    public:
        static bool flat() {return driver_base::ConfigString::dataTypeFlat(); };
        static std::string sourceXML() {return driver_base::ConfigString::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const driver_base::ConfigString & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const driver_base::ConfigString & value);

#endif  //  _DRIVER_BASE_CONFIGSTRING_H_
