...
#ifndef _CODEGEN_ROSGRAPH_MSGS_LOG_H_
#define _CODEGEN_ROSGRAPH_MSGS_LOG_H_
...
PREDECLARE_BSON(rosgraph_msgs::Log); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(rosgraph_msgs::Log); // see Common.h, macro used for a cleaner header

namespace rosgraph_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Log & inobj);   
    ...
    */
    ...
    public: 
        ...
        std::string  file; /**< file the message came from */
        std::string  function; /**< function the message came from */
        unsigned int  line; /**< line the message came from */
        std::vector<std::string >  topics; /**< topic names that the node publishes */

        static const char DEBUG; /**< debug level (value: 1) */
        static const char INFO; /**< general level (value: 2) */
        static const char WARN; /**< warning level (value: 4) */
        static const char ERROR; /**< error level (value: 8) */
        static const char FATAL; /**< fatal/critical level (value: 16) */
        ...
        static const unsigned int ID = 571172703U;
        ...
        static const unsigned int DATA_VERSION = 3054559606U;
        ...
        //        static const char * dataTypeName() { return "Log"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "98173a4713623145420ff19e80bf75f1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x98173a4713623145ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x420ff19e80bf75f1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Log * copy() { return new Log(*this); };

        /** assignment operator(s) */
        Log & operator=(const Log & inobj);
        /** equality operator */
        bool operator==(const Log & inobj) const;
        /** inequality operator */
        bool operator!=(const Log & inobj) const;
        /** less than operator */
        bool operator<(const Log & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Log & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<rosgraph_msgs::Log>
    {
    public:
        static bool flat() {return rosgraph_msgs::Log::dataTypeFlat(); };
        static std::string sourceXML() {return rosgraph_msgs::Log::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const rosgraph_msgs::Log & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const rosgraph_msgs::Log & value);

#endif  //  _ROSGRAPH_MSGS_LOG_H_
