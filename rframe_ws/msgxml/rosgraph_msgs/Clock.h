...
#ifndef _CODEGEN_ROSGRAPH_MSGS_CLOCK_H_
#define _CODEGEN_ROSGRAPH_MSGS_CLOCK_H_
...
PREDECLARE_BSON(rosgraph_msgs::Clock); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(rosgraph_msgs::Clock); // see Common.h, macro used for a cleaner header

namespace rosgraph_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Clock & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 571172702U;
        ...
        static const unsigned int DATA_VERSION = 718502662U;
        ...
        //        static const char * dataTypeName() { return "Clock"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "724d3c130d90f3610f21b1dca69bc345"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x724d3c130d90f361ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0f21b1dca69bc345ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Clock * copy() { return new Clock(*this); };

        /** assignment operator(s) */
        Clock & operator=(const Clock & inobj);
        /** equality operator */
        bool operator==(const Clock & inobj) const;
        /** inequality operator */
        bool operator!=(const Clock & inobj) const;
        /** less than operator */
        bool operator<(const Clock & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Clock & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<rosgraph_msgs::Clock>
    {
    public:
        static bool flat() {return rosgraph_msgs::Clock::dataTypeFlat(); };
        static std::string sourceXML() {return rosgraph_msgs::Clock::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const rosgraph_msgs::Clock & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const rosgraph_msgs::Clock & value);

#endif  //  _ROSGRAPH_MSGS_CLOCK_H_
