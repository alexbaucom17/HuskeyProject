...
#ifndef _CODEGEN_DIAGNOSTIC_MSGS_ADDDIAGNOSTICS_H_
#define _CODEGEN_DIAGNOSTIC_MSGS_ADDDIAGNOSTICS_H_
...
PREDECLARE_BSON(diagnostic_msgs::AddDiagnostics); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(diagnostic_msgs::AddDiagnostics); // see Common.h, macro used for a cleaner header

namespace diagnostic_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AddDiagnostics & inobj);   
    ...
    */
    ...
    public: 
        ...
        AddDiagnostics();
        /** copy constructor */
        AddDiagnostics(const AddDiagnostics & inobj);
        /** destructor */
        ~AddDiagnostics();

        /** allocator, convenience function for bind */
        static AddDiagnostics * New();
        ...
        static const unsigned int ID = 1097138112U;
        ...
        static const unsigned int DATA_VERSION = 796063868U;
        ...
        //        static const char * dataTypeName() { return "AddDiagnostics"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "19c4784819a58a3a6c8bc8f5aed8fd6e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x19c4784819a58a3aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6c8bc8f5aed8fd6eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AddDiagnostics * copy() { return new AddDiagnostics(*this); };

        /** assignment operator(s) */
        AddDiagnostics & operator=(const AddDiagnostics & inobj);
        /** equality operator */
        bool operator==(const AddDiagnostics & inobj) const;
        /** inequality operator */
        bool operator!=(const AddDiagnostics & inobj) const;
        /** less than operator */
        bool operator<(const AddDiagnostics & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AddDiagnostics & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<diagnostic_msgs::AddDiagnostics>
    {
    public:
        static bool flat() {return diagnostic_msgs::AddDiagnostics::dataTypeFlat(); };
        static std::string sourceXML() {return diagnostic_msgs::AddDiagnostics::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const diagnostic_msgs::AddDiagnostics & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const diagnostic_msgs::AddDiagnostics & value);

#endif  //  _DIAGNOSTIC_MSGS_ADDDIAGNOSTICS_H_
