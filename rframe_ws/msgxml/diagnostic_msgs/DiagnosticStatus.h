...
#ifndef _CODEGEN_DIAGNOSTIC_MSGS_DIAGNOSTICSTATUS_H_
#define _CODEGEN_DIAGNOSTIC_MSGS_DIAGNOSTICSTATUS_H_
...
PREDECLARE_BSON(diagnostic_msgs::DiagnosticStatus); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(diagnostic_msgs::DiagnosticStatus); // see Common.h, macro used for a cleaner header

namespace diagnostic_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DiagnosticStatus & inobj);   
    ...
    */
    ...
    public: 
        ...
        DiagnosticStatus();
        /** copy constructor */
        DiagnosticStatus(const DiagnosticStatus & inobj);
        /** destructor */
        ~DiagnosticStatus();

        /** allocator, convenience function for bind */
        static DiagnosticStatus * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        char  level; /**< level of operation enumerated above */
        std::string  name; /**< a description of the test/component reporting */
        std::string  message; /**< a description of the status */
        std::string  hardware_id; /**< a hardware unique string */
        std::vector<KeyValue >  values; /**< an array of values associated with the status */

        static const char OK; /**<  (value: 0) */
        static const char WARN; /**<  (value: 1) */
        static const char ERROR; /**<  (value: 2) */
        static const char STALE; /**<  (value: 3) */
        ...
        static const unsigned int ID = 1097138108U;
        ...
        static const unsigned int DATA_VERSION = 3257055761U;
        ...
        //        static const char * dataTypeName() { return "DiagnosticStatus"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0ac280bfc82557e279721e20af228be0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0ac280bfc82557e2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x79721e20af228be0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DiagnosticStatus * copy() { return new DiagnosticStatus(*this); };

        /** assignment operator(s) */
        DiagnosticStatus & operator=(const DiagnosticStatus & inobj);
        /** equality operator */
        bool operator==(const DiagnosticStatus & inobj) const;
        /** inequality operator */
        bool operator!=(const DiagnosticStatus & inobj) const;
        /** less than operator */
        bool operator<(const DiagnosticStatus & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DiagnosticStatus & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<diagnostic_msgs::DiagnosticStatus>
    {
    public:
        static bool flat() {return diagnostic_msgs::DiagnosticStatus::dataTypeFlat(); };
        static std::string sourceXML() {return diagnostic_msgs::DiagnosticStatus::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const diagnostic_msgs::DiagnosticStatus & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const diagnostic_msgs::DiagnosticStatus & value);

#endif  //  _DIAGNOSTIC_MSGS_DIAGNOSTICSTATUS_H_
