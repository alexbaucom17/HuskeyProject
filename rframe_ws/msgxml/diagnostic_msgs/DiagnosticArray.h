...
#ifndef _CODEGEN_DIAGNOSTIC_MSGS_DIAGNOSTICARRAY_H_
#define _CODEGEN_DIAGNOSTIC_MSGS_DIAGNOSTICARRAY_H_
...
PREDECLARE_BSON(diagnostic_msgs::DiagnosticArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(diagnostic_msgs::DiagnosticArray); // see Common.h, macro used for a cleaner header

namespace diagnostic_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DiagnosticArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        DiagnosticArray();
        /** copy constructor */
        DiagnosticArray(const DiagnosticArray & inobj);
        /** destructor */
        ~DiagnosticArray();

        /** allocator, convenience function for bind */
        static DiagnosticArray * New();
        ...
        std::vector<DiagnosticStatus >  status; /**< an array of components being reported on */
        ...
        static const unsigned int ID = 1097138107U;
        ...
        static const unsigned int DATA_VERSION = 2078078129U;
        ...
        //        static const char * dataTypeName() { return "DiagnosticArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "01efe165f6c5fc70679ff1e78453c3f3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x01efe165f6c5fc70ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x679ff1e78453c3f3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DiagnosticArray * copy() { return new DiagnosticArray(*this); };

        /** assignment operator(s) */
        DiagnosticArray & operator=(const DiagnosticArray & inobj);
        /** equality operator */
        bool operator==(const DiagnosticArray & inobj) const;
        /** inequality operator */
        bool operator!=(const DiagnosticArray & inobj) const;
        /** less than operator */
        bool operator<(const DiagnosticArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DiagnosticArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<diagnostic_msgs::DiagnosticArray>
    {
    public:
        static bool flat() {return diagnostic_msgs::DiagnosticArray::dataTypeFlat(); };
        static std::string sourceXML() {return diagnostic_msgs::DiagnosticArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const diagnostic_msgs::DiagnosticArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const diagnostic_msgs::DiagnosticArray & value);

#endif  //  _DIAGNOSTIC_MSGS_DIAGNOSTICARRAY_H_
