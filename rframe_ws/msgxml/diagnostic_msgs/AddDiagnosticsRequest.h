...
#ifndef _CODEGEN_DIAGNOSTIC_MSGS_ADDDIAGNOSTICSREQUEST_H_
#define _CODEGEN_DIAGNOSTIC_MSGS_ADDDIAGNOSTICSREQUEST_H_
...
PREDECLARE_BSON(diagnostic_msgs::AddDiagnosticsRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(diagnostic_msgs::AddDiagnosticsRequest); // see Common.h, macro used for a cleaner header

namespace diagnostic_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AddDiagnosticsRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        AddDiagnosticsRequest(const AddDiagnosticsRequest & inobj);
        /** destructor */
        ~AddDiagnosticsRequest();

        /** allocator, convenience function for bind */
        static AddDiagnosticsRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  load_namespace; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_LOAD_NAMESPACE,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1097138110U;
        ...
        static const unsigned int DATA_VERSION = 336859316U;
        ...
        //        static const char * dataTypeName() { return "AddDiagnosticsRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "82b4979ba9cfe5d53edc10f37587b610"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x82b4979ba9cfe5d5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3edc10f37587b610ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AddDiagnosticsRequest * copy() { return new AddDiagnosticsRequest(*this); };

        /** assignment operator(s) */
        AddDiagnosticsRequest & operator=(const AddDiagnosticsRequest & inobj);
        /** equality operator */
        bool operator==(const AddDiagnosticsRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const AddDiagnosticsRequest & inobj) const;
        /** less than operator */
        bool operator<(const AddDiagnosticsRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AddDiagnosticsRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<diagnostic_msgs::AddDiagnosticsRequest>
    {
    public:
        static bool flat() {return diagnostic_msgs::AddDiagnosticsRequest::dataTypeFlat(); };
        static std::string sourceXML() {return diagnostic_msgs::AddDiagnosticsRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const diagnostic_msgs::AddDiagnosticsRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const diagnostic_msgs::AddDiagnosticsRequest & value);

#endif  //  _DIAGNOSTIC_MSGS_ADDDIAGNOSTICSREQUEST_H_
