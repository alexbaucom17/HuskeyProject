...
#ifndef _CODEGEN_DIAGNOSTIC_MSGS_SELFTESTRESPONSE_H_
#define _CODEGEN_DIAGNOSTIC_MSGS_SELFTESTRESPONSE_H_
...
PREDECLARE_BSON(diagnostic_msgs::SelfTestResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(diagnostic_msgs::SelfTestResponse); // see Common.h, macro used for a cleaner header

namespace diagnostic_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SelfTestResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        SelfTestResponse();
        /** copy constructor */
        SelfTestResponse(const SelfTestResponse & inobj);
        /** destructor */
        ~SelfTestResponse();

        /** allocator, convenience function for bind */
        static SelfTestResponse * New();
        ...
        static const unsigned int ID = 1097138114U;
        ...
        static const unsigned int DATA_VERSION = 4123943616U;
        ...
        //        static const char * dataTypeName() { return "SelfTestResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "85cbaf8d42016ac6bc569df29cd89bbb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x85cbaf8d42016ac6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbc569df29cd89bbbULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SelfTestResponse * copy() { return new SelfTestResponse(*this); };

        /** assignment operator(s) */
        SelfTestResponse & operator=(const SelfTestResponse & inobj);
        /** equality operator */
        bool operator==(const SelfTestResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SelfTestResponse & inobj) const;
        /** less than operator */
        bool operator<(const SelfTestResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SelfTestResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<diagnostic_msgs::SelfTestResponse>
    {
    public:
        static bool flat() {return diagnostic_msgs::SelfTestResponse::dataTypeFlat(); };
        static std::string sourceXML() {return diagnostic_msgs::SelfTestResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const diagnostic_msgs::SelfTestResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const diagnostic_msgs::SelfTestResponse & value);

#endif  //  _DIAGNOSTIC_MSGS_SELFTESTRESPONSE_H_
