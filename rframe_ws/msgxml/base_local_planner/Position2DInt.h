...
#ifndef _CODEGEN_BASE_LOCAL_PLANNER_POSITION2DINT_H_
#define _CODEGEN_BASE_LOCAL_PLANNER_POSITION2DINT_H_
...
PREDECLARE_BSON(base_local_planner::Position2DInt); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(base_local_planner::Position2DInt); // see Common.h, macro used for a cleaner header

namespace base_local_planner
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Position2DInt & inobj);   
    ...
    */
    ...
    public: 
        ...
        Position2DInt();
        /** copy constructor */
        Position2DInt(const Position2DInt & inobj);
        /** destructor */
        ~Position2DInt();

        /** allocator, convenience function for bind */
        static Position2DInt * New();
        ...
        static const unsigned int ID = 1715023645U;
        ...
        static const unsigned int DATA_VERSION = 1592935769U;
        ...
        //        static const char * dataTypeName() { return "Position2DInt"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7f81526598566f1038f56e0c6a7a2f09"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7f81526598566f10ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x38f56e0c6a7a2f09ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Position2DInt * copy() { return new Position2DInt(*this); };

        /** assignment operator(s) */
        Position2DInt & operator=(const Position2DInt & inobj);
        /** equality operator */
        bool operator==(const Position2DInt & inobj) const;
        /** inequality operator */
        bool operator!=(const Position2DInt & inobj) const;
        /** less than operator */
        bool operator<(const Position2DInt & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Position2DInt & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<base_local_planner::Position2DInt>
    {
    public:
        static bool flat() {return base_local_planner::Position2DInt::dataTypeFlat(); };
        static std::string sourceXML() {return base_local_planner::Position2DInt::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const base_local_planner::Position2DInt & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const base_local_planner::Position2DInt & value);

#endif  //  _BASE_LOCAL_PLANNER_POSITION2DINT_H_
