...
#ifndef _CODEGEN_AUDIO_COMMON_MSGS_AUDIODATA_H_
#define _CODEGEN_AUDIO_COMMON_MSGS_AUDIODATA_H_
...
PREDECLARE_BSON(audio_common_msgs::AudioData); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(audio_common_msgs::AudioData); // see Common.h, macro used for a cleaner header

namespace audio_common_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AudioData & inobj);   
    ...
    */
    ...
    public: 
        ...
        AudioData();
        /** copy constructor */
        AudioData(const AudioData & inobj);
        /** destructor */
        ~AudioData();

        /** allocator, convenience function for bind */
        static AudioData * New();
        ...
        static const unsigned int ID = 831366185U;
        ...
        static const unsigned int DATA_VERSION = 1538283925U;
        ...
        //        static const char * dataTypeName() { return "AudioData"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5862d29a4fd7ea797141cf60d2c8489c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5862d29a4fd7ea79ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7141cf60d2c8489cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AudioData * copy() { return new AudioData(*this); };

        /** assignment operator(s) */
        AudioData & operator=(const AudioData & inobj);
        /** equality operator */
        bool operator==(const AudioData & inobj) const;
        /** inequality operator */
        bool operator!=(const AudioData & inobj) const;
        /** less than operator */
        bool operator<(const AudioData & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AudioData & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<audio_common_msgs::AudioData>
    {
    public:
        static bool flat() {return audio_common_msgs::AudioData::dataTypeFlat(); };
        static std::string sourceXML() {return audio_common_msgs::AudioData::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const audio_common_msgs::AudioData & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const audio_common_msgs::AudioData & value);

#endif  //  _AUDIO_COMMON_MSGS_AUDIODATA_H_
