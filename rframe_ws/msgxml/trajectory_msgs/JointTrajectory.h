...
#ifndef _CODEGEN_TRAJECTORY_MSGS_JOINTTRAJECTORY_H_
#define _CODEGEN_TRAJECTORY_MSGS_JOINTTRAJECTORY_H_
...
PREDECLARE_BSON(trajectory_msgs::JointTrajectory); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(trajectory_msgs::JointTrajectory); // see Common.h, macro used for a cleaner header

namespace trajectory_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointTrajectory & inobj);   
    ...
    */
    ...
    public: 
        ...
        JointTrajectory();
        /** copy constructor */
        JointTrajectory(const JointTrajectory & inobj);
        /** destructor */
        ~JointTrajectory();

        /** allocator, convenience function for bind */
        static JointTrajectory * New();
        ...
        static const unsigned int ID = 109236940U;
        ...
        static const unsigned int DATA_VERSION = 3225772196U;
        ...
        //        static const char * dataTypeName() { return "JointTrajectory"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "50723e5050237add728e9345927c6de9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x50723e5050237addULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x728e9345927c6de9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointTrajectory * copy() { return new JointTrajectory(*this); };

        /** assignment operator(s) */
        JointTrajectory & operator=(const JointTrajectory & inobj);
        /** equality operator */
        bool operator==(const JointTrajectory & inobj) const;
        /** inequality operator */
        bool operator!=(const JointTrajectory & inobj) const;
        /** less than operator */
        bool operator<(const JointTrajectory & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointTrajectory & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<trajectory_msgs::JointTrajectory>
    {
    public:
        static bool flat() {return trajectory_msgs::JointTrajectory::dataTypeFlat(); };
        static std::string sourceXML() {return trajectory_msgs::JointTrajectory::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const trajectory_msgs::JointTrajectory & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const trajectory_msgs::JointTrajectory & value);

#endif  //  _TRAJECTORY_MSGS_JOINTTRAJECTORY_H_
