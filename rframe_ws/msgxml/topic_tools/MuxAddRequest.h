...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXADDREQUEST_H_
#define _CODEGEN_TOPIC_TOOLS_MUXADDREQUEST_H_
...
PREDECLARE_BSON(topic_tools::MuxAddRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxAddRequest); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxAddRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxAddRequest();
        /** copy constructor */
        MuxAddRequest(const MuxAddRequest & inobj);
        /** destructor */
        ~MuxAddRequest();

        /** allocator, convenience function for bind */
        static MuxAddRequest * New();
        ...
        static const unsigned int ID = 104324638U;
        ...
        static const unsigned int DATA_VERSION = 2273893400U;
        ...
        //        static const char * dataTypeName() { return "MuxAddRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3d84047e4d5ba1f7d38ae31f7ac3300c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3d84047e4d5ba1f7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd38ae31f7ac3300cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxAddRequest * copy() { return new MuxAddRequest(*this); };

        /** assignment operator(s) */
        MuxAddRequest & operator=(const MuxAddRequest & inobj);
        /** equality operator */
        bool operator==(const MuxAddRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxAddRequest & inobj) const;
        /** less than operator */
        bool operator<(const MuxAddRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxAddRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxAddRequest>
    {
    public:
        static bool flat() {return topic_tools::MuxAddRequest::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxAddRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxAddRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxAddRequest & value);

#endif  //  _TOPIC_TOOLS_MUXADDREQUEST_H_
