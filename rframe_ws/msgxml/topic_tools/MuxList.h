...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXLIST_H_
#define _CODEGEN_TOPIC_TOOLS_MUXLIST_H_
...
PREDECLARE_BSON(topic_tools::MuxList); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxList); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxList & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 104324646U;
        ...
        static const unsigned int DATA_VERSION = 133480134U;
        ...
        //        static const char * dataTypeName() { return "MuxList"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ab162fcca36526cd0697fe067b284a4c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xab162fcca36526cdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0697fe067b284a4cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxList * copy() { return new MuxList(*this); };

        /** assignment operator(s) */
        MuxList & operator=(const MuxList & inobj);
        /** equality operator */
        bool operator==(const MuxList & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxList & inobj) const;
        /** less than operator */
        bool operator<(const MuxList & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxList & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxList>
    {
    public:
        static bool flat() {return topic_tools::MuxList::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxList::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxList & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxList & value);

#endif  //  _TOPIC_TOOLS_MUXLIST_H_
