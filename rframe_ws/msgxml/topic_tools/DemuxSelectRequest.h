...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXSELECTREQUEST_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXSELECTREQUEST_H_
...
PREDECLARE_BSON(topic_tools::DemuxSelectRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxSelectRequest); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxSelectRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxSelectRequest();
        /** copy constructor */
        DemuxSelectRequest(const DemuxSelectRequest & inobj);
        /** destructor */
        ~DemuxSelectRequest();

        /** allocator, convenience function for bind */
        static DemuxSelectRequest * New();
        ...
        static const unsigned int ID = 104324635U;
        ...
        static const unsigned int DATA_VERSION = 3431094967U;
        ...
        //        static const char * dataTypeName() { return "DemuxSelectRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "cebf21073067294f9463d99ccef5155b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xcebf21073067294fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9463d99ccef5155bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxSelectRequest * copy() { return new DemuxSelectRequest(*this); };

        /** assignment operator(s) */
        DemuxSelectRequest & operator=(const DemuxSelectRequest & inobj);
        /** equality operator */
        bool operator==(const DemuxSelectRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxSelectRequest & inobj) const;
        /** less than operator */
        bool operator<(const DemuxSelectRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxSelectRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxSelectRequest>
    {
    public:
        static bool flat() {return topic_tools::DemuxSelectRequest::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxSelectRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxSelectRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxSelectRequest & value);

#endif  //  _TOPIC_TOOLS_DEMUXSELECTREQUEST_H_
