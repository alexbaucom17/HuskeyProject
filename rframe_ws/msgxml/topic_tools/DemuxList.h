...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXLIST_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXLIST_H_
...
PREDECLARE_BSON(topic_tools::DemuxList); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxList); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxList & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxList();
        /** copy constructor */
        DemuxList(const DemuxList & inobj);
        /** destructor */
        ~DemuxList();

        /** allocator, convenience function for bind */
        static DemuxList * New();
        ...
        static const unsigned int ID = 104324634U;
        ...
        static const unsigned int DATA_VERSION = 3062624686U;
        ...
        //        static const char * dataTypeName() { return "DemuxList"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a68331a53a5c19d865c711187efe3dcd"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa68331a53a5c19d8ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x65c711187efe3dcdULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxList * copy() { return new DemuxList(*this); };

        /** assignment operator(s) */
        DemuxList & operator=(const DemuxList & inobj);
        /** equality operator */
        bool operator==(const DemuxList & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxList & inobj) const;
        /** less than operator */
        bool operator<(const DemuxList & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxList & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxList>
    {
    public:
        static bool flat() {return topic_tools::DemuxList::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxList::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxList & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxList & value);

#endif  //  _TOPIC_TOOLS_DEMUXLIST_H_
