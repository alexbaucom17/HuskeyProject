...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXDELETEREQUEST_H_
#define _CODEGEN_TOPIC_TOOLS_MUXDELETEREQUEST_H_
...
PREDECLARE_BSON(topic_tools::MuxDeleteRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxDeleteRequest); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxDeleteRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxDeleteRequest();
        /** copy constructor */
        MuxDeleteRequest(const MuxDeleteRequest & inobj);
        /** destructor */
        ~MuxDeleteRequest();

        /** allocator, convenience function for bind */
        static MuxDeleteRequest * New();
        ...
        static const unsigned int ID = 104324641U;
        ...
        static const unsigned int DATA_VERSION = 3632539443U;
        ...
        //        static const char * dataTypeName() { return "MuxDeleteRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "fce32b3ac2b46704ae7b8fd682264145"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfce32b3ac2b46704ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xae7b8fd682264145ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxDeleteRequest * copy() { return new MuxDeleteRequest(*this); };

        /** assignment operator(s) */
        MuxDeleteRequest & operator=(const MuxDeleteRequest & inobj);
        /** equality operator */
        bool operator==(const MuxDeleteRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxDeleteRequest & inobj) const;
        /** less than operator */
        bool operator<(const MuxDeleteRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxDeleteRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxDeleteRequest>
    {
    public:
        static bool flat() {return topic_tools::MuxDeleteRequest::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxDeleteRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxDeleteRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxDeleteRequest & value);

#endif  //  _TOPIC_TOOLS_MUXDELETEREQUEST_H_
