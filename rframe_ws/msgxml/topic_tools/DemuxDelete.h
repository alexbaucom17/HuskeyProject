...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXDELETE_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXDELETE_H_
...
PREDECLARE_BSON(topic_tools::DemuxDelete); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxDelete); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxDelete & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxDelete();
        /** copy constructor */
        DemuxDelete(const DemuxDelete & inobj);
        /** destructor */
        ~DemuxDelete();

        /** allocator, convenience function for bind */
        static DemuxDelete * New();
        ...
        static const unsigned int ID = 104324631U;
        ...
        static const unsigned int DATA_VERSION = 3357661580U;
        ...
        //        static const char * dataTypeName() { return "DemuxDelete"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "71acf66a9790a47adbdd2a7471e39d92"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x71acf66a9790a47aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdbdd2a7471e39d92ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxDelete * copy() { return new DemuxDelete(*this); };

        /** assignment operator(s) */
        DemuxDelete & operator=(const DemuxDelete & inobj);
        /** equality operator */
        bool operator==(const DemuxDelete & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxDelete & inobj) const;
        /** less than operator */
        bool operator<(const DemuxDelete & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxDelete & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxDelete>
    {
    public:
        static bool flat() {return topic_tools::DemuxDelete::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxDelete::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxDelete & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxDelete & value);

#endif  //  _TOPIC_TOOLS_DEMUXDELETE_H_
