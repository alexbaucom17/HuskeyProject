...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXLISTRESPONSE_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXLISTRESPONSE_H_
...
PREDECLARE_BSON(topic_tools::DemuxListResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxListResponse); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxListResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxListResponse();
        /** copy constructor */
        DemuxListResponse(const DemuxListResponse & inobj);
        /** destructor */
        ~DemuxListResponse();

        /** allocator, convenience function for bind */
        static DemuxListResponse * New();
        ...
        static const unsigned int ID = 104324633U;
        ...
        static const unsigned int DATA_VERSION = 1869090375U;
        ...
        //        static const char * dataTypeName() { return "DemuxListResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "18e53203ff7f31ebd91ae02708225ce2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x18e53203ff7f31ebULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd91ae02708225ce2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxListResponse * copy() { return new DemuxListResponse(*this); };

        /** assignment operator(s) */
        DemuxListResponse & operator=(const DemuxListResponse & inobj);
        /** equality operator */
        bool operator==(const DemuxListResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxListResponse & inobj) const;
        /** less than operator */
        bool operator<(const DemuxListResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxListResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxListResponse>
    {
    public:
        static bool flat() {return topic_tools::DemuxListResponse::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxListResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxListResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxListResponse & value);

#endif  //  _TOPIC_TOOLS_DEMUXLISTRESPONSE_H_
