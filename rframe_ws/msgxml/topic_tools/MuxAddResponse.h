...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXADDRESPONSE_H_
#define _CODEGEN_TOPIC_TOOLS_MUXADDRESPONSE_H_
...
PREDECLARE_BSON(topic_tools::MuxAddResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxAddResponse); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxAddResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxAddResponse();
        /** copy constructor */
        MuxAddResponse(const MuxAddResponse & inobj);
        /** destructor */
        ~MuxAddResponse();

        /** allocator, convenience function for bind */
        static MuxAddResponse * New();
        ...
        static const unsigned int ID = 104324639U;
        ...
        static const unsigned int DATA_VERSION = 3334598475U;
        ...
        //        static const char * dataTypeName() { return "MuxAddResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6c86fbd6cff3b6e6d46bf7043f5b8099"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6c86fbd6cff3b6e6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd46bf7043f5b8099ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxAddResponse * copy() { return new MuxAddResponse(*this); };

        /** assignment operator(s) */
        MuxAddResponse & operator=(const MuxAddResponse & inobj);
        /** equality operator */
        bool operator==(const MuxAddResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxAddResponse & inobj) const;
        /** less than operator */
        bool operator<(const MuxAddResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxAddResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxAddResponse>
    {
    public:
        static bool flat() {return topic_tools::MuxAddResponse::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxAddResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxAddResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxAddResponse & value);

#endif  //  _TOPIC_TOOLS_MUXADDRESPONSE_H_
