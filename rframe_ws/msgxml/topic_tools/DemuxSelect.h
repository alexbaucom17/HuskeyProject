...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXSELECT_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXSELECT_H_
...
PREDECLARE_BSON(topic_tools::DemuxSelect); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxSelect); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxSelect & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxSelect();
        /** copy constructor */
        DemuxSelect(const DemuxSelect & inobj);
        /** destructor */
        ~DemuxSelect();

        /** allocator, convenience function for bind */
        static DemuxSelect * New();
        ...
        static const unsigned int ID = 104324637U;
        ...
        static const unsigned int DATA_VERSION = 2483030382U;
        ...
        //        static const char * dataTypeName() { return "DemuxSelect"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "16dd6f94384a49ba24011f1627916800"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x16dd6f94384a49baULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x24011f1627916800ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxSelect * copy() { return new DemuxSelect(*this); };

        /** assignment operator(s) */
        DemuxSelect & operator=(const DemuxSelect & inobj);
        /** equality operator */
        bool operator==(const DemuxSelect & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxSelect & inobj) const;
        /** less than operator */
        bool operator<(const DemuxSelect & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxSelect & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxSelect>
    {
    public:
        static bool flat() {return topic_tools::DemuxSelect::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxSelect::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxSelect & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxSelect & value);

#endif  //  _TOPIC_TOOLS_DEMUXSELECT_H_
