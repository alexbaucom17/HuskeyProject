...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXLISTRESPONSE_H_
#define _CODEGEN_TOPIC_TOOLS_MUXLISTRESPONSE_H_
...
PREDECLARE_BSON(topic_tools::MuxListResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxListResponse); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxListResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxListResponse();
        /** copy constructor */
        MuxListResponse(const MuxListResponse & inobj);
        /** destructor */
        ~MuxListResponse();

        /** allocator, convenience function for bind */
        static MuxListResponse * New();
        ...
        static const unsigned int ID = 104324645U;
        ...
        static const unsigned int DATA_VERSION = 2214243503U;
        ...
        //        static const char * dataTypeName() { return "MuxListResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "901d52a0bc58d06f9231806fa1dea003"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x901d52a0bc58d06fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9231806fa1dea003ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxListResponse * copy() { return new MuxListResponse(*this); };

        /** assignment operator(s) */
        MuxListResponse & operator=(const MuxListResponse & inobj);
        /** equality operator */
        bool operator==(const MuxListResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxListResponse & inobj) const;
        /** less than operator */
        bool operator<(const MuxListResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxListResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxListResponse>
    {
    public:
        static bool flat() {return topic_tools::MuxListResponse::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxListResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxListResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxListResponse & value);

#endif  //  _TOPIC_TOOLS_MUXLISTRESPONSE_H_
