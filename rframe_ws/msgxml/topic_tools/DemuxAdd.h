...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXADD_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXADD_H_
...
PREDECLARE_BSON(topic_tools::DemuxAdd); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxAdd); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxAdd & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 104324628U;
        ...
        static const unsigned int DATA_VERSION = 3542439312U;
        ...
        //        static const char * dataTypeName() { return "DemuxAdd"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "29039e64e69654596fa615bfa31fc4d4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x29039e64e6965459ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6fa615bfa31fc4d4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxAdd * copy() { return new DemuxAdd(*this); };

        /** assignment operator(s) */
        DemuxAdd & operator=(const DemuxAdd & inobj);
        /** equality operator */
        bool operator==(const DemuxAdd & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxAdd & inobj) const;
        /** less than operator */
        bool operator<(const DemuxAdd & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxAdd & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxAdd>
    {
    public:
        static bool flat() {return topic_tools::DemuxAdd::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxAdd::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxAdd & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxAdd & value);

#endif  //  _TOPIC_TOOLS_DEMUXADD_H_
