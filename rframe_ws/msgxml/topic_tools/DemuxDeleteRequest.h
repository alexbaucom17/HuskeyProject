...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXDELETEREQUEST_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXDELETEREQUEST_H_
...
PREDECLARE_BSON(topic_tools::DemuxDeleteRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxDeleteRequest); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxDeleteRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxDeleteRequest();
        /** copy constructor */
        DemuxDeleteRequest(const DemuxDeleteRequest & inobj);
        /** destructor */
        ~DemuxDeleteRequest();

        /** allocator, convenience function for bind */
        static DemuxDeleteRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  topic; /**< no comment provided */
        ...
        static const unsigned int ID = 104324629U;
        ...
        static const unsigned int DATA_VERSION = 3703497260U;
        ...
        //        static const char * dataTypeName() { return "DemuxDeleteRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "acda2656095e2934bd717d8fc53473c9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xacda2656095e2934ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbd717d8fc53473c9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxDeleteRequest * copy() { return new DemuxDeleteRequest(*this); };

        /** assignment operator(s) */
        DemuxDeleteRequest & operator=(const DemuxDeleteRequest & inobj);
        /** equality operator */
        bool operator==(const DemuxDeleteRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxDeleteRequest & inobj) const;
        /** less than operator */
        bool operator<(const DemuxDeleteRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxDeleteRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxDeleteRequest>
    {
    public:
        static bool flat() {return topic_tools::DemuxDeleteRequest::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxDeleteRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxDeleteRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxDeleteRequest & value);

#endif  //  _TOPIC_TOOLS_DEMUXDELETEREQUEST_H_
