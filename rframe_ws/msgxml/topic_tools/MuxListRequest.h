...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXLISTREQUEST_H_
#define _CODEGEN_TOPIC_TOOLS_MUXLISTREQUEST_H_
...
PREDECLARE_BSON(topic_tools::MuxListRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxListRequest); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxListRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxListRequest();
        /** copy constructor */
        MuxListRequest(const MuxListRequest & inobj);
        /** destructor */
        ~MuxListRequest();

        /** allocator, convenience function for bind */
        static MuxListRequest * New();
        ...
        static const unsigned int ID = 104324644U;
        ...
        static const unsigned int DATA_VERSION = 3381379807U;
        ...
        //        static const char * dataTypeName() { return "MuxListRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e5a3adf3b864114856451ebb5bba3566"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe5a3adf3b8641148ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x56451ebb5bba3566ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxListRequest * copy() { return new MuxListRequest(*this); };

        /** assignment operator(s) */
        MuxListRequest & operator=(const MuxListRequest & inobj);
        /** equality operator */
        bool operator==(const MuxListRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxListRequest & inobj) const;
        /** less than operator */
        bool operator<(const MuxListRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxListRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxListRequest>
    {
    public:
        static bool flat() {return topic_tools::MuxListRequest::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxListRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxListRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxListRequest & value);

#endif  //  _TOPIC_TOOLS_MUXLISTREQUEST_H_
