...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXSELECT_H_
#define _CODEGEN_TOPIC_TOOLS_MUXSELECT_H_
...
PREDECLARE_BSON(topic_tools::MuxSelect); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxSelect); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxSelect & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxSelect();
        /** copy constructor */
        MuxSelect(const MuxSelect & inobj);
        /** destructor */
        ~MuxSelect();

        /** allocator, convenience function for bind */
        static MuxSelect * New();
        ...
        static const unsigned int ID = 104324649U;
        ...
        static const unsigned int DATA_VERSION = 248777891U;
        ...
        //        static const char * dataTypeName() { return "MuxSelect"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c98e43a2b19f43f458055fc2f1201ad0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc98e43a2b19f43f4ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x58055fc2f1201ad0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxSelect * copy() { return new MuxSelect(*this); };

        /** assignment operator(s) */
        MuxSelect & operator=(const MuxSelect & inobj);
        /** equality operator */
        bool operator==(const MuxSelect & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxSelect & inobj) const;
        /** less than operator */
        bool operator<(const MuxSelect & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxSelect & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxSelect>
    {
    public:
        static bool flat() {return topic_tools::MuxSelect::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxSelect::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxSelect & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxSelect & value);

#endif  //  _TOPIC_TOOLS_MUXSELECT_H_
