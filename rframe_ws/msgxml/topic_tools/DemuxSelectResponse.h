...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXSELECTRESPONSE_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXSELECTRESPONSE_H_
...
PREDECLARE_BSON(topic_tools::DemuxSelectResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxSelectResponse); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxSelectResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxSelectResponse();
        /** copy constructor */
        DemuxSelectResponse(const DemuxSelectResponse & inobj);
        /** destructor */
        ~DemuxSelectResponse();

        /** allocator, convenience function for bind */
        static DemuxSelectResponse * New();
        ...
        static const unsigned int ID = 104324636U;
        ...
        static const unsigned int DATA_VERSION = 2003794723U;
        ...
        //        static const char * dataTypeName() { return "DemuxSelectResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bd3182ee908013535f3a11c878f10e1a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbd3182ee90801353ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5f3a11c878f10e1aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxSelectResponse * copy() { return new DemuxSelectResponse(*this); };

        /** assignment operator(s) */
        DemuxSelectResponse & operator=(const DemuxSelectResponse & inobj);
        /** equality operator */
        bool operator==(const DemuxSelectResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxSelectResponse & inobj) const;
        /** less than operator */
        bool operator<(const DemuxSelectResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxSelectResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxSelectResponse>
    {
    public:
        static bool flat() {return topic_tools::DemuxSelectResponse::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxSelectResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxSelectResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxSelectResponse & value);

#endif  //  _TOPIC_TOOLS_DEMUXSELECTRESPONSE_H_
