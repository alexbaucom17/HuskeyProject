...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXADDREQUEST_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXADDREQUEST_H_
...
PREDECLARE_BSON(topic_tools::DemuxAddRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxAddRequest); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxAddRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxAddRequest();
        /** copy constructor */
        DemuxAddRequest(const DemuxAddRequest & inobj);
        /** destructor */
        ~DemuxAddRequest();

        /** allocator, convenience function for bind */
        static DemuxAddRequest * New();
        ...
        static const unsigned int ID = 104324626U;
        ...
        static const unsigned int DATA_VERSION = 4143437398U;
        ...
        //        static const char * dataTypeName() { return "DemuxAddRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1ef55dabd80ee895eab51d0822c6fe60"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1ef55dabd80ee895ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xeab51d0822c6fe60ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxAddRequest * copy() { return new DemuxAddRequest(*this); };

        /** assignment operator(s) */
        DemuxAddRequest & operator=(const DemuxAddRequest & inobj);
        /** equality operator */
        bool operator==(const DemuxAddRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxAddRequest & inobj) const;
        /** less than operator */
        bool operator<(const DemuxAddRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxAddRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxAddRequest>
    {
    public:
        static bool flat() {return topic_tools::DemuxAddRequest::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxAddRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxAddRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxAddRequest & value);

#endif  //  _TOPIC_TOOLS_DEMUXADDREQUEST_H_
