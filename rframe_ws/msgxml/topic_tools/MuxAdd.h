...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXADD_H_
#define _CODEGEN_TOPIC_TOOLS_MUXADD_H_
...
PREDECLARE_BSON(topic_tools::MuxAdd); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxAdd); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxAdd & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 104324640U;
        ...
        static const unsigned int DATA_VERSION = 360139088U;
        ...
        //        static const char * dataTypeName() { return "MuxAdd"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "df40944c8ec1d3117e018afe5de3d32c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xdf40944c8ec1d311ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7e018afe5de3d32cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxAdd * copy() { return new MuxAdd(*this); };

        /** assignment operator(s) */
        MuxAdd & operator=(const MuxAdd & inobj);
        /** equality operator */
        bool operator==(const MuxAdd & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxAdd & inobj) const;
        /** less than operator */
        bool operator<(const MuxAdd & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxAdd & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxAdd>
    {
    public:
        static bool flat() {return topic_tools::MuxAdd::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxAdd::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxAdd & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxAdd & value);

#endif  //  _TOPIC_TOOLS_MUXADD_H_
