...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXSELECTRESPONSE_H_
#define _CODEGEN_TOPIC_TOOLS_MUXSELECTRESPONSE_H_
...
PREDECLARE_BSON(topic_tools::MuxSelectResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxSelectResponse); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxSelectResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxSelectResponse();
        /** copy constructor */
        MuxSelectResponse(const MuxSelectResponse & inobj);
        /** destructor */
        ~MuxSelectResponse();

        /** allocator, convenience function for bind */
        static MuxSelectResponse * New();
        ...
        static const unsigned int ID = 104324648U;
        ...
        static const unsigned int DATA_VERSION = 1708947810U;
        ...
        //        static const char * dataTypeName() { return "MuxSelectResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "cba43fb650a56af2c3b3715cbff7c94a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xcba43fb650a56af2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc3b3715cbff7c94aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxSelectResponse * copy() { return new MuxSelectResponse(*this); };

        /** assignment operator(s) */
        MuxSelectResponse & operator=(const MuxSelectResponse & inobj);
        /** equality operator */
        bool operator==(const MuxSelectResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxSelectResponse & inobj) const;
        /** less than operator */
        bool operator<(const MuxSelectResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxSelectResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxSelectResponse>
    {
    public:
        static bool flat() {return topic_tools::MuxSelectResponse::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxSelectResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxSelectResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxSelectResponse & value);

#endif  //  _TOPIC_TOOLS_MUXSELECTRESPONSE_H_
