...
#ifndef _CODEGEN_STD_MSGS_UINT16MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_UINT16MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::UInt16MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::UInt16MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UInt16MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        UInt16MultiArray();
        /** copy constructor */
        UInt16MultiArray(const UInt16MultiArray & inobj);
        /** destructor */
        ~UInt16MultiArray();

        /** allocator, convenience function for bind */
        static UInt16MultiArray * New();
        ...
        std::vector<unsigned short int >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109289U;
        ...
        static const unsigned int DATA_VERSION = 735445747U;
        ...
        //        static const char * dataTypeName() { return "UInt16MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b739a6304ae723ce0ebfb2c4e8e315b2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb739a6304ae723ceULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0ebfb2c4e8e315b2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UInt16MultiArray * copy() { return new UInt16MultiArray(*this); };

        /** assignment operator(s) */
        UInt16MultiArray & operator=(const UInt16MultiArray & inobj);
        /** equality operator */
        bool operator==(const UInt16MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const UInt16MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const UInt16MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UInt16MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::UInt16MultiArray>
    {
    public:
        static bool flat() {return std_msgs::UInt16MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::UInt16MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::UInt16MultiArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::UInt16MultiArray & value);

#endif  //  _STD_MSGS_UINT16MULTIARRAY_H_
