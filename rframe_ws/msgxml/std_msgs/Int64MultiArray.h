...
#ifndef _CODEGEN_STD_MSGS_INT64MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_INT64MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::Int64MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Int64MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Int64MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        Int64MultiArray();
        /** copy constructor */
        Int64MultiArray(const Int64MultiArray & inobj);
        /** destructor */
        ~Int64MultiArray();

        /** allocator, convenience function for bind */
        static Int64MultiArray * New();
        ...
        std::vector<long long int >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109281U;
        ...
        static const unsigned int DATA_VERSION = 2409286728U;
        ...
        //        static const char * dataTypeName() { return "Int64MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7373e67e0bb32ef15c7bb60a49eb9513"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7373e67e0bb32ef1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5c7bb60a49eb9513ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Int64MultiArray * copy() { return new Int64MultiArray(*this); };

        /** assignment operator(s) */
        Int64MultiArray & operator=(const Int64MultiArray & inobj);
        /** equality operator */
        bool operator==(const Int64MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const Int64MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const Int64MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Int64MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Int64MultiArray>
    {
    public:
        static bool flat() {return std_msgs::Int64MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Int64MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Int64MultiArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::Int64MultiArray & value);

#endif  //  _STD_MSGS_INT64MULTIARRAY_H_
