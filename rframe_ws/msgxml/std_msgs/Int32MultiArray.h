...
#ifndef _CODEGEN_STD_MSGS_INT32MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_INT32MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::Int32MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Int32MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Int32MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        Int32MultiArray();
        /** copy constructor */
        Int32MultiArray(const Int32MultiArray & inobj);
        /** destructor */
        ~Int32MultiArray();

        /** allocator, convenience function for bind */
        static Int32MultiArray * New();
        ...
        std::vector<int >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109279U;
        ...
        static const unsigned int DATA_VERSION = 1525709526U;
        ...
        //        static const char * dataTypeName() { return "Int32MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "06574caa5074814e890650fd3a2644b7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x06574caa5074814eULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x890650fd3a2644b7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Int32MultiArray * copy() { return new Int32MultiArray(*this); };

        /** assignment operator(s) */
        Int32MultiArray & operator=(const Int32MultiArray & inobj);
        /** equality operator */
        bool operator==(const Int32MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const Int32MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const Int32MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Int32MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Int32MultiArray>
    {
    public:
        static bool flat() {return std_msgs::Int32MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Int32MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Int32MultiArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::Int32MultiArray & value);

#endif  //  _STD_MSGS_INT32MULTIARRAY_H_
