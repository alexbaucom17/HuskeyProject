...
#ifndef _CODEGEN_STD_MSGS_HEADER_H_
#define _CODEGEN_STD_MSGS_HEADER_H_
...
PREDECLARE_BSON(std_msgs::Header); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Header); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Header & inobj);   
    ...
    */
    ...
    public: 
        ...
        unsigned int  seq; /**< Two-integer timestamp that is expressed as:  * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')  * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')  time-handling sugar is provided by the client library */
        std_msgs::RosTime  stamp; /**< Frame this data is associated with  0: no frame  1: global frame */
        std::string  frame_id; /**<  */
        ...
        static const unsigned int ID = 2068109275U;
        ...
        static const unsigned int DATA_VERSION = 3914014808U;
        ...
        //        static const char * dataTypeName() { return "Header"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "941a361684ae8c5c02a1b9701a0f5031"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x941a361684ae8c5cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x02a1b9701a0f5031ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Header * copy() { return new Header(*this); };

        /** assignment operator(s) */
        Header & operator=(const Header & inobj);
        /** equality operator */
        bool operator==(const Header & inobj) const;
        /** inequality operator */
        bool operator!=(const Header & inobj) const;
        /** less than operator */
        bool operator<(const Header & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Header & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Header>
    {
    public:
        static bool flat() {return std_msgs::Header::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Header::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Header & value);
