...
#ifndef _CODEGEN_STD_MSGS_BYTE_H_
#define _CODEGEN_STD_MSGS_BYTE_H_
...
PREDECLARE_BSON(std_msgs::Byte); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Byte); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Byte & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109265U;
        ...
        static const unsigned int DATA_VERSION = 267835261U;
        ...
        //        static const char * dataTypeName() { return "Byte"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7b15794aaa737e9d570ea4efe72b617a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7b15794aaa737e9dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x570ea4efe72b617aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Byte * copy() { return new Byte(*this); };

        /** assignment operator(s) */
        Byte & operator=(const Byte & inobj);
        /** equality operator */
        bool operator==(const Byte & inobj) const;
        /** inequality operator */
        bool operator!=(const Byte & inobj) const;
        /** less than operator */
        bool operator<(const Byte & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Byte & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Byte>
    {
    public:
        static bool flat() {return std_msgs::Byte::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Byte::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Byte & value);
