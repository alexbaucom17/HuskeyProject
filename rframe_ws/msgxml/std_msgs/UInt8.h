...
#ifndef _CODEGEN_STD_MSGS_UINT8_H_
#define _CODEGEN_STD_MSGS_UINT8_H_
...
PREDECLARE_BSON(std_msgs::UInt8); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::UInt8); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UInt8 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109294U;
        ...
        static const unsigned int DATA_VERSION = 80693792U;
        ...
        //        static const char * dataTypeName() { return "UInt8"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1bfb1ed8532e08e559ea0a09748e3178"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1bfb1ed8532e08e5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x59ea0a09748e3178ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UInt8 * copy() { return new UInt8(*this); };

        /** assignment operator(s) */
        UInt8 & operator=(const UInt8 & inobj);
        /** equality operator */
        bool operator==(const UInt8 & inobj) const;
        /** inequality operator */
        bool operator!=(const UInt8 & inobj) const;
        /** less than operator */
        bool operator<(const UInt8 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UInt8 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::UInt8>
    {
    public:
        static bool flat() {return std_msgs::UInt8::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::UInt8::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::UInt8 & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::UInt8 & value);

#endif  //  _STD_MSGS_UINT8_H_
