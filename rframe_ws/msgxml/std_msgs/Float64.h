...
#ifndef _CODEGEN_STD_MSGS_FLOAT64_H_
#define _CODEGEN_STD_MSGS_FLOAT64_H_
...
PREDECLARE_BSON(std_msgs::Float64); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Float64); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Float64 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109273U;
        ...
        static const unsigned int DATA_VERSION = 3566339230U;
        ...
        //        static const char * dataTypeName() { return "Float64"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "927704cf1edfbc32d5a2b08677431d20"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x927704cf1edfbc32ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd5a2b08677431d20ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Float64 * copy() { return new Float64(*this); };

        /** assignment operator(s) */
        Float64 & operator=(const Float64 & inobj);
        /** equality operator */
        bool operator==(const Float64 & inobj) const;
        /** inequality operator */
        bool operator!=(const Float64 & inobj) const;
        /** less than operator */
        bool operator<(const Float64 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Float64 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Float64>
    {
    public:
        static bool flat() {return std_msgs::Float64::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Float64::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Float64 & value);
