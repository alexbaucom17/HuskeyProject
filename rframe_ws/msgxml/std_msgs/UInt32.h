...
#ifndef _CODEGEN_STD_MSGS_UINT32_H_
#define _CODEGEN_STD_MSGS_UINT32_H_
...
PREDECLARE_BSON(std_msgs::UInt32); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::UInt32); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UInt32 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109290U;
        ...
        static const unsigned int DATA_VERSION = 3210247234U;
        ...
        //        static const char * dataTypeName() { return "UInt32"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "abb675249c70370a68aeee66980e97a5"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xabb675249c70370aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x68aeee66980e97a5ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UInt32 * copy() { return new UInt32(*this); };

        /** assignment operator(s) */
        UInt32 & operator=(const UInt32 & inobj);
        /** equality operator */
        bool operator==(const UInt32 & inobj) const;
        /** inequality operator */
        bool operator!=(const UInt32 & inobj) const;
        /** less than operator */
        bool operator<(const UInt32 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UInt32 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::UInt32>
    {
    public:
        static bool flat() {return std_msgs::UInt32::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::UInt32::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::UInt32 & value);
