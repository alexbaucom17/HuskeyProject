...
#ifndef _CODEGEN_STD_MSGS_INT8MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_INT8MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::Int8MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Int8MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Int8MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        Int8MultiArray();
        /** copy constructor */
        Int8MultiArray(const Int8MultiArray & inobj);
        /** destructor */
        ~Int8MultiArray();

        /** allocator, convenience function for bind */
        static Int8MultiArray * New();
        ...
        std::vector<char >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109283U;
        ...
        static const unsigned int DATA_VERSION = 4260318284U;
        ...
        //        static const char * dataTypeName() { return "Int8MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "283eb9e1a844b821cfbc9cbac21ae5c6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x283eb9e1a844b821ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcfbc9cbac21ae5c6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Int8MultiArray * copy() { return new Int8MultiArray(*this); };

        /** assignment operator(s) */
        Int8MultiArray & operator=(const Int8MultiArray & inobj);
        /** equality operator */
        bool operator==(const Int8MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const Int8MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const Int8MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Int8MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Int8MultiArray>
    {
    public:
        static bool flat() {return std_msgs::Int8MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Int8MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Int8MultiArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::Int8MultiArray & value);

#endif  //  _STD_MSGS_INT8MULTIARRAY_H_
