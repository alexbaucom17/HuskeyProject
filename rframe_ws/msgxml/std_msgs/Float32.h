...
#ifndef _CODEGEN_STD_MSGS_FLOAT32_H_
#define _CODEGEN_STD_MSGS_FLOAT32_H_
...
PREDECLARE_BSON(std_msgs::Float32); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Float32); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Float32 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109271U;
        ...
        static const unsigned int DATA_VERSION = 806149483U;
        ...
        //        static const char * dataTypeName() { return "Float32"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9178d79d280a8c97fea369385616df7b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9178d79d280a8c97ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfea369385616df7bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Float32 * copy() { return new Float32(*this); };

        /** assignment operator(s) */
        Float32 & operator=(const Float32 & inobj);
        /** equality operator */
        bool operator==(const Float32 & inobj) const;
        /** inequality operator */
        bool operator!=(const Float32 & inobj) const;
        /** less than operator */
        bool operator<(const Float32 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Float32 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Float32>
    {
    public:
        static bool flat() {return std_msgs::Float32::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Float32::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Float32 & value);
