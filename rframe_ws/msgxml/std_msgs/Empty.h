...
#ifndef _CODEGEN_STD_MSGS_EMPTY_H_
#define _CODEGEN_STD_MSGS_EMPTY_H_
...
PREDECLARE_BSON(std_msgs::Empty); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Empty); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Empty & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109270U;
        ...
        static const unsigned int DATA_VERSION = 2546935630U;
        ...
        //        static const char * dataTypeName() { return "Empty"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d14ec63a1f0d31492a6093c3836e90cd"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd14ec63a1f0d3149ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2a6093c3836e90cdULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Empty * copy() { return new Empty(*this); };

        /** assignment operator(s) */
        Empty & operator=(const Empty & inobj);
        /** equality operator */
        bool operator==(const Empty & inobj) const;
        /** inequality operator */
        bool operator!=(const Empty & inobj) const;
        /** less than operator */
        bool operator<(const Empty & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Empty & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Empty>
    {
    public:
        static bool flat() {return std_msgs::Empty::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Empty::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Empty & value);
