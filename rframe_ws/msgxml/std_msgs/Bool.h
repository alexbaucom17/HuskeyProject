...
#ifndef _CODEGEN_STD_MSGS_BOOL_H_
#define _CODEGEN_STD_MSGS_BOOL_H_
...
PREDECLARE_BSON(std_msgs::Bool); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Bool); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Bool & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109264U;
        ...
        static const unsigned int DATA_VERSION = 1382073393U;
        ...
        //        static const char * dataTypeName() { return "Bool"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d8082f862916f54764aef5fdb57208d2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd8082f862916f547ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x64aef5fdb57208d2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Bool * copy() { return new Bool(*this); };

        /** assignment operator(s) */
        Bool & operator=(const Bool & inobj);
        /** equality operator */
        bool operator==(const Bool & inobj) const;
        /** inequality operator */
        bool operator!=(const Bool & inobj) const;
        /** less than operator */
        bool operator<(const Bool & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Bool & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Bool>
    {
    public:
        static bool flat() {return std_msgs::Bool::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Bool::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Bool & value);
