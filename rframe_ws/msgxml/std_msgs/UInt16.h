...
#ifndef _CODEGEN_STD_MSGS_UINT16_H_
#define _CODEGEN_STD_MSGS_UINT16_H_
...
PREDECLARE_BSON(std_msgs::UInt16); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::UInt16); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UInt16 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109288U;
        ...
        static const unsigned int DATA_VERSION = 4080783450U;
        ...
        //        static const char * dataTypeName() { return "UInt16"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "54151ddd6a44a7995f120bcf27335771"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x54151ddd6a44a799ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5f120bcf27335771ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UInt16 * copy() { return new UInt16(*this); };

        /** assignment operator(s) */
        UInt16 & operator=(const UInt16 & inobj);
        /** equality operator */
        bool operator==(const UInt16 & inobj) const;
        /** inequality operator */
        bool operator!=(const UInt16 & inobj) const;
        /** less than operator */
        bool operator<(const UInt16 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UInt16 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::UInt16>
    {
    public:
        static bool flat() {return std_msgs::UInt16::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::UInt16::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::UInt16 & value);
