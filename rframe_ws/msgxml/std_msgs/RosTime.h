...
#ifndef _CODEGEN_STD_MSGS_ROSTIME_H_
#define _CODEGEN_STD_MSGS_ROSTIME_H_
...
PREDECLARE_BSON(std_msgs::RosTime); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::RosTime); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, RosTime & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109261U;
        ...
        static const unsigned int DATA_VERSION = 2964936180U;
        ...
        //        static const char * dataTypeName() { return "RosTime"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c75dd528378c5ed69572cbde258e3ff6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc75dd528378c5ed6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9572cbde258e3ff6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        RosTime * copy() { return new RosTime(*this); };

        /** assignment operator(s) */
        RosTime & operator=(const RosTime & inobj);
        /** equality operator */
        bool operator==(const RosTime & inobj) const;
        /** inequality operator */
        bool operator!=(const RosTime & inobj) const;
        /** less than operator */
        bool operator<(const RosTime & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, RosTime & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::RosTime>
    {
    public:
        static bool flat() {return std_msgs::RosTime::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::RosTime::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::RosTime & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::RosTime & value);

#endif  //  _STD_MSGS_ROSTIME_H_
