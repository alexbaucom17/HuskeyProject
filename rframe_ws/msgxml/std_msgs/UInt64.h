...
#ifndef _CODEGEN_STD_MSGS_UINT64_H_
#define _CODEGEN_STD_MSGS_UINT64_H_
...
PREDECLARE_BSON(std_msgs::UInt64); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::UInt64); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UInt64 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109292U;
        ...
        static const unsigned int DATA_VERSION = 3668915173U;
        ...
        //        static const char * dataTypeName() { return "UInt64"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6ed1641c6438a6e24087ad73f50ba26a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6ed1641c6438a6e2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4087ad73f50ba26aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UInt64 * copy() { return new UInt64(*this); };

        /** assignment operator(s) */
        UInt64 & operator=(const UInt64 & inobj);
        /** equality operator */
        bool operator==(const UInt64 & inobj) const;
        /** inequality operator */
        bool operator!=(const UInt64 & inobj) const;
        /** less than operator */
        bool operator<(const UInt64 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UInt64 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::UInt64>
    {
    public:
        static bool flat() {return std_msgs::UInt64::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::UInt64::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::UInt64 & value);
