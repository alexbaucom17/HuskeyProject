...
#ifndef _CODEGEN_STD_MSGS_BYTEMULTIARRAY_H_
#define _CODEGEN_STD_MSGS_BYTEMULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::ByteMultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::ByteMultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ByteMultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        ByteMultiArray();
        /** copy constructor */
        ByteMultiArray(const ByteMultiArray & inobj);
        /** destructor */
        ~ByteMultiArray();

        /** allocator, convenience function for bind */
        static ByteMultiArray * New();
        ...
        static const unsigned int ID = 2068109266U;
        ...
        static const unsigned int DATA_VERSION = 3800362126U;
        ...
        //        static const char * dataTypeName() { return "ByteMultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "31fe5dc58446cd2bd39d9d5f2670465b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x31fe5dc58446cd2bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd39d9d5f2670465bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ByteMultiArray * copy() { return new ByteMultiArray(*this); };

        /** assignment operator(s) */
        ByteMultiArray & operator=(const ByteMultiArray & inobj);
        /** equality operator */
        bool operator==(const ByteMultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const ByteMultiArray & inobj) const;
        /** less than operator */
        bool operator<(const ByteMultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ByteMultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::ByteMultiArray>
    {
    public:
        static bool flat() {return std_msgs::ByteMultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::ByteMultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::ByteMultiArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::ByteMultiArray & value);

#endif  //  _STD_MSGS_BYTEMULTIARRAY_H_
