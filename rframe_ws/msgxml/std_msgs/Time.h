...
#ifndef _CODEGEN_STD_MSGS_TIME_H_
#define _CODEGEN_STD_MSGS_TIME_H_
...
PREDECLARE_BSON(std_msgs::Time); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Time); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Time & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109287U;
        ...
        static const unsigned int DATA_VERSION = 2005932466U;
        ...
        //        static const char * dataTypeName() { return "Time"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b0f32abf2478fce73551af56be9dc6cb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb0f32abf2478fce7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3551af56be9dc6cbULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Time * copy() { return new Time(*this); };

        /** assignment operator(s) */
        Time & operator=(const Time & inobj);
        /** equality operator */
        bool operator==(const Time & inobj) const;
        /** inequality operator */
        bool operator!=(const Time & inobj) const;
        /** less than operator */
        bool operator<(const Time & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Time & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Time>
    {
    public:
        static bool flat() {return std_msgs::Time::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Time::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Time & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::Time & value);

#endif  //  _STD_MSGS_TIME_H_
