...
#ifndef _CODEGEN_STD_MSGS_UINT32MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_UINT32MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::UInt32MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::UInt32MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UInt32MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        UInt32MultiArray();
        /** copy constructor */
        UInt32MultiArray(const UInt32MultiArray & inobj);
        /** destructor */
        ~UInt32MultiArray();

        /** allocator, convenience function for bind */
        static UInt32MultiArray * New();
        ...
        std::vector<unsigned int >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109291U;
        ...
        static const unsigned int DATA_VERSION = 2537429964U;
        ...
        //        static const char * dataTypeName() { return "UInt32MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "adab3a26e4de865cbed91edb50903a9f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xadab3a26e4de865cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbed91edb50903a9fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UInt32MultiArray * copy() { return new UInt32MultiArray(*this); };

        /** assignment operator(s) */
        UInt32MultiArray & operator=(const UInt32MultiArray & inobj);
        /** equality operator */
        bool operator==(const UInt32MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const UInt32MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const UInt32MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UInt32MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::UInt32MultiArray>
    {
    public:
        static bool flat() {return std_msgs::UInt32MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::UInt32MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::UInt32MultiArray & value);
