...
#ifndef _CODEGEN_STD_MSGS_DURATION_H_
#define _CODEGEN_STD_MSGS_DURATION_H_
...
PREDECLARE_BSON(std_msgs::Duration); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Duration); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Duration & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109269U;
        ...
        static const unsigned int DATA_VERSION = 1959271277U;
        ...
        //        static const char * dataTypeName() { return "Duration"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a19d9fc755a9bd751e0fc28ac1183985"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa19d9fc755a9bd75ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1e0fc28ac1183985ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Duration * copy() { return new Duration(*this); };

        /** assignment operator(s) */
        Duration & operator=(const Duration & inobj);
        /** equality operator */
        bool operator==(const Duration & inobj) const;
        /** inequality operator */
        bool operator!=(const Duration & inobj) const;
        /** less than operator */
        bool operator<(const Duration & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Duration & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Duration>
    {
    public:
        static bool flat() {return std_msgs::Duration::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Duration::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Duration & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::Duration & value);

#endif  //  _STD_MSGS_DURATION_H_
