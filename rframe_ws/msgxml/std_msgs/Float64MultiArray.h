...
#ifndef _CODEGEN_STD_MSGS_FLOAT64MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_FLOAT64MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::Float64MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Float64MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Float64MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        Float64MultiArray();
        /** copy constructor */
        Float64MultiArray(const Float64MultiArray & inobj);
        /** destructor */
        ~Float64MultiArray();

        /** allocator, convenience function for bind */
        static Float64MultiArray * New();
        ...
        std::vector<double >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109274U;
        ...
        static const unsigned int DATA_VERSION = 2250748860U;
        ...
        //        static const char * dataTypeName() { return "Float64MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "84d0ac7fff9dae67ea8049fe514f42af"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x84d0ac7fff9dae67ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xea8049fe514f42afULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Float64MultiArray * copy() { return new Float64MultiArray(*this); };

        /** assignment operator(s) */
        Float64MultiArray & operator=(const Float64MultiArray & inobj);
        /** equality operator */
        bool operator==(const Float64MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const Float64MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const Float64MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Float64MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Float64MultiArray>
    {
    public:
        static bool flat() {return std_msgs::Float64MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Float64MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Float64MultiArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::Float64MultiArray & value);

#endif  //  _STD_MSGS_FLOAT64MULTIARRAY_H_
