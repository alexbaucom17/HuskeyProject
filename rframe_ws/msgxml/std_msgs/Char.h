...
#ifndef _CODEGEN_STD_MSGS_CHAR_H_
#define _CODEGEN_STD_MSGS_CHAR_H_
...
PREDECLARE_BSON(std_msgs::Char); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Char); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Char & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109267U;
        ...
        static const unsigned int DATA_VERSION = 3207095791U;
        ...
        //        static const char * dataTypeName() { return "Char"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "fa5d7efd95e8ff3c6f4017e489ab3beb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfa5d7efd95e8ff3cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6f4017e489ab3bebULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Char * copy() { return new Char(*this); };

        /** assignment operator(s) */
        Char & operator=(const Char & inobj);
        /** equality operator */
        bool operator==(const Char & inobj) const;
        /** inequality operator */
        bool operator!=(const Char & inobj) const;
        /** less than operator */
        bool operator<(const Char & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Char & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Char>
    {
    public:
        static bool flat() {return std_msgs::Char::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Char::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Char & value);
