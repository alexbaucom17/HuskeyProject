...
#ifndef _CODEGEN_STD_MSGS_UINT8MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_UINT8MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::UInt8MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::UInt8MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UInt8MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        UInt8MultiArray();
        /** copy constructor */
        UInt8MultiArray(const UInt8MultiArray & inobj);
        /** destructor */
        ~UInt8MultiArray();

        /** allocator, convenience function for bind */
        static UInt8MultiArray * New();
        ...
        std::vector<unsigned char >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109295U;
        ...
        static const unsigned int DATA_VERSION = 3205788949U;
        ...
        //        static const char * dataTypeName() { return "UInt8MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "aec8e57aad2a688ade0688ed09d1d25a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xaec8e57aad2a688aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xde0688ed09d1d25aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UInt8MultiArray * copy() { return new UInt8MultiArray(*this); };

        /** assignment operator(s) */
        UInt8MultiArray & operator=(const UInt8MultiArray & inobj);
        /** equality operator */
        bool operator==(const UInt8MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const UInt8MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const UInt8MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UInt8MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::UInt8MultiArray>
    {
    public:
        static bool flat() {return std_msgs::UInt8MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::UInt8MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::UInt8MultiArray & value);
