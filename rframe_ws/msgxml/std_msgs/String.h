...
#ifndef _CODEGEN_STD_MSGS_STRING_H_
#define _CODEGEN_STD_MSGS_STRING_H_
...
PREDECLARE_BSON(std_msgs::String); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::String); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, String & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109286U;
        ...
        static const unsigned int DATA_VERSION = 189357253U;
        ...
        //        static const char * dataTypeName() { return "String"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7e2537ed99418d7d8fd985d823b8e41b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7e2537ed99418d7dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8fd985d823b8e41bULL;
        ...
        String & operator=(const String & inobj);
        /** equality operator */
        bool operator==(const String & inobj) const;
        /** inequality operator */
        bool operator!=(const String & inobj) const;
        /** less than operator */
        bool operator<(const String & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, String & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::String>
    {
    public:
        static bool flat() {return std_msgs::String::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::String::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::String & value);
