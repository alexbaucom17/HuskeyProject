...
#ifndef _CODEGEN_STD_MSGS_HEADERTEST_H_
#define _CODEGEN_STD_MSGS_HEADERTEST_H_
...
PREDECLARE_BSON(std_msgs::HeaderTest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::HeaderTest); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, HeaderTest & inobj);   

    /** 
        \ingroup CodeGen
        testing of header serialization
    */
    class HeaderTest
    {
    public: 
        ...
        HeaderTest();
        /** copy constructor */
        HeaderTest(const HeaderTest & inobj);
        /** destructor */
        ~HeaderTest();

        /** allocator, convenience function for bind */
        static HeaderTest * New();
        ...
        std_msgs::Header  header2; /**< ros header */
        ...
        static const unsigned int ID = 2068109263U;
        ...
        static const unsigned int DATA_VERSION = 3415790301U;
        ...
        //        static const char * dataTypeName() { return "HeaderTest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bf966b0769097e322bc8dc3af8b05877"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbf966b0769097e32ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2bc8dc3af8b05877ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        HeaderTest * copy() { return new HeaderTest(*this); };

        /** assignment operator(s) */
        HeaderTest & operator=(const HeaderTest & inobj);
        /** equality operator */
        bool operator==(const HeaderTest & inobj) const;
        /** inequality operator */
        bool operator!=(const HeaderTest & inobj) const;
        /** less than operator */
        bool operator<(const HeaderTest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, HeaderTest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::HeaderTest>
    {
    public:
        static bool flat() {return std_msgs::HeaderTest::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::HeaderTest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::HeaderTest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::HeaderTest & value);

#endif  //  _STD_MSGS_HEADERTEST_H_
