...
#ifndef _CODEGEN_STD_MSGS_INT16MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_INT16MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::Int16MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Int16MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Int16MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        Int16MultiArray();
        /** copy constructor */
        Int16MultiArray(const Int16MultiArray & inobj);
        /** destructor */
        ~Int16MultiArray();

        /** allocator, convenience function for bind */
        static Int16MultiArray * New();
        ...
        std::vector<short int >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109277U;
        ...
        static const unsigned int DATA_VERSION = 2531370436U;
        ...
        //        static const char * dataTypeName() { return "Int16MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "08e3d79d4ee9706f2f5cfd63e5138373"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x08e3d79d4ee9706fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2f5cfd63e5138373ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Int16MultiArray * copy() { return new Int16MultiArray(*this); };

        /** assignment operator(s) */
        Int16MultiArray & operator=(const Int16MultiArray & inobj);
        /** equality operator */
        bool operator==(const Int16MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const Int16MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const Int16MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Int16MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Int16MultiArray>
    {
    public:
        static bool flat() {return std_msgs::Int16MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Int16MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Int16MultiArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::Int16MultiArray & value);

#endif  //  _STD_MSGS_INT16MULTIARRAY_H_
