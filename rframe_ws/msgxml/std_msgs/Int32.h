...
#ifndef _CODEGEN_STD_MSGS_INT32_H_
#define _CODEGEN_STD_MSGS_INT32_H_
...
PREDECLARE_BSON(std_msgs::Int32); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Int32); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Int32 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109278U;
        ...
        static const unsigned int DATA_VERSION = 2829743221U;
        ...
        //        static const char * dataTypeName() { return "Int32"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "336d0d415f36a9896c036970a765447a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x336d0d415f36a989ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6c036970a765447aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Int32 * copy() { return new Int32(*this); };

        /** assignment operator(s) */
        Int32 & operator=(const Int32 & inobj);
        /** equality operator */
        bool operator==(const Int32 & inobj) const;
        /** inequality operator */
        bool operator!=(const Int32 & inobj) const;
        /** less than operator */
        bool operator<(const Int32 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Int32 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Int32>
    {
    public:
        static bool flat() {return std_msgs::Int32::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Int32::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Int32 & value);
