...
#ifndef _CODEGEN_STD_MSGS_UINT64MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_UINT64MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::UInt64MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::UInt64MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UInt64MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        UInt64MultiArray();
        /** copy constructor */
        UInt64MultiArray(const UInt64MultiArray & inobj);
        /** destructor */
        ~UInt64MultiArray();

        /** allocator, convenience function for bind */
        static UInt64MultiArray * New();
        ...
        std::vector<unsigned long long int >  data; /**< array of data */
        ...
        static const unsigned int ID = 2068109293U;
        ...
        static const unsigned int DATA_VERSION = 2619081785U;
        ...
        //        static const char * dataTypeName() { return "UInt64MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "84d0d840c46d09599e4475cfc5f43425"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x84d0d840c46d0959ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9e4475cfc5f43425ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UInt64MultiArray * copy() { return new UInt64MultiArray(*this); };

        /** assignment operator(s) */
        UInt64MultiArray & operator=(const UInt64MultiArray & inobj);
        /** equality operator */
        bool operator==(const UInt64MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const UInt64MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const UInt64MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UInt64MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::UInt64MultiArray>
    {
    public:
        static bool flat() {return std_msgs::UInt64MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::UInt64MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::UInt64MultiArray & value);
