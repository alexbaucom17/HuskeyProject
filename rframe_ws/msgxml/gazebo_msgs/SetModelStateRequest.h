...
#ifndef _CODEGEN_GAZEBO_MSGS_SETMODELSTATEREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_SETMODELSTATEREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::SetModelStateRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetModelStateRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetModelStateRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetModelStateRequest(const SetModelStateRequest & inobj);
        /** destructor */
        ~SetModelStateRequest();

        /** allocator, convenience function for bind */
        static SetModelStateRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        gazebo_msgs::ModelState  model_state; /**< no comment provided */
        ...
        static const unsigned int ID = 1781288173U;
        ...
        static const unsigned int DATA_VERSION = 3700190167U;
        ...
        //        static const char * dataTypeName() { return "SetModelStateRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3bb832d8551b1fb00f1a52f3ed3db212"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3bb832d8551b1fb0ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0f1a52f3ed3db212ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetModelStateRequest * copy() { return new SetModelStateRequest(*this); };

        /** assignment operator(s) */
        SetModelStateRequest & operator=(const SetModelStateRequest & inobj);
        /** equality operator */
        bool operator==(const SetModelStateRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetModelStateRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetModelStateRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetModelStateRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetModelStateRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::SetModelStateRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetModelStateRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetModelStateRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetModelStateRequest & value);

#endif  //  _GAZEBO_MSGS_SETMODELSTATEREQUEST_H_
