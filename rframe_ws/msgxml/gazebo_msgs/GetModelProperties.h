...
#ifndef _CODEGEN_GAZEBO_MSGS_GETMODELPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_GETMODELPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::GetModelProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetModelProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetModelProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetModelProperties();
        /** copy constructor */
        GetModelProperties(const GetModelProperties & inobj);
        /** destructor */
        ~GetModelProperties();

        /** allocator, convenience function for bind */
        static GetModelProperties * New();
        ...
        static const unsigned int ID = 1781288145U;
        ...
        static const unsigned int DATA_VERSION = 1768444928U;
        ...
        //        static const char * dataTypeName() { return "GetModelProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bb3c53029e7ea9fddddc3d5a0ce9da65"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbb3c53029e7ea9fdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdddc3d5a0ce9da65ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetModelProperties * copy() { return new GetModelProperties(*this); };

        /** assignment operator(s) */
        GetModelProperties & operator=(const GetModelProperties & inobj);
        /** equality operator */
        bool operator==(const GetModelProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const GetModelProperties & inobj) const;
        /** less than operator */
        bool operator<(const GetModelProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetModelProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetModelProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::GetModelProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetModelProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetModelProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetModelProperties & value);

#endif  //  _GAZEBO_MSGS_GETMODELPROPERTIES_H_
