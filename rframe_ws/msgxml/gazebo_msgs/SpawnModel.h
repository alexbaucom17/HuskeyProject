...
#ifndef _CODEGEN_GAZEBO_MSGS_SPAWNMODEL_H_
#define _CODEGEN_GAZEBO_MSGS_SPAWNMODEL_H_
...
PREDECLARE_BSON(gazebo_msgs::SpawnModel); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SpawnModel); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SpawnModel & inobj);   
    ...
    */
    ...
    public: 
        ...
        SpawnModel();
        /** copy constructor */
        SpawnModel(const SpawnModel & inobj);
        /** destructor */
        ~SpawnModel();

        /** allocator, convenience function for bind */
        static SpawnModel * New();
        ...
        static const unsigned int ID = 1781288181U;
        ...
        static const unsigned int DATA_VERSION = 2706948362U;
        ...
        //        static const char * dataTypeName() { return "SpawnModel"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "504218a1716888f2f599535146f386d8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x504218a1716888f2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf599535146f386d8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SpawnModel * copy() { return new SpawnModel(*this); };

        /** assignment operator(s) */
        SpawnModel & operator=(const SpawnModel & inobj);
        /** equality operator */
        bool operator==(const SpawnModel & inobj) const;
        /** inequality operator */
        bool operator!=(const SpawnModel & inobj) const;
        /** less than operator */
        bool operator<(const SpawnModel & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SpawnModel & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SpawnModel>
    {
    public:
        static bool flat() {return gazebo_msgs::SpawnModel::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SpawnModel::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SpawnModel & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SpawnModel & value);

#endif  //  _GAZEBO_MSGS_SPAWNMODEL_H_
