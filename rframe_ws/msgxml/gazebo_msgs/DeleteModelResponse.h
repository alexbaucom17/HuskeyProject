...
#ifndef _CODEGEN_GAZEBO_MSGS_DELETEMODELRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_DELETEMODELRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::DeleteModelResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::DeleteModelResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DeleteModelResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        DeleteModelResponse();
        /** copy constructor */
        DeleteModelResponse(const DeleteModelResponse & inobj);
        /** destructor */
        ~DeleteModelResponse();

        /** allocator, convenience function for bind */
        static DeleteModelResponse * New();
        ...
        static const unsigned int ID = 1781288132U;
        ...
        static const unsigned int DATA_VERSION = 2060846137U;
        ...
        //        static const char * dataTypeName() { return "DeleteModelResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "84e0bdb17be810305fe5af58c8e0dcf8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x84e0bdb17be81030ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5fe5af58c8e0dcf8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DeleteModelResponse * copy() { return new DeleteModelResponse(*this); };

        /** assignment operator(s) */
        DeleteModelResponse & operator=(const DeleteModelResponse & inobj);
        /** equality operator */
        bool operator==(const DeleteModelResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const DeleteModelResponse & inobj) const;
        /** less than operator */
        bool operator<(const DeleteModelResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DeleteModelResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::DeleteModelResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::DeleteModelResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::DeleteModelResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::DeleteModelResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::DeleteModelResponse & value);

#endif  //  _GAZEBO_MSGS_DELETEMODELRESPONSE_H_
