...
#ifndef _CODEGEN_GAZEBO_MSGS_CONTACTSTATE_H_
#define _CODEGEN_GAZEBO_MSGS_CONTACTSTATE_H_
...
PREDECLARE_BSON(gazebo_msgs::ContactState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ContactState); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ContactState & inobj);   
    ...
    */
    ...
    public: 
        ...
        ContactState();
        /** copy constructor */
        ContactState(const ContactState & inobj);
        /** destructor */
        ~ContactState();

        /** allocator, convenience function for bind */
        static ContactState * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  info; /**< text info on this contact */
        std::string  collision1_name; /**< name of contact collision1 */
        std::string  collision2_name; /**< name of contact collision2 */
        std::vector<geometry_msgs::Wrench >  wrenches; /**< list of forces/torques */
        geometry_msgs::Wrench  total_wrench; /**< sum of forces/torques in every DOF */
        std::vector<geometry_msgs::Vector3 >  contact_positions; /**< list of contact position */
        std::vector<geometry_msgs::Vector3 >  contact_normals; /**< list of contact normals */
        std::vector<double >  depths; /**< list of penetration depths */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_INFO,
            DAQ_1_COLLISION1_NAME,
            DAQ_2_COLLISION2_NAME,
            DAQ_3_WRENCHES,
            DAQ_4_TOTAL_WRENCH,
            DAQ_5_CONTACT_POSITIONS,
            DAQ_6_CONTACT_NORMALS,
            DAQ_7_DEPTHS,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288113U;
        ...
        static const unsigned int DATA_VERSION = 3701150858U;
        ...
        //        static const char * dataTypeName() { return "ContactState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e6448d383e4a796fce7245eee9a8ff65"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe6448d383e4a796fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xce7245eee9a8ff65ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ContactState * copy() { return new ContactState(*this); };

        /** assignment operator(s) */
        ContactState & operator=(const ContactState & inobj);
        /** equality operator */
        bool operator==(const ContactState & inobj) const;
        /** inequality operator */
        bool operator!=(const ContactState & inobj) const;
        /** less than operator */
        bool operator<(const ContactState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ContactState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ContactState>
    {
    public:
        static bool flat() {return gazebo_msgs::ContactState::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ContactState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ContactState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ContactState & value);

#endif  //  _GAZEBO_MSGS_CONTACTSTATE_H_
