...
#ifndef _CODEGEN_GAZEBO_MSGS_SETJOINTPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_SETJOINTPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::SetJointProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetJointProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetJointProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetJointProperties();
        /** copy constructor */
        SetJointProperties(const SetJointProperties & inobj);
        /** destructor */
        ~SetJointProperties();

        /** allocator, convenience function for bind */
        static SetJointProperties * New();
        ...
        static const unsigned int ID = 1781288160U;
        ...
        static const unsigned int DATA_VERSION = 687650671U;
        ...
        //        static const char * dataTypeName() { return "SetJointProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f8f345895db8509a14f70847cdc24a3e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf8f345895db8509aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x14f70847cdc24a3eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetJointProperties * copy() { return new SetJointProperties(*this); };

        /** assignment operator(s) */
        SetJointProperties & operator=(const SetJointProperties & inobj);
        /** equality operator */
        bool operator==(const SetJointProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const SetJointProperties & inobj) const;
        /** less than operator */
        bool operator<(const SetJointProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetJointProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetJointProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::SetJointProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetJointProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetJointProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetJointProperties & value);

#endif  //  _GAZEBO_MSGS_SETJOINTPROPERTIES_H_
