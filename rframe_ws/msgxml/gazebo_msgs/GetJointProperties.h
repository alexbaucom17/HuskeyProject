...
#ifndef _CODEGEN_GAZEBO_MSGS_GETJOINTPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_GETJOINTPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::GetJointProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetJointProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetJointProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetJointProperties();
        /** copy constructor */
        GetJointProperties(const GetJointProperties & inobj);
        /** destructor */
        ~GetJointProperties();

        /** allocator, convenience function for bind */
        static GetJointProperties * New();
        ...
        static const unsigned int ID = 1781288136U;
        ...
        static const unsigned int DATA_VERSION = 2020488305U;
        ...
        //        static const char * dataTypeName() { return "GetJointProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "742f91975c2331b593748536aeee9c87"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x742f91975c2331b5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x93748536aeee9c87ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetJointProperties * copy() { return new GetJointProperties(*this); };

        /** assignment operator(s) */
        GetJointProperties & operator=(const GetJointProperties & inobj);
        /** equality operator */
        bool operator==(const GetJointProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const GetJointProperties & inobj) const;
        /** less than operator */
        bool operator<(const GetJointProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetJointProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetJointProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::GetJointProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetJointProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetJointProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetJointProperties & value);

#endif  //  _GAZEBO_MSGS_GETJOINTPROPERTIES_H_
