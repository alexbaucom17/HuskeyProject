...
#ifndef _CODEGEN_GAZEBO_MSGS_GETMODELPROPERTIESRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_GETMODELPROPERTIESRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::GetModelPropertiesResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetModelPropertiesResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetModelPropertiesResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetModelPropertiesResponse(const GetModelPropertiesResponse & inobj);
        /** destructor */
        ~GetModelPropertiesResponse();

        /** allocator, convenience function for bind */
        static GetModelPropertiesResponse * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  parent_model_name; /**< parent model */
        std::string  canonical_body_name; /**< name of canonical body, body names are prefixed by model name, e.g. pr2::base_link */
        std::vector<std::string >  body_names; /**< list of bodies, body names are prefixed by model name, e.g. pr2::base_link */
        std::vector<std::string >  geom_names; /**< list of geoms */
        std::vector<std::string >  joint_names; /**< list of joints attached to the model */
        std::vector<std::string >  child_model_names; /**< list of child models */
        ...
        typedef enum
        { 
            DAQ_0_PARENT_MODEL_NAME,
            DAQ_1_CANONICAL_BODY_NAME,
            DAQ_2_BODY_NAMES,
            DAQ_3_GEOM_NAMES,
            DAQ_4_JOINT_NAMES,
            DAQ_5_CHILD_MODEL_NAMES,
            DAQ_6_IS_STATIC,
            DAQ_7_SUCCESS,
            DAQ_8_STATUS_MESSAGE,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288144U;
        ...
        static const unsigned int DATA_VERSION = 3485529571U;
        ...
        //        static const char * dataTypeName() { return "GetModelPropertiesResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "41cd2fb57d3971b870baf68a01701756"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x41cd2fb57d3971b8ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x70baf68a01701756ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetModelPropertiesResponse * copy() { return new GetModelPropertiesResponse(*this); };

        /** assignment operator(s) */
        GetModelPropertiesResponse & operator=(const GetModelPropertiesResponse & inobj);
        /** equality operator */
        bool operator==(const GetModelPropertiesResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetModelPropertiesResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetModelPropertiesResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetModelPropertiesResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetModelPropertiesResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::GetModelPropertiesResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetModelPropertiesResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetModelPropertiesResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetModelPropertiesResponse & value);

#endif  //  _GAZEBO_MSGS_GETMODELPROPERTIESRESPONSE_H_
