...
#ifndef _CODEGEN_GAZEBO_MSGS_SETJOINTTRAJECTORYREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_SETJOINTTRAJECTORYREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::SetJointTrajectoryRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetJointTrajectoryRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetJointTrajectoryRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetJointTrajectoryRequest(const SetJointTrajectoryRequest & inobj);
        /** destructor */
        ~SetJointTrajectoryRequest();

        /** allocator, convenience function for bind */
        static SetJointTrajectoryRequest * New();
        ...
        bool  set_model_pose; /**<  */
        bool  disable_physics_updates; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_MODEL_NAME,
            DAQ_1_JOINT_TRAJECTORY,
            DAQ_2_MODEL_POSE,
            DAQ_3_SET_MODEL_POSE,
            DAQ_4_DISABLE_PHYSICS_UPDATES,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288161U;
        ...
        static const unsigned int DATA_VERSION = 119657524U;
        ...
        //        static const char * dataTypeName() { return "SetJointTrajectoryRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b95e2b1774ef9c7bb6ac860e3d2c8500"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb95e2b1774ef9c7bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb6ac860e3d2c8500ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetJointTrajectoryRequest * copy() { return new SetJointTrajectoryRequest(*this); };

        /** assignment operator(s) */
        SetJointTrajectoryRequest & operator=(const SetJointTrajectoryRequest & inobj);
        /** equality operator */
        bool operator==(const SetJointTrajectoryRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetJointTrajectoryRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetJointTrajectoryRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetJointTrajectoryRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetJointTrajectoryRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::SetJointTrajectoryRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetJointTrajectoryRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetJointTrajectoryRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetJointTrajectoryRequest & value);

#endif  //  _GAZEBO_MSGS_SETJOINTTRAJECTORYREQUEST_H_
