...
#ifndef _CODEGEN_GAZEBO_MSGS_BODYREQUESTREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_BODYREQUESTREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::BodyRequestRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::BodyRequestRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, BodyRequestRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        BodyRequestRequest();
        /** copy constructor */
        BodyRequestRequest(const BodyRequestRequest & inobj);
        /** destructor */
        ~BodyRequestRequest();

        /** allocator, convenience function for bind */
        static BodyRequestRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  body_name; /**< no comment provided */
        ...
        static const unsigned int ID = 1781288128U;
        ...
        static const unsigned int DATA_VERSION = 3910242763U;
        ...
        //        static const char * dataTypeName() { return "BodyRequestRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e6518479fa4880b1bdcc9afb5fa92199"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe6518479fa4880b1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbdcc9afb5fa92199ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        BodyRequestRequest * copy() { return new BodyRequestRequest(*this); };

        /** assignment operator(s) */
        BodyRequestRequest & operator=(const BodyRequestRequest & inobj);
        /** equality operator */
        bool operator==(const BodyRequestRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const BodyRequestRequest & inobj) const;
        /** less than operator */
        bool operator<(const BodyRequestRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, BodyRequestRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::BodyRequestRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::BodyRequestRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::BodyRequestRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::BodyRequestRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::BodyRequestRequest & value);

#endif  //  _GAZEBO_MSGS_BODYREQUESTREQUEST_H_
