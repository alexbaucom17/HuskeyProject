...
#ifndef _CODEGEN_GAZEBO_MSGS_GETPHYSICSPROPERTIESRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_GETPHYSICSPROPERTIESRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::GetPhysicsPropertiesResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetPhysicsPropertiesResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPhysicsPropertiesResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetPhysicsPropertiesResponse(const GetPhysicsPropertiesResponse & inobj);
        /** destructor */
        ~GetPhysicsPropertiesResponse();

        /** allocator, convenience function for bind */
        static GetPhysicsPropertiesResponse * New();
        ...
        { 
            DAQ_0_TIME_STEP,
            DAQ_1_PAUSE,
            DAQ_2_MAX_UPDATE_RATE,
            DAQ_3_GRAVITY,
            DAQ_4_ODE_CONFIG,
            DAQ_5_SUCCESS,
            DAQ_6_STATUS_MESSAGE,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288150U;
        ...
        static const unsigned int DATA_VERSION = 2468180658U;
        ...
        //        static const char * dataTypeName() { return "GetPhysicsPropertiesResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e1f4b6dffdb2fb9fb8ee17d68df3bf70"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe1f4b6dffdb2fb9fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb8ee17d68df3bf70ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPhysicsPropertiesResponse * copy() { return new GetPhysicsPropertiesResponse(*this); };

        /** assignment operator(s) */
        GetPhysicsPropertiesResponse & operator=(const GetPhysicsPropertiesResponse & inobj);
        /** equality operator */
        bool operator==(const GetPhysicsPropertiesResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPhysicsPropertiesResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetPhysicsPropertiesResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPhysicsPropertiesResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetPhysicsPropertiesResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::GetPhysicsPropertiesResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetPhysicsPropertiesResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetPhysicsPropertiesResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetPhysicsPropertiesResponse & value);

#endif  //  _GAZEBO_MSGS_GETPHYSICSPROPERTIESRESPONSE_H_
