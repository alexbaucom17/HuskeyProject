...
#ifndef _CODEGEN_GAZEBO_MSGS_ODEJOINTPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_ODEJOINTPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::ODEJointProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ODEJointProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ODEJointProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        ODEJointProperties();
        /** copy constructor */
        ODEJointProperties(const ODEJointProperties & inobj);
        /** destructor */
        ~ODEJointProperties();

        /** allocator, convenience function for bind */
        static ODEJointProperties * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::vector<double >  damping; /**< joint damping */
        std::vector<double >  hiStop; /**< joint limit */
        std::vector<double >  loStop; /**< joint limit */
        std::vector<double >  erp; /**< set joint erp */
        std::vector<double >  cfm; /**< set joint cfm */
        std::vector<double >  stop_erp; /**< set joint erp for joint limit "contact" joint */
        std::vector<double >  stop_cfm; /**< set joint cfm for joint limit "contact" joint */
        std::vector<double >  fudge_factor; /**< joint fudge_factor applied at limits, see ODE manual for info. */
        std::vector<double >  fmax; /**< ode joint param fmax */
        std::vector<double >  vel; /**< ode joint param vel */
        ...
        static const unsigned int ID = 1781288119U;
        ...
        static const unsigned int DATA_VERSION = 3804265748U;
        ...
        //        static const char * dataTypeName() { return "ODEJointProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "01872e2f8392eb916def52a68e136b20"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x01872e2f8392eb91ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6def52a68e136b20ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ODEJointProperties * copy() { return new ODEJointProperties(*this); };

        /** assignment operator(s) */
        ODEJointProperties & operator=(const ODEJointProperties & inobj);
        /** equality operator */
        bool operator==(const ODEJointProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const ODEJointProperties & inobj) const;
        /** less than operator */
        bool operator<(const ODEJointProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ODEJointProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ODEJointProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::ODEJointProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ODEJointProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ODEJointProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ODEJointProperties & value);

#endif  //  _GAZEBO_MSGS_ODEJOINTPROPERTIES_H_
