...
#ifndef _CODEGEN_GAZEBO_MSGS_SETJOINTTRAJECTORYRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_SETJOINTTRAJECTORYRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::SetJointTrajectoryResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetJointTrajectoryResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetJointTrajectoryResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetJointTrajectoryResponse(const SetJointTrajectoryResponse & inobj);
        /** destructor */
        ~SetJointTrajectoryResponse();

        /** allocator, convenience function for bind */
        static SetJointTrajectoryResponse * New();
        ...
        static const unsigned int ID = 1781288162U;
        ...
        static const unsigned int DATA_VERSION = 1733439087U;
        ...
        //        static const char * dataTypeName() { return "SetJointTrajectoryResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ff8d47d4f9d2da5e0d7341b467de9de6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xff8d47d4f9d2da5eULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0d7341b467de9de6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetJointTrajectoryResponse * copy() { return new SetJointTrajectoryResponse(*this); };

        /** assignment operator(s) */
        SetJointTrajectoryResponse & operator=(const SetJointTrajectoryResponse & inobj);
        /** equality operator */
        bool operator==(const SetJointTrajectoryResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetJointTrajectoryResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetJointTrajectoryResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetJointTrajectoryResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetJointTrajectoryResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::SetJointTrajectoryResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetJointTrajectoryResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetJointTrajectoryResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetJointTrajectoryResponse & value);

#endif  //  _GAZEBO_MSGS_SETJOINTTRAJECTORYRESPONSE_H_
