...
#ifndef _CODEGEN_GAZEBO_MSGS_APPLYBODYWRENCHRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_APPLYBODYWRENCHRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::ApplyBodyWrenchResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ApplyBodyWrenchResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ApplyBodyWrenchResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        ApplyBodyWrenchResponse(const ApplyBodyWrenchResponse & inobj);
        /** destructor */
        ~ApplyBodyWrenchResponse();

        /** allocator, convenience function for bind */
        static ApplyBodyWrenchResponse * New();
        ...
        static const unsigned int ID = 1781288123U;
        ...
        static const unsigned int DATA_VERSION = 4250818212U;
        ...
        //        static const char * dataTypeName() { return "ApplyBodyWrenchResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "69781abe69d88e6d5d204db7d31a4006"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x69781abe69d88e6dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5d204db7d31a4006ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ApplyBodyWrenchResponse * copy() { return new ApplyBodyWrenchResponse(*this); };

        /** assignment operator(s) */
        ApplyBodyWrenchResponse & operator=(const ApplyBodyWrenchResponse & inobj);
        /** equality operator */
        bool operator==(const ApplyBodyWrenchResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const ApplyBodyWrenchResponse & inobj) const;
        /** less than operator */
        bool operator<(const ApplyBodyWrenchResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ApplyBodyWrenchResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ApplyBodyWrenchResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::ApplyBodyWrenchResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ApplyBodyWrenchResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ApplyBodyWrenchResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ApplyBodyWrenchResponse & value);

#endif  //  _GAZEBO_MSGS_APPLYBODYWRENCHRESPONSE_H_
