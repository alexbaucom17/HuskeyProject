...
#ifndef _CODEGEN_GAZEBO_MSGS_SETMODELCONFIGURATION_H_
#define _CODEGEN_GAZEBO_MSGS_SETMODELCONFIGURATION_H_
...
PREDECLARE_BSON(gazebo_msgs::SetModelConfiguration); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetModelConfiguration); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetModelConfiguration & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetModelConfiguration(const SetModelConfiguration & inobj);
        /** destructor */
        ~SetModelConfiguration();

        /** allocator, convenience function for bind */
        static SetModelConfiguration * New();
        ...
        static const unsigned int ID = 1781288172U;
        ...
        static const unsigned int DATA_VERSION = 1900524334U;
        ...
        //        static const char * dataTypeName() { return "SetModelConfiguration"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8920e2f7f5496e43d92bb9858baed450"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8920e2f7f5496e43ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd92bb9858baed450ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetModelConfiguration * copy() { return new SetModelConfiguration(*this); };

        /** assignment operator(s) */
        SetModelConfiguration & operator=(const SetModelConfiguration & inobj);
        /** equality operator */
        bool operator==(const SetModelConfiguration & inobj) const;
        /** inequality operator */
        bool operator!=(const SetModelConfiguration & inobj) const;
        /** less than operator */
        bool operator<(const SetModelConfiguration & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetModelConfiguration & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetModelConfiguration>
    {
    public:
        static bool flat() {return gazebo_msgs::SetModelConfiguration::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetModelConfiguration::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetModelConfiguration & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetModelConfiguration & value);

#endif  //  _GAZEBO_MSGS_SETMODELCONFIGURATION_H_
