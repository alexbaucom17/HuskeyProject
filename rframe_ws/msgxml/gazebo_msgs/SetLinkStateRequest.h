...
#ifndef _CODEGEN_GAZEBO_MSGS_SETLINKSTATEREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_SETLINKSTATEREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::SetLinkStateRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetLinkStateRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetLinkStateRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetLinkStateRequest();
        /** copy constructor */
        SetLinkStateRequest(const SetLinkStateRequest & inobj);
        /** destructor */
        ~SetLinkStateRequest();

        /** allocator, convenience function for bind */
        static SetLinkStateRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        gazebo_msgs::LinkState  link_state; /**< no comment provided */
        ...
        static const unsigned int ID = 1781288167U;
        ...
        static const unsigned int DATA_VERSION = 245652635U;
        ...
        //        static const char * dataTypeName() { return "SetLinkStateRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "05d5e51278e97c5bc919b37f3176e6c1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x05d5e51278e97c5bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc919b37f3176e6c1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetLinkStateRequest * copy() { return new SetLinkStateRequest(*this); };

        /** assignment operator(s) */
        SetLinkStateRequest & operator=(const SetLinkStateRequest & inobj);
        /** equality operator */
        bool operator==(const SetLinkStateRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetLinkStateRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetLinkStateRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetLinkStateRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetLinkStateRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::SetLinkStateRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetLinkStateRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetLinkStateRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetLinkStateRequest & value);

#endif  //  _GAZEBO_MSGS_SETLINKSTATEREQUEST_H_
