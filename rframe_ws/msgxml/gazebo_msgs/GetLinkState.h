...
#ifndef _CODEGEN_GAZEBO_MSGS_GETLINKSTATE_H_
#define _CODEGEN_GAZEBO_MSGS_GETLINKSTATE_H_
...
PREDECLARE_BSON(gazebo_msgs::GetLinkState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetLinkState); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLinkState & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetLinkState();
        /** copy constructor */
        GetLinkState(const GetLinkState & inobj);
        /** destructor */
        ~GetLinkState();

        /** allocator, convenience function for bind */
        static GetLinkState * New();
        ...
        static const unsigned int ID = 1781288142U;
        ...
        static const unsigned int DATA_VERSION = 3063400231U;
        ...
        //        static const char * dataTypeName() { return "GetLinkState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "dc23e2878cbfc4be00e35c9d5489eff2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xdc23e2878cbfc4beULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x00e35c9d5489eff2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLinkState * copy() { return new GetLinkState(*this); };

        /** assignment operator(s) */
        GetLinkState & operator=(const GetLinkState & inobj);
        /** equality operator */
        bool operator==(const GetLinkState & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLinkState & inobj) const;
        /** less than operator */
        bool operator<(const GetLinkState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLinkState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetLinkState>
    {
    public:
        static bool flat() {return gazebo_msgs::GetLinkState::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetLinkState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetLinkState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetLinkState & value);

#endif  //  _GAZEBO_MSGS_GETLINKSTATE_H_
