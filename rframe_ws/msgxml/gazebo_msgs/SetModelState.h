...
#ifndef _CODEGEN_GAZEBO_MSGS_SETMODELSTATE_H_
#define _CODEGEN_GAZEBO_MSGS_SETMODELSTATE_H_
...
PREDECLARE_BSON(gazebo_msgs::SetModelState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetModelState); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetModelState & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetModelState();
        /** copy constructor */
        SetModelState(const SetModelState & inobj);
        /** destructor */
        ~SetModelState();

        /** allocator, convenience function for bind */
        static SetModelState * New();
        ...
        static const unsigned int ID = 1781288175U;
        ...
        static const unsigned int DATA_VERSION = 3185347781U;
        ...
        //        static const char * dataTypeName() { return "SetModelState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e7e5afea6bcbb97f7263fd5f3eea63e8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe7e5afea6bcbb97fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7263fd5f3eea63e8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetModelState * copy() { return new SetModelState(*this); };

        /** assignment operator(s) */
        SetModelState & operator=(const SetModelState & inobj);
        /** equality operator */
        bool operator==(const SetModelState & inobj) const;
        /** inequality operator */
        bool operator!=(const SetModelState & inobj) const;
        /** less than operator */
        bool operator<(const SetModelState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetModelState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetModelState>
    {
    public:
        static bool flat() {return gazebo_msgs::SetModelState::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetModelState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetModelState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetModelState & value);

#endif  //  _GAZEBO_MSGS_SETMODELSTATE_H_
