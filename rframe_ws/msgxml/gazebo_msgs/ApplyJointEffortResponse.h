...
#ifndef _CODEGEN_GAZEBO_MSGS_APPLYJOINTEFFORTRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_APPLYJOINTEFFORTRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::ApplyJointEffortResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ApplyJointEffortResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ApplyJointEffortResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        ApplyJointEffortResponse(const ApplyJointEffortResponse & inobj);
        /** destructor */
        ~ApplyJointEffortResponse();

        /** allocator, convenience function for bind */
        static ApplyJointEffortResponse * New();
        ...
        static const unsigned int ID = 1781288126U;
        ...
        static const unsigned int DATA_VERSION = 968872395U;
        ...
        //        static const char * dataTypeName() { return "ApplyJointEffortResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "da7af1960b8daee6b90c33f8e3746e08"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xda7af1960b8daee6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb90c33f8e3746e08ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ApplyJointEffortResponse * copy() { return new ApplyJointEffortResponse(*this); };

        /** assignment operator(s) */
        ApplyJointEffortResponse & operator=(const ApplyJointEffortResponse & inobj);
        /** equality operator */
        bool operator==(const ApplyJointEffortResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const ApplyJointEffortResponse & inobj) const;
        /** less than operator */
        bool operator<(const ApplyJointEffortResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ApplyJointEffortResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ApplyJointEffortResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::ApplyJointEffortResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ApplyJointEffortResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ApplyJointEffortResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ApplyJointEffortResponse & value);

#endif  //  _GAZEBO_MSGS_APPLYJOINTEFFORTRESPONSE_H_
