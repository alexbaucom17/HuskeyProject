...
#ifndef _CODEGEN_GAZEBO_MSGS_SETJOINTPROPERTIESRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_SETJOINTPROPERTIESRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::SetJointPropertiesResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetJointPropertiesResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetJointPropertiesResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetJointPropertiesResponse(const SetJointPropertiesResponse & inobj);
        /** destructor */
        ~SetJointPropertiesResponse();

        /** allocator, convenience function for bind */
        static SetJointPropertiesResponse * New();
        ...
        static const unsigned int ID = 1781288159U;
        ...
        static const unsigned int DATA_VERSION = 2236631719U;
        ...
        //        static const char * dataTypeName() { return "SetJointPropertiesResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "45dd8b9451c7ef1dfbd431abe897a1f4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x45dd8b9451c7ef1dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfbd431abe897a1f4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetJointPropertiesResponse * copy() { return new SetJointPropertiesResponse(*this); };

        /** assignment operator(s) */
        SetJointPropertiesResponse & operator=(const SetJointPropertiesResponse & inobj);
        /** equality operator */
        bool operator==(const SetJointPropertiesResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetJointPropertiesResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetJointPropertiesResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetJointPropertiesResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetJointPropertiesResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::SetJointPropertiesResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetJointPropertiesResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetJointPropertiesResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetJointPropertiesResponse & value);

#endif  //  _GAZEBO_MSGS_SETJOINTPROPERTIESRESPONSE_H_
