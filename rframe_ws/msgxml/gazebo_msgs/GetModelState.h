...
#ifndef _CODEGEN_GAZEBO_MSGS_GETMODELSTATE_H_
#define _CODEGEN_GAZEBO_MSGS_GETMODELSTATE_H_
...
PREDECLARE_BSON(gazebo_msgs::GetModelState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetModelState); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetModelState & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetModelState();
        /** copy constructor */
        GetModelState(const GetModelState & inobj);
        /** destructor */
        ~GetModelState();

        /** allocator, convenience function for bind */
        static GetModelState * New();
        ...
        static const unsigned int ID = 1781288148U;
        ...
        static const unsigned int DATA_VERSION = 2469159835U;
        ...
        //        static const char * dataTypeName() { return "GetModelState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "cafae778f654fddfe4cd8713d33f33e8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xcafae778f654fddfULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe4cd8713d33f33e8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetModelState * copy() { return new GetModelState(*this); };

        /** assignment operator(s) */
        GetModelState & operator=(const GetModelState & inobj);
        /** equality operator */
        bool operator==(const GetModelState & inobj) const;
        /** inequality operator */
        bool operator!=(const GetModelState & inobj) const;
        /** less than operator */
        bool operator<(const GetModelState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetModelState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetModelState>
    {
    public:
        static bool flat() {return gazebo_msgs::GetModelState::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetModelState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetModelState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetModelState & value);

#endif  //  _GAZEBO_MSGS_GETMODELSTATE_H_
