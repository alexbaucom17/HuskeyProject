...
#ifndef _CODEGEN_GAZEBO_MSGS_JOINTREQUESTRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_JOINTREQUESTRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::JointRequestResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::JointRequestResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointRequestResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        JointRequestResponse(const JointRequestResponse & inobj);
        /** destructor */
        ~JointRequestResponse();

        /** allocator, convenience function for bind */
        static JointRequestResponse * New();
        ...
        static const unsigned int ID = 1781288156U;
        ...
        static const unsigned int DATA_VERSION = 304828676U;
        ...
        //        static const char * dataTypeName() { return "JointRequestResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "dec67286fde67093b0bc7fcd1d154d4c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xdec67286fde67093ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb0bc7fcd1d154d4cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointRequestResponse * copy() { return new JointRequestResponse(*this); };

        /** assignment operator(s) */
        JointRequestResponse & operator=(const JointRequestResponse & inobj);
        /** equality operator */
        bool operator==(const JointRequestResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const JointRequestResponse & inobj) const;
        /** less than operator */
        bool operator<(const JointRequestResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointRequestResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::JointRequestResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::JointRequestResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::JointRequestResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::JointRequestResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::JointRequestResponse & value);

#endif  //  _GAZEBO_MSGS_JOINTREQUESTRESPONSE_H_
