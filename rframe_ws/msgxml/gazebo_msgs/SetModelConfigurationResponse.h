...
#ifndef _CODEGEN_GAZEBO_MSGS_SETMODELCONFIGURATIONRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_SETMODELCONFIGURATIONRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::SetModelConfigurationResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetModelConfigurationResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetModelConfigurationResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetModelConfigurationResponse(const SetModelConfigurationResponse & inobj);
        /** destructor */
        ~SetModelConfigurationResponse();

        /** allocator, convenience function for bind */
        static SetModelConfigurationResponse * New();
        ...
        static const unsigned int ID = 1781288171U;
        ...
        static const unsigned int DATA_VERSION = 4067711172U;
        ...
        //        static const char * dataTypeName() { return "SetModelConfigurationResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6da8435f59e48392b72faddd64f120cd"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6da8435f59e48392ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb72faddd64f120cdULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetModelConfigurationResponse * copy() { return new SetModelConfigurationResponse(*this); };

        /** assignment operator(s) */
        SetModelConfigurationResponse & operator=(const SetModelConfigurationResponse & inobj);
        /** equality operator */
        bool operator==(const SetModelConfigurationResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetModelConfigurationResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetModelConfigurationResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetModelConfigurationResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetModelConfigurationResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::SetModelConfigurationResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetModelConfigurationResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetModelConfigurationResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetModelConfigurationResponse & value);

#endif  //  _GAZEBO_MSGS_SETMODELCONFIGURATIONRESPONSE_H_
