...
#ifndef _CODEGEN_GAZEBO_MSGS_APPLYBODYWRENCHREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_APPLYBODYWRENCHREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::ApplyBodyWrenchRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ApplyBodyWrenchRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ApplyBodyWrenchRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        ApplyBodyWrenchRequest(const ApplyBodyWrenchRequest & inobj);
        /** destructor */
        ~ApplyBodyWrenchRequest();

        /** allocator, convenience function for bind */
        static ApplyBodyWrenchRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  body_name; /**< Gazebo body to apply wrench (linear force and torque)  wrench is applied in the gazebo world by default  body names are prefixed by model name, e.g. pr2::base_link */
        std::string  reference_frame; /**< wrench is defined in the reference frame of this entity  use inertial frame if left empty  frame names are bodies prefixed by model name, e.g. pr2::base_link */
        ...
        std_msgs::RosTime  start_time; /**< (optional) wrench application start time (seconds)  if start_time is not specified, or  start_time < current time, start as soon as possible */
        std_msgs::RosDuration  duration; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_BODY_NAME,
            DAQ_1_REFERENCE_FRAME,
            DAQ_2_REFERENCE_POINT,
            DAQ_3_WRENCH,
            DAQ_4_START_TIME,
            DAQ_5_DURATION,
            DAQ_MAX_
        ...
        static const unsigned int ID = 1781288122U;
        ...
        static const unsigned int DATA_VERSION = 79257530U;
        ...
        //        static const char * dataTypeName() { return "ApplyBodyWrenchRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c4a41df4ceb92d05a18f0ef9b269edfa"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc4a41df4ceb92d05ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa18f0ef9b269edfaULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ApplyBodyWrenchRequest * copy() { return new ApplyBodyWrenchRequest(*this); };

        /** assignment operator(s) */
        ApplyBodyWrenchRequest & operator=(const ApplyBodyWrenchRequest & inobj);
        /** equality operator */
        bool operator==(const ApplyBodyWrenchRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const ApplyBodyWrenchRequest & inobj) const;
        /** less than operator */
        bool operator<(const ApplyBodyWrenchRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ApplyBodyWrenchRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ApplyBodyWrenchRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::ApplyBodyWrenchRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ApplyBodyWrenchRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ApplyBodyWrenchRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ApplyBodyWrenchRequest & value);

#endif  //  _GAZEBO_MSGS_APPLYBODYWRENCHREQUEST_H_
