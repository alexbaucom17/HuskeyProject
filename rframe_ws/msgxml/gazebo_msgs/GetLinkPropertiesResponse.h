...
#ifndef _CODEGEN_GAZEBO_MSGS_GETLINKPROPERTIESRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_GETLINKPROPERTIESRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::GetLinkPropertiesResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetLinkPropertiesResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLinkPropertiesResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetLinkPropertiesResponse(const GetLinkPropertiesResponse & inobj);
        /** destructor */
        ~GetLinkPropertiesResponse();

        /** allocator, convenience function for bind */
        static GetLinkPropertiesResponse * New();
        ...
        static const unsigned int ID = 1781288138U;
        ...
        static const unsigned int DATA_VERSION = 394179042U;
        ...
        //        static const char * dataTypeName() { return "GetLinkPropertiesResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "faba7da01af3bb8656caf7535ea63165"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfaba7da01af3bb86ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x56caf7535ea63165ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLinkPropertiesResponse * copy() { return new GetLinkPropertiesResponse(*this); };

        /** assignment operator(s) */
        GetLinkPropertiesResponse & operator=(const GetLinkPropertiesResponse & inobj);
        /** equality operator */
        bool operator==(const GetLinkPropertiesResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLinkPropertiesResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetLinkPropertiesResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLinkPropertiesResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetLinkPropertiesResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::GetLinkPropertiesResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetLinkPropertiesResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetLinkPropertiesResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetLinkPropertiesResponse & value);

#endif  //  _GAZEBO_MSGS_GETLINKPROPERTIESRESPONSE_H_
