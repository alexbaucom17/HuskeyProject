...
#ifndef _CODEGEN_GAZEBO_MSGS_GETLINKPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_GETLINKPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::GetLinkProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetLinkProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLinkProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetLinkProperties();
        /** copy constructor */
        GetLinkProperties(const GetLinkProperties & inobj);
        /** destructor */
        ~GetLinkProperties();

        /** allocator, convenience function for bind */
        static GetLinkProperties * New();
        ...
        static const unsigned int ID = 1781288139U;
        ...
        static const unsigned int DATA_VERSION = 3446070366U;
        ...
        //        static const char * dataTypeName() { return "GetLinkProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0515d6518421195f1d4368a471f776e1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0515d6518421195fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1d4368a471f776e1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLinkProperties * copy() { return new GetLinkProperties(*this); };

        /** assignment operator(s) */
        GetLinkProperties & operator=(const GetLinkProperties & inobj);
        /** equality operator */
        bool operator==(const GetLinkProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLinkProperties & inobj) const;
        /** less than operator */
        bool operator<(const GetLinkProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLinkProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetLinkProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::GetLinkProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetLinkProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetLinkProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetLinkProperties & value);

#endif  //  _GAZEBO_MSGS_GETLINKPROPERTIES_H_
