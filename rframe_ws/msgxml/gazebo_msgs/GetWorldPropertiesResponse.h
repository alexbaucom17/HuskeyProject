...
#ifndef _CODEGEN_GAZEBO_MSGS_GETWORLDPROPERTIESRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_GETWORLDPROPERTIESRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::GetWorldPropertiesResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetWorldPropertiesResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetWorldPropertiesResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetWorldPropertiesResponse(const GetWorldPropertiesResponse & inobj);
        /** destructor */
        ~GetWorldPropertiesResponse();

        /** allocator, convenience function for bind */
        static GetWorldPropertiesResponse * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        double  sim_time; /**< current sim time */
        std::vector<std::string >  model_names; /**< list of models in the world */
        ...
        static const unsigned int ID = 1781288153U;
        ...
        static const unsigned int DATA_VERSION = 2840364301U;
        ...
        //        static const char * dataTypeName() { return "GetWorldPropertiesResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c1ded6e3c2757f2aab7942f24675f20b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc1ded6e3c2757f2aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xab7942f24675f20bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetWorldPropertiesResponse * copy() { return new GetWorldPropertiesResponse(*this); };

        /** assignment operator(s) */
        GetWorldPropertiesResponse & operator=(const GetWorldPropertiesResponse & inobj);
        /** equality operator */
        bool operator==(const GetWorldPropertiesResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetWorldPropertiesResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetWorldPropertiesResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetWorldPropertiesResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetWorldPropertiesResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::GetWorldPropertiesResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetWorldPropertiesResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetWorldPropertiesResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetWorldPropertiesResponse & value);

#endif  //  _GAZEBO_MSGS_GETWORLDPROPERTIESRESPONSE_H_
