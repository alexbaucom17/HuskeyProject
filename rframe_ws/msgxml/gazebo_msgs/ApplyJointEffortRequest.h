...
#ifndef _CODEGEN_GAZEBO_MSGS_APPLYJOINTEFFORTREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_APPLYJOINTEFFORTREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::ApplyJointEffortRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ApplyJointEffortRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ApplyJointEffortRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        ApplyJointEffortRequest(const ApplyJointEffortRequest & inobj);
        /** destructor */
        ~ApplyJointEffortRequest();

        /** allocator, convenience function for bind */
        static ApplyJointEffortRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  joint_name; /**< joint to apply wrench (linear force and torque) */
        double  effort; /**< effort to apply */
        std_msgs::RosTime  start_time; /**< optional wrench application start time (seconds)  if start_time < current time, start as soon as possible */
        ...
        static const unsigned int ID = 1781288125U;
        ...
        static const unsigned int DATA_VERSION = 3373758203U;
        ...
        //        static const char * dataTypeName() { return "ApplyJointEffortRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "eed40d24533302e6cf5b23a37bde3ee4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xeed40d24533302e6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcf5b23a37bde3ee4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ApplyJointEffortRequest * copy() { return new ApplyJointEffortRequest(*this); };

        /** assignment operator(s) */
        ApplyJointEffortRequest & operator=(const ApplyJointEffortRequest & inobj);
        /** equality operator */
        bool operator==(const ApplyJointEffortRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const ApplyJointEffortRequest & inobj) const;
        /** less than operator */
        bool operator<(const ApplyJointEffortRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ApplyJointEffortRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ApplyJointEffortRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::ApplyJointEffortRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ApplyJointEffortRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ApplyJointEffortRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ApplyJointEffortRequest & value);

#endif  //  _GAZEBO_MSGS_APPLYJOINTEFFORTREQUEST_H_
