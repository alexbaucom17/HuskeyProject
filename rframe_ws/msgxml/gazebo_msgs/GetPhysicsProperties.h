...
#ifndef _CODEGEN_GAZEBO_MSGS_GETPHYSICSPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_GETPHYSICSPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::GetPhysicsProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetPhysicsProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPhysicsProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetPhysicsProperties(const GetPhysicsProperties & inobj);
        /** destructor */
        ~GetPhysicsProperties();

        /** allocator, convenience function for bind */
        static GetPhysicsProperties * New();
        ...
        static const unsigned int ID = 1781288151U;
        ...
        static const unsigned int DATA_VERSION = 1888757942U;
        ...
        //        static const char * dataTypeName() { return "GetPhysicsProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9f51175ffd51bfeccedb620696450c03"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9f51175ffd51bfecULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcedb620696450c03ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPhysicsProperties * copy() { return new GetPhysicsProperties(*this); };

        /** assignment operator(s) */
        GetPhysicsProperties & operator=(const GetPhysicsProperties & inobj);
        /** equality operator */
        bool operator==(const GetPhysicsProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPhysicsProperties & inobj) const;
        /** less than operator */
        bool operator<(const GetPhysicsProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPhysicsProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetPhysicsProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::GetPhysicsProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetPhysicsProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetPhysicsProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetPhysicsProperties & value);

#endif  //  _GAZEBO_MSGS_GETPHYSICSPROPERTIES_H_
