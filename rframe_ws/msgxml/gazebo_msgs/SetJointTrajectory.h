...
#ifndef _CODEGEN_GAZEBO_MSGS_SETJOINTTRAJECTORY_H_
#define _CODEGEN_GAZEBO_MSGS_SETJOINTTRAJECTORY_H_
...
PREDECLARE_BSON(gazebo_msgs::SetJointTrajectory); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetJointTrajectory); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetJointTrajectory & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetJointTrajectory();
        /** copy constructor */
        SetJointTrajectory(const SetJointTrajectory & inobj);
        /** destructor */
        ~SetJointTrajectory();

        /** allocator, convenience function for bind */
        static SetJointTrajectory * New();
        ...
        static const unsigned int ID = 1781288163U;
        ...
        static const unsigned int DATA_VERSION = 331722658U;
        ...
        //        static const char * dataTypeName() { return "SetJointTrajectory"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "4bc70a375770b071cddc106d3865f17e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x4bc70a375770b071ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcddc106d3865f17eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetJointTrajectory * copy() { return new SetJointTrajectory(*this); };

        /** assignment operator(s) */
        SetJointTrajectory & operator=(const SetJointTrajectory & inobj);
        /** equality operator */
        bool operator==(const SetJointTrajectory & inobj) const;
        /** inequality operator */
        bool operator!=(const SetJointTrajectory & inobj) const;
        /** less than operator */
        bool operator<(const SetJointTrajectory & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetJointTrajectory & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetJointTrajectory>
    {
    public:
        static bool flat() {return gazebo_msgs::SetJointTrajectory::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetJointTrajectory::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetJointTrajectory & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetJointTrajectory & value);

#endif  //  _GAZEBO_MSGS_SETJOINTTRAJECTORY_H_
