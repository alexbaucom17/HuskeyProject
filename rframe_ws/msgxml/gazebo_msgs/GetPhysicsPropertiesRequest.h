...
#ifndef _CODEGEN_GAZEBO_MSGS_GETPHYSICSPROPERTIESREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_GETPHYSICSPROPERTIESREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::GetPhysicsPropertiesRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetPhysicsPropertiesRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPhysicsPropertiesRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetPhysicsPropertiesRequest(const GetPhysicsPropertiesRequest & inobj);
        /** destructor */
        ~GetPhysicsPropertiesRequest();

        /** allocator, convenience function for bind */
        static GetPhysicsPropertiesRequest * New();
        ...
        static const unsigned int ID = 1781288149U;
        ...
        static const unsigned int DATA_VERSION = 2435189737U;
        ...
        //        static const char * dataTypeName() { return "GetPhysicsPropertiesRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "67b7253744afb86562e5bb28531a0c7b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x67b7253744afb865ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x62e5bb28531a0c7bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPhysicsPropertiesRequest * copy() { return new GetPhysicsPropertiesRequest(*this); };

        /** assignment operator(s) */
        GetPhysicsPropertiesRequest & operator=(const GetPhysicsPropertiesRequest & inobj);
        /** equality operator */
        bool operator==(const GetPhysicsPropertiesRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPhysicsPropertiesRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetPhysicsPropertiesRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPhysicsPropertiesRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetPhysicsPropertiesRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::GetPhysicsPropertiesRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetPhysicsPropertiesRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetPhysicsPropertiesRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetPhysicsPropertiesRequest & value);

#endif  //  _GAZEBO_MSGS_GETPHYSICSPROPERTIESREQUEST_H_
