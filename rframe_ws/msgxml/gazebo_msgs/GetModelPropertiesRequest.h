...
#ifndef _CODEGEN_GAZEBO_MSGS_GETMODELPROPERTIESREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_GETMODELPROPERTIESREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::GetModelPropertiesRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetModelPropertiesRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetModelPropertiesRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetModelPropertiesRequest(const GetModelPropertiesRequest & inobj);
        /** destructor */
        ~GetModelPropertiesRequest();

        /** allocator, convenience function for bind */
        static GetModelPropertiesRequest * New();
        ...
        static const unsigned int ID = 1781288143U;
        ...
        static const unsigned int DATA_VERSION = 1170650970U;
        ...
        //        static const char * dataTypeName() { return "GetModelPropertiesRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "40b7a5fa83fe3f774165b56a152f728e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x40b7a5fa83fe3f77ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4165b56a152f728eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetModelPropertiesRequest * copy() { return new GetModelPropertiesRequest(*this); };

        /** assignment operator(s) */
        GetModelPropertiesRequest & operator=(const GetModelPropertiesRequest & inobj);
        /** equality operator */
        bool operator==(const GetModelPropertiesRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetModelPropertiesRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetModelPropertiesRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetModelPropertiesRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetModelPropertiesRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::GetModelPropertiesRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetModelPropertiesRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetModelPropertiesRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetModelPropertiesRequest & value);

#endif  //  _GAZEBO_MSGS_GETMODELPROPERTIESREQUEST_H_
