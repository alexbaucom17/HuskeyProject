...
#ifndef _CODEGEN_GAZEBO_MSGS_APPLYBODYWRENCH_H_
#define _CODEGEN_GAZEBO_MSGS_APPLYBODYWRENCH_H_
...
PREDECLARE_BSON(gazebo_msgs::ApplyBodyWrench); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ApplyBodyWrench); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ApplyBodyWrench & inobj);   
    ...
    */
    ...
    public: 
        ...
        ApplyBodyWrench();
        /** copy constructor */
        ApplyBodyWrench(const ApplyBodyWrench & inobj);
        /** destructor */
        ~ApplyBodyWrench();

        /** allocator, convenience function for bind */
        static ApplyBodyWrench * New();
        ...
        static const unsigned int ID = 1781288124U;
        ...
        static const unsigned int DATA_VERSION = 3277272446U;
        ...
        //        static const char * dataTypeName() { return "ApplyBodyWrench"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "98273eaa4d9fc64ff8fb561191c352fa"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x98273eaa4d9fc64fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf8fb561191c352faULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ApplyBodyWrench * copy() { return new ApplyBodyWrench(*this); };

        /** assignment operator(s) */
        ApplyBodyWrench & operator=(const ApplyBodyWrench & inobj);
        /** equality operator */
        bool operator==(const ApplyBodyWrench & inobj) const;
        /** inequality operator */
        bool operator!=(const ApplyBodyWrench & inobj) const;
        /** less than operator */
        bool operator<(const ApplyBodyWrench & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ApplyBodyWrench & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ApplyBodyWrench>
    {
    public:
        static bool flat() {return gazebo_msgs::ApplyBodyWrench::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ApplyBodyWrench::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ApplyBodyWrench & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ApplyBodyWrench & value);

#endif  //  _GAZEBO_MSGS_APPLYBODYWRENCH_H_
