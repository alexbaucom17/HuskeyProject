...
#ifndef _CODEGEN_GAZEBO_MSGS_SETPHYSICSPROPERTIESRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_SETPHYSICSPROPERTIESRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::SetPhysicsPropertiesResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetPhysicsPropertiesResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetPhysicsPropertiesResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetPhysicsPropertiesResponse(const SetPhysicsPropertiesResponse & inobj);
        /** destructor */
        ~SetPhysicsPropertiesResponse();

        /** allocator, convenience function for bind */
        static SetPhysicsPropertiesResponse * New();
        ...
        static const unsigned int ID = 1781288177U;
        ...
        static const unsigned int DATA_VERSION = 1135294862U;
        ...
        //        static const char * dataTypeName() { return "SetPhysicsPropertiesResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2c936af1e54b802ecb8e81f187f31133"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2c936af1e54b802eULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcb8e81f187f31133ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetPhysicsPropertiesResponse * copy() { return new SetPhysicsPropertiesResponse(*this); };

        /** assignment operator(s) */
        SetPhysicsPropertiesResponse & operator=(const SetPhysicsPropertiesResponse & inobj);
        /** equality operator */
        bool operator==(const SetPhysicsPropertiesResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetPhysicsPropertiesResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetPhysicsPropertiesResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetPhysicsPropertiesResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetPhysicsPropertiesResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::SetPhysicsPropertiesResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetPhysicsPropertiesResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetPhysicsPropertiesResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetPhysicsPropertiesResponse & value);

#endif  //  _GAZEBO_MSGS_SETPHYSICSPROPERTIESRESPONSE_H_
