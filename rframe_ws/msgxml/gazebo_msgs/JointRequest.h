...
#ifndef _CODEGEN_GAZEBO_MSGS_JOINTREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_JOINTREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::JointRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::JointRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        JointRequest();
        /** copy constructor */
        JointRequest(const JointRequest & inobj);
        /** destructor */
        ~JointRequest();

        /** allocator, convenience function for bind */
        static JointRequest * New();
        ...
        static const unsigned int ID = 1781288157U;
        ...
        static const unsigned int DATA_VERSION = 973457327U;
        ...
        //        static const char * dataTypeName() { return "JointRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2557d2af060da1119580c674aed3e895"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2557d2af060da111ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9580c674aed3e895ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointRequest * copy() { return new JointRequest(*this); };

        /** assignment operator(s) */
        JointRequest & operator=(const JointRequest & inobj);
        /** equality operator */
        bool operator==(const JointRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const JointRequest & inobj) const;
        /** less than operator */
        bool operator<(const JointRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::JointRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::JointRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::JointRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::JointRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::JointRequest & value);

#endif  //  _GAZEBO_MSGS_JOINTREQUEST_H_
