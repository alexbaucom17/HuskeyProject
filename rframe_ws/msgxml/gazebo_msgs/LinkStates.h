...
#ifndef _CODEGEN_GAZEBO_MSGS_LINKSTATES_H_
#define _CODEGEN_GAZEBO_MSGS_LINKSTATES_H_
...
PREDECLARE_BSON(gazebo_msgs::LinkStates); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::LinkStates); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LinkStates & inobj);   
    ...
    */
    ...
    public: 
        ...
        LinkStates();
        /** copy constructor */
        LinkStates(const LinkStates & inobj);
        /** destructor */
        ~LinkStates();

        /** allocator, convenience function for bind */
        static LinkStates * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::vector<std::string >  name; /**< link names */
        ...
        static const unsigned int ID = 1781288116U;
        ...
        static const unsigned int DATA_VERSION = 3308646058U;
        ...
        //        static const char * dataTypeName() { return "LinkStates"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "894e783cf61f171abf959d6c69af9306"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x894e783cf61f171aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbf959d6c69af9306ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LinkStates * copy() { return new LinkStates(*this); };

        /** assignment operator(s) */
        LinkStates & operator=(const LinkStates & inobj);
        /** equality operator */
        bool operator==(const LinkStates & inobj) const;
        /** inequality operator */
        bool operator!=(const LinkStates & inobj) const;
        /** less than operator */
        bool operator<(const LinkStates & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LinkStates & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::LinkStates>
    {
    public:
        static bool flat() {return gazebo_msgs::LinkStates::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::LinkStates::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::LinkStates & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::LinkStates & value);

#endif  //  _GAZEBO_MSGS_LINKSTATES_H_
