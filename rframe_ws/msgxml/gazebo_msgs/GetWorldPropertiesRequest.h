...
#ifndef _CODEGEN_GAZEBO_MSGS_GETWORLDPROPERTIESREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_GETWORLDPROPERTIESREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::GetWorldPropertiesRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetWorldPropertiesRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetWorldPropertiesRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetWorldPropertiesRequest(const GetWorldPropertiesRequest & inobj);
        /** destructor */
        ~GetWorldPropertiesRequest();

        /** allocator, convenience function for bind */
        static GetWorldPropertiesRequest * New();
        ...
        static const unsigned int ID = 1781288152U;
        ...
        static const unsigned int DATA_VERSION = 4129226857U;
        ...
        //        static const char * dataTypeName() { return "GetWorldPropertiesRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bdf85f50fc7da20c1dfe16b6da299b10"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbdf85f50fc7da20cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1dfe16b6da299b10ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetWorldPropertiesRequest * copy() { return new GetWorldPropertiesRequest(*this); };

        /** assignment operator(s) */
        GetWorldPropertiesRequest & operator=(const GetWorldPropertiesRequest & inobj);
        /** equality operator */
        bool operator==(const GetWorldPropertiesRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetWorldPropertiesRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetWorldPropertiesRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetWorldPropertiesRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetWorldPropertiesRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::GetWorldPropertiesRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetWorldPropertiesRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetWorldPropertiesRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetWorldPropertiesRequest & value);

#endif  //  _GAZEBO_MSGS_GETWORLDPROPERTIESREQUEST_H_
