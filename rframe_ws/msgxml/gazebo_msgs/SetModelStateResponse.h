...
#ifndef _CODEGEN_GAZEBO_MSGS_SETMODELSTATERESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_SETMODELSTATERESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::SetModelStateResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetModelStateResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetModelStateResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetModelStateResponse(const SetModelStateResponse & inobj);
        /** destructor */
        ~SetModelStateResponse();

        /** allocator, convenience function for bind */
        static SetModelStateResponse * New();
        ...
        static const unsigned int ID = 1781288174U;
        ...
        static const unsigned int DATA_VERSION = 3284679171U;
        ...
        //        static const char * dataTypeName() { return "SetModelStateResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "29f07a8bf35c522d738abb7ad93197a8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x29f07a8bf35c522dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x738abb7ad93197a8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetModelStateResponse * copy() { return new SetModelStateResponse(*this); };

        /** assignment operator(s) */
        SetModelStateResponse & operator=(const SetModelStateResponse & inobj);
        /** equality operator */
        bool operator==(const SetModelStateResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetModelStateResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetModelStateResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetModelStateResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetModelStateResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::SetModelStateResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetModelStateResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetModelStateResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetModelStateResponse & value);

#endif  //  _GAZEBO_MSGS_SETMODELSTATERESPONSE_H_
