...
#ifndef _CODEGEN_GAZEBO_MSGS_GETLINKSTATEREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_GETLINKSTATEREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::GetLinkStateRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetLinkStateRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLinkStateRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetLinkStateRequest();
        /** copy constructor */
        GetLinkStateRequest(const GetLinkStateRequest & inobj);
        /** destructor */
        ~GetLinkStateRequest();

        /** allocator, convenience function for bind */
        static GetLinkStateRequest * New();
        ...
        static const unsigned int ID = 1781288140U;
        ...
        static const unsigned int DATA_VERSION = 3493787349U;
        ...
        //        static const char * dataTypeName() { return "GetLinkStateRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "090954e749265c1745ffb1f0a4a6c888"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x090954e749265c17ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x45ffb1f0a4a6c888ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLinkStateRequest * copy() { return new GetLinkStateRequest(*this); };

        /** assignment operator(s) */
        GetLinkStateRequest & operator=(const GetLinkStateRequest & inobj);
        /** equality operator */
        bool operator==(const GetLinkStateRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLinkStateRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetLinkStateRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLinkStateRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetLinkStateRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::GetLinkStateRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetLinkStateRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetLinkStateRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetLinkStateRequest & value);

#endif  //  _GAZEBO_MSGS_GETLINKSTATEREQUEST_H_
