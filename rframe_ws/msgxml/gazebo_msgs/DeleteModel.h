...
#ifndef _CODEGEN_GAZEBO_MSGS_DELETEMODEL_H_
#define _CODEGEN_GAZEBO_MSGS_DELETEMODEL_H_
...
PREDECLARE_BSON(gazebo_msgs::DeleteModel); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::DeleteModel); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DeleteModel & inobj);   
    ...
    */
    ...
    public: 
        ...
        DeleteModel();
        /** copy constructor */
        DeleteModel(const DeleteModel & inobj);
        /** destructor */
        ~DeleteModel();

        /** allocator, convenience function for bind */
        static DeleteModel * New();
        ...
        static const unsigned int ID = 1781288133U;
        ...
        static const unsigned int DATA_VERSION = 72803004U;
        ...
        //        static const char * dataTypeName() { return "DeleteModel"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "064d364dc4dea786db74c7da22f5960b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x064d364dc4dea786ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdb74c7da22f5960bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DeleteModel * copy() { return new DeleteModel(*this); };

        /** assignment operator(s) */
        DeleteModel & operator=(const DeleteModel & inobj);
        /** equality operator */
        bool operator==(const DeleteModel & inobj) const;
        /** inequality operator */
        bool operator!=(const DeleteModel & inobj) const;
        /** less than operator */
        bool operator<(const DeleteModel & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DeleteModel & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::DeleteModel>
    {
    public:
        static bool flat() {return gazebo_msgs::DeleteModel::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::DeleteModel::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::DeleteModel & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::DeleteModel & value);

#endif  //  _GAZEBO_MSGS_DELETEMODEL_H_
