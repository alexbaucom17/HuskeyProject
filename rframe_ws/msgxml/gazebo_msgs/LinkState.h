...
#ifndef _CODEGEN_GAZEBO_MSGS_LINKSTATE_H_
#define _CODEGEN_GAZEBO_MSGS_LINKSTATE_H_
...
PREDECLARE_BSON(gazebo_msgs::LinkState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::LinkState); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LinkState & inobj);   
    ...
    */
    ...
    public: 
        ...
        LinkState();
        /** copy constructor */
        LinkState(const LinkState & inobj);
        /** destructor */
        ~LinkState();

        /** allocator, convenience function for bind */
        static LinkState * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  link_name; /**< link name, link_names are in gazebo scoped name notation, [model_name::body_name] */
        geometry_msgs::Pose  pose; /**< desired pose in reference frame */
        geometry_msgs::Twist  twist; /**< desired twist in reference frame */
        std::string  reference_frame; /**< set pose/twist relative to the frame of this link/body  leave empty or "world" or "map" defaults to world-frame */
        ...
        static const unsigned int ID = 1781288115U;
        ...
        static const unsigned int DATA_VERSION = 2785654908U;
        ...
        //        static const char * dataTypeName() { return "LinkState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "21225ff1700192454181e0dbb9256d09"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x21225ff170019245ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4181e0dbb9256d09ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LinkState * copy() { return new LinkState(*this); };

        /** assignment operator(s) */
        LinkState & operator=(const LinkState & inobj);
        /** equality operator */
        bool operator==(const LinkState & inobj) const;
        /** inequality operator */
        bool operator!=(const LinkState & inobj) const;
        /** less than operator */
        bool operator<(const LinkState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LinkState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::LinkState>
    {
    public:
        static bool flat() {return gazebo_msgs::LinkState::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::LinkState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::LinkState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::LinkState & value);

#endif  //  _GAZEBO_MSGS_LINKSTATE_H_
