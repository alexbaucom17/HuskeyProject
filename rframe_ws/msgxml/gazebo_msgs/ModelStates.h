...
#ifndef _CODEGEN_GAZEBO_MSGS_MODELSTATES_H_
#define _CODEGEN_GAZEBO_MSGS_MODELSTATES_H_
...
PREDECLARE_BSON(gazebo_msgs::ModelStates); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ModelStates); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ModelStates & inobj);   
    ...
    */
    ...
    public: 
        ...
        ModelStates();
        /** copy constructor */
        ModelStates(const ModelStates & inobj);
        /** destructor */
        ~ModelStates();

        /** allocator, convenience function for bind */
        static ModelStates * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::vector<std::string >  name; /**< model names */
        std::vector<geometry_msgs::Pose >  pose; /**< desired pose in world frame */
        std::vector<geometry_msgs::Twist >  twist; /**< desired twist in world frame */
        ...
        static const unsigned int ID = 1781288118U;
        ...
        static const unsigned int DATA_VERSION = 3471299611U;
        ...
        //        static const char * dataTypeName() { return "ModelStates"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3e574a8bb940b98d130370410e4e18fe"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3e574a8bb940b98dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x130370410e4e18feULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ModelStates * copy() { return new ModelStates(*this); };

        /** assignment operator(s) */
        ModelStates & operator=(const ModelStates & inobj);
        /** equality operator */
        bool operator==(const ModelStates & inobj) const;
        /** inequality operator */
        bool operator!=(const ModelStates & inobj) const;
        /** less than operator */
        bool operator<(const ModelStates & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ModelStates & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ModelStates>
    {
    public:
        static bool flat() {return gazebo_msgs::ModelStates::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ModelStates::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ModelStates & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ModelStates & value);

#endif  //  _GAZEBO_MSGS_MODELSTATES_H_
