...
#ifndef _CODEGEN_GAZEBO_MSGS_GETJOINTPROPERTIESREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_GETJOINTPROPERTIESREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::GetJointPropertiesRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetJointPropertiesRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetJointPropertiesRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetJointPropertiesRequest(const GetJointPropertiesRequest & inobj);
        /** destructor */
        ~GetJointPropertiesRequest();

        /** allocator, convenience function for bind */
        static GetJointPropertiesRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  joint_name; /**< no comment provided */
        ...
        static const unsigned int ID = 1781288134U;
        ...
        static const unsigned int DATA_VERSION = 1341215283U;
        ...
        //        static const char * dataTypeName() { return "GetJointPropertiesRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "08f5fed8a8eea9c21c427a576c85c794"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x08f5fed8a8eea9c2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1c427a576c85c794ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetJointPropertiesRequest * copy() { return new GetJointPropertiesRequest(*this); };

        /** assignment operator(s) */
        GetJointPropertiesRequest & operator=(const GetJointPropertiesRequest & inobj);
        /** equality operator */
        bool operator==(const GetJointPropertiesRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetJointPropertiesRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetJointPropertiesRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetJointPropertiesRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetJointPropertiesRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::GetJointPropertiesRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetJointPropertiesRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetJointPropertiesRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetJointPropertiesRequest & value);

#endif  //  _GAZEBO_MSGS_GETJOINTPROPERTIESREQUEST_H_
