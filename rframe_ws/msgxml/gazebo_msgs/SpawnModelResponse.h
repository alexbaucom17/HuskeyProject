...
#ifndef _CODEGEN_GAZEBO_MSGS_SPAWNMODELRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_SPAWNMODELRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::SpawnModelResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SpawnModelResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SpawnModelResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        SpawnModelResponse();
        /** copy constructor */
        SpawnModelResponse(const SpawnModelResponse & inobj);
        /** destructor */
        ~SpawnModelResponse();

        /** allocator, convenience function for bind */
        static SpawnModelResponse * New();
        ...
        static const unsigned int ID = 1781288180U;
        ...
        static const unsigned int DATA_VERSION = 1458624878U;
        ...
        //        static const char * dataTypeName() { return "SpawnModelResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "20cfab9c76194c1fbaf6970d4e20eca0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x20cfab9c76194c1fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbaf6970d4e20eca0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SpawnModelResponse * copy() { return new SpawnModelResponse(*this); };

        /** assignment operator(s) */
        SpawnModelResponse & operator=(const SpawnModelResponse & inobj);
        /** equality operator */
        bool operator==(const SpawnModelResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SpawnModelResponse & inobj) const;
        /** less than operator */
        bool operator<(const SpawnModelResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SpawnModelResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SpawnModelResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::SpawnModelResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SpawnModelResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SpawnModelResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SpawnModelResponse & value);

#endif  //  _GAZEBO_MSGS_SPAWNMODELRESPONSE_H_
