...
#ifndef _CODEGEN_GAZEBO_MSGS_GETMODELSTATEREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_GETMODELSTATEREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::GetModelStateRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetModelStateRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetModelStateRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetModelStateRequest(const GetModelStateRequest & inobj);
        /** destructor */
        ~GetModelStateRequest();

        /** allocator, convenience function for bind */
        static GetModelStateRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  model_name; /**< name of Gazebo Model */
        std::string  relative_entity_name; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_MODEL_NAME,
            DAQ_1_RELATIVE_ENTITY_NAME,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288146U;
        ...
        static const unsigned int DATA_VERSION = 2348188332U;
        ...
        //        static const char * dataTypeName() { return "GetModelStateRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a324eb6a78a0d76f42ec8708444abf6e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa324eb6a78a0d76fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x42ec8708444abf6eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetModelStateRequest * copy() { return new GetModelStateRequest(*this); };

        /** assignment operator(s) */
        GetModelStateRequest & operator=(const GetModelStateRequest & inobj);
        /** equality operator */
        bool operator==(const GetModelStateRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetModelStateRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetModelStateRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetModelStateRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetModelStateRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::GetModelStateRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetModelStateRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetModelStateRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetModelStateRequest & value);

#endif  //  _GAZEBO_MSGS_GETMODELSTATEREQUEST_H_
