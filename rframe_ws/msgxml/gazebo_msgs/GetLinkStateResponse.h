...
#ifndef _CODEGEN_GAZEBO_MSGS_GETLINKSTATERESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_GETLINKSTATERESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::GetLinkStateResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetLinkStateResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLinkStateResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetLinkStateResponse(const GetLinkStateResponse & inobj);
        /** destructor */
        ~GetLinkStateResponse();

        /** allocator, convenience function for bind */
        static GetLinkStateResponse * New();
        ...
        static const unsigned int ID = 1781288141U;
        ...
        static const unsigned int DATA_VERSION = 3154131489U;
        ...
        //        static const char * dataTypeName() { return "GetLinkStateResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "344a8ce563b593470472f3097c4c021f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x344a8ce563b59347ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0472f3097c4c021fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLinkStateResponse * copy() { return new GetLinkStateResponse(*this); };

        /** assignment operator(s) */
        GetLinkStateResponse & operator=(const GetLinkStateResponse & inobj);
        /** equality operator */
        bool operator==(const GetLinkStateResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLinkStateResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetLinkStateResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLinkStateResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetLinkStateResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::GetLinkStateResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetLinkStateResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetLinkStateResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetLinkStateResponse & value);

#endif  //  _GAZEBO_MSGS_GETLINKSTATERESPONSE_H_
