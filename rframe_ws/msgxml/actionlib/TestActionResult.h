...
#ifndef _CODEGEN_ACTIONLIB_TESTACTIONRESULT_H_
#define _CODEGEN_ACTIONLIB_TESTACTIONRESULT_H_
...
PREDECLARE_BSON(actionlib::TestActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestActionResult); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestActionResult();
        /** copy constructor */
        TestActionResult(const TestActionResult & inobj);
        /** destructor */
        ~TestActionResult();

        /** allocator, convenience function for bind */
        static TestActionResult * New();
        ...
        static const unsigned int ID = 1134863280U;
        ...
        static const unsigned int DATA_VERSION = 1541609388U;
        ...
        //        static const char * dataTypeName() { return "TestActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "67bd4c4d24875d9f0844de09536b833f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x67bd4c4d24875d9fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0844de09536b833fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestActionResult * copy() { return new TestActionResult(*this); };

        /** assignment operator(s) */
        TestActionResult & operator=(const TestActionResult & inobj);
        /** equality operator */
        bool operator==(const TestActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const TestActionResult & inobj) const;
        /** less than operator */
        bool operator<(const TestActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestActionResult>
    {
    public:
        static bool flat() {return actionlib::TestActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestActionResult & value);

#endif  //  _ACTIONLIB_TESTACTIONRESULT_H_
