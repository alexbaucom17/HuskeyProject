...
#ifndef _CODEGEN_ACTIONLIB_TESTACTIONFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TESTACTIONFEEDBACK_H_
...
PREDECLARE_BSON(actionlib::TestActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestActionFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestActionFeedback();
        /** copy constructor */
        TestActionFeedback(const TestActionFeedback & inobj);
        /** destructor */
        ~TestActionFeedback();

        /** allocator, convenience function for bind */
        static TestActionFeedback * New();
        ...
        static const unsigned int ID = 1134863278U;
        ...
        static const unsigned int DATA_VERSION = 4179237610U;
        ...
        //        static const char * dataTypeName() { return "TestActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0fc422a9d39f5f10151e03a08262d4a8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0fc422a9d39f5f10ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x151e03a08262d4a8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestActionFeedback * copy() { return new TestActionFeedback(*this); };

        /** assignment operator(s) */
        TestActionFeedback & operator=(const TestActionFeedback & inobj);
        /** equality operator */
        bool operator==(const TestActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const TestActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const TestActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestActionFeedback>
    {
    public:
        static bool flat() {return actionlib::TestActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestActionFeedback & value);

#endif  //  _ACTIONLIB_TESTACTIONFEEDBACK_H_
