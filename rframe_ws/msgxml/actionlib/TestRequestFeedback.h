...
#ifndef _CODEGEN_ACTIONLIB_TESTREQUESTFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TESTREQUESTFEEDBACK_H_
...
PREDECLARE_BSON(actionlib::TestRequestFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestRequestFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestRequestFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestRequestFeedback();
        /** copy constructor */
        TestRequestFeedback(const TestRequestFeedback & inobj);
        /** destructor */
        ~TestRequestFeedback();

        /** allocator, convenience function for bind */
        static TestRequestFeedback * New();
        ...
        static const unsigned int ID = 1134863287U;
        ...
        static const unsigned int DATA_VERSION = 1295944202U;
        ...
        //        static const char * dataTypeName() { return "TestRequestFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "992f7aed10a5e8168288732871c0516e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x992f7aed10a5e816ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8288732871c0516eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestRequestFeedback * copy() { return new TestRequestFeedback(*this); };

        /** assignment operator(s) */
        TestRequestFeedback & operator=(const TestRequestFeedback & inobj);
        /** equality operator */
        bool operator==(const TestRequestFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const TestRequestFeedback & inobj) const;
        /** less than operator */
        bool operator<(const TestRequestFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestRequestFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestRequestFeedback>
    {
    public:
        static bool flat() {return actionlib::TestRequestFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestRequestFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestRequestFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestRequestFeedback & value);

#endif  //  _ACTIONLIB_TESTREQUESTFEEDBACK_H_
