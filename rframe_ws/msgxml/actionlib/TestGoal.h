...
#ifndef _CODEGEN_ACTIONLIB_TESTGOAL_H_
#define _CODEGEN_ACTIONLIB_TESTGOAL_H_
...
PREDECLARE_BSON(actionlib::TestGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestGoal); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1134863282U;
        ...
        static const unsigned int DATA_VERSION = 3787573248U;
        ...
        //        static const char * dataTypeName() { return "TestGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "737ec4bdfffca8a8fd5babd78471dfeb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x737ec4bdfffca8a8ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfd5babd78471dfebULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestGoal * copy() { return new TestGoal(*this); };

        /** assignment operator(s) */
        TestGoal & operator=(const TestGoal & inobj);
        /** equality operator */
        bool operator==(const TestGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const TestGoal & inobj) const;
        /** less than operator */
        bool operator<(const TestGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestGoal>
    {
    public:
        static bool flat() {return actionlib::TestGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestGoal & value);

#endif  //  _ACTIONLIB_TESTGOAL_H_
