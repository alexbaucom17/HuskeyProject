...
#ifndef _CODEGEN_ACTIONLIB_TWOINTSACTIONGOAL_H_
#define _CODEGEN_ACTIONLIB_TWOINTSACTIONGOAL_H_
...
PREDECLARE_BSON(actionlib::TwoIntsActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TwoIntsActionGoal); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwoIntsActionGoal();
        /** copy constructor */
        TwoIntsActionGoal(const TwoIntsActionGoal & inobj);
        /** destructor */
        ~TwoIntsActionGoal();

        /** allocator, convenience function for bind */
        static TwoIntsActionGoal * New();
        ...
        static const unsigned int ID = 1134863293U;
        ...
        static const unsigned int DATA_VERSION = 70461032U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bc66cb4d0c3aa341281ad6f81ba08485"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbc66cb4d0c3aa341ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x281ad6f81ba08485ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsActionGoal * copy() { return new TwoIntsActionGoal(*this); };

        /** assignment operator(s) */
        TwoIntsActionGoal & operator=(const TwoIntsActionGoal & inobj);
        /** equality operator */
        bool operator==(const TwoIntsActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TwoIntsActionGoal>
    {
    public:
        static bool flat() {return actionlib::TwoIntsActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TwoIntsActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TwoIntsActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TwoIntsActionGoal & value);

#endif  //  _ACTIONLIB_TWOINTSACTIONGOAL_H_
