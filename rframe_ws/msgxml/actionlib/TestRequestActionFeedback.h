...
#ifndef _CODEGEN_ACTIONLIB_TESTREQUESTACTIONFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TESTREQUESTACTIONFEEDBACK_H_
...
PREDECLARE_BSON(actionlib::TestRequestActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestRequestActionFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestRequestActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TestRequestActionFeedback(const TestRequestActionFeedback & inobj);
        /** destructor */
        ~TestRequestActionFeedback();

        /** allocator, convenience function for bind */
        static TestRequestActionFeedback * New();
        ...
        static const unsigned int ID = 1134863284U;
        ...
        static const unsigned int DATA_VERSION = 1299496397U;
        ...
        //        static const char * dataTypeName() { return "TestRequestActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e01c15fa6bf9f82237e728323021707a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe01c15fa6bf9f822ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x37e728323021707aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestRequestActionFeedback * copy() { return new TestRequestActionFeedback(*this); };

        /** assignment operator(s) */
        TestRequestActionFeedback & operator=(const TestRequestActionFeedback & inobj);
        /** equality operator */
        bool operator==(const TestRequestActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const TestRequestActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const TestRequestActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestRequestActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestRequestActionFeedback>
    {
    public:
        static bool flat() {return actionlib::TestRequestActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestRequestActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestRequestActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestRequestActionFeedback & value);

#endif  //  _ACTIONLIB_TESTREQUESTACTIONFEEDBACK_H_
