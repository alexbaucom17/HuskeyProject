...
#ifndef _CODEGEN_ACTIONLIB_TWOINTSACTIONFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TWOINTSACTIONFEEDBACK_H_
...
PREDECLARE_BSON(actionlib::TwoIntsActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TwoIntsActionFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TwoIntsActionFeedback(const TwoIntsActionFeedback & inobj);
        /** destructor */
        ~TwoIntsActionFeedback();

        /** allocator, convenience function for bind */
        static TwoIntsActionFeedback * New();
        ...
        static const unsigned int ID = 1134863292U;
        ...
        static const unsigned int DATA_VERSION = 3342251069U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "31cf48f398a1208e5c12ec5ecca71eaf"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x31cf48f398a1208eULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5c12ec5ecca71eafULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsActionFeedback * copy() { return new TwoIntsActionFeedback(*this); };

        /** assignment operator(s) */
        TwoIntsActionFeedback & operator=(const TwoIntsActionFeedback & inobj);
        /** equality operator */
        bool operator==(const TwoIntsActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TwoIntsActionFeedback>
    {
    public:
        static bool flat() {return actionlib::TwoIntsActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TwoIntsActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TwoIntsActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TwoIntsActionFeedback & value);

#endif  //  _ACTIONLIB_TWOINTSACTIONFEEDBACK_H_
