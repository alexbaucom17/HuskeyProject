...
#ifndef _CODEGEN_ACTIONLIB_TWOINTSRESULT_H_
#define _CODEGEN_ACTIONLIB_TWOINTSRESULT_H_
...
PREDECLARE_BSON(actionlib::TwoIntsResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TwoIntsResult); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwoIntsResult();
        /** copy constructor */
        TwoIntsResult(const TwoIntsResult & inobj);
        /** destructor */
        ~TwoIntsResult();

        /** allocator, convenience function for bind */
        static TwoIntsResult * New();
        ...
        static const unsigned int ID = 1134863297U;
        ...
        static const unsigned int DATA_VERSION = 2115128445U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "20b1fac016bac14963d51f6ab8406db7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x20b1fac016bac149ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x63d51f6ab8406db7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsResult * copy() { return new TwoIntsResult(*this); };

        /** assignment operator(s) */
        TwoIntsResult & operator=(const TwoIntsResult & inobj);
        /** equality operator */
        bool operator==(const TwoIntsResult & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsResult & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TwoIntsResult>
    {
    public:
        static bool flat() {return actionlib::TwoIntsResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TwoIntsResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TwoIntsResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TwoIntsResult & value);

#endif  //  _ACTIONLIB_TWOINTSRESULT_H_
