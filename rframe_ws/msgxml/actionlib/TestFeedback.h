...
#ifndef _CODEGEN_ACTIONLIB_TESTFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TESTFEEDBACK_H_
...
PREDECLARE_BSON(actionlib::TestFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestFeedback();
        /** copy constructor */
        TestFeedback(const TestFeedback & inobj);
        /** destructor */
        ~TestFeedback();

        /** allocator, convenience function for bind */
        static TestFeedback * New();
        ...
        static const unsigned int ID = 1134863281U;
        ...
        static const unsigned int DATA_VERSION = 3300547517U;
        ...
        //        static const char * dataTypeName() { return "TestFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ca93c84e02e430bdf97e61413c046ff7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xca93c84e02e430bdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf97e61413c046ff7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestFeedback * copy() { return new TestFeedback(*this); };

        /** assignment operator(s) */
        TestFeedback & operator=(const TestFeedback & inobj);
        /** equality operator */
        bool operator==(const TestFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const TestFeedback & inobj) const;
        /** less than operator */
        bool operator<(const TestFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestFeedback>
    {
    public:
        static bool flat() {return actionlib::TestFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestFeedback & value);

#endif  //  _ACTIONLIB_TESTFEEDBACK_H_
