...
#ifndef _CODEGEN_ACTIONLIB_TESTREQUESTGOAL_H_
#define _CODEGEN_ACTIONLIB_TESTREQUESTGOAL_H_
...
PREDECLARE_BSON(actionlib::TestRequestGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestRequestGoal); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestRequestGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestRequestGoal();
        /** copy constructor */
        TestRequestGoal(const TestRequestGoal & inobj);
        /** destructor */
        ~TestRequestGoal();

        /** allocator, convenience function for bind */
        static TestRequestGoal * New();
        ...
        int  the_result; /**< Desired value for the_result in the Result */
        bool  is_simple_client; /**<  */
        std_msgs::RosDuration  delay_accept; /**< Delays accepting the goal by this amount of time */
        std_msgs::RosDuration  delay_terminate; /**< Delays terminating for this amount of time */
        std_msgs::RosDuration  pause_status; /**< Pauses the status messages for this amount of time */

        static const int TERMINATE_SUCCESS; /**<  (value: 0) */
        static const int TERMINATE_ABORTED; /**<  (value: 1) */
        static const int TERMINATE_REJECTED; /**<  (value: 2) */
        static const int TERMINATE_LOSE; /**<  (value: 3) */
        static const int TERMINATE_DROP; /**<  (value: 4) */
        static const int TERMINATE_EXCEPTION; /**<  (value: 5) */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_TERMINATE_STATUS,
            DAQ_1_IGNORE_CANCEL,
            DAQ_2_RESULT_TEXT,
            DAQ_3_THE_RESULT,
            DAQ_4_IS_SIMPLE_CLIENT,
            DAQ_5_DELAY_ACCEPT,
            DAQ_6_DELAY_TERMINATE,
            DAQ_7_PAUSE_STATUS,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1134863288U;
        ...
        static const unsigned int DATA_VERSION = 2525412871U;
        ...
        //        static const char * dataTypeName() { return "TestRequestGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b516683e473c80def34165ce77f94821"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb516683e473c80deULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf34165ce77f94821ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestRequestGoal * copy() { return new TestRequestGoal(*this); };

        /** assignment operator(s) */
        TestRequestGoal & operator=(const TestRequestGoal & inobj);
        /** equality operator */
        bool operator==(const TestRequestGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const TestRequestGoal & inobj) const;
        /** less than operator */
        bool operator<(const TestRequestGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestRequestGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestRequestGoal>
    {
    public:
        static bool flat() {return actionlib::TestRequestGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestRequestGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestRequestGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestRequestGoal & value);

#endif  //  _ACTIONLIB_TESTREQUESTGOAL_H_
