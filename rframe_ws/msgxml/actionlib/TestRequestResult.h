...
#ifndef _CODEGEN_ACTIONLIB_TESTREQUESTRESULT_H_
#define _CODEGEN_ACTIONLIB_TESTREQUESTRESULT_H_
...
PREDECLARE_BSON(actionlib::TestRequestResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestRequestResult); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestRequestResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestRequestResult();
        /** copy constructor */
        TestRequestResult(const TestRequestResult & inobj);
        /** destructor */
        ~TestRequestResult();

        /** allocator, convenience function for bind */
        static TestRequestResult * New();
        ...
        static const unsigned int ID = 1134863289U;
        ...
        static const unsigned int DATA_VERSION = 1750104537U;
        ...
        //        static const char * dataTypeName() { return "TestRequestResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bac0302e060bd760326813dfe93d3e0d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbac0302e060bd760ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x326813dfe93d3e0dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestRequestResult * copy() { return new TestRequestResult(*this); };

        /** assignment operator(s) */
        TestRequestResult & operator=(const TestRequestResult & inobj);
        /** equality operator */
        bool operator==(const TestRequestResult & inobj) const;
        /** inequality operator */
        bool operator!=(const TestRequestResult & inobj) const;
        /** less than operator */
        bool operator<(const TestRequestResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestRequestResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestRequestResult>
    {
    public:
        static bool flat() {return actionlib::TestRequestResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestRequestResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestRequestResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestRequestResult & value);

#endif  //  _ACTIONLIB_TESTREQUESTRESULT_H_
