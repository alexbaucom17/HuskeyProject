...
#ifndef _CODEGEN_ACTIONLIB_TESTACTIONGOAL_H_
#define _CODEGEN_ACTIONLIB_TESTACTIONGOAL_H_
...
PREDECLARE_BSON(actionlib::TestActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestActionGoal); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestActionGoal();
        /** copy constructor */
        TestActionGoal(const TestActionGoal & inobj);
        /** destructor */
        ~TestActionGoal();

        /** allocator, convenience function for bind */
        static TestActionGoal * New();
        ...
        static const unsigned int ID = 1134863279U;
        ...
        static const unsigned int DATA_VERSION = 2740202474U;
        ...
        //        static const char * dataTypeName() { return "TestActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8753052d2cadc74d366e769dba90c57f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8753052d2cadc74dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x366e769dba90c57fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestActionGoal * copy() { return new TestActionGoal(*this); };

        /** assignment operator(s) */
        TestActionGoal & operator=(const TestActionGoal & inobj);
        /** equality operator */
        bool operator==(const TestActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const TestActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const TestActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestActionGoal>
    {
    public:
        static bool flat() {return actionlib::TestActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestActionGoal & value);

#endif  //  _ACTIONLIB_TESTACTIONGOAL_H_
