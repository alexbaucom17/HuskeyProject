...
#ifndef _CODEGEN_ACTIONLIB_TWOINTSFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TWOINTSFEEDBACK_H_
...
PREDECLARE_BSON(actionlib::TwoIntsFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TwoIntsFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwoIntsFeedback();
        /** copy constructor */
        TwoIntsFeedback(const TwoIntsFeedback & inobj);
        /** destructor */
        ~TwoIntsFeedback();

        /** allocator, convenience function for bind */
        static TwoIntsFeedback * New();
        ...
        static const unsigned int ID = 1134863295U;
        ...
        static const unsigned int DATA_VERSION = 4218494108U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8b2f1a91126011c310fb0f5f4b76d7d8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8b2f1a91126011c3ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x10fb0f5f4b76d7d8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsFeedback * copy() { return new TwoIntsFeedback(*this); };

        /** assignment operator(s) */
        TwoIntsFeedback & operator=(const TwoIntsFeedback & inobj);
        /** equality operator */
        bool operator==(const TwoIntsFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsFeedback & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TwoIntsFeedback>
    {
    public:
        static bool flat() {return actionlib::TwoIntsFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TwoIntsFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TwoIntsFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TwoIntsFeedback & value);

#endif  //  _ACTIONLIB_TWOINTSFEEDBACK_H_
