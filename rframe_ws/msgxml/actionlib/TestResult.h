...
#ifndef _CODEGEN_ACTIONLIB_TESTRESULT_H_
#define _CODEGEN_ACTIONLIB_TESTRESULT_H_
...
PREDECLARE_BSON(actionlib::TestResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestResult); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestResult();
        /** copy constructor */
        TestResult(const TestResult & inobj);
        /** destructor */
        ~TestResult();

        /** allocator, convenience function for bind */
        static TestResult * New();
        ...
        static const unsigned int ID = 1134863290U;
        ...
        static const unsigned int DATA_VERSION = 4014366767U;
        ...
        //        static const char * dataTypeName() { return "TestResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "4baeffac315cbcb768a0cf9636ec4d2c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x4baeffac315cbcb7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x68a0cf9636ec4d2cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestResult * copy() { return new TestResult(*this); };

        /** assignment operator(s) */
        TestResult & operator=(const TestResult & inobj);
        /** equality operator */
        bool operator==(const TestResult & inobj) const;
        /** inequality operator */
        bool operator!=(const TestResult & inobj) const;
        /** less than operator */
        bool operator<(const TestResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestResult>
    {
    public:
        static bool flat() {return actionlib::TestResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestResult & value);

#endif  //  _ACTIONLIB_TESTRESULT_H_
