...
#ifndef _CODEGEN_ACTIONLIB_TWOINTSACTIONRESULT_H_
#define _CODEGEN_ACTIONLIB_TWOINTSACTIONRESULT_H_
...
PREDECLARE_BSON(actionlib::TwoIntsActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TwoIntsActionResult); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwoIntsActionResult();
        /** copy constructor */
        TwoIntsActionResult(const TwoIntsActionResult & inobj);
        /** destructor */
        ~TwoIntsActionResult();

        /** allocator, convenience function for bind */
        static TwoIntsActionResult * New();
        ...
        static const unsigned int ID = 1134863294U;
        ...
        static const unsigned int DATA_VERSION = 2234218184U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1904568e679bb4cd1b72b0b49384155a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1904568e679bb4cdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1b72b0b49384155aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsActionResult * copy() { return new TwoIntsActionResult(*this); };

        /** assignment operator(s) */
        TwoIntsActionResult & operator=(const TwoIntsActionResult & inobj);
        /** equality operator */
        bool operator==(const TwoIntsActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsActionResult & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TwoIntsActionResult>
    {
    public:
        static bool flat() {return actionlib::TwoIntsActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TwoIntsActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TwoIntsActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TwoIntsActionResult & value);

#endif  //  _ACTIONLIB_TWOINTSACTIONRESULT_H_
