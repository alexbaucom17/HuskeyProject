...
#ifndef _CODEGEN_NODELET_NODELETUNLOADREQUEST_H_
#define _CODEGEN_NODELET_NODELETUNLOADREQUEST_H_
...
PREDECLARE_BSON(nodelet::NodeletUnloadRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletUnloadRequest); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletUnloadRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        NodeletUnloadRequest(const NodeletUnloadRequest & inobj);
        /** destructor */
        ~NodeletUnloadRequest();

        /** allocator, convenience function for bind */
        static NodeletUnloadRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  name; /**< no comment provided */
        ...
        static const unsigned int ID = 1210331551U;
        ...
        static const unsigned int DATA_VERSION = 461703044U;
        ...
        //        static const char * dataTypeName() { return "NodeletUnloadRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "55771c08f34a356f0ec61be8adcf4de1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x55771c08f34a356fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0ec61be8adcf4de1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletUnloadRequest * copy() { return new NodeletUnloadRequest(*this); };

        /** assignment operator(s) */
        NodeletUnloadRequest & operator=(const NodeletUnloadRequest & inobj);
        /** equality operator */
        bool operator==(const NodeletUnloadRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletUnloadRequest & inobj) const;
        /** less than operator */
        bool operator<(const NodeletUnloadRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletUnloadRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletUnloadRequest>
    {
    public:
        static bool flat() {return nodelet::NodeletUnloadRequest::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletUnloadRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletUnloadRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletUnloadRequest & value);

#endif  //  _NODELET_NODELETUNLOADREQUEST_H_
