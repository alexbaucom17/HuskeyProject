...
#ifndef _CODEGEN_NODELET_NODELETUNLOADRESPONSE_H_
#define _CODEGEN_NODELET_NODELETUNLOADRESPONSE_H_
...
PREDECLARE_BSON(nodelet::NodeletUnloadResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletUnloadResponse); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletUnloadResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        NodeletUnloadResponse(const NodeletUnloadResponse & inobj);
        /** destructor */
        ~NodeletUnloadResponse();

        /** allocator, convenience function for bind */
        static NodeletUnloadResponse * New();
        ...
        static const unsigned int ID = 1210331552U;
        ...
        static const unsigned int DATA_VERSION = 3169072437U;
        ...
        //        static const char * dataTypeName() { return "NodeletUnloadResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "588d604b76022dfeb584c583e699d55d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x588d604b76022dfeULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb584c583e699d55dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletUnloadResponse * copy() { return new NodeletUnloadResponse(*this); };

        /** assignment operator(s) */
        NodeletUnloadResponse & operator=(const NodeletUnloadResponse & inobj);
        /** equality operator */
        bool operator==(const NodeletUnloadResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletUnloadResponse & inobj) const;
        /** less than operator */
        bool operator<(const NodeletUnloadResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletUnloadResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletUnloadResponse>
    {
    public:
        static bool flat() {return nodelet::NodeletUnloadResponse::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletUnloadResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletUnloadResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletUnloadResponse & value);

#endif  //  _NODELET_NODELETUNLOADRESPONSE_H_
