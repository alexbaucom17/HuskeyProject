...
#ifndef _CODEGEN_NODELET_NODELETLOADRESPONSE_H_
#define _CODEGEN_NODELET_NODELETLOADRESPONSE_H_
...
PREDECLARE_BSON(nodelet::NodeletLoadResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletLoadResponse); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletLoadResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        NodeletLoadResponse();
        /** copy constructor */
        NodeletLoadResponse(const NodeletLoadResponse & inobj);
        /** destructor */
        ~NodeletLoadResponse();

        /** allocator, convenience function for bind */
        static NodeletLoadResponse * New();
        ...
        static const unsigned int ID = 1210331549U;
        ...
        static const unsigned int DATA_VERSION = 2491635085U;
        ...
        //        static const char * dataTypeName() { return "NodeletLoadResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "cd8f6b8e899eeb589e9c07e88a4624e8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xcd8f6b8e899eeb58ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9e9c07e88a4624e8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletLoadResponse * copy() { return new NodeletLoadResponse(*this); };

        /** assignment operator(s) */
        NodeletLoadResponse & operator=(const NodeletLoadResponse & inobj);
        /** equality operator */
        bool operator==(const NodeletLoadResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletLoadResponse & inobj) const;
        /** less than operator */
        bool operator<(const NodeletLoadResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletLoadResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletLoadResponse>
    {
    public:
        static bool flat() {return nodelet::NodeletLoadResponse::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletLoadResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletLoadResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletLoadResponse & value);

#endif  //  _NODELET_NODELETLOADRESPONSE_H_
