...
#ifndef _CODEGEN_NODELET_NODELETLIST_H_
#define _CODEGEN_NODELET_NODELETLIST_H_
...
PREDECLARE_BSON(nodelet::NodeletList); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletList); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletList & inobj);   
    ...
    */
    ...
    public: 
        ...
        NodeletList();
        /** copy constructor */
        NodeletList(const NodeletList & inobj);
        /** destructor */
        ~NodeletList();

        /** allocator, convenience function for bind */
        static NodeletList * New();
        ...
        static const unsigned int ID = 1210331547U;
        ...
        static const unsigned int DATA_VERSION = 666861614U;
        ...
        //        static const char * dataTypeName() { return "NodeletList"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "212c3814d2d229de3564bc72848a9743"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x212c3814d2d229deULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3564bc72848a9743ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletList * copy() { return new NodeletList(*this); };

        /** assignment operator(s) */
        NodeletList & operator=(const NodeletList & inobj);
        /** equality operator */
        bool operator==(const NodeletList & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletList & inobj) const;
        /** less than operator */
        bool operator<(const NodeletList & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletList & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletList>
    {
    public:
        static bool flat() {return nodelet::NodeletList::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletList::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletList & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletList & value);

#endif  //  _NODELET_NODELETLIST_H_
