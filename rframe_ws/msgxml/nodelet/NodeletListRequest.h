...
#ifndef _CODEGEN_NODELET_NODELETLISTREQUEST_H_
#define _CODEGEN_NODELET_NODELETLISTREQUEST_H_
...
PREDECLARE_BSON(nodelet::NodeletListRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletListRequest); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletListRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        NodeletListRequest();
        /** copy constructor */
        NodeletListRequest(const NodeletListRequest & inobj);
        /** destructor */
        ~NodeletListRequest();

        /** allocator, convenience function for bind */
        static NodeletListRequest * New();
        ...
        static const unsigned int ID = 1210331545U;
        ...
        static const unsigned int DATA_VERSION = 3729738590U;
        ...
        //        static const char * dataTypeName() { return "NodeletListRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0d3c100dc517bfffd178becda14d7948"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0d3c100dc517bfffULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd178becda14d7948ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletListRequest * copy() { return new NodeletListRequest(*this); };

        /** assignment operator(s) */
        NodeletListRequest & operator=(const NodeletListRequest & inobj);
        /** equality operator */
        bool operator==(const NodeletListRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletListRequest & inobj) const;
        /** less than operator */
        bool operator<(const NodeletListRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletListRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletListRequest>
    {
    public:
        static bool flat() {return nodelet::NodeletListRequest::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletListRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletListRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletListRequest & value);

#endif  //  _NODELET_NODELETLISTREQUEST_H_
