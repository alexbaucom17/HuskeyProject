...
#ifndef _CODEGEN_NODELET_NODELETLOAD_H_
#define _CODEGEN_NODELET_NODELETLOAD_H_
...
PREDECLARE_BSON(nodelet::NodeletLoad); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletLoad); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletLoad & inobj);   
    ...
    */
    ...
    public: 
        ...
        NodeletLoad();
        /** copy constructor */
        NodeletLoad(const NodeletLoad & inobj);
        /** destructor */
        ~NodeletLoad();

        /** allocator, convenience function for bind */
        static NodeletLoad * New();
        ...
        static const unsigned int ID = 1210331550U;
        ...
        static const unsigned int DATA_VERSION = 2336346374U;
        ...
        //        static const char * dataTypeName() { return "NodeletLoad"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f649ddb3fcc750e400fb1e5354e9fbc8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf649ddb3fcc750e4ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x00fb1e5354e9fbc8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletLoad * copy() { return new NodeletLoad(*this); };

        /** assignment operator(s) */
        NodeletLoad & operator=(const NodeletLoad & inobj);
        /** equality operator */
        bool operator==(const NodeletLoad & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletLoad & inobj) const;
        /** less than operator */
        bool operator<(const NodeletLoad & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletLoad & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletLoad>
    {
    public:
        static bool flat() {return nodelet::NodeletLoad::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletLoad::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletLoad & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletLoad & value);

#endif  //  _NODELET_NODELETLOAD_H_
