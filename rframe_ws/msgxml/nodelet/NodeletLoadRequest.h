...
#ifndef _CODEGEN_NODELET_NODELETLOADREQUEST_H_
#define _CODEGEN_NODELET_NODELETLOADREQUEST_H_
...
PREDECLARE_BSON(nodelet::NodeletLoadRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletLoadRequest); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletLoadRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        NodeletLoadRequest();
        /** copy constructor */
        NodeletLoadRequest(const NodeletLoadRequest & inobj);
        /** destructor */
        ~NodeletLoadRequest();

        /** allocator, convenience function for bind */
        static NodeletLoadRequest * New();
        ...
        std::string  name; /**<  */
        std::string  type; /**<  */
        std::vector<std::string >  remap_source_args; /**<  */
        std::vector<std::string >  remap_target_args; /**<  */
        std::vector<std::string >  my_argv; /**<  */
        std::string  bond_id; /**< no comment provided */
        ...
        { 
            DAQ_0_NAME,
            DAQ_1_TYPE,
            DAQ_2_REMAP_SOURCE_ARGS,
            DAQ_3_REMAP_TARGET_ARGS,
            DAQ_4_MY_ARGV,
            DAQ_5_BOND_ID,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1210331548U;
        ...
        static const unsigned int DATA_VERSION = 3043024625U;
        ...
        //        static const char * dataTypeName() { return "NodeletLoadRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "11c70aab3d87c2c707e8a7865ae492d5"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x11c70aab3d87c2c7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x07e8a7865ae492d5ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletLoadRequest * copy() { return new NodeletLoadRequest(*this); };

        /** assignment operator(s) */
        NodeletLoadRequest & operator=(const NodeletLoadRequest & inobj);
        /** equality operator */
        bool operator==(const NodeletLoadRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletLoadRequest & inobj) const;
        /** less than operator */
        bool operator<(const NodeletLoadRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletLoadRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletLoadRequest>
    {
    public:
        static bool flat() {return nodelet::NodeletLoadRequest::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletLoadRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletLoadRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletLoadRequest & value);

#endif  //  _NODELET_NODELETLOADREQUEST_H_
