...
#ifndef _CODEGEN_NODELET_NODELETUNLOAD_H_
#define _CODEGEN_NODELET_NODELETUNLOAD_H_
...
PREDECLARE_BSON(nodelet::NodeletUnload); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletUnload); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletUnload & inobj);   
    ...
    */
    ...
    public: 
        ...
        NodeletUnload();
        /** copy constructor */
        NodeletUnload(const NodeletUnload & inobj);
        /** destructor */
        ~NodeletUnload();

        /** allocator, convenience function for bind */
        static NodeletUnload * New();
        ...
        static const unsigned int ID = 1210331553U;
        ...
        static const unsigned int DATA_VERSION = 203800439U;
        ...
        //        static const char * dataTypeName() { return "NodeletUnload"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "da7d9aab2a4c95d2151722d46e38e80f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xda7d9aab2a4c95d2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x151722d46e38e80fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletUnload * copy() { return new NodeletUnload(*this); };

        /** assignment operator(s) */
        NodeletUnload & operator=(const NodeletUnload & inobj);
        /** equality operator */
        bool operator==(const NodeletUnload & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletUnload & inobj) const;
        /** less than operator */
        bool operator<(const NodeletUnload & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletUnload & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletUnload>
    {
    public:
        static bool flat() {return nodelet::NodeletUnload::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletUnload::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletUnload & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletUnload & value);

#endif  //  _NODELET_NODELETUNLOAD_H_
