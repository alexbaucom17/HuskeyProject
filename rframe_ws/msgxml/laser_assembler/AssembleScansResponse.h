...
#ifndef _CODEGEN_LASER_ASSEMBLER_ASSEMBLESCANSRESPONSE_H_
#define _CODEGEN_LASER_ASSEMBLER_ASSEMBLESCANSRESPONSE_H_
...
PREDECLARE_BSON(laser_assembler::AssembleScansResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(laser_assembler::AssembleScansResponse); // see Common.h, macro used for a cleaner header

namespace laser_assembler
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AssembleScansResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        AssembleScansResponse(const AssembleScansResponse & inobj);
        /** destructor */
        ~AssembleScansResponse();

        /** allocator, convenience function for bind */
        static AssembleScansResponse * New();
        ...
        static const unsigned int ID = 1126634654U;
        ...
        static const unsigned int DATA_VERSION = 2967660106U;
        ...
        //        static const char * dataTypeName() { return "AssembleScansResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c6d681ff30e111a76fb1d8b7c789990a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc6d681ff30e111a7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6fb1d8b7c789990aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AssembleScansResponse * copy() { return new AssembleScansResponse(*this); };

        /** assignment operator(s) */
        AssembleScansResponse & operator=(const AssembleScansResponse & inobj);
        /** equality operator */
        bool operator==(const AssembleScansResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const AssembleScansResponse & inobj) const;
        /** less than operator */
        bool operator<(const AssembleScansResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AssembleScansResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<laser_assembler::AssembleScansResponse>
    {
    public:
        static bool flat() {return laser_assembler::AssembleScansResponse::dataTypeFlat(); };
        static std::string sourceXML() {return laser_assembler::AssembleScansResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const laser_assembler::AssembleScansResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const laser_assembler::AssembleScansResponse & value);

#endif  //  _LASER_ASSEMBLER_ASSEMBLESCANSRESPONSE_H_
