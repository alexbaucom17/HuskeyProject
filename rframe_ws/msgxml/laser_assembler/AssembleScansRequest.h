...
#ifndef _CODEGEN_LASER_ASSEMBLER_ASSEMBLESCANSREQUEST_H_
#define _CODEGEN_LASER_ASSEMBLER_ASSEMBLESCANSREQUEST_H_
...
PREDECLARE_BSON(laser_assembler::AssembleScansRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(laser_assembler::AssembleScansRequest); // see Common.h, macro used for a cleaner header

namespace laser_assembler
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AssembleScansRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        AssembleScansRequest(const AssembleScansRequest & inobj);
        /** destructor */
        ~AssembleScansRequest();

        /** allocator, convenience function for bind */
        static AssembleScansRequest * New();
        ...
        static const unsigned int ID = 1126634653U;
        ...
        static const unsigned int DATA_VERSION = 3906521630U;
        ...
        //        static const char * dataTypeName() { return "AssembleScansRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8810ec5bcaad4f2dfa9a7a581578affa"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8810ec5bcaad4f2dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfa9a7a581578affaULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AssembleScansRequest * copy() { return new AssembleScansRequest(*this); };

        /** assignment operator(s) */
        AssembleScansRequest & operator=(const AssembleScansRequest & inobj);
        /** equality operator */
        bool operator==(const AssembleScansRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const AssembleScansRequest & inobj) const;
        /** less than operator */
        bool operator<(const AssembleScansRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AssembleScansRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<laser_assembler::AssembleScansRequest>
    {
    public:
        static bool flat() {return laser_assembler::AssembleScansRequest::dataTypeFlat(); };
        static std::string sourceXML() {return laser_assembler::AssembleScansRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const laser_assembler::AssembleScansRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const laser_assembler::AssembleScansRequest & value);

#endif  //  _LASER_ASSEMBLER_ASSEMBLESCANSREQUEST_H_
