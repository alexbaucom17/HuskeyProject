...
#ifndef _CODEGEN_LASER_ASSEMBLER_ASSEMBLESCANS2RESPONSE_H_
#define _CODEGEN_LASER_ASSEMBLER_ASSEMBLESCANS2RESPONSE_H_
...
PREDECLARE_BSON(laser_assembler::AssembleScans2Response); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(laser_assembler::AssembleScans2Response); // see Common.h, macro used for a cleaner header

namespace laser_assembler
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AssembleScans2Response & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        AssembleScans2Response(const AssembleScans2Response & inobj);
        /** destructor */
        ~AssembleScans2Response();

        /** allocator, convenience function for bind */
        static AssembleScans2Response * New();
        ...
        static const unsigned int ID = 1126634657U;
        ...
        static const unsigned int DATA_VERSION = 4082615775U;
        ...
        //        static const char * dataTypeName() { return "AssembleScans2Response"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5efa152867eb31a40bb6f2c27c59e119"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5efa152867eb31a4ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0bb6f2c27c59e119ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AssembleScans2Response * copy() { return new AssembleScans2Response(*this); };

        /** assignment operator(s) */
        AssembleScans2Response & operator=(const AssembleScans2Response & inobj);
        /** equality operator */
        bool operator==(const AssembleScans2Response & inobj) const;
        /** inequality operator */
        bool operator!=(const AssembleScans2Response & inobj) const;
        /** less than operator */
        bool operator<(const AssembleScans2Response & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AssembleScans2Response & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<laser_assembler::AssembleScans2Response>
    {
    public:
        static bool flat() {return laser_assembler::AssembleScans2Response::dataTypeFlat(); };
        static std::string sourceXML() {return laser_assembler::AssembleScans2Response::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const laser_assembler::AssembleScans2Response & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const laser_assembler::AssembleScans2Response & value);

#endif  //  _LASER_ASSEMBLER_ASSEMBLESCANS2RESPONSE_H_
