...
#ifndef _CODEGEN_POLLED_CAMERA_GETPOLLEDIMAGE_H_
#define _CODEGEN_POLLED_CAMERA_GETPOLLEDIMAGE_H_
...
PREDECLARE_BSON(polled_camera::GetPolledImage); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(polled_camera::GetPolledImage); // see Common.h, macro used for a cleaner header

namespace polled_camera
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPolledImage & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetPolledImage();
        /** copy constructor */
        GetPolledImage(const GetPolledImage & inobj);
        /** destructor */
        ~GetPolledImage();

        /** allocator, convenience function for bind */
        static GetPolledImage * New();
        ...
        static const unsigned int ID = 324220286U;
        ...
        static const unsigned int DATA_VERSION = 2504488608U;
        ...
        //        static const char * dataTypeName() { return "GetPolledImage"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2e26da8f2ca71b7407d8c16e9608a309"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2e26da8f2ca71b74ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x07d8c16e9608a309ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPolledImage * copy() { return new GetPolledImage(*this); };

        /** assignment operator(s) */
        GetPolledImage & operator=(const GetPolledImage & inobj);
        /** equality operator */
        bool operator==(const GetPolledImage & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPolledImage & inobj) const;
        /** less than operator */
        bool operator<(const GetPolledImage & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPolledImage & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<polled_camera::GetPolledImage>
    {
    public:
        static bool flat() {return polled_camera::GetPolledImage::dataTypeFlat(); };
        static std::string sourceXML() {return polled_camera::GetPolledImage::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const polled_camera::GetPolledImage & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const polled_camera::GetPolledImage & value);

#endif  //  _POLLED_CAMERA_GETPOLLEDIMAGE_H_
