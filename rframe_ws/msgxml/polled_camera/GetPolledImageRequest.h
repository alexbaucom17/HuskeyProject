...
#ifndef _CODEGEN_POLLED_CAMERA_GETPOLLEDIMAGEREQUEST_H_
#define _CODEGEN_POLLED_CAMERA_GETPOLLEDIMAGEREQUEST_H_
...
PREDECLARE_BSON(polled_camera::GetPolledImageRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(polled_camera::GetPolledImageRequest); // see Common.h, macro used for a cleaner header

namespace polled_camera
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPolledImageRequest & inobj);   

    /** 
        \ingroup CodeGen
        Namespace to publish response topics in. A polled camera driver node  should publish:    <response_namespace>/image_raw    <response_namespace>/camera_info
    */
    class GetPolledImageRequest
    {
    public: 
        ...
        /** copy constructor */
        GetPolledImageRequest(const GetPolledImageRequest & inobj);
        /** destructor */
        ~GetPolledImageRequest();

        /** allocator, convenience function for bind */
        static GetPolledImageRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  response_namespace; /**< Timeout for attempting to capture data from the device. This does not  include latency from ROS communication, post-processing of raw camera  data, etc. A zero duration indicates no time limit. */
        std_msgs::RosDuration  timeout; /**< Binning settings, if supported by the camera. */
        unsigned int  binning_x; /**<  */
        unsigned int  binning_y; /**< Region of interest, if supported by the camera. */
        sensor_msgs::RegionOfInterest  roi; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_RESPONSE_NAMESPACE,
            DAQ_1_TIMEOUT,
            DAQ_2_BINNING_X,
            DAQ_3_BINNING_Y,
            DAQ_4_ROI,
        ...
        static const unsigned int ID = 324220284U;
        ...
        static const unsigned int DATA_VERSION = 594589609U;
        ...
        //        static const char * dataTypeName() { return "GetPolledImageRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "02b250a8731d82d2206a5e902a752a29"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x02b250a8731d82d2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x206a5e902a752a29ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPolledImageRequest * copy() { return new GetPolledImageRequest(*this); };

        /** assignment operator(s) */
        GetPolledImageRequest & operator=(const GetPolledImageRequest & inobj);
        /** equality operator */
        bool operator==(const GetPolledImageRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPolledImageRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetPolledImageRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPolledImageRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<polled_camera::GetPolledImageRequest>
    {
    public:
        static bool flat() {return polled_camera::GetPolledImageRequest::dataTypeFlat(); };
        static std::string sourceXML() {return polled_camera::GetPolledImageRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const polled_camera::GetPolledImageRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const polled_camera::GetPolledImageRequest & value);

#endif  //  _POLLED_CAMERA_GETPOLLEDIMAGEREQUEST_H_
