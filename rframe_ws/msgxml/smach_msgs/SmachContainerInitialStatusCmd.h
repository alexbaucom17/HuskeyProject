...
#ifndef _CODEGEN_SMACH_MSGS_SMACHCONTAINERINITIALSTATUSCMD_H_
#define _CODEGEN_SMACH_MSGS_SMACHCONTAINERINITIALSTATUSCMD_H_
...
PREDECLARE_BSON(smach_msgs::SmachContainerInitialStatusCmd); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(smach_msgs::SmachContainerInitialStatusCmd); // see Common.h, macro used for a cleaner header

namespace smach_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SmachContainerInitialStatusCmd & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SmachContainerInitialStatusCmd(const SmachContainerInitialStatusCmd & inobj);
        /** destructor */
        ~SmachContainerInitialStatusCmd();

        /** allocator, convenience function for bind */
        static SmachContainerInitialStatusCmd * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  path; /**< The desired initial state(s) */
        std::vector<std::string >  initial_states; /**< Initial values for the local user data of the state machine  A pickled user data structure  i.e. the UserData's internal dictionary */
        ...
        static const unsigned int ID = 326898366U;
        ...
        static const unsigned int DATA_VERSION = 2281775538U;
        ...
        //        static const char * dataTypeName() { return "SmachContainerInitialStatusCmd"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c9f1af2ab9d74dde10ab8f48b3547ff5"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc9f1af2ab9d74ddeULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x10ab8f48b3547ff5ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SmachContainerInitialStatusCmd * copy() { return new SmachContainerInitialStatusCmd(*this); };

        /** assignment operator(s) */
        SmachContainerInitialStatusCmd & operator=(const SmachContainerInitialStatusCmd & inobj);
        /** equality operator */
        bool operator==(const SmachContainerInitialStatusCmd & inobj) const;
        /** inequality operator */
        bool operator!=(const SmachContainerInitialStatusCmd & inobj) const;
        /** less than operator */
        bool operator<(const SmachContainerInitialStatusCmd & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SmachContainerInitialStatusCmd & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<smach_msgs::SmachContainerInitialStatusCmd>
    {
    public:
        static bool flat() {return smach_msgs::SmachContainerInitialStatusCmd::dataTypeFlat(); };
        static std::string sourceXML() {return smach_msgs::SmachContainerInitialStatusCmd::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const smach_msgs::SmachContainerInitialStatusCmd & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const smach_msgs::SmachContainerInitialStatusCmd & value);

#endif  //  _SMACH_MSGS_SMACHCONTAINERINITIALSTATUSCMD_H_
