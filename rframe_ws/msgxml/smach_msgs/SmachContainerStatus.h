...
#ifndef _CODEGEN_SMACH_MSGS_SMACHCONTAINERSTATUS_H_
#define _CODEGEN_SMACH_MSGS_SMACHCONTAINERSTATUS_H_
...
PREDECLARE_BSON(smach_msgs::SmachContainerStatus); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(smach_msgs::SmachContainerStatus); // see Common.h, macro used for a cleaner header

namespace smach_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SmachContainerStatus & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SmachContainerStatus(const SmachContainerStatus & inobj);
        /** destructor */
        ~SmachContainerStatus();

        /** allocator, convenience function for bind */
        static SmachContainerStatus * New();
        ...
        std::string  path; /**< The initial state description  Effects an arc from the top state to each one */
        std::vector<std::string >  initial_states; /**< The current state description */
        std::vector<std::string >  active_states; /**< A pickled user data structure  i.e. the UserData's internal dictionary */
        std::string  local_data; /**< Debugging info string */
        std::string  info; /**<  */
        ...
        static const unsigned int ID = 326898367U;
        ...
        static const unsigned int DATA_VERSION = 3599468045U;
        ...
        //        static const char * dataTypeName() { return "SmachContainerStatus"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b6d1acaed9cb1162a32daf549c612ed0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb6d1acaed9cb1162ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa32daf549c612ed0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SmachContainerStatus * copy() { return new SmachContainerStatus(*this); };

        /** assignment operator(s) */
        SmachContainerStatus & operator=(const SmachContainerStatus & inobj);
        /** equality operator */
        bool operator==(const SmachContainerStatus & inobj) const;
        /** inequality operator */
        bool operator!=(const SmachContainerStatus & inobj) const;
        /** less than operator */
        bool operator<(const SmachContainerStatus & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SmachContainerStatus & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<smach_msgs::SmachContainerStatus>
    {
    public:
        static bool flat() {return smach_msgs::SmachContainerStatus::dataTypeFlat(); };
        static std::string sourceXML() {return smach_msgs::SmachContainerStatus::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const smach_msgs::SmachContainerStatus & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const smach_msgs::SmachContainerStatus & value);

#endif  //  _SMACH_MSGS_SMACHCONTAINERSTATUS_H_
