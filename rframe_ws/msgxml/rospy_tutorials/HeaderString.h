...
#ifndef _CODEGEN_ROSPY_TUTORIALS_HEADERSTRING_H_
#define _CODEGEN_ROSPY_TUTORIALS_HEADERSTRING_H_
...
PREDECLARE_BSON(rospy_tutorials::HeaderString); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(rospy_tutorials::HeaderString); // see Common.h, macro used for a cleaner header

namespace rospy_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, HeaderString & inobj);   
    ...
    */
    ...
    public: 
        ...
        HeaderString();
        /** copy constructor */
        HeaderString(const HeaderString & inobj);
        /** destructor */
        ~HeaderString();

        /** allocator, convenience function for bind */
        static HeaderString * New();
        ...
        static const unsigned int ID = 862848160U;
        ...
        static const unsigned int DATA_VERSION = 2390114962U;
        ...
        //        static const char * dataTypeName() { return "HeaderString"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7ce9a8ab3ad26db97360afbbbfac2f55"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7ce9a8ab3ad26db9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7360afbbbfac2f55ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        HeaderString * copy() { return new HeaderString(*this); };

        /** assignment operator(s) */
        HeaderString & operator=(const HeaderString & inobj);
        /** equality operator */
        bool operator==(const HeaderString & inobj) const;
        /** inequality operator */
        bool operator!=(const HeaderString & inobj) const;
        /** less than operator */
        bool operator<(const HeaderString & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, HeaderString & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<rospy_tutorials::HeaderString>
    {
    public:
        static bool flat() {return rospy_tutorials::HeaderString::dataTypeFlat(); };
        static std::string sourceXML() {return rospy_tutorials::HeaderString::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const rospy_tutorials::HeaderString & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const rospy_tutorials::HeaderString & value);

#endif  //  _ROSPY_TUTORIALS_HEADERSTRING_H_
