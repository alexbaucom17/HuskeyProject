...
#ifndef _CODEGEN_ROSPY_TUTORIALS_FLOATS_H_
#define _CODEGEN_ROSPY_TUTORIALS_FLOATS_H_
...
PREDECLARE_BSON(rospy_tutorials::Floats); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(rospy_tutorials::Floats); // see Common.h, macro used for a cleaner header

namespace rospy_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Floats & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 862848159U;
        ...
        static const unsigned int DATA_VERSION = 266075401U;
        ...
        //        static const char * dataTypeName() { return "Floats"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "84d2dd294033a2a9101bd8fc95f34f36"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x84d2dd294033a2a9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x101bd8fc95f34f36ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Floats * copy() { return new Floats(*this); };

        /** assignment operator(s) */
        Floats & operator=(const Floats & inobj);
        /** equality operator */
        bool operator==(const Floats & inobj) const;
        /** inequality operator */
        bool operator!=(const Floats & inobj) const;
        /** less than operator */
        bool operator<(const Floats & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Floats & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<rospy_tutorials::Floats>
    {
    public:
        static bool flat() {return rospy_tutorials::Floats::dataTypeFlat(); };
        static std::string sourceXML() {return rospy_tutorials::Floats::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const rospy_tutorials::Floats & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const rospy_tutorials::Floats & value);

#endif  //  _ROSPY_TUTORIALS_FLOATS_H_
