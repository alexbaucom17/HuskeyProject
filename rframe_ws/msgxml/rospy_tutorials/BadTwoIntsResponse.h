...
#ifndef _CODEGEN_ROSPY_TUTORIALS_BADTWOINTSRESPONSE_H_
#define _CODEGEN_ROSPY_TUTORIALS_BADTWOINTSRESPONSE_H_
...
PREDECLARE_BSON(rospy_tutorials::BadTwoIntsResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(rospy_tutorials::BadTwoIntsResponse); // see Common.h, macro used for a cleaner header

namespace rospy_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, BadTwoIntsResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        BadTwoIntsResponse();
        /** copy constructor */
        BadTwoIntsResponse(const BadTwoIntsResponse & inobj);
        /** destructor */
        ~BadTwoIntsResponse();

        /** allocator, convenience function for bind */
        static BadTwoIntsResponse * New();
        ...
        static const unsigned int ID = 862848165U;
        ...
        static const unsigned int DATA_VERSION = 810149893U;
        ...
        //        static const char * dataTypeName() { return "BadTwoIntsResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "4e897e27dd1e0b266815e582c447c3d6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x4e897e27dd1e0b26ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6815e582c447c3d6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        BadTwoIntsResponse * copy() { return new BadTwoIntsResponse(*this); };

        /** assignment operator(s) */
        BadTwoIntsResponse & operator=(const BadTwoIntsResponse & inobj);
        /** equality operator */
        bool operator==(const BadTwoIntsResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const BadTwoIntsResponse & inobj) const;
        /** less than operator */
        bool operator<(const BadTwoIntsResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, BadTwoIntsResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<rospy_tutorials::BadTwoIntsResponse>
    {
    public:
        static bool flat() {return rospy_tutorials::BadTwoIntsResponse::dataTypeFlat(); };
        static std::string sourceXML() {return rospy_tutorials::BadTwoIntsResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const rospy_tutorials::BadTwoIntsResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const rospy_tutorials::BadTwoIntsResponse & value);

#endif  //  _ROSPY_TUTORIALS_BADTWOINTSRESPONSE_H_
