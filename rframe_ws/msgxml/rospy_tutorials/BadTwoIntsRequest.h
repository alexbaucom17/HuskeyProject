...
#ifndef _CODEGEN_ROSPY_TUTORIALS_BADTWOINTSREQUEST_H_
#define _CODEGEN_ROSPY_TUTORIALS_BADTWOINTSREQUEST_H_
...
PREDECLARE_BSON(rospy_tutorials::BadTwoIntsRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(rospy_tutorials::BadTwoIntsRequest); // see Common.h, macro used for a cleaner header

namespace rospy_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, BadTwoIntsRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        BadTwoIntsRequest();
        /** copy constructor */
        BadTwoIntsRequest(const BadTwoIntsRequest & inobj);
        /** destructor */
        ~BadTwoIntsRequest();

        /** allocator, convenience function for bind */
        static BadTwoIntsRequest * New();
        ...
        static const unsigned int ID = 862848164U;
        ...
        static const unsigned int DATA_VERSION = 3698926434U;
        ...
        //        static const char * dataTypeName() { return "BadTwoIntsRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5c8f9db54aa19d5b6f7422de0f561de8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5c8f9db54aa19d5bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6f7422de0f561de8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        BadTwoIntsRequest * copy() { return new BadTwoIntsRequest(*this); };

        /** assignment operator(s) */
        BadTwoIntsRequest & operator=(const BadTwoIntsRequest & inobj);
        /** equality operator */
        bool operator==(const BadTwoIntsRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const BadTwoIntsRequest & inobj) const;
        /** less than operator */
        bool operator<(const BadTwoIntsRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, BadTwoIntsRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<rospy_tutorials::BadTwoIntsRequest>
    {
    public:
        static bool flat() {return rospy_tutorials::BadTwoIntsRequest::dataTypeFlat(); };
        static std::string sourceXML() {return rospy_tutorials::BadTwoIntsRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const rospy_tutorials::BadTwoIntsRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const rospy_tutorials::BadTwoIntsRequest & value);

#endif  //  _ROSPY_TUTORIALS_BADTWOINTSREQUEST_H_
