...
#ifndef _CODEGEN_ROSCPP_TUTORIALS_TWOINTS_H_
#define _CODEGEN_ROSCPP_TUTORIALS_TWOINTS_H_
...
PREDECLARE_BSON(roscpp_tutorials::TwoInts); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp_tutorials::TwoInts); // see Common.h, macro used for a cleaner header

namespace roscpp_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoInts & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1840529930U;
        ...
        static const unsigned int DATA_VERSION = 1590387596U;
        ...
        //        static const char * dataTypeName() { return "TwoInts"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "369bdcbd5132ecae47c1729d012ea8b2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x369bdcbd5132ecaeULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x47c1729d012ea8b2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoInts * copy() { return new TwoInts(*this); };

        /** assignment operator(s) */
        TwoInts & operator=(const TwoInts & inobj);
        /** equality operator */
        bool operator==(const TwoInts & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoInts & inobj) const;
        /** less than operator */
        bool operator<(const TwoInts & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoInts & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp_tutorials::TwoInts>
    {
    public:
        static bool flat() {return roscpp_tutorials::TwoInts::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp_tutorials::TwoInts::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp_tutorials::TwoInts & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp_tutorials::TwoInts & value);

#endif  //  _ROSCPP_TUTORIALS_TWOINTS_H_
