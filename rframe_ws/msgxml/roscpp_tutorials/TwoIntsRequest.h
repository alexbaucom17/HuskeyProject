...
#ifndef _CODEGEN_ROSCPP_TUTORIALS_TWOINTSREQUEST_H_
#define _CODEGEN_ROSCPP_TUTORIALS_TWOINTSREQUEST_H_
...
PREDECLARE_BSON(roscpp_tutorials::TwoIntsRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp_tutorials::TwoIntsRequest); // see Common.h, macro used for a cleaner header

namespace roscpp_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwoIntsRequest();
        /** copy constructor */
        TwoIntsRequest(const TwoIntsRequest & inobj);
        /** destructor */
        ~TwoIntsRequest();

        /** allocator, convenience function for bind */
        static TwoIntsRequest * New();
        ...
        long long int  a; /**<  */
        long long int  b; /**< no comment provided */
        ...
        static const unsigned int ID = 1840529928U;
        ...
        static const unsigned int DATA_VERSION = 3159045203U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c4e6e46119066922d8573b31908fe3b6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc4e6e46119066922ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd8573b31908fe3b6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsRequest * copy() { return new TwoIntsRequest(*this); };

        /** assignment operator(s) */
        TwoIntsRequest & operator=(const TwoIntsRequest & inobj);
        /** equality operator */
        bool operator==(const TwoIntsRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsRequest & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp_tutorials::TwoIntsRequest>
    {
    public:
        static bool flat() {return roscpp_tutorials::TwoIntsRequest::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp_tutorials::TwoIntsRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp_tutorials::TwoIntsRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp_tutorials::TwoIntsRequest & value);

#endif  //  _ROSCPP_TUTORIALS_TWOINTSREQUEST_H_
