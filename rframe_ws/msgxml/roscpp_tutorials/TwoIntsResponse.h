...
#ifndef _CODEGEN_ROSCPP_TUTORIALS_TWOINTSRESPONSE_H_
#define _CODEGEN_ROSCPP_TUTORIALS_TWOINTSRESPONSE_H_
...
PREDECLARE_BSON(roscpp_tutorials::TwoIntsResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp_tutorials::TwoIntsResponse); // see Common.h, macro used for a cleaner header

namespace roscpp_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwoIntsResponse();
        /** copy constructor */
        TwoIntsResponse(const TwoIntsResponse & inobj);
        /** destructor */
        ~TwoIntsResponse();

        /** allocator, convenience function for bind */
        static TwoIntsResponse * New();
        ...
        static const unsigned int ID = 1840529929U;
        ...
        static const unsigned int DATA_VERSION = 1653968199U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a6b9628b8da634fe89430a9139b99095"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa6b9628b8da634feULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x89430a9139b99095ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsResponse * copy() { return new TwoIntsResponse(*this); };

        /** assignment operator(s) */
        TwoIntsResponse & operator=(const TwoIntsResponse & inobj);
        /** equality operator */
        bool operator==(const TwoIntsResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsResponse & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp_tutorials::TwoIntsResponse>
    {
    public:
        static bool flat() {return roscpp_tutorials::TwoIntsResponse::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp_tutorials::TwoIntsResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp_tutorials::TwoIntsResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp_tutorials::TwoIntsResponse & value);

#endif  //  _ROSCPP_TUTORIALS_TWOINTSRESPONSE_H_
