...
#ifndef _CODEGEN_CONTROL_MSGS_QUERYTRAJECTORYSTATE_H_
#define _CODEGEN_CONTROL_MSGS_QUERYTRAJECTORYSTATE_H_
...
PREDECLARE_BSON(control_msgs::QueryTrajectoryState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::QueryTrajectoryState); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, QueryTrajectoryState & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        QueryTrajectoryState(const QueryTrajectoryState & inobj);
        /** destructor */
        ~QueryTrajectoryState();

        /** allocator, convenience function for bind */
        static QueryTrajectoryState * New();
        ...
        static const unsigned int ID = 1246705473U;
        ...
        static const unsigned int DATA_VERSION = 1650160598U;
        ...
        //        static const char * dataTypeName() { return "QueryTrajectoryState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "73095d526cdba496ca237a49210e857f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x73095d526cdba496ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xca237a49210e857fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        QueryTrajectoryState * copy() { return new QueryTrajectoryState(*this); };

        /** assignment operator(s) */
        QueryTrajectoryState & operator=(const QueryTrajectoryState & inobj);
        /** equality operator */
        bool operator==(const QueryTrajectoryState & inobj) const;
        /** inequality operator */
        bool operator!=(const QueryTrajectoryState & inobj) const;
        /** less than operator */
        bool operator<(const QueryTrajectoryState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, QueryTrajectoryState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::QueryTrajectoryState>
    {
    public:
        static bool flat() {return control_msgs::QueryTrajectoryState::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::QueryTrajectoryState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::QueryTrajectoryState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::QueryTrajectoryState & value);

#endif  //  _CONTROL_MSGS_QUERYTRAJECTORYSTATE_H_
