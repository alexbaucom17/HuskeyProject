...
#ifndef _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONRESULT_H_
#define _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONRESULT_H_
...
PREDECLARE_BSON(control_msgs::FollowJointTrajectoryActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::FollowJointTrajectoryActionResult); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FollowJointTrajectoryActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        FollowJointTrajectoryActionResult(const FollowJointTrajectoryActionResult & inobj);
        /** destructor */
        ~FollowJointTrajectoryActionResult();

        /** allocator, convenience function for bind */
        static FollowJointTrajectoryActionResult * New();
        ...
        static const unsigned int ID = 1246705432U;
        ...
        static const unsigned int DATA_VERSION = 2908534690U;
        ...
        //        static const char * dataTypeName() { return "FollowJointTrajectoryActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "594c66deca78fd2b040140faba67efbc"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x594c66deca78fd2bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x040140faba67efbcULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FollowJointTrajectoryActionResult * copy() { return new FollowJointTrajectoryActionResult(*this); };

        /** assignment operator(s) */
        FollowJointTrajectoryActionResult & operator=(const FollowJointTrajectoryActionResult & inobj);
        /** equality operator */
        bool operator==(const FollowJointTrajectoryActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const FollowJointTrajectoryActionResult & inobj) const;
        /** less than operator */
        bool operator<(const FollowJointTrajectoryActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FollowJointTrajectoryActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::FollowJointTrajectoryActionResult>
    {
    public:
        static bool flat() {return control_msgs::FollowJointTrajectoryActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::FollowJointTrajectoryActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::FollowJointTrajectoryActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::FollowJointTrajectoryActionResult & value);

#endif  //  _CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONRESULT_H_
