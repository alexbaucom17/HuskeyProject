...
#ifndef _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONGOAL_H_
#define _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONGOAL_H_
...
PREDECLARE_BSON(control_msgs::SingleJointPositionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::SingleJointPositionGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SingleJointPositionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SingleJointPositionGoal(const SingleJointPositionGoal & inobj);
        /** destructor */
        ~SingleJointPositionGoal();

        /** allocator, convenience function for bind */
        static SingleJointPositionGoal * New();
        ...
        double  position; /**<  */
        std_msgs::RosDuration  min_duration; /**<  */
        double  max_velocity; /**<  */
        ...
        static const unsigned int ID = 1246705466U;
        ...
        static const unsigned int DATA_VERSION = 1232363336U;
        ...
        //        static const char * dataTypeName() { return "SingleJointPositionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0de4544ec5df6a0635456490cfa0856d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0de4544ec5df6a06ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x35456490cfa0856dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SingleJointPositionGoal * copy() { return new SingleJointPositionGoal(*this); };

        /** assignment operator(s) */
        SingleJointPositionGoal & operator=(const SingleJointPositionGoal & inobj);
        /** equality operator */
        bool operator==(const SingleJointPositionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const SingleJointPositionGoal & inobj) const;
        /** less than operator */
        bool operator<(const SingleJointPositionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SingleJointPositionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::SingleJointPositionGoal>
    {
    public:
        static bool flat() {return control_msgs::SingleJointPositionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::SingleJointPositionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::SingleJointPositionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::SingleJointPositionGoal & value);

#endif  //  _CONTROL_MSGS_SINGLEJOINTPOSITIONGOAL_H_
