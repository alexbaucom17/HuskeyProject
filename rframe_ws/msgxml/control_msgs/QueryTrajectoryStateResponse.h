...
#ifndef _CODEGEN_CONTROL_MSGS_QUERYTRAJECTORYSTATERESPONSE_H_
#define _CODEGEN_CONTROL_MSGS_QUERYTRAJECTORYSTATERESPONSE_H_
...
PREDECLARE_BSON(control_msgs::QueryTrajectoryStateResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::QueryTrajectoryStateResponse); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, QueryTrajectoryStateResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        QueryTrajectoryStateResponse(const QueryTrajectoryStateResponse & inobj);
        /** destructor */
        ~QueryTrajectoryStateResponse();

        /** allocator, convenience function for bind */
        static QueryTrajectoryStateResponse * New();
        ...
        static const unsigned int ID = 1246705472U;
        ...
        static const unsigned int DATA_VERSION = 249339021U;
        ...
        //        static const char * dataTypeName() { return "QueryTrajectoryStateResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b5ae07cd758fd4cc6e576db494d8471b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb5ae07cd758fd4ccULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6e576db494d8471bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        QueryTrajectoryStateResponse * copy() { return new QueryTrajectoryStateResponse(*this); };

        /** assignment operator(s) */
        QueryTrajectoryStateResponse & operator=(const QueryTrajectoryStateResponse & inobj);
        /** equality operator */
        bool operator==(const QueryTrajectoryStateResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const QueryTrajectoryStateResponse & inobj) const;
        /** less than operator */
        bool operator<(const QueryTrajectoryStateResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, QueryTrajectoryStateResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::QueryTrajectoryStateResponse>
    {
    public:
        static bool flat() {return control_msgs::QueryTrajectoryStateResponse::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::QueryTrajectoryStateResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::QueryTrajectoryStateResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::QueryTrajectoryStateResponse & value);

#endif  //  _CONTROL_MSGS_QUERYTRAJECTORYSTATERESPONSE_H_
