...
#ifndef _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::SingleJointPositionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::SingleJointPositionFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SingleJointPositionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SingleJointPositionFeedback(const SingleJointPositionFeedback & inobj);
        /** destructor */
        ~SingleJointPositionFeedback();

        /** allocator, convenience function for bind */
        static SingleJointPositionFeedback * New();
        ...
        static const unsigned int ID = 1246705465U;
        ...
        static const unsigned int DATA_VERSION = 3895918972U;
        ...
        //        static const char * dataTypeName() { return "SingleJointPositionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1d89d23191d8969a2a826fedf36fe6f7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1d89d23191d8969aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2a826fedf36fe6f7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SingleJointPositionFeedback * copy() { return new SingleJointPositionFeedback(*this); };

        /** assignment operator(s) */
        SingleJointPositionFeedback & operator=(const SingleJointPositionFeedback & inobj);
        /** equality operator */
        bool operator==(const SingleJointPositionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const SingleJointPositionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const SingleJointPositionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SingleJointPositionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::SingleJointPositionFeedback>
    {
    public:
        static bool flat() {return control_msgs::SingleJointPositionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::SingleJointPositionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::SingleJointPositionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::SingleJointPositionFeedback & value);

#endif  //  _CONTROL_MSGS_SINGLEJOINTPOSITIONFEEDBACK_H_
