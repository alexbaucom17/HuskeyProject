...
#ifndef _CODEGEN_CONTROL_MSGS_POINTHEADACTIONFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_POINTHEADACTIONFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::PointHeadActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::PointHeadActionFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointHeadActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        PointHeadActionFeedback(const PointHeadActionFeedback & inobj);
        /** destructor */
        ~PointHeadActionFeedback();

        /** allocator, convenience function for bind */
        static PointHeadActionFeedback * New();
        ...
        static const unsigned int ID = 1246705455U;
        ...
        static const unsigned int DATA_VERSION = 2670475034U;
        ...
        //        static const char * dataTypeName() { return "PointHeadActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e14919b23db46314cae8f32beb4e51af"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe14919b23db46314ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcae8f32beb4e51afULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointHeadActionFeedback * copy() { return new PointHeadActionFeedback(*this); };

        /** assignment operator(s) */
        PointHeadActionFeedback & operator=(const PointHeadActionFeedback & inobj);
        /** equality operator */
        bool operator==(const PointHeadActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const PointHeadActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const PointHeadActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointHeadActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::PointHeadActionFeedback>
    {
    public:
        static bool flat() {return control_msgs::PointHeadActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::PointHeadActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::PointHeadActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::PointHeadActionFeedback & value);

#endif  //  _CONTROL_MSGS_POINTHEADACTIONFEEDBACK_H_
