...
#ifndef _CODEGEN_CONTROL_MSGS_QUERYCALIBRATIONSTATE_H_
#define _CODEGEN_CONTROL_MSGS_QUERYCALIBRATIONSTATE_H_
...
PREDECLARE_BSON(control_msgs::QueryCalibrationState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::QueryCalibrationState); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, QueryCalibrationState & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        QueryCalibrationState(const QueryCalibrationState & inobj);
        /** destructor */
        ~QueryCalibrationState();

        /** allocator, convenience function for bind */
        static QueryCalibrationState * New();
        ...
        static const unsigned int ID = 1246705470U;
        ...
        static const unsigned int DATA_VERSION = 1315236404U;
        ...
        //        static const char * dataTypeName() { return "QueryCalibrationState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c416e7c100e45ff43ae3f7e6c9683016"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc416e7c100e45ff4ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3ae3f7e6c9683016ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        QueryCalibrationState * copy() { return new QueryCalibrationState(*this); };

        /** assignment operator(s) */
        QueryCalibrationState & operator=(const QueryCalibrationState & inobj);
        /** equality operator */
        bool operator==(const QueryCalibrationState & inobj) const;
        /** inequality operator */
        bool operator!=(const QueryCalibrationState & inobj) const;
        /** less than operator */
        bool operator<(const QueryCalibrationState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, QueryCalibrationState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::QueryCalibrationState>
    {
    public:
        static bool flat() {return control_msgs::QueryCalibrationState::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::QueryCalibrationState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::QueryCalibrationState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::QueryCalibrationState & value);

#endif  //  _CONTROL_MSGS_QUERYCALIBRATIONSTATE_H_
