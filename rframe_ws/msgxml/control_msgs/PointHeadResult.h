...
#ifndef _CODEGEN_CONTROL_MSGS_POINTHEADRESULT_H_
#define _CODEGEN_CONTROL_MSGS_POINTHEADRESULT_H_
...
PREDECLARE_BSON(control_msgs::PointHeadResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::PointHeadResult); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointHeadResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointHeadResult();
        /** copy constructor */
        PointHeadResult(const PointHeadResult & inobj);
        /** destructor */
        ~PointHeadResult();

        /** allocator, convenience function for bind */
        static PointHeadResult * New();
        ...
        static const unsigned int ID = 1246705460U;
        ...
        static const unsigned int DATA_VERSION = 322889745U;
        ...
        //        static const char * dataTypeName() { return "PointHeadResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "486888dfddfa6a8b70ddf906bbea5f93"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x486888dfddfa6a8bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x70ddf906bbea5f93ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointHeadResult * copy() { return new PointHeadResult(*this); };

        /** assignment operator(s) */
        PointHeadResult & operator=(const PointHeadResult & inobj);
        /** equality operator */
        bool operator==(const PointHeadResult & inobj) const;
        /** inequality operator */
        bool operator!=(const PointHeadResult & inobj) const;
        /** less than operator */
        bool operator<(const PointHeadResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointHeadResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::PointHeadResult>
    {
    public:
        static bool flat() {return control_msgs::PointHeadResult::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::PointHeadResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::PointHeadResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::PointHeadResult & value);

#endif  //  _CONTROL_MSGS_POINTHEADRESULT_H_
