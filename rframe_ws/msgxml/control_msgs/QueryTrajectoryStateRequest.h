...
#ifndef _CODEGEN_CONTROL_MSGS_QUERYTRAJECTORYSTATEREQUEST_H_
#define _CODEGEN_CONTROL_MSGS_QUERYTRAJECTORYSTATEREQUEST_H_
...
PREDECLARE_BSON(control_msgs::QueryTrajectoryStateRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::QueryTrajectoryStateRequest); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, QueryTrajectoryStateRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        QueryTrajectoryStateRequest(const QueryTrajectoryStateRequest & inobj);
        /** destructor */
        ~QueryTrajectoryStateRequest();

        /** allocator, convenience function for bind */
        static QueryTrajectoryStateRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::RosTime  time; /**< no comment provided */
        ...
        static const unsigned int ID = 1246705471U;
        ...
        static const unsigned int DATA_VERSION = 1024444894U;
        ...
        //        static const char * dataTypeName() { return "QueryTrajectoryStateRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "29784759770b194c8112b5a77a250d18"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x29784759770b194cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8112b5a77a250d18ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        QueryTrajectoryStateRequest * copy() { return new QueryTrajectoryStateRequest(*this); };

        /** assignment operator(s) */
        QueryTrajectoryStateRequest & operator=(const QueryTrajectoryStateRequest & inobj);
        /** equality operator */
        bool operator==(const QueryTrajectoryStateRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const QueryTrajectoryStateRequest & inobj) const;
        /** less than operator */
        bool operator<(const QueryTrajectoryStateRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, QueryTrajectoryStateRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::QueryTrajectoryStateRequest>
    {
    public:
        static bool flat() {return control_msgs::QueryTrajectoryStateRequest::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::QueryTrajectoryStateRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::QueryTrajectoryStateRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::QueryTrajectoryStateRequest & value);

#endif  //  _CONTROL_MSGS_QUERYTRAJECTORYSTATEREQUEST_H_
