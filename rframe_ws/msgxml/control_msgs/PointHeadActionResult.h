...
#ifndef _CODEGEN_CONTROL_MSGS_POINTHEADACTIONRESULT_H_
#define _CODEGEN_CONTROL_MSGS_POINTHEADACTIONRESULT_H_
...
PREDECLARE_BSON(control_msgs::PointHeadActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::PointHeadActionResult); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointHeadActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        PointHeadActionResult(const PointHeadActionResult & inobj);
        /** destructor */
        ~PointHeadActionResult();

        /** allocator, convenience function for bind */
        static PointHeadActionResult * New();
        ...
        static const unsigned int ID = 1246705457U;
        ...
        static const unsigned int DATA_VERSION = 891898812U;
        ...
        //        static const char * dataTypeName() { return "PointHeadActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "eb452c3de909a56d3591b74d04844a98"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xeb452c3de909a56dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3591b74d04844a98ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointHeadActionResult * copy() { return new PointHeadActionResult(*this); };

        /** assignment operator(s) */
        PointHeadActionResult & operator=(const PointHeadActionResult & inobj);
        /** equality operator */
        bool operator==(const PointHeadActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const PointHeadActionResult & inobj) const;
        /** less than operator */
        bool operator<(const PointHeadActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointHeadActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::PointHeadActionResult>
    {
    public:
        static bool flat() {return control_msgs::PointHeadActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::PointHeadActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::PointHeadActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::PointHeadActionResult & value);

#endif  //  _CONTROL_MSGS_POINTHEADACTIONRESULT_H_
