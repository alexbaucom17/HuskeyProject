...
#ifndef _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONACTION_H_
#define _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONACTION_H_
...
PREDECLARE_BSON(control_msgs::SingleJointPositionAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::SingleJointPositionAction); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SingleJointPositionAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SingleJointPositionAction(const SingleJointPositionAction & inobj);
        /** destructor */
        ~SingleJointPositionAction();

        /** allocator, convenience function for bind */
        static SingleJointPositionAction * New();
        ...
        static const unsigned int ID = 1246705461U;
        ...
        static const unsigned int DATA_VERSION = 3197727901U;
        ...
        //        static const char * dataTypeName() { return "SingleJointPositionAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "31dbbac4bfbcfe242c0ad98ce3000b66"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x31dbbac4bfbcfe24ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2c0ad98ce3000b66ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SingleJointPositionAction * copy() { return new SingleJointPositionAction(*this); };

        /** assignment operator(s) */
        SingleJointPositionAction & operator=(const SingleJointPositionAction & inobj);
        /** equality operator */
        bool operator==(const SingleJointPositionAction & inobj) const;
        /** inequality operator */
        bool operator!=(const SingleJointPositionAction & inobj) const;
        /** less than operator */
        bool operator<(const SingleJointPositionAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SingleJointPositionAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::SingleJointPositionAction>
    {
    public:
        static bool flat() {return control_msgs::SingleJointPositionAction::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::SingleJointPositionAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::SingleJointPositionAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::SingleJointPositionAction & value);

#endif  //  _CONTROL_MSGS_SINGLEJOINTPOSITIONACTION_H_
