...
#ifndef _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYGOAL_H_
#define _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYGOAL_H_
...
PREDECLARE_BSON(control_msgs::FollowJointTrajectoryGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::FollowJointTrajectoryGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FollowJointTrajectoryGoal & inobj);   

    /** 
        \ingroup CodeGen
        ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======  The joint trajectory to follow
    */
    class FollowJointTrajectoryGoal
    {
    public: 
        ...
        /** copy constructor */
        FollowJointTrajectoryGoal(const FollowJointTrajectoryGoal & inobj);
        /** destructor */
        ~FollowJointTrajectoryGoal();

        /** allocator, convenience function for bind */
        static FollowJointTrajectoryGoal * New();
        ...
        static const unsigned int ID = 1246705434U;
        ...
        static const unsigned int DATA_VERSION = 2300734680U;
        ...
        //        static const char * dataTypeName() { return "FollowJointTrajectoryGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ed80aae50bd2cc91b6bb2f34b990eb7a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xed80aae50bd2cc91ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb6bb2f34b990eb7aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FollowJointTrajectoryGoal * copy() { return new FollowJointTrajectoryGoal(*this); };

        /** assignment operator(s) */
        FollowJointTrajectoryGoal & operator=(const FollowJointTrajectoryGoal & inobj);
        /** equality operator */
        bool operator==(const FollowJointTrajectoryGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const FollowJointTrajectoryGoal & inobj) const;
        /** less than operator */
        bool operator<(const FollowJointTrajectoryGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FollowJointTrajectoryGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::FollowJointTrajectoryGoal>
    {
    public:
        static bool flat() {return control_msgs::FollowJointTrajectoryGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::FollowJointTrajectoryGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::FollowJointTrajectoryGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::FollowJointTrajectoryGoal & value);

#endif  //  _CONTROL_MSGS_FOLLOWJOINTTRAJECTORYGOAL_H_
