...
#ifndef _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYGOAL_H_
#define _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYGOAL_H_
...
PREDECLARE_BSON(control_msgs::JointTrajectoryGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::JointTrajectoryGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointTrajectoryGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        JointTrajectoryGoal();
        /** copy constructor */
        JointTrajectoryGoal(const JointTrajectoryGoal & inobj);
        /** destructor */
        ~JointTrajectoryGoal();

        /** allocator, convenience function for bind */
        static JointTrajectoryGoal * New();
        ...
        static const unsigned int ID = 1246705452U;
        ...
        static const unsigned int DATA_VERSION = 1411761210U;
        ...
        //        static const char * dataTypeName() { return "JointTrajectoryGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "043f199ab62344f2c6431402017639ec"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x043f199ab62344f2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc6431402017639ecULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointTrajectoryGoal * copy() { return new JointTrajectoryGoal(*this); };

        /** assignment operator(s) */
        JointTrajectoryGoal & operator=(const JointTrajectoryGoal & inobj);
        /** equality operator */
        bool operator==(const JointTrajectoryGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const JointTrajectoryGoal & inobj) const;
        /** less than operator */
        bool operator<(const JointTrajectoryGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointTrajectoryGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::JointTrajectoryGoal>
    {
    public:
        static bool flat() {return control_msgs::JointTrajectoryGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::JointTrajectoryGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::JointTrajectoryGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::JointTrajectoryGoal & value);

#endif  //  _CONTROL_MSGS_JOINTTRAJECTORYGOAL_H_
