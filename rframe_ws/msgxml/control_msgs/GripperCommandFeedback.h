...
#ifndef _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::GripperCommandFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::GripperCommandFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GripperCommandFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GripperCommandFeedback(const GripperCommandFeedback & inobj);
        /** destructor */
        ~GripperCommandFeedback();

        /** allocator, convenience function for bind */
        static GripperCommandFeedback * New();
        ...
        static const unsigned int ID = 1246705441U;
        ...
        static const unsigned int DATA_VERSION = 3718016241U;
        ...
        //        static const char * dataTypeName() { return "GripperCommandFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "abe4a9648739e74c88838cfb49d460bb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xabe4a9648739e74cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x88838cfb49d460bbULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GripperCommandFeedback * copy() { return new GripperCommandFeedback(*this); };

        /** assignment operator(s) */
        GripperCommandFeedback & operator=(const GripperCommandFeedback & inobj);
        /** equality operator */
        bool operator==(const GripperCommandFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const GripperCommandFeedback & inobj) const;
        /** less than operator */
        bool operator<(const GripperCommandFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GripperCommandFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::GripperCommandFeedback>
    {
    public:
        static bool flat() {return control_msgs::GripperCommandFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::GripperCommandFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::GripperCommandFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::GripperCommandFeedback & value);

#endif  //  _CONTROL_MSGS_GRIPPERCOMMANDFEEDBACK_H_
