...
#ifndef _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYACTIONRESULT_H_
#define _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYACTIONRESULT_H_
...
PREDECLARE_BSON(control_msgs::JointTrajectoryActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::JointTrajectoryActionResult); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointTrajectoryActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        JointTrajectoryActionResult(const JointTrajectoryActionResult & inobj);
        /** destructor */
        ~JointTrajectoryActionResult();

        /** allocator, convenience function for bind */
        static JointTrajectoryActionResult * New();
        ...
        static const unsigned int ID = 1246705449U;
        ...
        static const unsigned int DATA_VERSION = 3701138192U;
        ...
        //        static const char * dataTypeName() { return "JointTrajectoryActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ade1a1fdfd819deb432bcabe579c7889"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xade1a1fdfd819debULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x432bcabe579c7889ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointTrajectoryActionResult * copy() { return new JointTrajectoryActionResult(*this); };

        /** assignment operator(s) */
        JointTrajectoryActionResult & operator=(const JointTrajectoryActionResult & inobj);
        /** equality operator */
        bool operator==(const JointTrajectoryActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const JointTrajectoryActionResult & inobj) const;
        /** less than operator */
        bool operator<(const JointTrajectoryActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointTrajectoryActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::JointTrajectoryActionResult>
    {
    public:
        static bool flat() {return control_msgs::JointTrajectoryActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::JointTrajectoryActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::JointTrajectoryActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::JointTrajectoryActionResult & value);

#endif  //  _CONTROL_MSGS_JOINTTRAJECTORYACTIONRESULT_H_
