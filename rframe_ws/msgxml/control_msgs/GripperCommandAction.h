...
#ifndef _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDACTION_H_
#define _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDACTION_H_
...
PREDECLARE_BSON(control_msgs::GripperCommandAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::GripperCommandAction); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GripperCommandAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GripperCommandAction(const GripperCommandAction & inobj);
        /** destructor */
        ~GripperCommandAction();

        /** allocator, convenience function for bind */
        static GripperCommandAction * New();
        ...
        static const unsigned int ID = 1246705437U;
        ...
        static const unsigned int DATA_VERSION = 277690778U;
        ...
        //        static const char * dataTypeName() { return "GripperCommandAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d629b04e0cf1bfe545ca0bdefd2be098"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd629b04e0cf1bfe5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x45ca0bdefd2be098ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GripperCommandAction * copy() { return new GripperCommandAction(*this); };

        /** assignment operator(s) */
        GripperCommandAction & operator=(const GripperCommandAction & inobj);
        /** equality operator */
        bool operator==(const GripperCommandAction & inobj) const;
        /** inequality operator */
        bool operator!=(const GripperCommandAction & inobj) const;
        /** less than operator */
        bool operator<(const GripperCommandAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GripperCommandAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::GripperCommandAction>
    {
    public:
        static bool flat() {return control_msgs::GripperCommandAction::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::GripperCommandAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::GripperCommandAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::GripperCommandAction & value);

#endif  //  _CONTROL_MSGS_GRIPPERCOMMANDACTION_H_
