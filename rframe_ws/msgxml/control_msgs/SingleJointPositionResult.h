...
#ifndef _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONRESULT_H_
#define _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONRESULT_H_
...
PREDECLARE_BSON(control_msgs::SingleJointPositionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::SingleJointPositionResult); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SingleJointPositionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SingleJointPositionResult(const SingleJointPositionResult & inobj);
        /** destructor */
        ~SingleJointPositionResult();

        /** allocator, convenience function for bind */
        static SingleJointPositionResult * New();
        ...
        static const unsigned int ID = 1246705467U;
        ...
        static const unsigned int DATA_VERSION = 2495651604U;
        ...
        //        static const char * dataTypeName() { return "SingleJointPositionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9cacde18e8b064984af325192fcccaca"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9cacde18e8b06498ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4af325192fcccacaULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SingleJointPositionResult * copy() { return new SingleJointPositionResult(*this); };

        /** assignment operator(s) */
        SingleJointPositionResult & operator=(const SingleJointPositionResult & inobj);
        /** equality operator */
        bool operator==(const SingleJointPositionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const SingleJointPositionResult & inobj) const;
        /** less than operator */
        bool operator<(const SingleJointPositionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SingleJointPositionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::SingleJointPositionResult>
    {
    public:
        static bool flat() {return control_msgs::SingleJointPositionResult::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::SingleJointPositionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::SingleJointPositionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::SingleJointPositionResult & value);

#endif  //  _CONTROL_MSGS_SINGLEJOINTPOSITIONRESULT_H_
