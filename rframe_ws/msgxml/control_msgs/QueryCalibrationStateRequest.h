...
#ifndef _CODEGEN_CONTROL_MSGS_QUERYCALIBRATIONSTATEREQUEST_H_
#define _CODEGEN_CONTROL_MSGS_QUERYCALIBRATIONSTATEREQUEST_H_
...
PREDECLARE_BSON(control_msgs::QueryCalibrationStateRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::QueryCalibrationStateRequest); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, QueryCalibrationStateRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        QueryCalibrationStateRequest(const QueryCalibrationStateRequest & inobj);
        /** destructor */
        ~QueryCalibrationStateRequest();

        /** allocator, convenience function for bind */
        static QueryCalibrationStateRequest * New();
        ...
        static const unsigned int ID = 1246705468U;
        ...
        static const unsigned int DATA_VERSION = 2237727511U;
        ...
        //        static const char * dataTypeName() { return "QueryCalibrationStateRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ec2fe32cc9d966c4b4b435002372e2cf"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xec2fe32cc9d966c4ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb4b435002372e2cfULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        QueryCalibrationStateRequest * copy() { return new QueryCalibrationStateRequest(*this); };

        /** assignment operator(s) */
        QueryCalibrationStateRequest & operator=(const QueryCalibrationStateRequest & inobj);
        /** equality operator */
        bool operator==(const QueryCalibrationStateRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const QueryCalibrationStateRequest & inobj) const;
        /** less than operator */
        bool operator<(const QueryCalibrationStateRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, QueryCalibrationStateRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::QueryCalibrationStateRequest>
    {
    public:
        static bool flat() {return control_msgs::QueryCalibrationStateRequest::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::QueryCalibrationStateRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::QueryCalibrationStateRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::QueryCalibrationStateRequest & value);

#endif  //  _CONTROL_MSGS_QUERYCALIBRATIONSTATEREQUEST_H_
