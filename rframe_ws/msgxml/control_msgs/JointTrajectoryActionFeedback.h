...
#ifndef _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYACTIONFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYACTIONFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::JointTrajectoryActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::JointTrajectoryActionFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointTrajectoryActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        JointTrajectoryActionFeedback(const JointTrajectoryActionFeedback & inobj);
        /** destructor */
        ~JointTrajectoryActionFeedback();

        /** allocator, convenience function for bind */
        static JointTrajectoryActionFeedback * New();
        ...
        static const unsigned int ID = 1246705447U;
        ...
        static const unsigned int DATA_VERSION = 3716929671U;
        ...
        //        static const char * dataTypeName() { return "JointTrajectoryActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d3a823921afff440b22638ef4248bdcc"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd3a823921afff440ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb22638ef4248bdccULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointTrajectoryActionFeedback * copy() { return new JointTrajectoryActionFeedback(*this); };

        /** assignment operator(s) */
        JointTrajectoryActionFeedback & operator=(const JointTrajectoryActionFeedback & inobj);
        /** equality operator */
        bool operator==(const JointTrajectoryActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const JointTrajectoryActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const JointTrajectoryActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointTrajectoryActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::JointTrajectoryActionFeedback>
    {
    public:
        static bool flat() {return control_msgs::JointTrajectoryActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::JointTrajectoryActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::JointTrajectoryActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::JointTrajectoryActionFeedback & value);

#endif  //  _CONTROL_MSGS_JOINTTRAJECTORYACTIONFEEDBACK_H_
