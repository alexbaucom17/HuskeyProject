...
#ifndef _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDGOAL_H_
#define _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDGOAL_H_
...
PREDECLARE_BSON(control_msgs::GripperCommandGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::GripperCommandGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GripperCommandGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        GripperCommandGoal();
        /** copy constructor */
        GripperCommandGoal(const GripperCommandGoal & inobj);
        /** destructor */
        ~GripperCommandGoal();

        /** allocator, convenience function for bind */
        static GripperCommandGoal * New();
        ...
        static const unsigned int ID = 1246705442U;
        ...
        static const unsigned int DATA_VERSION = 134596556U;
        ...
        //        static const char * dataTypeName() { return "GripperCommandGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f9792ef418a61b0c16e5868086869712"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf9792ef418a61b0cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x16e5868086869712ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GripperCommandGoal * copy() { return new GripperCommandGoal(*this); };

        /** assignment operator(s) */
        GripperCommandGoal & operator=(const GripperCommandGoal & inobj);
        /** equality operator */
        bool operator==(const GripperCommandGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const GripperCommandGoal & inobj) const;
        /** less than operator */
        bool operator<(const GripperCommandGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GripperCommandGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::GripperCommandGoal>
    {
    public:
        static bool flat() {return control_msgs::GripperCommandGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::GripperCommandGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::GripperCommandGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::GripperCommandGoal & value);

#endif  //  _CONTROL_MSGS_GRIPPERCOMMANDGOAL_H_
