...
#ifndef _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYACTIONGOAL_H_
#define _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYACTIONGOAL_H_
...
PREDECLARE_BSON(control_msgs::JointTrajectoryActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::JointTrajectoryActionGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointTrajectoryActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        JointTrajectoryActionGoal(const JointTrajectoryActionGoal & inobj);
        /** destructor */
        ~JointTrajectoryActionGoal();

        /** allocator, convenience function for bind */
        static JointTrajectoryActionGoal * New();
        ...
        static const unsigned int ID = 1246705448U;
        ...
        static const unsigned int DATA_VERSION = 1159458477U;
        ...
        //        static const char * dataTypeName() { return "JointTrajectoryActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "04272eaa2dfbddab9a5e59e16b33dbfe"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x04272eaa2dfbddabULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9a5e59e16b33dbfeULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointTrajectoryActionGoal * copy() { return new JointTrajectoryActionGoal(*this); };

        /** assignment operator(s) */
        JointTrajectoryActionGoal & operator=(const JointTrajectoryActionGoal & inobj);
        /** equality operator */
        bool operator==(const JointTrajectoryActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const JointTrajectoryActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const JointTrajectoryActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointTrajectoryActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::JointTrajectoryActionGoal>
    {
    public:
        static bool flat() {return control_msgs::JointTrajectoryActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::JointTrajectoryActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::JointTrajectoryActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::JointTrajectoryActionGoal & value);

#endif  //  _CONTROL_MSGS_JOINTTRAJECTORYACTIONGOAL_H_
