...
#ifndef _CODEGEN_CONTROL_MSGS_POINTHEADACTION_H_
#define _CODEGEN_CONTROL_MSGS_POINTHEADACTION_H_
...
PREDECLARE_BSON(control_msgs::PointHeadAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::PointHeadAction); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointHeadAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointHeadAction();
        /** copy constructor */
        PointHeadAction(const PointHeadAction & inobj);
        /** destructor */
        ~PointHeadAction();

        /** allocator, convenience function for bind */
        static PointHeadAction * New();
        ...
        static const unsigned int ID = 1246705454U;
        ...
        static const unsigned int DATA_VERSION = 3129989727U;
        ...
        //        static const char * dataTypeName() { return "PointHeadAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5a688e77c0f6c0b34c4dcb0272c38c49"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5a688e77c0f6c0b3ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4c4dcb0272c38c49ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointHeadAction * copy() { return new PointHeadAction(*this); };

        /** assignment operator(s) */
        PointHeadAction & operator=(const PointHeadAction & inobj);
        /** equality operator */
        bool operator==(const PointHeadAction & inobj) const;
        /** inequality operator */
        bool operator!=(const PointHeadAction & inobj) const;
        /** less than operator */
        bool operator<(const PointHeadAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointHeadAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::PointHeadAction>
    {
    public:
        static bool flat() {return control_msgs::PointHeadAction::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::PointHeadAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::PointHeadAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::PointHeadAction & value);

#endif  //  _CONTROL_MSGS_POINTHEADACTION_H_
