...
#ifndef _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::FollowJointTrajectoryFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::FollowJointTrajectoryFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FollowJointTrajectoryFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        FollowJointTrajectoryFeedback(const FollowJointTrajectoryFeedback & inobj);
        /** destructor */
        ~FollowJointTrajectoryFeedback();

        /** allocator, convenience function for bind */
        static FollowJointTrajectoryFeedback * New();
        ...
        static const unsigned int ID = 1246705433U;
        ...
        static const unsigned int DATA_VERSION = 452464220U;
        ...
        //        static const char * dataTypeName() { return "FollowJointTrajectoryFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e882fefe9b9fa8126dd86b3ce4269297"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe882fefe9b9fa812ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6dd86b3ce4269297ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FollowJointTrajectoryFeedback * copy() { return new FollowJointTrajectoryFeedback(*this); };

        /** assignment operator(s) */
        FollowJointTrajectoryFeedback & operator=(const FollowJointTrajectoryFeedback & inobj);
        /** equality operator */
        bool operator==(const FollowJointTrajectoryFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const FollowJointTrajectoryFeedback & inobj) const;
        /** less than operator */
        bool operator<(const FollowJointTrajectoryFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FollowJointTrajectoryFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::FollowJointTrajectoryFeedback>
    {
    public:
        static bool flat() {return control_msgs::FollowJointTrajectoryFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::FollowJointTrajectoryFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::FollowJointTrajectoryFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::FollowJointTrajectoryFeedback & value);

#endif  //  _CONTROL_MSGS_FOLLOWJOINTTRAJECTORYFEEDBACK_H_
