...
#ifndef _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::JointTrajectoryFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::JointTrajectoryFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointTrajectoryFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        JointTrajectoryFeedback(const JointTrajectoryFeedback & inobj);
        /** destructor */
        ~JointTrajectoryFeedback();

        /** allocator, convenience function for bind */
        static JointTrajectoryFeedback * New();
        ...
        static const unsigned int ID = 1246705451U;
        ...
        static const unsigned int DATA_VERSION = 3568891914U;
        ...
        //        static const char * dataTypeName() { return "JointTrajectoryFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2368c75e6b74749a670f83bd6610a5be"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2368c75e6b74749aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x670f83bd6610a5beULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointTrajectoryFeedback * copy() { return new JointTrajectoryFeedback(*this); };

        /** assignment operator(s) */
        JointTrajectoryFeedback & operator=(const JointTrajectoryFeedback & inobj);
        /** equality operator */
        bool operator==(const JointTrajectoryFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const JointTrajectoryFeedback & inobj) const;
        /** less than operator */
        bool operator<(const JointTrajectoryFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointTrajectoryFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::JointTrajectoryFeedback>
    {
    public:
        static bool flat() {return control_msgs::JointTrajectoryFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::JointTrajectoryFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::JointTrajectoryFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::JointTrajectoryFeedback & value);

#endif  //  _CONTROL_MSGS_JOINTTRAJECTORYFEEDBACK_H_
