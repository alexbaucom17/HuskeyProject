...
#ifndef _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDACTIONFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDACTIONFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::GripperCommandActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::GripperCommandActionFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GripperCommandActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GripperCommandActionFeedback(const GripperCommandActionFeedback & inobj);
        /** destructor */
        ~GripperCommandActionFeedback();

        /** allocator, convenience function for bind */
        static GripperCommandActionFeedback * New();
        ...
        static const unsigned int ID = 1246705438U;
        ...
        static const unsigned int DATA_VERSION = 2570437290U;
        ...
        //        static const char * dataTypeName() { return "GripperCommandActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "409029a4c8682da9edb2ae713d2c271a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x409029a4c8682da9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xedb2ae713d2c271aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GripperCommandActionFeedback * copy() { return new GripperCommandActionFeedback(*this); };

        /** assignment operator(s) */
        GripperCommandActionFeedback & operator=(const GripperCommandActionFeedback & inobj);
        /** equality operator */
        bool operator==(const GripperCommandActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const GripperCommandActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const GripperCommandActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GripperCommandActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::GripperCommandActionFeedback>
    {
    public:
        static bool flat() {return control_msgs::GripperCommandActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::GripperCommandActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::GripperCommandActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::GripperCommandActionFeedback & value);

#endif  //  _CONTROL_MSGS_GRIPPERCOMMANDACTIONFEEDBACK_H_
