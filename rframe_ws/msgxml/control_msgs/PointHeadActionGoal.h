...
#ifndef _CODEGEN_CONTROL_MSGS_POINTHEADACTIONGOAL_H_
#define _CODEGEN_CONTROL_MSGS_POINTHEADACTIONGOAL_H_
...
PREDECLARE_BSON(control_msgs::PointHeadActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::PointHeadActionGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointHeadActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointHeadActionGoal();
        /** copy constructor */
        PointHeadActionGoal(const PointHeadActionGoal & inobj);
        /** destructor */
        ~PointHeadActionGoal();

        /** allocator, convenience function for bind */
        static PointHeadActionGoal * New();
        ...
        static const unsigned int ID = 1246705456U;
        ...
        static const unsigned int DATA_VERSION = 2599741653U;
        ...
        //        static const char * dataTypeName() { return "PointHeadActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6d2fbbe3cf0aad3672638bab76d872a0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6d2fbbe3cf0aad36ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x72638bab76d872a0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointHeadActionGoal * copy() { return new PointHeadActionGoal(*this); };

        /** assignment operator(s) */
        PointHeadActionGoal & operator=(const PointHeadActionGoal & inobj);
        /** equality operator */
        bool operator==(const PointHeadActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const PointHeadActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const PointHeadActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointHeadActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::PointHeadActionGoal>
    {
    public:
        static bool flat() {return control_msgs::PointHeadActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::PointHeadActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::PointHeadActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::PointHeadActionGoal & value);

#endif  //  _CONTROL_MSGS_POINTHEADACTIONGOAL_H_
