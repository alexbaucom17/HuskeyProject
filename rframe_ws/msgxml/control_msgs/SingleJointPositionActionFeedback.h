...
#ifndef _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::SingleJointPositionActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::SingleJointPositionActionFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SingleJointPositionActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SingleJointPositionActionFeedback(const SingleJointPositionActionFeedback & inobj);
        /** destructor */
        ~SingleJointPositionActionFeedback();

        /** allocator, convenience function for bind */
        static SingleJointPositionActionFeedback * New();
        ...
        static const unsigned int ID = 1246705462U;
        ...
        static const unsigned int DATA_VERSION = 2563485382U;
        ...
        //        static const char * dataTypeName() { return "SingleJointPositionActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d6ee3c008e9e84d056d55020ab7face3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd6ee3c008e9e84d0ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x56d55020ab7face3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SingleJointPositionActionFeedback * copy() { return new SingleJointPositionActionFeedback(*this); };

        /** assignment operator(s) */
        SingleJointPositionActionFeedback & operator=(const SingleJointPositionActionFeedback & inobj);
        /** equality operator */
        bool operator==(const SingleJointPositionActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const SingleJointPositionActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const SingleJointPositionActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SingleJointPositionActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::SingleJointPositionActionFeedback>
    {
    public:
        static bool flat() {return control_msgs::SingleJointPositionActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::SingleJointPositionActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::SingleJointPositionActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::SingleJointPositionActionFeedback & value);

#endif  //  _CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONFEEDBACK_H_
