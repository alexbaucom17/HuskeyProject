...
#ifndef _CODEGEN_STD_SRVS_TRIGGERREQUEST_H_
#define _CODEGEN_STD_SRVS_TRIGGERREQUEST_H_
...
PREDECLARE_BSON(std_srvs::TriggerRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::TriggerRequest); // see Common.h, macro used for a cleaner header

namespace std_srvs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TriggerRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        TriggerRequest();
        /** copy constructor */
        TriggerRequest(const TriggerRequest & inobj);
        /** destructor */
        ~TriggerRequest();

        /** allocator, convenience function for bind */
        static TriggerRequest * New();
        ...
        static const unsigned int ID = 1986463663U;
        ...
        static const unsigned int DATA_VERSION = 1802984844U;
        ...
        //        static const char * dataTypeName() { return "TriggerRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "95dd0139a005f45af9300022617dbbb3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x95dd0139a005f45aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf9300022617dbbb3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TriggerRequest * copy() { return new TriggerRequest(*this); };

        /** assignment operator(s) */
        TriggerRequest & operator=(const TriggerRequest & inobj);
        /** equality operator */
        bool operator==(const TriggerRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const TriggerRequest & inobj) const;
        /** less than operator */
        bool operator<(const TriggerRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TriggerRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::TriggerRequest>
    {
    public:
        static bool flat() {return std_srvs::TriggerRequest::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::TriggerRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::TriggerRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::TriggerRequest & value);

#endif  //  _STD_SRVS_TRIGGERREQUEST_H_
