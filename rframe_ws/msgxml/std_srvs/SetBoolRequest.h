...
#ifndef _CODEGEN_STD_SRVS_SETBOOLREQUEST_H_
#define _CODEGEN_STD_SRVS_SETBOOLREQUEST_H_
...
PREDECLARE_BSON(std_srvs::SetBoolRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::SetBoolRequest); // see Common.h, macro used for a cleaner header

namespace std_srvs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetBoolRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetBoolRequest();
        /** copy constructor */
        SetBoolRequest(const SetBoolRequest & inobj);
        /** destructor */
        ~SetBoolRequest();

        /** allocator, convenience function for bind */
        static SetBoolRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        bool  data; /**< no comment provided */
        ...
        static const unsigned int ID = 1986463660U;
        ...
        static const unsigned int DATA_VERSION = 2473479886U;
        ...
        //        static const char * dataTypeName() { return "SetBoolRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f50113811ba95bcdad38cafb8df0759f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf50113811ba95bcdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xad38cafb8df0759fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetBoolRequest * copy() { return new SetBoolRequest(*this); };

        /** assignment operator(s) */
        SetBoolRequest & operator=(const SetBoolRequest & inobj);
        /** equality operator */
        bool operator==(const SetBoolRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetBoolRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetBoolRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetBoolRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::SetBoolRequest>
    {
    public:
        static bool flat() {return std_srvs::SetBoolRequest::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::SetBoolRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::SetBoolRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::SetBoolRequest & value);

#endif  //  _STD_SRVS_SETBOOLREQUEST_H_
