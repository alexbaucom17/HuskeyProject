...
#ifndef _CODEGEN_STD_SRVS_EMPTYRESPONSE_H_
#define _CODEGEN_STD_SRVS_EMPTYRESPONSE_H_
...
PREDECLARE_BSON(std_srvs::EmptyResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::EmptyResponse); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1986463658U;
        ...
        static const unsigned int DATA_VERSION = 2921285604U;
        ...
        */
        ...
        static const std::string versionMD5() { return "29c203cee2550fce25b7c868988bde08"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x29c203cee2550fceULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x25b7c868988bde08ULL;
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::EmptyResponse>
    {
    public:
        static bool flat() {return std_srvs::EmptyResponse::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::EmptyResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::EmptyResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::EmptyResponse & value);

#endif  //  _STD_SRVS_EMPTYRESPONSE_H_
