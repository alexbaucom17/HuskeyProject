...
#ifndef _CODEGEN_STD_SRVS_SETBOOL_H_
#define _CODEGEN_STD_SRVS_SETBOOL_H_
...
PREDECLARE_BSON(std_srvs::SetBool); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::SetBool); // see Common.h, macro used for a cleaner header

namespace std_srvs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetBool & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1986463662U;
        ...
        static const unsigned int DATA_VERSION = 3807387862U;
        ...
        //        static const char * dataTypeName() { return "SetBool"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "67bd2fc1bc7676b133442cce73fa46b8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x67bd2fc1bc7676b1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x33442cce73fa46b8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetBool * copy() { return new SetBool(*this); };

        /** assignment operator(s) */
        SetBool & operator=(const SetBool & inobj);
        /** equality operator */
        bool operator==(const SetBool & inobj) const;
        /** inequality operator */
        bool operator!=(const SetBool & inobj) const;
        /** less than operator */
        bool operator<(const SetBool & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetBool & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::SetBool>
    {
    public:
        static bool flat() {return std_srvs::SetBool::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::SetBool::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::SetBool & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::SetBool & value);

#endif  //  _STD_SRVS_SETBOOL_H_
