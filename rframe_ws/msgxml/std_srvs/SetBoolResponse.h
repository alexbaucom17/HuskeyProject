...
#ifndef _CODEGEN_STD_SRVS_SETBOOLRESPONSE_H_
#define _CODEGEN_STD_SRVS_SETBOOLRESPONSE_H_
...
PREDECLARE_BSON(std_srvs::SetBoolResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::SetBoolResponse); // see Common.h, macro used for a cleaner header

namespace std_srvs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetBoolResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetBoolResponse();
        /** copy constructor */
        SetBoolResponse(const SetBoolResponse & inobj);
        /** destructor */
        ~SetBoolResponse();

        /** allocator, convenience function for bind */
        static SetBoolResponse * New();
        ...
        std::string  message; /**< informational, e.g. for error messages */
        ...
        static const unsigned int ID = 1986463661U;
        ...
        static const unsigned int DATA_VERSION = 2249984602U;
        ...
        //        static const char * dataTypeName() { return "SetBoolResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d82c22293d4196493a33ebee8bba9479"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd82c22293d419649ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3a33ebee8bba9479ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetBoolResponse * copy() { return new SetBoolResponse(*this); };

        /** assignment operator(s) */
        SetBoolResponse & operator=(const SetBoolResponse & inobj);
        /** equality operator */
        bool operator==(const SetBoolResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetBoolResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetBoolResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetBoolResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::SetBoolResponse>
    {
    public:
        static bool flat() {return std_srvs::SetBoolResponse::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::SetBoolResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::SetBoolResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::SetBoolResponse & value);

#endif  //  _STD_SRVS_SETBOOLRESPONSE_H_
