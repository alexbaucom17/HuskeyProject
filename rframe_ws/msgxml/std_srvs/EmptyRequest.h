...
#ifndef _CODEGEN_STD_SRVS_EMPTYREQUEST_H_
#define _CODEGEN_STD_SRVS_EMPTYREQUEST_H_
...
PREDECLARE_BSON(std_srvs::EmptyRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::EmptyRequest); // see Common.h, macro used for a cleaner header

namespace std_srvs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, EmptyRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        EmptyRequest();
        /** copy constructor */
        EmptyRequest(const EmptyRequest & inobj);
        /** destructor */
        ~EmptyRequest();

        /** allocator, convenience function for bind */
        static EmptyRequest * New();
        ...
        static const unsigned int ID = 1986463657U;
        ...
        static const unsigned int DATA_VERSION = 3297339842U;
        ...
        //        static const char * dataTypeName() { return "EmptyRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5b6f3328166ce41b615b6d4916a7d94b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5b6f3328166ce41bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x615b6d4916a7d94bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        EmptyRequest * copy() { return new EmptyRequest(*this); };

        /** assignment operator(s) */
        EmptyRequest & operator=(const EmptyRequest & inobj);
        /** equality operator */
        bool operator==(const EmptyRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const EmptyRequest & inobj) const;
        /** less than operator */
        bool operator<(const EmptyRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, EmptyRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::EmptyRequest>
    {
    public:
        static bool flat() {return std_srvs::EmptyRequest::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::EmptyRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::EmptyRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::EmptyRequest & value);

#endif  //  _STD_SRVS_EMPTYREQUEST_H_
