...
#ifndef _CODEGEN_NAVFN_SETCOSTMAPRESPONSE_H_
#define _CODEGEN_NAVFN_SETCOSTMAPRESPONSE_H_
...
PREDECLARE_BSON(navfn::SetCostmapResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(navfn::SetCostmapResponse); // see Common.h, macro used for a cleaner header

namespace navfn
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetCostmapResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetCostmapResponse();
        /** copy constructor */
        SetCostmapResponse(const SetCostmapResponse & inobj);
        /** destructor */
        ~SetCostmapResponse();

        /** allocator, convenience function for bind */
        static SetCostmapResponse * New();
        ...
        static const unsigned int ID = 1154588002U;
        ...
        static const unsigned int DATA_VERSION = 2697379213U;
        ...
        //        static const char * dataTypeName() { return "SetCostmapResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9e8b1a4b688563b8cc5842e1508cbb60"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9e8b1a4b688563b8ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcc5842e1508cbb60ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetCostmapResponse * copy() { return new SetCostmapResponse(*this); };

        /** assignment operator(s) */
        SetCostmapResponse & operator=(const SetCostmapResponse & inobj);
        /** equality operator */
        bool operator==(const SetCostmapResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetCostmapResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetCostmapResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetCostmapResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<navfn::SetCostmapResponse>
    {
    public:
        static bool flat() {return navfn::SetCostmapResponse::dataTypeFlat(); };
        static std::string sourceXML() {return navfn::SetCostmapResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const navfn::SetCostmapResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const navfn::SetCostmapResponse & value);

#endif  //  _NAVFN_SETCOSTMAPRESPONSE_H_
