...
#ifndef _CODEGEN_NAVFN_MAKENAVPLANRESPONSE_H_
#define _CODEGEN_NAVFN_MAKENAVPLANRESPONSE_H_
...
PREDECLARE_BSON(navfn::MakeNavPlanResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(navfn::MakeNavPlanResponse); // see Common.h, macro used for a cleaner header

namespace navfn
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MakeNavPlanResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        MakeNavPlanResponse();
        /** copy constructor */
        MakeNavPlanResponse(const MakeNavPlanResponse & inobj);
        /** destructor */
        ~MakeNavPlanResponse();

        /** allocator, convenience function for bind */
        static MakeNavPlanResponse * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        unsigned char  plan_found; /**<  */
        std::string  error_message; /**< if plan_found is true, this is an array of waypoints from start to goal, where the first one equals start and the last one equals goal */
        ...
        static const unsigned int ID = 1154587999U;
        ...
        static const unsigned int DATA_VERSION = 2670809276U;
        ...
        //        static const char * dataTypeName() { return "MakeNavPlanResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "40f21567b4ad1928ac2f2d539d3e003c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x40f21567b4ad1928ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xac2f2d539d3e003cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MakeNavPlanResponse * copy() { return new MakeNavPlanResponse(*this); };

        /** assignment operator(s) */
        MakeNavPlanResponse & operator=(const MakeNavPlanResponse & inobj);
        /** equality operator */
        bool operator==(const MakeNavPlanResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const MakeNavPlanResponse & inobj) const;
        /** less than operator */
        bool operator<(const MakeNavPlanResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MakeNavPlanResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<navfn::MakeNavPlanResponse>
    {
    public:
        static bool flat() {return navfn::MakeNavPlanResponse::dataTypeFlat(); };
        static std::string sourceXML() {return navfn::MakeNavPlanResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const navfn::MakeNavPlanResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const navfn::MakeNavPlanResponse & value);

#endif  //  _NAVFN_MAKENAVPLANRESPONSE_H_
