...
#ifndef _CODEGEN_NAVFN_MAKENAVPLANREQUEST_H_
#define _CODEGEN_NAVFN_MAKENAVPLANREQUEST_H_
...
PREDECLARE_BSON(navfn::MakeNavPlanRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(navfn::MakeNavPlanRequest); // see Common.h, macro used for a cleaner header

namespace navfn
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MakeNavPlanRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        MakeNavPlanRequest();
        /** copy constructor */
        MakeNavPlanRequest(const MakeNavPlanRequest & inobj);
        /** destructor */
        ~MakeNavPlanRequest();

        /** allocator, convenience function for bind */
        static MakeNavPlanRequest * New();
        ...
        geometry_msgs::PoseStamped  goal; /**< no comment provided */
        ...
        static const unsigned int ID = 1154587998U;
        ...
        static const unsigned int DATA_VERSION = 3569680634U;
        ...
        //        static const char * dataTypeName() { return "MakeNavPlanRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "36e404893a50c72dc5cbb410f9544c82"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x36e404893a50c72dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc5cbb410f9544c82ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MakeNavPlanRequest * copy() { return new MakeNavPlanRequest(*this); };

        /** assignment operator(s) */
        MakeNavPlanRequest & operator=(const MakeNavPlanRequest & inobj);
        /** equality operator */
        bool operator==(const MakeNavPlanRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const MakeNavPlanRequest & inobj) const;
        /** less than operator */
        bool operator<(const MakeNavPlanRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MakeNavPlanRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<navfn::MakeNavPlanRequest>
    {
    public:
        static bool flat() {return navfn::MakeNavPlanRequest::dataTypeFlat(); };
        static std::string sourceXML() {return navfn::MakeNavPlanRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const navfn::MakeNavPlanRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const navfn::MakeNavPlanRequest & value);

#endif  //  _NAVFN_MAKENAVPLANREQUEST_H_
