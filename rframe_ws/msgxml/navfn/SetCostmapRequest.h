...
#ifndef _CODEGEN_NAVFN_SETCOSTMAPREQUEST_H_
#define _CODEGEN_NAVFN_SETCOSTMAPREQUEST_H_
...
PREDECLARE_BSON(navfn::SetCostmapRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(navfn::SetCostmapRequest); // see Common.h, macro used for a cleaner header

namespace navfn
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetCostmapRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetCostmapRequest();
        /** copy constructor */
        SetCostmapRequest(const SetCostmapRequest & inobj);
        /** destructor */
        ~SetCostmapRequest();

        /** allocator, convenience function for bind */
        static SetCostmapRequest * New();
        ...
        unsigned short int  width; /**< no comment provided */
        ...
        static const unsigned int ID = 1154588001U;
        ...
        static const unsigned int DATA_VERSION = 824244953U;
        ...
        //        static const char * dataTypeName() { return "SetCostmapRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bf76c55afe43be00653a250f482bb319"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbf76c55afe43be00ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x653a250f482bb319ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetCostmapRequest * copy() { return new SetCostmapRequest(*this); };

        /** assignment operator(s) */
        SetCostmapRequest & operator=(const SetCostmapRequest & inobj);
        /** equality operator */
        bool operator==(const SetCostmapRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetCostmapRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetCostmapRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetCostmapRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<navfn::SetCostmapRequest>
    {
    public:
        static bool flat() {return navfn::SetCostmapRequest::dataTypeFlat(); };
        static std::string sourceXML() {return navfn::SetCostmapRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const navfn::SetCostmapRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const navfn::SetCostmapRequest & value);

#endif  //  _NAVFN_SETCOSTMAPREQUEST_H_
