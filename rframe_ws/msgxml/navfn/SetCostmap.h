...
#ifndef _CODEGEN_NAVFN_SETCOSTMAP_H_
#define _CODEGEN_NAVFN_SETCOSTMAP_H_
...
PREDECLARE_BSON(navfn::SetCostmap); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(navfn::SetCostmap); // see Common.h, macro used for a cleaner header

namespace navfn
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetCostmap & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetCostmap();
        /** copy constructor */
        SetCostmap(const SetCostmap & inobj);
        /** destructor */
        ~SetCostmap();

        /** allocator, convenience function for bind */
        static SetCostmap * New();
        ...
        static const unsigned int ID = 1154588003U;
        ...
        static const unsigned int DATA_VERSION = 2419837933U;
        ...
        //        static const char * dataTypeName() { return "SetCostmap"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c1b4dcc82e1f670c5341170456254cdc"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc1b4dcc82e1f670cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5341170456254cdcULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetCostmap * copy() { return new SetCostmap(*this); };

        /** assignment operator(s) */
        SetCostmap & operator=(const SetCostmap & inobj);
        /** equality operator */
        bool operator==(const SetCostmap & inobj) const;
        /** inequality operator */
        bool operator!=(const SetCostmap & inobj) const;
        /** less than operator */
        bool operator<(const SetCostmap & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetCostmap & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<navfn::SetCostmap>
    {
    public:
        static bool flat() {return navfn::SetCostmap::dataTypeFlat(); };
        static std::string sourceXML() {return navfn::SetCostmap::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const navfn::SetCostmap & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const navfn::SetCostmap & value);

#endif  //  _NAVFN_SETCOSTMAP_H_
