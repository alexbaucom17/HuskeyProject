...
#ifndef _CODEGEN_GEOMETRY_MSGS_POSESTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_POSESTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::PoseStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::PoseStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PoseStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        PoseStamped();
        /** copy constructor */
        PoseStamped(const PoseStamped & inobj);
        /** destructor */
        ~PoseStamped();

        /** allocator, convenience function for bind */
        static PoseStamped * New();
        ...
        static const unsigned int ID = 1901327804U;
        ...
        static const unsigned int DATA_VERSION = 1289601393U;
        ...
        //        static const char * dataTypeName() { return "PoseStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d74a8edce75a792b469ccd3f0ebc5e34"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd74a8edce75a792bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x469ccd3f0ebc5e34ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PoseStamped * copy() { return new PoseStamped(*this); };

        /** assignment operator(s) */
        PoseStamped & operator=(const PoseStamped & inobj);
        /** equality operator */
        bool operator==(const PoseStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const PoseStamped & inobj) const;
        /** less than operator */
        bool operator<(const PoseStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PoseStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::PoseStamped>
    {
    public:
        static bool flat() {return geometry_msgs::PoseStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::PoseStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::PoseStamped & value);
