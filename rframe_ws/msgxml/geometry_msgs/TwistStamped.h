...
#ifndef _CODEGEN_GEOMETRY_MSGS_TWISTSTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_TWISTSTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::TwistStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::TwistStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwistStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwistStamped();
        /** copy constructor */
        TwistStamped(const TwistStamped & inobj);
        /** destructor */
        ~TwistStamped();

        /** allocator, convenience function for bind */
        static TwistStamped * New();
        ...
        static const unsigned int ID = 1901327812U;
        ...
        static const unsigned int DATA_VERSION = 1990845278U;
        ...
        //        static const char * dataTypeName() { return "TwistStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5305e3c5b2bfca5b42b14748264a1ba0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5305e3c5b2bfca5bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x42b14748264a1ba0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwistStamped * copy() { return new TwistStamped(*this); };

        /** assignment operator(s) */
        TwistStamped & operator=(const TwistStamped & inobj);
        /** equality operator */
        bool operator==(const TwistStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const TwistStamped & inobj) const;
        /** less than operator */
        bool operator<(const TwistStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwistStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::TwistStamped>
    {
    public:
        static bool flat() {return geometry_msgs::TwistStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::TwistStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::TwistStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::TwistStamped & value);

#endif  //  _GEOMETRY_MSGS_TWISTSTAMPED_H_
