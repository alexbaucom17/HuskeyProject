...
#ifndef _CODEGEN_GEOMETRY_MSGS_VECTOR3STAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_VECTOR3STAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::Vector3Stamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Vector3Stamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Vector3Stamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        Vector3Stamped();
        /** copy constructor */
        Vector3Stamped(const Vector3Stamped & inobj);
        /** destructor */
        ~Vector3Stamped();

        /** allocator, convenience function for bind */
        static Vector3Stamped * New();
        ...
        static const unsigned int ID = 1901327816U;
        ...
        static const unsigned int DATA_VERSION = 1697440656U;
        ...
        //        static const char * dataTypeName() { return "Vector3Stamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "25637e70e19952e2b25e336a275acb9c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x25637e70e19952e2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb25e336a275acb9cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Vector3Stamped * copy() { return new Vector3Stamped(*this); };

        /** assignment operator(s) */
        Vector3Stamped & operator=(const Vector3Stamped & inobj);
        /** equality operator */
        bool operator==(const Vector3Stamped & inobj) const;
        /** inequality operator */
        bool operator!=(const Vector3Stamped & inobj) const;
        /** less than operator */
        bool operator<(const Vector3Stamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Vector3Stamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Vector3Stamped>
    {
    public:
        static bool flat() {return geometry_msgs::Vector3Stamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Vector3Stamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Vector3Stamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::Vector3Stamped & value);

#endif  //  _GEOMETRY_MSGS_VECTOR3STAMPED_H_
