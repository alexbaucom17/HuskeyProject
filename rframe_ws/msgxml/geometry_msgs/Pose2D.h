...
#ifndef _CODEGEN_GEOMETRY_MSGS_POSE2D_H_
#define _CODEGEN_GEOMETRY_MSGS_POSE2D_H_
...
PREDECLARE_BSON(geometry_msgs::Pose2D); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Pose2D); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Pose2D & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327802U;
        ...
        static const unsigned int DATA_VERSION = 2234601530U;
        ...
        //        static const char * dataTypeName() { return "Pose2D"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bb9409bc6fae7d92a890cb59255ec9e9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbb9409bc6fae7d92ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa890cb59255ec9e9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Pose2D * copy() { return new Pose2D(*this); };

        /** assignment operator(s) */
        Pose2D & operator=(const Pose2D & inobj);
        /** equality operator */
        bool operator==(const Pose2D & inobj) const;
        /** inequality operator */
        bool operator!=(const Pose2D & inobj) const;
        /** less than operator */
        bool operator<(const Pose2D & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Pose2D & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Pose2D>
    {
    public:
        static bool flat() {return geometry_msgs::Pose2D::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Pose2D::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Pose2D & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::Pose2D & value);

#endif  //  _GEOMETRY_MSGS_POSE2D_H_
