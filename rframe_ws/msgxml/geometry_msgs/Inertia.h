...
#ifndef _CODEGEN_GEOMETRY_MSGS_INERTIA_H_
#define _CODEGEN_GEOMETRY_MSGS_INERTIA_H_
...
PREDECLARE_BSON(geometry_msgs::Inertia); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Inertia); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Inertia & inobj);   
    ...
    */
    ...
    public: 
        ...
        double  m; /**< Center of mass [m] */
        geometry_msgs::Vector3  com; /**< Inertia Tensor [kg-m^2]      | ixx ixy ixz |  I = | ixy iyy iyz |      | ixz iyz izz | */
        double  ixx; /**<  */
        double  ixy; /**<  */
        double  ixz; /**<  */
        double  iyy; /**<  */
        ...
        static const unsigned int ID = 1901327794U;
        ...
        static const unsigned int DATA_VERSION = 3490240981U;
        ...
        //        static const char * dataTypeName() { return "Inertia"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3d8546a870719f47eaaff7d515789de5"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3d8546a870719f47ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xeaaff7d515789de5ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Inertia * copy() { return new Inertia(*this); };

        /** assignment operator(s) */
        Inertia & operator=(const Inertia & inobj);
        /** equality operator */
        bool operator==(const Inertia & inobj) const;
        /** inequality operator */
        bool operator!=(const Inertia & inobj) const;
        /** less than operator */
        bool operator<(const Inertia & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Inertia & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Inertia>
    {
    public:
        static bool flat() {return geometry_msgs::Inertia::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Inertia::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Inertia & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::Inertia & value);

#endif  //  _GEOMETRY_MSGS_INERTIA_H_
