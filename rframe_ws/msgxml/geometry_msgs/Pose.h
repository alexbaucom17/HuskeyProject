...
#ifndef _CODEGEN_GEOMETRY_MSGS_POSE_H_
#define _CODEGEN_GEOMETRY_MSGS_POSE_H_
...
PREDECLARE_BSON(geometry_msgs::Pose); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Pose); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327801U;
        ...
        static const unsigned int DATA_VERSION = 3510591958U;
        ...
        */
        ...
        static const std::string versionMD5() { return "aa085b3533513e24f1acb1afbca31c83"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xaa085b3533513e24ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf1acb1afbca31c83ULL;
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Pose>
    {
    public:
        static bool flat() {return geometry_msgs::Pose::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Pose::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Pose & value);
