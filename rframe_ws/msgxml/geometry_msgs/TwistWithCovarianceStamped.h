...
#ifndef _CODEGEN_GEOMETRY_MSGS_TWISTWITHCOVARIANCESTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_TWISTWITHCOVARIANCESTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::TwistWithCovarianceStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::TwistWithCovarianceStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwistWithCovarianceStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TwistWithCovarianceStamped(const TwistWithCovarianceStamped & inobj);
        /** destructor */
        ~TwistWithCovarianceStamped();

        /** allocator, convenience function for bind */
        static TwistWithCovarianceStamped * New();
        ...
        static const unsigned int ID = 1901327814U;
        ...
        static const unsigned int DATA_VERSION = 3825199649U;
        ...
        //        static const char * dataTypeName() { return "TwistWithCovarianceStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3e8322e1024287fd47e4d62c8a2bcdc0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3e8322e1024287fdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x47e4d62c8a2bcdc0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwistWithCovarianceStamped * copy() { return new TwistWithCovarianceStamped(*this); };

        /** assignment operator(s) */
        TwistWithCovarianceStamped & operator=(const TwistWithCovarianceStamped & inobj);
        /** equality operator */
        bool operator==(const TwistWithCovarianceStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const TwistWithCovarianceStamped & inobj) const;
        /** less than operator */
        bool operator<(const TwistWithCovarianceStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwistWithCovarianceStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::TwistWithCovarianceStamped>
    {
    public:
        static bool flat() {return geometry_msgs::TwistWithCovarianceStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::TwistWithCovarianceStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::TwistWithCovarianceStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::TwistWithCovarianceStamped & value);

#endif  //  _GEOMETRY_MSGS_TWISTWITHCOVARIANCESTAMPED_H_
