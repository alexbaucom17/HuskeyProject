...
#ifndef _CODEGEN_GEOMETRY_MSGS_POINT_H_
#define _CODEGEN_GEOMETRY_MSGS_POINT_H_
...
PREDECLARE_BSON(geometry_msgs::Point); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Point); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Point & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327796U;
        ...
        static const unsigned int DATA_VERSION = 1593635301U;
        ...
        //        static const char * dataTypeName() { return "Point"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "27e3840ad80849483f5b22929c81fea0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x27e3840ad8084948ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3f5b22929c81fea0ULL;
        ...
        Point & operator=(const Point & inobj);
        /** equality operator */
        bool operator==(const Point & inobj) const;
        /** inequality operator */
        bool operator!=(const Point & inobj) const;
        /** less than operator */
        bool operator<(const Point & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Point & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Point>
    {
    public:
        static bool flat() {return geometry_msgs::Point::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Point::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Point & value);
