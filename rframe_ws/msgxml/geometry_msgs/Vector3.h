...
#ifndef _CODEGEN_GEOMETRY_MSGS_VECTOR3_H_
#define _CODEGEN_GEOMETRY_MSGS_VECTOR3_H_
...
PREDECLARE_BSON(geometry_msgs::Vector3); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Vector3); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Vector3 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327815U;
        ...
        static const unsigned int DATA_VERSION = 2628000651U;
        ...
        //        static const char * dataTypeName() { return "Vector3"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "974aa75493560c562a3a64d1ad3d07a9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x974aa75493560c56ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2a3a64d1ad3d07a9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Vector3 * copy() { return new Vector3(*this); };

        /** assignment operator(s) */
        Vector3 & operator=(const Vector3 & inobj);
        /** equality operator */
        bool operator==(const Vector3 & inobj) const;
        /** inequality operator */
        bool operator!=(const Vector3 & inobj) const;
        /** less than operator */
        bool operator<(const Vector3 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Vector3 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Vector3>
    {
    public:
        static bool flat() {return geometry_msgs::Vector3::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Vector3::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Vector3 & value);
