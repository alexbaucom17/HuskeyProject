...
#ifndef _CODEGEN_GEOMETRY_MSGS_POLYGON_H_
#define _CODEGEN_GEOMETRY_MSGS_POLYGON_H_
...
PREDECLARE_BSON(geometry_msgs::Polygon); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Polygon); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Polygon & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327799U;
        ...
        static const unsigned int DATA_VERSION = 2670464278U;
        ...
        //        static const char * dataTypeName() { return "Polygon"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "4101ce3b92fbce922b2338d06333eebc"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x4101ce3b92fbce92ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2b2338d06333eebcULL;
        ...
        Polygon & operator=(const Polygon & inobj);
        /** equality operator */
        bool operator==(const Polygon & inobj) const;
        /** inequality operator */
        bool operator!=(const Polygon & inobj) const;
        /** less than operator */
        bool operator<(const Polygon & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Polygon & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Polygon>
    {
    public:
        static bool flat() {return geometry_msgs::Polygon::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Polygon::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Polygon & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::Polygon & value);

#endif  //  _GEOMETRY_MSGS_POLYGON_H_
