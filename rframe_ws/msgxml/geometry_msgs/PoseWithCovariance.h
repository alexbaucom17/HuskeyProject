...
#ifndef _CODEGEN_GEOMETRY_MSGS_POSEWITHCOVARIANCE_H_
#define _CODEGEN_GEOMETRY_MSGS_POSEWITHCOVARIANCE_H_
...
PREDECLARE_BSON(geometry_msgs::PoseWithCovariance); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::PoseWithCovariance); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PoseWithCovariance & inobj);   
    ...
    */
    ...
    public: 
        ...
        PoseWithCovariance();
        /** copy constructor */
        PoseWithCovariance(const PoseWithCovariance & inobj);
        /** destructor */
        ~PoseWithCovariance();

        /** allocator, convenience function for bind */
        static PoseWithCovariance * New();
        ...
        Pose  pose; /**< Row-major representation of the 6x6 covariance matrix  The orientation parameters use a fixed-axis representation.  In order, the parameters are:  (x, y, z, rotation about X axis, rotation about Y axis, rotation about Z axis) */
        ...
        static const unsigned int ID = 1901327805U;
        ...
        static const unsigned int DATA_VERSION = 1073431412U;
        ...
        //        static const char * dataTypeName() { return "PoseWithCovariance"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f97ca047f1649355d2ca86f0349bd615"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf97ca047f1649355ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd2ca86f0349bd615ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PoseWithCovariance * copy() { return new PoseWithCovariance(*this); };

        /** assignment operator(s) */
        PoseWithCovariance & operator=(const PoseWithCovariance & inobj);
        /** equality operator */
        bool operator==(const PoseWithCovariance & inobj) const;
        /** inequality operator */
        bool operator!=(const PoseWithCovariance & inobj) const;
        /** less than operator */
        bool operator<(const PoseWithCovariance & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PoseWithCovariance & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::PoseWithCovariance>
    {
    public:
        static bool flat() {return geometry_msgs::PoseWithCovariance::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::PoseWithCovariance::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::PoseWithCovariance & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::PoseWithCovariance & value);

#endif  //  _GEOMETRY_MSGS_POSEWITHCOVARIANCE_H_
