...
#ifndef _CODEGEN_GEOMETRY_MSGS_ACCELSTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_ACCELSTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::AccelStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::AccelStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AccelStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        AccelStamped();
        /** copy constructor */
        AccelStamped(const AccelStamped & inobj);
        /** destructor */
        ~AccelStamped();

        /** allocator, convenience function for bind */
        static AccelStamped * New();
        ...
        static const unsigned int ID = 1901327791U;
        ...
        static const unsigned int DATA_VERSION = 2672128981U;
        ...
        //        static const char * dataTypeName() { return "AccelStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "cb8fa575fedebcdb45a700e165991bc8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xcb8fa575fedebcdbULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x45a700e165991bc8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AccelStamped * copy() { return new AccelStamped(*this); };

        /** assignment operator(s) */
        AccelStamped & operator=(const AccelStamped & inobj);
        /** equality operator */
        bool operator==(const AccelStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const AccelStamped & inobj) const;
        /** less than operator */
        bool operator<(const AccelStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AccelStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::AccelStamped>
    {
    public:
        static bool flat() {return geometry_msgs::AccelStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::AccelStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::AccelStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::AccelStamped & value);

#endif  //  _GEOMETRY_MSGS_ACCELSTAMPED_H_
