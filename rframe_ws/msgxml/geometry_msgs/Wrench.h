...
#ifndef _CODEGEN_GEOMETRY_MSGS_WRENCH_H_
#define _CODEGEN_GEOMETRY_MSGS_WRENCH_H_
...
PREDECLARE_BSON(geometry_msgs::Wrench); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Wrench); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Wrench & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327817U;
        ...
        static const unsigned int DATA_VERSION = 14536910U;
        ...
        //        static const char * dataTypeName() { return "Wrench"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7ceef29623a5a92b2f9807bef7a00246"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7ceef29623a5a92bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2f9807bef7a00246ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Wrench * copy() { return new Wrench(*this); };

        /** assignment operator(s) */
        Wrench & operator=(const Wrench & inobj);
        /** equality operator */
        bool operator==(const Wrench & inobj) const;
        /** inequality operator */
        bool operator!=(const Wrench & inobj) const;
        /** less than operator */
        bool operator<(const Wrench & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Wrench & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Wrench>
    {
    public:
        static bool flat() {return geometry_msgs::Wrench::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Wrench::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Wrench & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::Wrench & value);

#endif  //  _GEOMETRY_MSGS_WRENCH_H_
