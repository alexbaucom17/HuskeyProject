...
#ifndef _CODEGEN_GEOMETRY_MSGS_TWISTWITHCOVARIANCE_H_
#define _CODEGEN_GEOMETRY_MSGS_TWISTWITHCOVARIANCE_H_
...
PREDECLARE_BSON(geometry_msgs::TwistWithCovariance); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::TwistWithCovariance); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwistWithCovariance & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwistWithCovariance();
        /** copy constructor */
        TwistWithCovariance(const TwistWithCovariance & inobj);
        /** destructor */
        ~TwistWithCovariance();

        /** allocator, convenience function for bind */
        static TwistWithCovariance * New();

        /* shorthand definitions for constant sized arrays */
        /** definition of max size of array for covariance */
        static const unsigned int COVARIANCE_MAX = 36;
        /** shorthand definition for array of covariance */
        typedef std::array<double,COVARIANCE_MAX> CovarianceArray;

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        Twist  twist; /**< Row-major representation of the 6x6 covariance matrix  The orientation parameters use a fixed-axis representation.  In order, the parameters are:  (x, y, z, rotation about X axis, rotation about Y axis, rotation about Z axis) */
        ...
        static const unsigned int ID = 1901327813U;
        ...
        static const unsigned int DATA_VERSION = 189845010U;
        ...
        //        static const char * dataTypeName() { return "TwistWithCovariance"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c63edfea281c994b4f388decab377d56"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc63edfea281c994bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4f388decab377d56ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwistWithCovariance * copy() { return new TwistWithCovariance(*this); };

        /** assignment operator(s) */
        TwistWithCovariance & operator=(const TwistWithCovariance & inobj);
        /** equality operator */
        bool operator==(const TwistWithCovariance & inobj) const;
        /** inequality operator */
        bool operator!=(const TwistWithCovariance & inobj) const;
        /** less than operator */
        bool operator<(const TwistWithCovariance & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwistWithCovariance & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::TwistWithCovariance>
    {
    public:
        static bool flat() {return geometry_msgs::TwistWithCovariance::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::TwistWithCovariance::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::TwistWithCovariance & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::TwistWithCovariance & value);

#endif  //  _GEOMETRY_MSGS_TWISTWITHCOVARIANCE_H_
