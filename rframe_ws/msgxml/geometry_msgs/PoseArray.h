...
#ifndef _CODEGEN_GEOMETRY_MSGS_POSEARRAY_H_
#define _CODEGEN_GEOMETRY_MSGS_POSEARRAY_H_
...
PREDECLARE_BSON(geometry_msgs::PoseArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::PoseArray); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PoseArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        PoseArray();
        /** copy constructor */
        PoseArray(const PoseArray & inobj);
        /** destructor */
        ~PoseArray();

        /** allocator, convenience function for bind */
        static PoseArray * New();
        ...
        static const unsigned int ID = 1901327803U;
        ...
        static const unsigned int DATA_VERSION = 1352798652U;
        ...
        //        static const char * dataTypeName() { return "PoseArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "286608724fff0d99091463710d3048ae"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x286608724fff0d99ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x091463710d3048aeULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PoseArray * copy() { return new PoseArray(*this); };

        /** assignment operator(s) */
        PoseArray & operator=(const PoseArray & inobj);
        /** equality operator */
        bool operator==(const PoseArray & inobj) const;
        /** inequality operator */
        bool operator!=(const PoseArray & inobj) const;
        /** less than operator */
        bool operator<(const PoseArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PoseArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::PoseArray>
    {
    public:
        static bool flat() {return geometry_msgs::PoseArray::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::PoseArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::PoseArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::PoseArray & value);

#endif  //  _GEOMETRY_MSGS_POSEARRAY_H_
