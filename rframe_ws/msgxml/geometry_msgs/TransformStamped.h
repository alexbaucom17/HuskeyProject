...
#ifndef _CODEGEN_GEOMETRY_MSGS_TRANSFORMSTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_TRANSFORMSTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::TransformStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::TransformStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TransformStamped & inobj);   

    /** 
        \ingroup CodeGen
        This expresses a transform from coordinate frame header.frame_id  to the coordinate frame child_frame_id   This message is mostly used by the   <a href="http://wiki.ros.org/tf">tf</a> package.   See its documentation for more information.
    */
    class TransformStamped
    {
    public: 
        ...
        TransformStamped();
        /** copy constructor */
        TransformStamped(const TransformStamped & inobj);
        /** destructor */
        ~TransformStamped();

        /** allocator, convenience function for bind */
        static TransformStamped * New();
        ...
        static const unsigned int ID = 1901327810U;
        ...
        static const unsigned int DATA_VERSION = 101104941U;
        ...
        //        static const char * dataTypeName() { return "TransformStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7e59c2067cf5001cbe70a528cdf35a89"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7e59c2067cf5001cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbe70a528cdf35a89ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TransformStamped * copy() { return new TransformStamped(*this); };

        /** assignment operator(s) */
        TransformStamped & operator=(const TransformStamped & inobj);
        /** equality operator */
        bool operator==(const TransformStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const TransformStamped & inobj) const;
        /** less than operator */
        bool operator<(const TransformStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TransformStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::TransformStamped>
    {
    public:
        static bool flat() {return geometry_msgs::TransformStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::TransformStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::TransformStamped & value);
