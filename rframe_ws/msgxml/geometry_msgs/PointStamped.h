...
#ifndef _CODEGEN_GEOMETRY_MSGS_POINTSTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_POINTSTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::PointStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::PointStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointStamped();
        /** copy constructor */
        PointStamped(const PointStamped & inobj);
        /** destructor */
        ~PointStamped();

        /** allocator, convenience function for bind */
        static PointStamped * New();
        ...
        static const unsigned int ID = 1901327798U;
        ...
        static const unsigned int DATA_VERSION = 2783524956U;
        ...
        //        static const char * dataTypeName() { return "PointStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "fa5b9e55fb8a7394079285a85c632b89"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfa5b9e55fb8a7394ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x079285a85c632b89ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointStamped * copy() { return new PointStamped(*this); };

        /** assignment operator(s) */
        PointStamped & operator=(const PointStamped & inobj);
        /** equality operator */
        bool operator==(const PointStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const PointStamped & inobj) const;
        /** less than operator */
        bool operator<(const PointStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::PointStamped>
    {
    public:
        static bool flat() {return geometry_msgs::PointStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::PointStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::PointStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::PointStamped & value);

#endif  //  _GEOMETRY_MSGS_POINTSTAMPED_H_
