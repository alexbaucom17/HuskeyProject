...
#ifndef _CODEGEN_GEOMETRY_MSGS_ACCELWITHCOVARIANCE_H_
#define _CODEGEN_GEOMETRY_MSGS_ACCELWITHCOVARIANCE_H_
...
PREDECLARE_BSON(geometry_msgs::AccelWithCovariance); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::AccelWithCovariance); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AccelWithCovariance & inobj);   
    ...
    */
    ...
    public: 
        ...
        AccelWithCovariance();
        /** copy constructor */
        AccelWithCovariance(const AccelWithCovariance & inobj);
        /** destructor */
        ~AccelWithCovariance();

        /** allocator, convenience function for bind */
        static AccelWithCovariance * New();
        ...
        Accel  accel; /**< Row-major representation of the 6x6 covariance matrix  The orientation parameters use a fixed-axis representation.  In order, the parameters are:  (x, y, z, rotation about X axis, rotation about Y axis, rotation about Z axis) */
        ...
        static const unsigned int ID = 1901327792U;
        ...
        static const unsigned int DATA_VERSION = 154465694U;
        ...
        //        static const char * dataTypeName() { return "AccelWithCovariance"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "166835ef239f3e450e5df47a9a6625db"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x166835ef239f3e45ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0e5df47a9a6625dbULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AccelWithCovariance * copy() { return new AccelWithCovariance(*this); };

        /** assignment operator(s) */
        AccelWithCovariance & operator=(const AccelWithCovariance & inobj);
        /** equality operator */
        bool operator==(const AccelWithCovariance & inobj) const;
        /** inequality operator */
        bool operator!=(const AccelWithCovariance & inobj) const;
        /** less than operator */
        bool operator<(const AccelWithCovariance & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AccelWithCovariance & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::AccelWithCovariance>
    {
    public:
        static bool flat() {return geometry_msgs::AccelWithCovariance::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::AccelWithCovariance::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::AccelWithCovariance & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::AccelWithCovariance & value);

#endif  //  _GEOMETRY_MSGS_ACCELWITHCOVARIANCE_H_
