...
#ifndef _CODEGEN_GEOMETRY_MSGS_TRANSFORM_H_
#define _CODEGEN_GEOMETRY_MSGS_TRANSFORM_H_
...
PREDECLARE_BSON(geometry_msgs::Transform); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Transform); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Transform & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327809U;
        ...
        static const unsigned int DATA_VERSION = 3092557992U;
        ...
        //        static const char * dataTypeName() { return "Transform"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9eb77631f70efb0f8e634b9a4fd1b393"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9eb77631f70efb0fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8e634b9a4fd1b393ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Transform * copy() { return new Transform(*this); };

        /** assignment operator(s) */
        Transform & operator=(const Transform & inobj);
        /** equality operator */
        bool operator==(const Transform & inobj) const;
        /** inequality operator */
        bool operator!=(const Transform & inobj) const;
        /** less than operator */
        bool operator<(const Transform & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Transform & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Transform>
    {
    public:
        static bool flat() {return geometry_msgs::Transform::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Transform::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Transform & value);
