...
int geometry_msgs_gencppROSMessageFactory::desc(std::string & str, rframe::ID_TYPE id)
{
    ...
    {   
        ...
        case Pose::ID:
        {
            str = "# A representation of pose in free space, composed of position and orientation. \nPoint position\nQuaternion orientation\n\n================================================================================\nMSG: geometry_msgs/Point\n# This contains the position of a point in free space\nfloat64 x\nfloat64 y\nfloat64 z\n\n================================================================================\nMSG: geometry_msgs/Quaternion\n# This represents an orientation in free space in quaternion form.\n\nfloat64 x\nfloat64 y\nfloat64 z\nfloat64 w\n";
            break;
        }
        case Pose2D::ID:
        {
...
int geometry_msgs_gencppROSMessageFactory::md5String(std::string & str, rframe::ID_TYPE id)
{
    ...
    {   
        ...
        case Pose::ID:
        {
            str = "e45d45a5a1ce597b249e23fb30fc871f";
            break;
        }
        case Pose2D::ID:
        {
...
int geometry_msgs_gencppROSMessageFactory::md5(unsigned long long & highOrder, unsigned long long & lowOrder, rframe::ID_TYPE id)
{
    ...
    {   
        ...
        case Pose::ID:
        {   
		    highOrder = 0xe45d45a5a1ce597bULL;
            lowOrder = 0x249e23fb30fc871fULL;
            break;
        }
        case Pose2D::ID:
        {   
