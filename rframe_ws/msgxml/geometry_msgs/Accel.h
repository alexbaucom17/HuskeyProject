...
#ifndef _CODEGEN_GEOMETRY_MSGS_ACCEL_H_
#define _CODEGEN_GEOMETRY_MSGS_ACCEL_H_
...
PREDECLARE_BSON(geometry_msgs::Accel); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Accel); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Accel & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327790U;
        ...
        static const unsigned int DATA_VERSION = 3839268703U;
        ...
        //        static const char * dataTypeName() { return "Accel"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d30c69ee44113a0b73c785197c4f718b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd30c69ee44113a0bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x73c785197c4f718bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Accel * copy() { return new Accel(*this); };

        /** assignment operator(s) */
        Accel & operator=(const Accel & inobj);
        /** equality operator */
        bool operator==(const Accel & inobj) const;
        /** inequality operator */
        bool operator!=(const Accel & inobj) const;
        /** less than operator */
        bool operator<(const Accel & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Accel & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Accel>
    {
    public:
        static bool flat() {return geometry_msgs::Accel::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Accel::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Accel & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::Accel & value);

#endif  //  _GEOMETRY_MSGS_ACCEL_H_
