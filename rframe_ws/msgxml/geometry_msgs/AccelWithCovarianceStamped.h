...
#ifndef _CODEGEN_GEOMETRY_MSGS_ACCELWITHCOVARIANCESTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_ACCELWITHCOVARIANCESTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::AccelWithCovarianceStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::AccelWithCovarianceStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AccelWithCovarianceStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        AccelWithCovarianceStamped(const AccelWithCovarianceStamped & inobj);
        /** destructor */
        ~AccelWithCovarianceStamped();

        /** allocator, convenience function for bind */
        static AccelWithCovarianceStamped * New();
        ...
        static const unsigned int ID = 1901327793U;
        ...
        static const unsigned int DATA_VERSION = 682999809U;
        ...
        //        static const char * dataTypeName() { return "AccelWithCovarianceStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "36078d96d30bd0da79efd20366153739"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x36078d96d30bd0daULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x79efd20366153739ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AccelWithCovarianceStamped * copy() { return new AccelWithCovarianceStamped(*this); };

        /** assignment operator(s) */
        AccelWithCovarianceStamped & operator=(const AccelWithCovarianceStamped & inobj);
        /** equality operator */
        bool operator==(const AccelWithCovarianceStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const AccelWithCovarianceStamped & inobj) const;
        /** less than operator */
        bool operator<(const AccelWithCovarianceStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AccelWithCovarianceStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::AccelWithCovarianceStamped>
    {
    public:
        static bool flat() {return geometry_msgs::AccelWithCovarianceStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::AccelWithCovarianceStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::AccelWithCovarianceStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::AccelWithCovarianceStamped & value);

#endif  //  _GEOMETRY_MSGS_ACCELWITHCOVARIANCESTAMPED_H_
