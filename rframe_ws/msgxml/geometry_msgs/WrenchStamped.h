...
#ifndef _CODEGEN_GEOMETRY_MSGS_WRENCHSTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_WRENCHSTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::WrenchStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::WrenchStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, WrenchStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        WrenchStamped();
        /** copy constructor */
        WrenchStamped(const WrenchStamped & inobj);
        /** destructor */
        ~WrenchStamped();

        /** allocator, convenience function for bind */
        static WrenchStamped * New();
        ...
        static const unsigned int ID = 1901327818U;
        ...
        static const unsigned int DATA_VERSION = 329813067U;
        ...
        //        static const char * dataTypeName() { return "WrenchStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "704e01254c5096670f0b4dc2e969a4fd"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x704e01254c509667ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0f0b4dc2e969a4fdULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        WrenchStamped * copy() { return new WrenchStamped(*this); };

        /** assignment operator(s) */
        WrenchStamped & operator=(const WrenchStamped & inobj);
        /** equality operator */
        bool operator==(const WrenchStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const WrenchStamped & inobj) const;
        /** less than operator */
        bool operator<(const WrenchStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, WrenchStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::WrenchStamped>
    {
    public:
        static bool flat() {return geometry_msgs::WrenchStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::WrenchStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::WrenchStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::WrenchStamped & value);

#endif  //  _GEOMETRY_MSGS_WRENCHSTAMPED_H_
