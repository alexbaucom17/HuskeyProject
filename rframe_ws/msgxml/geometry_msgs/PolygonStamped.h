...
#ifndef _CODEGEN_GEOMETRY_MSGS_POLYGONSTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_POLYGONSTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::PolygonStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::PolygonStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PolygonStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        PolygonStamped();
        /** copy constructor */
        PolygonStamped(const PolygonStamped & inobj);
        /** destructor */
        ~PolygonStamped();

        /** allocator, convenience function for bind */
        static PolygonStamped * New();
        ...
        static const unsigned int ID = 1901327800U;
        ...
        static const unsigned int DATA_VERSION = 689957287U;
        ...
        //        static const char * dataTypeName() { return "PolygonStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7d3a7bb2e32111fdfd481533268b910c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7d3a7bb2e32111fdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfd481533268b910cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PolygonStamped * copy() { return new PolygonStamped(*this); };

        /** assignment operator(s) */
        PolygonStamped & operator=(const PolygonStamped & inobj);
        /** equality operator */
        bool operator==(const PolygonStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const PolygonStamped & inobj) const;
        /** less than operator */
        bool operator<(const PolygonStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PolygonStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::PolygonStamped>
    {
    public:
        static bool flat() {return geometry_msgs::PolygonStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::PolygonStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::PolygonStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::PolygonStamped & value);

#endif  //  _GEOMETRY_MSGS_POLYGONSTAMPED_H_
