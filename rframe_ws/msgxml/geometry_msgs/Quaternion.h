...
#ifndef _CODEGEN_GEOMETRY_MSGS_QUATERNION_H_
#define _CODEGEN_GEOMETRY_MSGS_QUATERNION_H_
...
PREDECLARE_BSON(geometry_msgs::Quaternion); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Quaternion); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Quaternion & inobj);   
    ...
    */
    ...
    public: 
        ...
        Quaternion();
        /** copy constructor */
        Quaternion(const Quaternion & inobj);
        /** destructor */
        ~Quaternion();
        ...
        static const unsigned int ID = 1901327807U;
        ...
        static const unsigned int DATA_VERSION = 3670333188U;
        ...
        //        static const char * dataTypeName() { return "Quaternion"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "192f598a5e8d90cb2ec16aa4806f9c6b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x192f598a5e8d90cbULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2ec16aa4806f9c6bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Quaternion * copy() { return new Quaternion(*this); };

        /** assignment operator(s) */
        Quaternion & operator=(const Quaternion & inobj);
        /** equality operator */
        bool operator==(const Quaternion & inobj) const;
        /** inequality operator */
        bool operator!=(const Quaternion & inobj) const;
        /** less than operator */
        bool operator<(const Quaternion & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Quaternion & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Quaternion>
    {
    public:
        static bool flat() {return geometry_msgs::Quaternion::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Quaternion::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Quaternion & value);
