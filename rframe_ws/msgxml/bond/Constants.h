...
#ifndef _CODEGEN_BOND_CONSTANTS_H_
#define _CODEGEN_BOND_CONSTANTS_H_
...
PREDECLARE_BSON(bond::Constants); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(bond::Constants); // see Common.h, macro used for a cleaner header

namespace bond
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Constants & inobj);   
    ...
    */
    ...
    public: 
        ...
        Constants();
        /** copy constructor */
        Constants(const Constants & inobj);
        /** destructor */
        ~Constants();

        /** allocator, convenience function for bind */
        static Constants * New();
        ...
        static const float DEAD_PUBLISH_PERIOD; /**<  (value: 0.05) */
        static const float DEFAULT_CONNECT_TIMEOUT; /**<  (value: 10.0) */
        static const float DEFAULT_HEARTBEAT_TIMEOUT; /**<  (value: 4.0) */
        static const float DEFAULT_DISCONNECT_TIMEOUT; /**<  (value: 2.0) */
        static const float DEFAULT_HEARTBEAT_PERIOD; /**<  (value: 1.0) */
        static const std::string DISABLE_HEARTBEAT_TIMEOUT_PARAM; /**<  (value: /bond_disable_heartbeat_timeout) */
        ...
        static const unsigned int ID = 202404712U;
        ...
        static const unsigned int DATA_VERSION = 1434713915U;
        ...
        //        static const char * dataTypeName() { return "Constants"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6f06db9d3ea7e87c2317cdb3220d98fc"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6f06db9d3ea7e87cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2317cdb3220d98fcULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Constants * copy() { return new Constants(*this); };

        /** assignment operator(s) */
        Constants & operator=(const Constants & inobj);
        /** equality operator */
        bool operator==(const Constants & inobj) const;
        /** inequality operator */
        bool operator!=(const Constants & inobj) const;
        /** less than operator */
        bool operator<(const Constants & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Constants & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<bond::Constants>
    {
    public:
        static bool flat() {return bond::Constants::dataTypeFlat(); };
        static std::string sourceXML() {return bond::Constants::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const bond::Constants & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const bond::Constants & value);

#endif  //  _BOND_CONSTANTS_H_
