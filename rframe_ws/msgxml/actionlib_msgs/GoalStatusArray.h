...
#ifndef _CODEGEN_ACTIONLIB_MSGS_GOALSTATUSARRAY_H_
#define _CODEGEN_ACTIONLIB_MSGS_GOALSTATUSARRAY_H_
...
PREDECLARE_BSON(actionlib_msgs::GoalStatusArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_msgs::GoalStatusArray); // see Common.h, macro used for a cleaner header

namespace actionlib_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GoalStatusArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        GoalStatusArray();
        /** copy constructor */
        GoalStatusArray(const GoalStatusArray & inobj);
        /** destructor */
        ~GoalStatusArray();

        /** allocator, convenience function for bind */
        static GoalStatusArray * New();
        ...
        static const unsigned int ID = 1211121731U;
        ...
        static const unsigned int DATA_VERSION = 2023849453U;
        ...
        //        static const char * dataTypeName() { return "GoalStatusArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b2fc0758f276fffa09c0d7efaf643acf"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb2fc0758f276fffaULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x09c0d7efaf643acfULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GoalStatusArray * copy() { return new GoalStatusArray(*this); };

        /** assignment operator(s) */
        GoalStatusArray & operator=(const GoalStatusArray & inobj);
        /** equality operator */
        bool operator==(const GoalStatusArray & inobj) const;
        /** inequality operator */
        bool operator!=(const GoalStatusArray & inobj) const;
        /** less than operator */
        bool operator<(const GoalStatusArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GoalStatusArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_msgs::GoalStatusArray>
    {
    public:
        static bool flat() {return actionlib_msgs::GoalStatusArray::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_msgs::GoalStatusArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_msgs::GoalStatusArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_msgs::GoalStatusArray & value);

#endif  //  _ACTIONLIB_MSGS_GOALSTATUSARRAY_H_
