...
#ifndef _CODEGEN_ACTIONLIB_MSGS_GOALID_H_
#define _CODEGEN_ACTIONLIB_MSGS_GOALID_H_
...
PREDECLARE_BSON(actionlib_msgs::GoalID); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_msgs::GoalID); // see Common.h, macro used for a cleaner header

namespace actionlib_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GoalID & inobj);   
    ...
    */
    ...
    public: 
        ...
        std_msgs::RosTime  stamp; /**< The id provides a way to associate feedback and  result message with specific goal requests. The id  specified must be unique. */
        std::string  id; /**<  */
        ...
        static const unsigned int ID = 1211121729U;
        ...
        static const unsigned int DATA_VERSION = 1780575281U;
        ...
        //        static const char * dataTypeName() { return "GoalID"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "81e80356abd3a3234316270ae0c80c06"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x81e80356abd3a323ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4316270ae0c80c06ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GoalID * copy() { return new GoalID(*this); };

        /** assignment operator(s) */
        GoalID & operator=(const GoalID & inobj);
        /** equality operator */
        bool operator==(const GoalID & inobj) const;
        /** inequality operator */
        bool operator!=(const GoalID & inobj) const;
        /** less than operator */
        bool operator<(const GoalID & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GoalID & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_msgs::GoalID>
    {
    public:
        static bool flat() {return actionlib_msgs::GoalID::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_msgs::GoalID::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_msgs::GoalID & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_msgs::GoalID & value);

#endif  //  _ACTIONLIB_MSGS_GOALID_H_
