...
#ifndef _CODEGEN_SENSOR_MSGS_CHANNELFLOAT32_H_
#define _CODEGEN_SENSOR_MSGS_CHANNELFLOAT32_H_
...
PREDECLARE_BSON(sensor_msgs::ChannelFloat32); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::ChannelFloat32); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ChannelFloat32 & inobj);   
    ...
    */
    ...
    public: 
        ...
        ChannelFloat32();
        /** copy constructor */
        ChannelFloat32(const ChannelFloat32 & inobj);
        /** destructor */
        ~ChannelFloat32();

        /** allocator, convenience function for bind */
        static ChannelFloat32 * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  name; /**< The values array should be 1-1 with the elements of the associated  PointCloud. */
        ...
        static const unsigned int ID = 237354212U;
        ...
        static const unsigned int DATA_VERSION = 3650943839U;
        ...
        //        static const char * dataTypeName() { return "ChannelFloat32"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6ebbd6d50c95a4ba0e37325b0f35631c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6ebbd6d50c95a4baULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0e37325b0f35631cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ChannelFloat32 * copy() { return new ChannelFloat32(*this); };

        /** assignment operator(s) */
        ChannelFloat32 & operator=(const ChannelFloat32 & inobj);
        /** equality operator */
        bool operator==(const ChannelFloat32 & inobj) const;
        /** inequality operator */
        bool operator!=(const ChannelFloat32 & inobj) const;
        /** less than operator */
        bool operator<(const ChannelFloat32 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ChannelFloat32 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::ChannelFloat32>
    {
    public:
        static bool flat() {return sensor_msgs::ChannelFloat32::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::ChannelFloat32::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::ChannelFloat32 & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::ChannelFloat32 & value);

#endif  //  _SENSOR_MSGS_CHANNELFLOAT32_H_
