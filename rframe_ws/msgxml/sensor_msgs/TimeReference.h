...
#ifndef _CODEGEN_SENSOR_MSGS_TIMEREFERENCE_H_
#define _CODEGEN_SENSOR_MSGS_TIMEREFERENCE_H_
...
PREDECLARE_BSON(sensor_msgs::TimeReference); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::TimeReference); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TimeReference & inobj);   
    ...
    */
    ...
    public: 
        ...
        TimeReference();
        /** copy constructor */
        TimeReference(const TimeReference & inobj);
        /** destructor */
        ~TimeReference();

        /** allocator, convenience function for bind */
        static TimeReference * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< stamp is system time for which measurement was valid  frame_id is not used */
        std_msgs::RosTime  time_ref; /**< corresponding time from this external source */
        std::string  source; /**< (optional) name of time source */
        ...
        static const unsigned int ID = 237354236U;
        ...
        static const unsigned int DATA_VERSION = 2582498110U;
        ...
        //        static const char * dataTypeName() { return "TimeReference"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f9edf400eaaf99332f490066b44a4481"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf9edf400eaaf9933ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2f490066b44a4481ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TimeReference * copy() { return new TimeReference(*this); };

        /** assignment operator(s) */
        TimeReference & operator=(const TimeReference & inobj);
        /** equality operator */
        bool operator==(const TimeReference & inobj) const;
        /** inequality operator */
        bool operator!=(const TimeReference & inobj) const;
        /** less than operator */
        bool operator<(const TimeReference & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TimeReference & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::TimeReference>
    {
    public:
        static bool flat() {return sensor_msgs::TimeReference::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::TimeReference::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::TimeReference & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::TimeReference & value);

#endif  //  _SENSOR_MSGS_TIMEREFERENCE_H_
