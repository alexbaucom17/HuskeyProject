...
#ifndef _CODEGEN_SENSOR_MSGS_JOINTSTATE_H_
#define _CODEGEN_SENSOR_MSGS_JOINTSTATE_H_
...
PREDECLARE_BSON(sensor_msgs::JointState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::JointState); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointState & inobj);   
    ...
    */
    ...
    public: 
        ...
        JointState();
        /** copy constructor */
        JointState(const JointState & inobj);
        /** destructor */
        ~JointState();

        /** allocator, convenience function for bind */
        static JointState * New();
        ...
        static const unsigned int ID = 237354218U;
        ...
        static const unsigned int DATA_VERSION = 3254499806U;
        ...
        //        static const char * dataTypeName() { return "JointState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "300ead38d53c1b5c9ce18e16aace5e54"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x300ead38d53c1b5cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9ce18e16aace5e54ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointState * copy() { return new JointState(*this); };

        /** assignment operator(s) */
        JointState & operator=(const JointState & inobj);
        /** equality operator */
        bool operator==(const JointState & inobj) const;
        /** inequality operator */
        bool operator!=(const JointState & inobj) const;
        /** less than operator */
        bool operator<(const JointState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::JointState>
    {
    public:
        static bool flat() {return sensor_msgs::JointState::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::JointState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::JointState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::JointState & value);

#endif  //  _SENSOR_MSGS_JOINTSTATE_H_
