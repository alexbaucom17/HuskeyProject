...
#ifndef _CODEGEN_SENSOR_MSGS_SETCAMERAINFO_H_
#define _CODEGEN_SENSOR_MSGS_SETCAMERAINFO_H_
...
PREDECLARE_BSON(sensor_msgs::SetCameraInfo); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::SetCameraInfo); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetCameraInfo & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetCameraInfo();
        /** copy constructor */
        SetCameraInfo(const SetCameraInfo & inobj);
        /** destructor */
        ~SetCameraInfo();

        /** allocator, convenience function for bind */
        static SetCameraInfo * New();
        ...
        static const unsigned int ID = 237354239U;
        ...
        static const unsigned int DATA_VERSION = 4034319769U;
        ...
        //        static const char * dataTypeName() { return "SetCameraInfo"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "39b3d1197bd05fc60f91e1743126eb3c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x39b3d1197bd05fc6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0f91e1743126eb3cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetCameraInfo * copy() { return new SetCameraInfo(*this); };

        /** assignment operator(s) */
        SetCameraInfo & operator=(const SetCameraInfo & inobj);
        /** equality operator */
        bool operator==(const SetCameraInfo & inobj) const;
        /** inequality operator */
        bool operator!=(const SetCameraInfo & inobj) const;
        /** less than operator */
        bool operator<(const SetCameraInfo & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetCameraInfo & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::SetCameraInfo>
    {
    public:
        static bool flat() {return sensor_msgs::SetCameraInfo::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::SetCameraInfo::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::SetCameraInfo & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::SetCameraInfo & value);

#endif  //  _SENSOR_MSGS_SETCAMERAINFO_H_
