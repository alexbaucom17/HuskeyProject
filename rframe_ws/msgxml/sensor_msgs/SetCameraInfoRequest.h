...
#ifndef _CODEGEN_SENSOR_MSGS_SETCAMERAINFOREQUEST_H_
#define _CODEGEN_SENSOR_MSGS_SETCAMERAINFOREQUEST_H_
...
PREDECLARE_BSON(sensor_msgs::SetCameraInfoRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::SetCameraInfoRequest); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetCameraInfoRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetCameraInfoRequest(const SetCameraInfoRequest & inobj);
        /** destructor */
        ~SetCameraInfoRequest();

        /** allocator, convenience function for bind */
        static SetCameraInfoRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        sensor_msgs::CameraInfo  camera_info; /**< no comment provided */
        ...
        static const unsigned int ID = 237354237U;
        ...
        static const unsigned int DATA_VERSION = 903462961U;
        ...
        //        static const char * dataTypeName() { return "SetCameraInfoRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "47265d6cca17081b9f35182dc733e0ab"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x47265d6cca17081bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9f35182dc733e0abULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetCameraInfoRequest * copy() { return new SetCameraInfoRequest(*this); };

        /** assignment operator(s) */
        SetCameraInfoRequest & operator=(const SetCameraInfoRequest & inobj);
        /** equality operator */
        bool operator==(const SetCameraInfoRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetCameraInfoRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetCameraInfoRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetCameraInfoRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::SetCameraInfoRequest>
    {
    public:
        static bool flat() {return sensor_msgs::SetCameraInfoRequest::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::SetCameraInfoRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::SetCameraInfoRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::SetCameraInfoRequest & value);

#endif  //  _SENSOR_MSGS_SETCAMERAINFOREQUEST_H_
