...
#ifndef _CODEGEN_SENSOR_MSGS_JOY_H_
#define _CODEGEN_SENSOR_MSGS_JOY_H_
...
PREDECLARE_BSON(sensor_msgs::Joy); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::Joy); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Joy & inobj);   
    ...
    */
    ...
    public: 
        ...
        std_msgs::Header  header; /**< timestamp in the header is the time the data is received from the joystick */
        std::vector<float >  axes; /**< the axes measurements from a joystick */
        std::vector<int >  buttons; /**< the buttons measurements from a joystick */
        ...
        static const unsigned int ID = 237354219U;
        ...
        static const unsigned int DATA_VERSION = 2611517864U;
        ...
        //        static const char * dataTypeName() { return "Joy"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "105215fb425cd742e5310211c6677127"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x105215fb425cd742ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe5310211c6677127ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Joy * copy() { return new Joy(*this); };

        /** assignment operator(s) */
        Joy & operator=(const Joy & inobj);
        /** equality operator */
        bool operator==(const Joy & inobj) const;
        /** inequality operator */
        bool operator!=(const Joy & inobj) const;
        /** less than operator */
        bool operator<(const Joy & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Joy & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::Joy>
    {
    public:
        static bool flat() {return sensor_msgs::Joy::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::Joy::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::Joy & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::Joy & value);

#endif  //  _SENSOR_MSGS_JOY_H_
