...
#ifndef _CODEGEN_SENSOR_MSGS_LASERECHO_H_
#define _CODEGEN_SENSOR_MSGS_LASERECHO_H_
...
PREDECLARE_BSON(sensor_msgs::LaserEcho); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::LaserEcho); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LaserEcho & inobj);   
    ...
    */
    ...
    public: 
        ...
        LaserEcho();
        /** copy constructor */
        LaserEcho(const LaserEcho & inobj);
        /** destructor */
        ~LaserEcho();

        /** allocator, convenience function for bind */
        static LaserEcho * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::vector<float >  echoes; /**< Multiple values of ranges or intensities.  Each array represents data from the same angle increment. */
        ...
        static const unsigned int ID = 237354222U;
        ...
        static const unsigned int DATA_VERSION = 3142468097U;
        ...
        //        static const char * dataTypeName() { return "LaserEcho"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bc2313e98a7864ab78a27447abec204d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbc2313e98a7864abULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x78a27447abec204dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LaserEcho * copy() { return new LaserEcho(*this); };

        /** assignment operator(s) */
        LaserEcho & operator=(const LaserEcho & inobj);
        /** equality operator */
        bool operator==(const LaserEcho & inobj) const;
        /** inequality operator */
        bool operator!=(const LaserEcho & inobj) const;
        /** less than operator */
        bool operator<(const LaserEcho & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LaserEcho & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::LaserEcho>
    {
    public:
        static bool flat() {return sensor_msgs::LaserEcho::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::LaserEcho::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::LaserEcho & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::LaserEcho & value);

#endif  //  _SENSOR_MSGS_LASERECHO_H_
