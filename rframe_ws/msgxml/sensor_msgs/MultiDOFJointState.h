...
#ifndef _CODEGEN_SENSOR_MSGS_MULTIDOFJOINTSTATE_H_
#define _CODEGEN_SENSOR_MSGS_MULTIDOFJOINTSTATE_H_
...
PREDECLARE_BSON(sensor_msgs::MultiDOFJointState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::MultiDOFJointState); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MultiDOFJointState & inobj);   
    ...
    */
    ...
    public: 
        ...
        MultiDOFJointState();
        /** copy constructor */
        MultiDOFJointState(const MultiDOFJointState & inobj);
        /** destructor */
        ~MultiDOFJointState();

        /** allocator, convenience function for bind */
        static MultiDOFJointState * New();
        ...
        static const unsigned int ID = 237354225U;
        ...
        static const unsigned int DATA_VERSION = 3317855440U;
        ...
        //        static const char * dataTypeName() { return "MultiDOFJointState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7583df4219d45aa1fe24cd1bc873b975"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7583df4219d45aa1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfe24cd1bc873b975ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MultiDOFJointState * copy() { return new MultiDOFJointState(*this); };

        /** assignment operator(s) */
        MultiDOFJointState & operator=(const MultiDOFJointState & inobj);
        /** equality operator */
        bool operator==(const MultiDOFJointState & inobj) const;
        /** inequality operator */
        bool operator!=(const MultiDOFJointState & inobj) const;
        /** less than operator */
        bool operator<(const MultiDOFJointState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MultiDOFJointState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::MultiDOFJointState>
    {
    public:
        static bool flat() {return sensor_msgs::MultiDOFJointState::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::MultiDOFJointState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::MultiDOFJointState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::MultiDOFJointState & value);

#endif  //  _SENSOR_MSGS_MULTIDOFJOINTSTATE_H_
