...
#ifndef _CODEGEN_SENSOR_MSGS_TEMPERATURE_H_
#define _CODEGEN_SENSOR_MSGS_TEMPERATURE_H_
...
PREDECLARE_BSON(sensor_msgs::Temperature); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::Temperature); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Temperature & inobj);   
    ...
    */
    ...
    public: 
        ...
        Temperature();
        /** copy constructor */
        Temperature(const Temperature & inobj);
        /** destructor */
        ~Temperature();

        /** allocator, convenience function for bind */
        static Temperature * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< timestamp is the time the temperature was measured  frame_id is the location of the temperature reading */
        double  temperature; /**< Measurement of the Temperature in Degrees Celsius */
        ...
        static const unsigned int ID = 237354235U;
        ...
        static const unsigned int DATA_VERSION = 2585298681U;
        ...
        //        static const char * dataTypeName() { return "Temperature"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f8353038967b0d9ba6e5d63e00d0dcc6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf8353038967b0d9bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa6e5d63e00d0dcc6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Temperature * copy() { return new Temperature(*this); };

        /** assignment operator(s) */
        Temperature & operator=(const Temperature & inobj);
        /** equality operator */
        bool operator==(const Temperature & inobj) const;
        /** inequality operator */
        bool operator!=(const Temperature & inobj) const;
        /** less than operator */
        bool operator<(const Temperature & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Temperature & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::Temperature>
    {
    public:
        static bool flat() {return sensor_msgs::Temperature::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::Temperature::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::Temperature & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::Temperature & value);

#endif  //  _SENSOR_MSGS_TEMPERATURE_H_
