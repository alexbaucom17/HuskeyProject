...
#ifndef _CODEGEN_SENSOR_MSGS_NAVSATSTATUS_H_
#define _CODEGEN_SENSOR_MSGS_NAVSATSTATUS_H_
...
PREDECLARE_BSON(sensor_msgs::NavSatStatus); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::NavSatStatus); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NavSatStatus & inobj);   
    ...
    */
    ...
    public: 
        ...
        NavSatStatus();
        /** copy constructor */
        NavSatStatus(const NavSatStatus & inobj);
        /** destructor */
        ~NavSatStatus();

        /** allocator, convenience function for bind */
        static NavSatStatus * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        char  status; /**< Bits defining which Global Navigation Satellite System signals were  used by the receiver. */
        unsigned short int  service; /**<  */

        static const char STATUS_NO_FIX; /**< unable to fix position (value: -1) */
        static const char STATUS_FIX; /**< unaugmented fix (value: 0) */
        static const char STATUS_SBAS_FIX; /**< with satellite-based augmentation (value: 1) */
        static const char STATUS_GBAS_FIX; /**< with ground-based augmentation (value: 2) */
        static const unsigned short int SERVICE_GPS; /**<  (value: 1) */
        static const unsigned short int SERVICE_GLONASS; /**<  (value: 2) */
        static const unsigned short int SERVICE_COMPASS; /**< includes BeiDou. (value: 4) */
        static const unsigned short int SERVICE_GALILEO; /**<  (value: 8) */
        ...
        static const unsigned int ID = 237354228U;
        ...
        static const unsigned int DATA_VERSION = 3520042912U;
        ...
        //        static const char * dataTypeName() { return "NavSatStatus"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7352700dc4d81543ef34d580342fdac0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7352700dc4d81543ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xef34d580342fdac0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NavSatStatus * copy() { return new NavSatStatus(*this); };

        /** assignment operator(s) */
        NavSatStatus & operator=(const NavSatStatus & inobj);
        /** equality operator */
        bool operator==(const NavSatStatus & inobj) const;
        /** inequality operator */
        bool operator!=(const NavSatStatus & inobj) const;
        /** less than operator */
        bool operator<(const NavSatStatus & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NavSatStatus & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::NavSatStatus>
    {
    public:
        static bool flat() {return sensor_msgs::NavSatStatus::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::NavSatStatus::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::NavSatStatus & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::NavSatStatus & value);

#endif  //  _SENSOR_MSGS_NAVSATSTATUS_H_
