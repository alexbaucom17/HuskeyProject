...
#ifndef _CODEGEN_SENSOR_MSGS_MULTIECHOLASERSCAN_H_
#define _CODEGEN_SENSOR_MSGS_MULTIECHOLASERSCAN_H_
...
PREDECLARE_BSON(sensor_msgs::MultiEchoLaserScan); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::MultiEchoLaserScan); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MultiEchoLaserScan & inobj);   
    ...
    */
    ...
    public: 
        ...
        MultiEchoLaserScan();
        /** copy constructor */
        MultiEchoLaserScan(const MultiEchoLaserScan & inobj);
        /** destructor */
        ~MultiEchoLaserScan();

        /** allocator, convenience function for bind */
        static MultiEchoLaserScan * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< timestamp in the header is the acquisition time of   the first ray in the scan.   in frame frame_id, angles are measured around   the positive Z axis (counterclockwise, if Z is up)  with zero angle being forward along the x axis */
        ...
        std::vector<LaserEcho >  ranges; /**< range data [m] (Note: NaNs, values < range_min or > range_max should be discarded)  +Inf measurements are out of range  -Inf measurements are too close to determine exact distance. */
        std::vector<LaserEcho >  intensities; /**< intensity data [device-specific units].  If your  device does not provide intensities, please leave  the array empty. */
        ...
        { 
            ...
            DAQ_1_ANGLE_MIN,
            DAQ_2_ANGLE_MAX,
            DAQ_3_ANGLE_INCREMENT,
            DAQ_4_TIME_INCREMENT,
            DAQ_5_SCAN_TIME,
            DAQ_6_RANGE_MIN,
            DAQ_7_RANGE_MAX,
            DAQ_8_RANGES,
        ...
        static const unsigned int ID = 237354226U;
        ...
        static const unsigned int DATA_VERSION = 1126579021U;
        ...
        //        static const char * dataTypeName() { return "MultiEchoLaserScan"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "04300f0e89ac0e05dec5139512f03fe4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x04300f0e89ac0e05ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdec5139512f03fe4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MultiEchoLaserScan * copy() { return new MultiEchoLaserScan(*this); };

        /** assignment operator(s) */
        MultiEchoLaserScan & operator=(const MultiEchoLaserScan & inobj);
        /** equality operator */
        bool operator==(const MultiEchoLaserScan & inobj) const;
        /** inequality operator */
        bool operator!=(const MultiEchoLaserScan & inobj) const;
        /** less than operator */
        bool operator<(const MultiEchoLaserScan & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MultiEchoLaserScan & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::MultiEchoLaserScan>
    {
    public:
        static bool flat() {return sensor_msgs::MultiEchoLaserScan::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::MultiEchoLaserScan::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::MultiEchoLaserScan & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::MultiEchoLaserScan & value);

#endif  //  _SENSOR_MSGS_MULTIECHOLASERSCAN_H_
