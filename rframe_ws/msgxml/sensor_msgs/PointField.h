...
#ifndef _CODEGEN_SENSOR_MSGS_POINTFIELD_H_
#define _CODEGEN_SENSOR_MSGS_POINTFIELD_H_
...
PREDECLARE_BSON(sensor_msgs::PointField); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::PointField); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointField & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointField();
        /** copy constructor */
        PointField(const PointField & inobj);
        /** destructor */
        ~PointField();

        /** allocator, convenience function for bind */
        static PointField * New();
        ...
        unsigned char  datatype; /**< Datatype enumeration, see above */
        unsigned int  count; /**< How many elements in the field */

        static const unsigned char INT8; /**<  (value: 1) */
        static const unsigned char UINT8; /**<  (value: 2) */
        static const unsigned char INT16; /**<  (value: 3) */
        static const unsigned char UINT16; /**<  (value: 4) */
        static const unsigned char INT32; /**<  (value: 5) */
        static const unsigned char UINT32; /**<  (value: 6) */
        static const unsigned char FLOAT32; /**<  (value: 7) */
        static const unsigned char FLOAT64; /**<  (value: 8) */
        ...
        static const unsigned int ID = 237354231U;
        ...
        static const unsigned int DATA_VERSION = 126702930U;
        ...
        //        static const char * dataTypeName() { return "PointField"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2addf6e00d6b21d57c1e3b1fb5f4ec2c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2addf6e00d6b21d5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7c1e3b1fb5f4ec2cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointField * copy() { return new PointField(*this); };

        /** assignment operator(s) */
        PointField & operator=(const PointField & inobj);
        /** equality operator */
        bool operator==(const PointField & inobj) const;
        /** inequality operator */
        bool operator!=(const PointField & inobj) const;
        /** less than operator */
        bool operator<(const PointField & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointField & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::PointField>
    {
    public:
        static bool flat() {return sensor_msgs::PointField::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::PointField::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::PointField & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::PointField & value);

#endif  //  _SENSOR_MSGS_POINTFIELD_H_
