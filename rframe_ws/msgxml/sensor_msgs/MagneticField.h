...
#ifndef _CODEGEN_SENSOR_MSGS_MAGNETICFIELD_H_
#define _CODEGEN_SENSOR_MSGS_MAGNETICFIELD_H_
...
PREDECLARE_BSON(sensor_msgs::MagneticField); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::MagneticField); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MagneticField & inobj);   
    ...
    */
    ...
    public: 
        ...
        MagneticField();
        /** copy constructor */
        MagneticField(const MagneticField & inobj);
        /** destructor */
        ~MagneticField();

        /** allocator, convenience function for bind */
        static MagneticField * New();

        /* shorthand definitions for constant sized arrays */
        /** definition of max size of array for magnetic_field_covariance */
        static const unsigned int MAGNETIC_FIELD_COVARIANCE_MAX = 9;
        /** shorthand definition for array of magnetic_field_covariance */
        typedef std::array<double,MAGNETIC_FIELD_COVARIANCE_MAX> Magnetic_field_covarianceArray;

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< timestamp is the time the  field was measured  frame_id is the location and orientation  of the field measurement */
        geometry_msgs::Vector3  magnetic_field; /**< x, y, and z components of the  field vector in Tesla  If your sensor does not output 3 axes,  put NaNs in the components not reported. */
        std::array<double,9>  magnetic_field_covariance; /**< Row major about x, y, z axes  0 is interpreted as variance unknown */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_HEADER,
            DAQ_1_MAGNETIC_FIELD,
            DAQ_2_MAGNETIC_FIELD_COVARIANCE,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 237354224U;
        ...
        static const unsigned int DATA_VERSION = 3985144346U;
        ...
        //        static const char * dataTypeName() { return "MagneticField"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a085c070fe760133fed4546e593646d9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa085c070fe760133ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfed4546e593646d9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MagneticField * copy() { return new MagneticField(*this); };

        /** assignment operator(s) */
        MagneticField & operator=(const MagneticField & inobj);
        /** equality operator */
        bool operator==(const MagneticField & inobj) const;
        /** inequality operator */
        bool operator!=(const MagneticField & inobj) const;
        /** less than operator */
        bool operator<(const MagneticField & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MagneticField & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::MagneticField>
    {
    public:
        static bool flat() {return sensor_msgs::MagneticField::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::MagneticField::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::MagneticField & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::MagneticField & value);

#endif  //  _SENSOR_MSGS_MAGNETICFIELD_H_
