...
#ifndef _CODEGEN_SENSOR_MSGS_JOYFEEDBACKARRAY_H_
#define _CODEGEN_SENSOR_MSGS_JOYFEEDBACKARRAY_H_
...
PREDECLARE_BSON(sensor_msgs::JoyFeedbackArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::JoyFeedbackArray); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JoyFeedbackArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        JoyFeedbackArray();
        /** copy constructor */
        JoyFeedbackArray(const JoyFeedbackArray & inobj);
        /** destructor */
        ~JoyFeedbackArray();

        /** allocator, convenience function for bind */
        static JoyFeedbackArray * New();
        ...
        static const unsigned int ID = 237354221U;
        ...
        static const unsigned int DATA_VERSION = 2630023698U;
        ...
        //        static const char * dataTypeName() { return "JoyFeedbackArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b9d3b29f35dd0b31e0bd93bf682be267"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb9d3b29f35dd0b31ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe0bd93bf682be267ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JoyFeedbackArray * copy() { return new JoyFeedbackArray(*this); };

        /** assignment operator(s) */
        JoyFeedbackArray & operator=(const JoyFeedbackArray & inobj);
        /** equality operator */
        bool operator==(const JoyFeedbackArray & inobj) const;
        /** inequality operator */
        bool operator!=(const JoyFeedbackArray & inobj) const;
        /** less than operator */
        bool operator<(const JoyFeedbackArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JoyFeedbackArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::JoyFeedbackArray>
    {
    public:
        static bool flat() {return sensor_msgs::JoyFeedbackArray::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::JoyFeedbackArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::JoyFeedbackArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::JoyFeedbackArray & value);

#endif  //  _SENSOR_MSGS_JOYFEEDBACKARRAY_H_
