...
#ifndef _CODEGEN_SENSOR_MSGS_LASERSCAN_H_
#define _CODEGEN_SENSOR_MSGS_LASERSCAN_H_
...
PREDECLARE_BSON(sensor_msgs::LaserScan); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::LaserScan); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LaserScan & inobj);   
    ...
    */
    ...
    public: 
        ...
        LaserScan();
        /** copy constructor */
        LaserScan(const LaserScan & inobj);
        /** destructor */
        ~LaserScan();

        /** allocator, convenience function for bind */
        static LaserScan * New();
        ...
        std::vector<float >  intensities; /**< intensity data [device-specific units].  If your  device does not provide intensities, please leave  the array empty. */
        ...
        static const unsigned int ID = 237354223U;
        ...
        static const unsigned int DATA_VERSION = 271915635U;
        ...
        //        static const char * dataTypeName() { return "LaserScan"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5cedbebece3b604e889fba8c4ce3b030"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5cedbebece3b604eULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x889fba8c4ce3b030ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LaserScan * copy() { return new LaserScan(*this); };

        /** assignment operator(s) */
        LaserScan & operator=(const LaserScan & inobj);
        /** equality operator */
        bool operator==(const LaserScan & inobj) const;
        /** inequality operator */
        bool operator!=(const LaserScan & inobj) const;
        /** less than operator */
        bool operator<(const LaserScan & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LaserScan & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::LaserScan>
    {
    public:
        static bool flat() {return sensor_msgs::LaserScan::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::LaserScan::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::LaserScan & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::LaserScan & value);

#endif  //  _SENSOR_MSGS_LASERSCAN_H_
