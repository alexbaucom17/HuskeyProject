...
#ifndef _CODEGEN_SENSOR_MSGS_COMPRESSEDIMAGE_H_
#define _CODEGEN_SENSOR_MSGS_COMPRESSEDIMAGE_H_
...
PREDECLARE_BSON(sensor_msgs::CompressedImage); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::CompressedImage); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, CompressedImage & inobj);   
    ...
    */
    ...
    public: 
        ...
        CompressedImage();
        /** copy constructor */
        CompressedImage(const CompressedImage & inobj);
        /** destructor */
        ~CompressedImage();

        /** allocator, convenience function for bind */
        static CompressedImage * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< Header timestamp should be acquisition time of image  Header frame_id should be optical frame of camera  origin of frame should be optical center of cameara  +x should point to the right in the image  +y should point down in the image  +z should point into to plane of the image */
        std::string  format; /**< Specifies the format of the data    Acceptable values:      jpeg, png */
        std::vector<unsigned char >  data; /**< Compressed image buffer */
        ...
        static const unsigned int ID = 237354213U;
        ...
        static const unsigned int DATA_VERSION = 716377299U;
        ...
        //        static const char * dataTypeName() { return "CompressedImage"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e03414adcca0be292efdc2d6f90cf1fa"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe03414adcca0be29ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2efdc2d6f90cf1faULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        CompressedImage * copy() { return new CompressedImage(*this); };

        /** assignment operator(s) */
        CompressedImage & operator=(const CompressedImage & inobj);
        /** equality operator */
        bool operator==(const CompressedImage & inobj) const;
        /** inequality operator */
        bool operator!=(const CompressedImage & inobj) const;
        /** less than operator */
        bool operator<(const CompressedImage & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, CompressedImage & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::CompressedImage>
    {
    public:
        static bool flat() {return sensor_msgs::CompressedImage::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::CompressedImage::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::CompressedImage & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::CompressedImage & value);

#endif  //  _SENSOR_MSGS_COMPRESSEDIMAGE_H_
