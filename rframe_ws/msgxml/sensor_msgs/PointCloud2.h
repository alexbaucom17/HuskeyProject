...
#ifndef _CODEGEN_SENSOR_MSGS_POINTCLOUD2_H_
#define _CODEGEN_SENSOR_MSGS_POINTCLOUD2_H_
...
PREDECLARE_BSON(sensor_msgs::PointCloud2); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::PointCloud2); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointCloud2 & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointCloud2();
        /** copy constructor */
        PointCloud2(const PointCloud2 & inobj);
        /** destructor */
        ~PointCloud2();

        /** allocator, convenience function for bind */
        static PointCloud2 * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< 2D structure of the point cloud. If the cloud is unordered, height is  1 and width is the length of the point cloud. */
        unsigned int  height; /**<  */
        unsigned int  width; /**< Describes the channels and their layout in the binary data blob. */
        std::vector<PointField >  fields; /**<  */
        bool  is_bigendian; /**< Is this data bigendian? */
        unsigned int  point_step; /**< Length of a point in bytes */
        unsigned int  row_step; /**< Length of a row in bytes */
        ...
        static const unsigned int ID = 237354230U;
        ...
        static const unsigned int DATA_VERSION = 2412725490U;
        ...
        //        static const char * dataTypeName() { return "PointCloud2"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7926175170818d793a3bcf3665c73c8b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7926175170818d79ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3a3bcf3665c73c8bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointCloud2 * copy() { return new PointCloud2(*this); };

        /** assignment operator(s) */
        PointCloud2 & operator=(const PointCloud2 & inobj);
        /** equality operator */
        bool operator==(const PointCloud2 & inobj) const;
        /** inequality operator */
        bool operator!=(const PointCloud2 & inobj) const;
        /** less than operator */
        bool operator<(const PointCloud2 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointCloud2 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::PointCloud2>
    {
    public:
        static bool flat() {return sensor_msgs::PointCloud2::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::PointCloud2::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::PointCloud2 & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::PointCloud2 & value);

#endif  //  _SENSOR_MSGS_POINTCLOUD2_H_
