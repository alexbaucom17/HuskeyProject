...
#ifndef _CODEGEN_SENSOR_MSGS_SETCAMERAINFORESPONSE_H_
#define _CODEGEN_SENSOR_MSGS_SETCAMERAINFORESPONSE_H_
...
PREDECLARE_BSON(sensor_msgs::SetCameraInfoResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::SetCameraInfoResponse); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetCameraInfoResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetCameraInfoResponse(const SetCameraInfoResponse & inobj);
        /** destructor */
        ~SetCameraInfoResponse();

        /** allocator, convenience function for bind */
        static SetCameraInfoResponse * New();
        ...
        std::string  status_message; /**< Used to give details about success */
        ...
        static const unsigned int ID = 237354238U;
        ...
        static const unsigned int DATA_VERSION = 2131007291U;
        ...
        //        static const char * dataTypeName() { return "SetCameraInfoResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5159e5d372ac9054978304bfba1c08cb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5159e5d372ac9054ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x978304bfba1c08cbULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetCameraInfoResponse * copy() { return new SetCameraInfoResponse(*this); };

        /** assignment operator(s) */
        SetCameraInfoResponse & operator=(const SetCameraInfoResponse & inobj);
        /** equality operator */
        bool operator==(const SetCameraInfoResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetCameraInfoResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetCameraInfoResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetCameraInfoResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::SetCameraInfoResponse>
    {
    public:
        static bool flat() {return sensor_msgs::SetCameraInfoResponse::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::SetCameraInfoResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::SetCameraInfoResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::SetCameraInfoResponse & value);

#endif  //  _SENSOR_MSGS_SETCAMERAINFORESPONSE_H_
