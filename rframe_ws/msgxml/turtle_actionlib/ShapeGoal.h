...
#ifndef _CODEGEN_TURTLE_ACTIONLIB_SHAPEGOAL_H_
#define _CODEGEN_TURTLE_ACTIONLIB_SHAPEGOAL_H_
...
PREDECLARE_BSON(turtle_actionlib::ShapeGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtle_actionlib::ShapeGoal); // see Common.h, macro used for a cleaner header

namespace turtle_actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ShapeGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        ShapeGoal();
        /** copy constructor */
        ShapeGoal(const ShapeGoal & inobj);
        /** destructor */
        ~ShapeGoal();

        /** allocator, convenience function for bind */
        static ShapeGoal * New();
        ...
        static const unsigned int ID = 1300583015U;
        ...
        static const unsigned int DATA_VERSION = 1674742318U;
        ...
        //        static const char * dataTypeName() { return "ShapeGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b316fe6d42acd3a997ee03e038210e49"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb316fe6d42acd3a9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x97ee03e038210e49ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ShapeGoal * copy() { return new ShapeGoal(*this); };

        /** assignment operator(s) */
        ShapeGoal & operator=(const ShapeGoal & inobj);
        /** equality operator */
        bool operator==(const ShapeGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const ShapeGoal & inobj) const;
        /** less than operator */
        bool operator<(const ShapeGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ShapeGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtle_actionlib::ShapeGoal>
    {
    public:
        static bool flat() {return turtle_actionlib::ShapeGoal::dataTypeFlat(); };
        static std::string sourceXML() {return turtle_actionlib::ShapeGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtle_actionlib::ShapeGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtle_actionlib::ShapeGoal & value);

#endif  //  _TURTLE_ACTIONLIB_SHAPEGOAL_H_
