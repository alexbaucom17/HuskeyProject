...
#ifndef _CODEGEN_TURTLE_ACTIONLIB_VELOCITY_H_
#define _CODEGEN_TURTLE_ACTIONLIB_VELOCITY_H_
...
PREDECLARE_BSON(turtle_actionlib::Velocity); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtle_actionlib::Velocity); // see Common.h, macro used for a cleaner header

namespace turtle_actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Velocity & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1300583017U;
        ...
        static const unsigned int DATA_VERSION = 260234587U;
        ...
        //        static const char * dataTypeName() { return "Velocity"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8aca79d23c342c664d6dc1f41b995b02"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8aca79d23c342c66ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4d6dc1f41b995b02ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Velocity * copy() { return new Velocity(*this); };

        /** assignment operator(s) */
        Velocity & operator=(const Velocity & inobj);
        /** equality operator */
        bool operator==(const Velocity & inobj) const;
        /** inequality operator */
        bool operator!=(const Velocity & inobj) const;
        /** less than operator */
        bool operator<(const Velocity & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Velocity & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtle_actionlib::Velocity>
    {
    public:
        static bool flat() {return turtle_actionlib::Velocity::dataTypeFlat(); };
        static std::string sourceXML() {return turtle_actionlib::Velocity::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtle_actionlib::Velocity & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtle_actionlib::Velocity & value);

#endif  //  _TURTLE_ACTIONLIB_VELOCITY_H_
