...
#ifndef _CODEGEN_TURTLE_ACTIONLIB_SHAPEFEEDBACK_H_
#define _CODEGEN_TURTLE_ACTIONLIB_SHAPEFEEDBACK_H_
...
PREDECLARE_BSON(turtle_actionlib::ShapeFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtle_actionlib::ShapeFeedback); // see Common.h, macro used for a cleaner header

namespace turtle_actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ShapeFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        ShapeFeedback();
        /** copy constructor */
        ShapeFeedback(const ShapeFeedback & inobj);
        /** destructor */
        ~ShapeFeedback();

        /** allocator, convenience function for bind */
        static ShapeFeedback * New();
        ...
        static const unsigned int ID = 1300583014U;
        ...
        static const unsigned int DATA_VERSION = 3415138843U;
        ...
        //        static const char * dataTypeName() { return "ShapeFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0f99011b8d19e6c9c5ac1df729c3410b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0f99011b8d19e6c9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc5ac1df729c3410bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ShapeFeedback * copy() { return new ShapeFeedback(*this); };

        /** assignment operator(s) */
        ShapeFeedback & operator=(const ShapeFeedback & inobj);
        /** equality operator */
        bool operator==(const ShapeFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const ShapeFeedback & inobj) const;
        /** less than operator */
        bool operator<(const ShapeFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ShapeFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtle_actionlib::ShapeFeedback>
    {
    public:
        static bool flat() {return turtle_actionlib::ShapeFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return turtle_actionlib::ShapeFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtle_actionlib::ShapeFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtle_actionlib::ShapeFeedback & value);

#endif  //  _TURTLE_ACTIONLIB_SHAPEFEEDBACK_H_
