...
#ifndef _CODEGEN_TURTLE_ACTIONLIB_SHAPERESULT_H_
#define _CODEGEN_TURTLE_ACTIONLIB_SHAPERESULT_H_
...
PREDECLARE_BSON(turtle_actionlib::ShapeResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtle_actionlib::ShapeResult); // see Common.h, macro used for a cleaner header

namespace turtle_actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ShapeResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        ShapeResult();
        /** copy constructor */
        ShapeResult(const ShapeResult & inobj);
        /** destructor */
        ~ShapeResult();

        /** allocator, convenience function for bind */
        static ShapeResult * New();
        ...
        static const unsigned int ID = 1300583016U;
        ...
        static const unsigned int DATA_VERSION = 3895414993U;
        ...
        //        static const char * dataTypeName() { return "ShapeResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "21a91550a82f47140ec9b48d50ca2b8c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x21a91550a82f4714ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0ec9b48d50ca2b8cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ShapeResult * copy() { return new ShapeResult(*this); };

        /** assignment operator(s) */
        ShapeResult & operator=(const ShapeResult & inobj);
        /** equality operator */
        bool operator==(const ShapeResult & inobj) const;
        /** inequality operator */
        bool operator!=(const ShapeResult & inobj) const;
        /** less than operator */
        bool operator<(const ShapeResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ShapeResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtle_actionlib::ShapeResult>
    {
    public:
        static bool flat() {return turtle_actionlib::ShapeResult::dataTypeFlat(); };
        static std::string sourceXML() {return turtle_actionlib::ShapeResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtle_actionlib::ShapeResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtle_actionlib::ShapeResult & value);

#endif  //  _TURTLE_ACTIONLIB_SHAPERESULT_H_
