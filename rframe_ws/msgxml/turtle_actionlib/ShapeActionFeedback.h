...
#ifndef _CODEGEN_TURTLE_ACTIONLIB_SHAPEACTIONFEEDBACK_H_
#define _CODEGEN_TURTLE_ACTIONLIB_SHAPEACTIONFEEDBACK_H_
...
PREDECLARE_BSON(turtle_actionlib::ShapeActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtle_actionlib::ShapeActionFeedback); // see Common.h, macro used for a cleaner header

namespace turtle_actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ShapeActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        ShapeActionFeedback();
        /** copy constructor */
        ShapeActionFeedback(const ShapeActionFeedback & inobj);
        /** destructor */
        ~ShapeActionFeedback();

        /** allocator, convenience function for bind */
        static ShapeActionFeedback * New();
        ...
        static const unsigned int ID = 1300583011U;
        ...
        static const unsigned int DATA_VERSION = 475396678U;
        ...
        //        static const char * dataTypeName() { return "ShapeActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b9aa0ce9419342b7ed3948a9601282cb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb9aa0ce9419342b7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xed3948a9601282cbULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ShapeActionFeedback * copy() { return new ShapeActionFeedback(*this); };

        /** assignment operator(s) */
        ShapeActionFeedback & operator=(const ShapeActionFeedback & inobj);
        /** equality operator */
        bool operator==(const ShapeActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const ShapeActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const ShapeActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ShapeActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtle_actionlib::ShapeActionFeedback>
    {
    public:
        static bool flat() {return turtle_actionlib::ShapeActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return turtle_actionlib::ShapeActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtle_actionlib::ShapeActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtle_actionlib::ShapeActionFeedback & value);

#endif  //  _TURTLE_ACTIONLIB_SHAPEACTIONFEEDBACK_H_
