...
#ifndef _CODEGEN_TURTLE_ACTIONLIB_SHAPEACTIONRESULT_H_
#define _CODEGEN_TURTLE_ACTIONLIB_SHAPEACTIONRESULT_H_
...
PREDECLARE_BSON(turtle_actionlib::ShapeActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtle_actionlib::ShapeActionResult); // see Common.h, macro used for a cleaner header

namespace turtle_actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ShapeActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        ShapeActionResult();
        /** copy constructor */
        ShapeActionResult(const ShapeActionResult & inobj);
        /** destructor */
        ~ShapeActionResult();

        /** allocator, convenience function for bind */
        static ShapeActionResult * New();
        ...
        static const unsigned int ID = 1300583013U;
        ...
        static const unsigned int DATA_VERSION = 2471745445U;
        ...
        //        static const char * dataTypeName() { return "ShapeActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "fb3bb6ae754a5dbaa11db8eb6cc75a79"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfb3bb6ae754a5dbaULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa11db8eb6cc75a79ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ShapeActionResult * copy() { return new ShapeActionResult(*this); };

        /** assignment operator(s) */
        ShapeActionResult & operator=(const ShapeActionResult & inobj);
        /** equality operator */
        bool operator==(const ShapeActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const ShapeActionResult & inobj) const;
        /** less than operator */
        bool operator<(const ShapeActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ShapeActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtle_actionlib::ShapeActionResult>
    {
    public:
        static bool flat() {return turtle_actionlib::ShapeActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return turtle_actionlib::ShapeActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtle_actionlib::ShapeActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtle_actionlib::ShapeActionResult & value);

#endif  //  _TURTLE_ACTIONLIB_SHAPEACTIONRESULT_H_
