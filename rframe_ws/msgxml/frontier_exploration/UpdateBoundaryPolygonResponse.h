...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGONRESPONSE_H_
#define _CODEGEN_FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGONRESPONSE_H_
...
PREDECLARE_BSON(frontier_exploration::UpdateBoundaryPolygonResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::UpdateBoundaryPolygonResponse); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UpdateBoundaryPolygonResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        UpdateBoundaryPolygonResponse(const UpdateBoundaryPolygonResponse & inobj);
        /** destructor */
        ~UpdateBoundaryPolygonResponse();

        /** allocator, convenience function for bind */
        static UpdateBoundaryPolygonResponse * New();
        ...
        static const unsigned int ID = 185647710U;
        ...
        static const unsigned int DATA_VERSION = 1651474153U;
        ...
        //        static const char * dataTypeName() { return "UpdateBoundaryPolygonResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3a7a386cfc262b9fe0042e31483725e8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3a7a386cfc262b9fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe0042e31483725e8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UpdateBoundaryPolygonResponse * copy() { return new UpdateBoundaryPolygonResponse(*this); };

        /** assignment operator(s) */
        UpdateBoundaryPolygonResponse & operator=(const UpdateBoundaryPolygonResponse & inobj);
        /** equality operator */
        bool operator==(const UpdateBoundaryPolygonResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const UpdateBoundaryPolygonResponse & inobj) const;
        /** less than operator */
        bool operator<(const UpdateBoundaryPolygonResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UpdateBoundaryPolygonResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::UpdateBoundaryPolygonResponse>
    {
    public:
        static bool flat() {return frontier_exploration::UpdateBoundaryPolygonResponse::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::UpdateBoundaryPolygonResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::UpdateBoundaryPolygonResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::UpdateBoundaryPolygonResponse & value);

#endif  //  _FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGONRESPONSE_H_
