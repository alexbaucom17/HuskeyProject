...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGON_H_
#define _CODEGEN_FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGON_H_
...
PREDECLARE_BSON(frontier_exploration::UpdateBoundaryPolygon); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::UpdateBoundaryPolygon); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UpdateBoundaryPolygon & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        UpdateBoundaryPolygon(const UpdateBoundaryPolygon & inobj);
        /** destructor */
        ~UpdateBoundaryPolygon();

        /** allocator, convenience function for bind */
        static UpdateBoundaryPolygon * New();
        ...
        static const unsigned int ID = 185647711U;
        ...
        static const unsigned int DATA_VERSION = 985799073U;
        ...
        //        static const char * dataTypeName() { return "UpdateBoundaryPolygon"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a47101c1411b7374b5a8fb927dffcde7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa47101c1411b7374ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb5a8fb927dffcde7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UpdateBoundaryPolygon * copy() { return new UpdateBoundaryPolygon(*this); };

        /** assignment operator(s) */
        UpdateBoundaryPolygon & operator=(const UpdateBoundaryPolygon & inobj);
        /** equality operator */
        bool operator==(const UpdateBoundaryPolygon & inobj) const;
        /** inequality operator */
        bool operator!=(const UpdateBoundaryPolygon & inobj) const;
        /** less than operator */
        bool operator<(const UpdateBoundaryPolygon & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UpdateBoundaryPolygon & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::UpdateBoundaryPolygon>
    {
    public:
        static bool flat() {return frontier_exploration::UpdateBoundaryPolygon::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::UpdateBoundaryPolygon::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::UpdateBoundaryPolygon & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::UpdateBoundaryPolygon & value);

#endif  //  _FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGON_H_
