...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKRESULT_H_
#define _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKRESULT_H_
...
PREDECLARE_BSON(frontier_exploration::ExploreTaskResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::ExploreTaskResult); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ExploreTaskResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        ExploreTaskResult();
        /** copy constructor */
        ExploreTaskResult(const ExploreTaskResult & inobj);
        /** destructor */
        ~ExploreTaskResult();

        /** allocator, convenience function for bind */
        static ExploreTaskResult * New();
        ...
        static const unsigned int ID = 185647704U;
        ...
        static const unsigned int DATA_VERSION = 739702781U;
        ...
        //        static const char * dataTypeName() { return "ExploreTaskResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "48e046940d4c3f2bece04b523350cb0a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x48e046940d4c3f2bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xece04b523350cb0aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ExploreTaskResult * copy() { return new ExploreTaskResult(*this); };

        /** assignment operator(s) */
        ExploreTaskResult & operator=(const ExploreTaskResult & inobj);
        /** equality operator */
        bool operator==(const ExploreTaskResult & inobj) const;
        /** inequality operator */
        bool operator!=(const ExploreTaskResult & inobj) const;
        /** less than operator */
        bool operator<(const ExploreTaskResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ExploreTaskResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::ExploreTaskResult>
    {
    public:
        static bool flat() {return frontier_exploration::ExploreTaskResult::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::ExploreTaskResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::ExploreTaskResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::ExploreTaskResult & value);

#endif  //  _FRONTIER_EXPLORATION_EXPLORETASKRESULT_H_
