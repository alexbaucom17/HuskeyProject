...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKACTIONRESULT_H_
#define _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKACTIONRESULT_H_
...
PREDECLARE_BSON(frontier_exploration::ExploreTaskActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::ExploreTaskActionResult); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ExploreTaskActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        ExploreTaskActionResult(const ExploreTaskActionResult & inobj);
        /** destructor */
        ~ExploreTaskActionResult();

        /** allocator, convenience function for bind */
        static ExploreTaskActionResult * New();
        ...
        static const unsigned int ID = 185647701U;
        ...
        static const unsigned int DATA_VERSION = 1260128621U;
        ...
        //        static const char * dataTypeName() { return "ExploreTaskActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e6765e453399e56f45183f261a2aad55"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe6765e453399e56fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x45183f261a2aad55ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ExploreTaskActionResult * copy() { return new ExploreTaskActionResult(*this); };

        /** assignment operator(s) */
        ExploreTaskActionResult & operator=(const ExploreTaskActionResult & inobj);
        /** equality operator */
        bool operator==(const ExploreTaskActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const ExploreTaskActionResult & inobj) const;
        /** less than operator */
        bool operator<(const ExploreTaskActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ExploreTaskActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::ExploreTaskActionResult>
    {
    public:
        static bool flat() {return frontier_exploration::ExploreTaskActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::ExploreTaskActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::ExploreTaskActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::ExploreTaskActionResult & value);

#endif  //  _FRONTIER_EXPLORATION_EXPLORETASKACTIONRESULT_H_
