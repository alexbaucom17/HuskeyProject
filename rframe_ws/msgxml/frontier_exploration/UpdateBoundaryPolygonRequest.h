...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGONREQUEST_H_
#define _CODEGEN_FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGONREQUEST_H_
...
PREDECLARE_BSON(frontier_exploration::UpdateBoundaryPolygonRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::UpdateBoundaryPolygonRequest); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, UpdateBoundaryPolygonRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        UpdateBoundaryPolygonRequest(const UpdateBoundaryPolygonRequest & inobj);
        /** destructor */
        ~UpdateBoundaryPolygonRequest();

        /** allocator, convenience function for bind */
        static UpdateBoundaryPolygonRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        geometry_msgs::PolygonStamped  explore_boundary; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_EXPLORE_BOUNDARY,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 185647709U;
        ...
        static const unsigned int DATA_VERSION = 2412208929U;
        ...
        //        static const char * dataTypeName() { return "UpdateBoundaryPolygonRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "82f5db8661763d0d62ba1fad2cb74ffd"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x82f5db8661763d0dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x62ba1fad2cb74ffdULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        UpdateBoundaryPolygonRequest * copy() { return new UpdateBoundaryPolygonRequest(*this); };

        /** assignment operator(s) */
        UpdateBoundaryPolygonRequest & operator=(const UpdateBoundaryPolygonRequest & inobj);
        /** equality operator */
        bool operator==(const UpdateBoundaryPolygonRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const UpdateBoundaryPolygonRequest & inobj) const;
        /** less than operator */
        bool operator<(const UpdateBoundaryPolygonRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, UpdateBoundaryPolygonRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::UpdateBoundaryPolygonRequest>
    {
    public:
        static bool flat() {return frontier_exploration::UpdateBoundaryPolygonRequest::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::UpdateBoundaryPolygonRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::UpdateBoundaryPolygonRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::UpdateBoundaryPolygonRequest & value);

#endif  //  _FRONTIER_EXPLORATION_UPDATEBOUNDARYPOLYGONREQUEST_H_
