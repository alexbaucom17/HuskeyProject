...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKACTIONFEEDBACK_H_
#define _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKACTIONFEEDBACK_H_
...
PREDECLARE_BSON(frontier_exploration::ExploreTaskActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::ExploreTaskActionFeedback); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ExploreTaskActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        ExploreTaskActionFeedback(const ExploreTaskActionFeedback & inobj);
        /** destructor */
        ~ExploreTaskActionFeedback();

        /** allocator, convenience function for bind */
        static ExploreTaskActionFeedback * New();
        ...
        static const unsigned int ID = 185647699U;
        ...
        static const unsigned int DATA_VERSION = 1182433372U;
        ...
        //        static const char * dataTypeName() { return "ExploreTaskActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "213073a684ca791d2c812dc7be1cab64"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x213073a684ca791dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2c812dc7be1cab64ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ExploreTaskActionFeedback * copy() { return new ExploreTaskActionFeedback(*this); };

        /** assignment operator(s) */
        ExploreTaskActionFeedback & operator=(const ExploreTaskActionFeedback & inobj);
        /** equality operator */
        bool operator==(const ExploreTaskActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const ExploreTaskActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const ExploreTaskActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ExploreTaskActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::ExploreTaskActionFeedback>
    {
    public:
        static bool flat() {return frontier_exploration::ExploreTaskActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::ExploreTaskActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::ExploreTaskActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::ExploreTaskActionFeedback & value);

#endif  //  _FRONTIER_EXPLORATION_EXPLORETASKACTIONFEEDBACK_H_
