...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKACTIONGOAL_H_
#define _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKACTIONGOAL_H_
...
PREDECLARE_BSON(frontier_exploration::ExploreTaskActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::ExploreTaskActionGoal); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ExploreTaskActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        ExploreTaskActionGoal(const ExploreTaskActionGoal & inobj);
        /** destructor */
        ~ExploreTaskActionGoal();

        /** allocator, convenience function for bind */
        static ExploreTaskActionGoal * New();
        ...
        static const unsigned int ID = 185647700U;
        ...
        static const unsigned int DATA_VERSION = 492354513U;
        ...
        //        static const char * dataTypeName() { return "ExploreTaskActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b92ecad175d445f3df0aef1f897cec60"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb92ecad175d445f3ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdf0aef1f897cec60ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ExploreTaskActionGoal * copy() { return new ExploreTaskActionGoal(*this); };

        /** assignment operator(s) */
        ExploreTaskActionGoal & operator=(const ExploreTaskActionGoal & inobj);
        /** equality operator */
        bool operator==(const ExploreTaskActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const ExploreTaskActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const ExploreTaskActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ExploreTaskActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::ExploreTaskActionGoal>
    {
    public:
        static bool flat() {return frontier_exploration::ExploreTaskActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::ExploreTaskActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::ExploreTaskActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::ExploreTaskActionGoal & value);

#endif  //  _FRONTIER_EXPLORATION_EXPLORETASKACTIONGOAL_H_
