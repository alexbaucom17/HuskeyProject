...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKGOAL_H_
#define _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKGOAL_H_
...
PREDECLARE_BSON(frontier_exploration::ExploreTaskGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::ExploreTaskGoal); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ExploreTaskGoal & inobj);   

    /** 
        \ingroup CodeGen
        ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ====== Boundary for frontier exploration
    */
    class ExploreTaskGoal
    {
    public: 
        ...
        ExploreTaskGoal();
        /** copy constructor */
        ExploreTaskGoal(const ExploreTaskGoal & inobj);
        /** destructor */
        ~ExploreTaskGoal();

        /** allocator, convenience function for bind */
        static ExploreTaskGoal * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        geometry_msgs::PolygonStamped  explore_boundary; /**< Center point for frontier exploration, inside explore_boundary */
        ...
        static const unsigned int ID = 185647703U;
        ...
        static const unsigned int DATA_VERSION = 1856169828U;
        ...
        //        static const char * dataTypeName() { return "ExploreTaskGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "faa53c366dbef2cd95df0f774c218d5a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfaa53c366dbef2cdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x95df0f774c218d5aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ExploreTaskGoal * copy() { return new ExploreTaskGoal(*this); };

        /** assignment operator(s) */
        ExploreTaskGoal & operator=(const ExploreTaskGoal & inobj);
        /** equality operator */
        bool operator==(const ExploreTaskGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const ExploreTaskGoal & inobj) const;
        /** less than operator */
        bool operator<(const ExploreTaskGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ExploreTaskGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::ExploreTaskGoal>
    {
    public:
        static bool flat() {return frontier_exploration::ExploreTaskGoal::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::ExploreTaskGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::ExploreTaskGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::ExploreTaskGoal & value);

#endif  //  _FRONTIER_EXPLORATION_EXPLORETASKGOAL_H_
