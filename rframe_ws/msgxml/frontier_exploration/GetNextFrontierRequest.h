...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_GETNEXTFRONTIERREQUEST_H_
#define _CODEGEN_FRONTIER_EXPLORATION_GETNEXTFRONTIERREQUEST_H_
...
PREDECLARE_BSON(frontier_exploration::GetNextFrontierRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::GetNextFrontierRequest); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetNextFrontierRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetNextFrontierRequest(const GetNextFrontierRequest & inobj);
        /** destructor */
        ~GetNextFrontierRequest();

        /** allocator, convenience function for bind */
        static GetNextFrontierRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        geometry_msgs::PoseStamped  start_pose; /**< no comment provided */
        ...
        static const unsigned int ID = 185647706U;
        ...
        static const unsigned int DATA_VERSION = 3392350835U;
        ...
        //        static const char * dataTypeName() { return "GetNextFrontierRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "00c4624cf2640ff160dee0c0258a0487"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x00c4624cf2640ff1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x60dee0c0258a0487ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetNextFrontierRequest * copy() { return new GetNextFrontierRequest(*this); };

        /** assignment operator(s) */
        GetNextFrontierRequest & operator=(const GetNextFrontierRequest & inobj);
        /** equality operator */
        bool operator==(const GetNextFrontierRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetNextFrontierRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetNextFrontierRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetNextFrontierRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::GetNextFrontierRequest>
    {
    public:
        static bool flat() {return frontier_exploration::GetNextFrontierRequest::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::GetNextFrontierRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::GetNextFrontierRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::GetNextFrontierRequest & value);

#endif  //  _FRONTIER_EXPLORATION_GETNEXTFRONTIERREQUEST_H_
