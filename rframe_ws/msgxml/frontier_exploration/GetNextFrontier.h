...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_GETNEXTFRONTIER_H_
#define _CODEGEN_FRONTIER_EXPLORATION_GETNEXTFRONTIER_H_
...
PREDECLARE_BSON(frontier_exploration::GetNextFrontier); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::GetNextFrontier); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetNextFrontier & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetNextFrontier();
        /** copy constructor */
        GetNextFrontier(const GetNextFrontier & inobj);
        /** destructor */
        ~GetNextFrontier();

        /** allocator, convenience function for bind */
        static GetNextFrontier * New();
        ...
        static const unsigned int ID = 185647708U;
        ...
        static const unsigned int DATA_VERSION = 2275476623U;
        ...
        //        static const char * dataTypeName() { return "GetNextFrontier"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7d89dc3d1c1e4ae1b9754b0cee67b593"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7d89dc3d1c1e4ae1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb9754b0cee67b593ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetNextFrontier * copy() { return new GetNextFrontier(*this); };

        /** assignment operator(s) */
        GetNextFrontier & operator=(const GetNextFrontier & inobj);
        /** equality operator */
        bool operator==(const GetNextFrontier & inobj) const;
        /** inequality operator */
        bool operator!=(const GetNextFrontier & inobj) const;
        /** less than operator */
        bool operator<(const GetNextFrontier & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetNextFrontier & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::GetNextFrontier>
    {
    public:
        static bool flat() {return frontier_exploration::GetNextFrontier::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::GetNextFrontier::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::GetNextFrontier & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::GetNextFrontier & value);

#endif  //  _FRONTIER_EXPLORATION_GETNEXTFRONTIER_H_
