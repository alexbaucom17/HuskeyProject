...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKFEEDBACK_H_
#define _CODEGEN_FRONTIER_EXPLORATION_EXPLORETASKFEEDBACK_H_
...
PREDECLARE_BSON(frontier_exploration::ExploreTaskFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::ExploreTaskFeedback); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ExploreTaskFeedback & inobj);   

    /** 
        \ingroup CodeGen
        ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ====== Current target frontier to explore
    */
    class ExploreTaskFeedback
    {
    public: 
        ...
        ExploreTaskFeedback();
        /** copy constructor */
        ExploreTaskFeedback(const ExploreTaskFeedback & inobj);
        /** destructor */
        ~ExploreTaskFeedback();

        /** allocator, convenience function for bind */
        static ExploreTaskFeedback * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        geometry_msgs::PoseStamped  next_frontier; /**< Current position of robot */
        ...
        static const unsigned int ID = 185647702U;
        ...
        static const unsigned int DATA_VERSION = 2012734448U;
        ...
        //        static const char * dataTypeName() { return "ExploreTaskFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "439402334bbf0a0f095dab09fbed97b8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x439402334bbf0a0fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x095dab09fbed97b8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ExploreTaskFeedback * copy() { return new ExploreTaskFeedback(*this); };

        /** assignment operator(s) */
        ExploreTaskFeedback & operator=(const ExploreTaskFeedback & inobj);
        /** equality operator */
        bool operator==(const ExploreTaskFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const ExploreTaskFeedback & inobj) const;
        /** less than operator */
        bool operator<(const ExploreTaskFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ExploreTaskFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::ExploreTaskFeedback>
    {
    public:
        static bool flat() {return frontier_exploration::ExploreTaskFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::ExploreTaskFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::ExploreTaskFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::ExploreTaskFeedback & value);

#endif  //  _FRONTIER_EXPLORATION_EXPLORETASKFEEDBACK_H_
