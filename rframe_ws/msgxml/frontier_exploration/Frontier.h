...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_FRONTIER_H_
#define _CODEGEN_FRONTIER_EXPLORATION_FRONTIER_H_
...
PREDECLARE_BSON(frontier_exploration::Frontier); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::Frontier); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Frontier & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 185647705U;
        ...
        static const unsigned int DATA_VERSION = 2086652125U;
        ...
        //        static const char * dataTypeName() { return "Frontier"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2be887befc2974c592665a9fa3f2ac59"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2be887befc2974c5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x92665a9fa3f2ac59ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Frontier * copy() { return new Frontier(*this); };

        /** assignment operator(s) */
        Frontier & operator=(const Frontier & inobj);
        /** equality operator */
        bool operator==(const Frontier & inobj) const;
        /** inequality operator */
        bool operator!=(const Frontier & inobj) const;
        /** less than operator */
        bool operator<(const Frontier & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Frontier & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::Frontier>
    {
    public:
        static bool flat() {return frontier_exploration::Frontier::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::Frontier::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::Frontier & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::Frontier & value);

#endif  //  _FRONTIER_EXPLORATION_FRONTIER_H_
