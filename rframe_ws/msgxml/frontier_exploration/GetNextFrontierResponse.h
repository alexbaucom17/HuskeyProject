...
#ifndef _CODEGEN_FRONTIER_EXPLORATION_GETNEXTFRONTIERRESPONSE_H_
#define _CODEGEN_FRONTIER_EXPLORATION_GETNEXTFRONTIERRESPONSE_H_
...
PREDECLARE_BSON(frontier_exploration::GetNextFrontierResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(frontier_exploration::GetNextFrontierResponse); // see Common.h, macro used for a cleaner header

namespace frontier_exploration
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetNextFrontierResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetNextFrontierResponse(const GetNextFrontierResponse & inobj);
        /** destructor */
        ~GetNextFrontierResponse();

        /** allocator, convenience function for bind */
        static GetNextFrontierResponse * New();
        ...
        static const unsigned int ID = 185647707U;
        ...
        static const unsigned int DATA_VERSION = 2393184974U;
        ...
        //        static const char * dataTypeName() { return "GetNextFrontierResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8d1489add07220769f6a55842564f0b9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8d1489add0722076ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9f6a55842564f0b9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetNextFrontierResponse * copy() { return new GetNextFrontierResponse(*this); };

        /** assignment operator(s) */
        GetNextFrontierResponse & operator=(const GetNextFrontierResponse & inobj);
        /** equality operator */
        bool operator==(const GetNextFrontierResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetNextFrontierResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetNextFrontierResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetNextFrontierResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<frontier_exploration::GetNextFrontierResponse>
    {
    public:
        static bool flat() {return frontier_exploration::GetNextFrontierResponse::dataTypeFlat(); };
        static std::string sourceXML() {return frontier_exploration::GetNextFrontierResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const frontier_exploration::GetNextFrontierResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const frontier_exploration::GetNextFrontierResponse & value);

#endif  //  _FRONTIER_EXPLORATION_GETNEXTFRONTIERRESPONSE_H_
