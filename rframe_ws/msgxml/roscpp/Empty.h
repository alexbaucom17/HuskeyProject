...
#ifndef _CODEGEN_ROSCPP_EMPTY_H_
#define _CODEGEN_ROSCPP_EMPTY_H_
...
PREDECLARE_BSON(roscpp::Empty); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::Empty); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1381512809U;
        ...
        static const unsigned int DATA_VERSION = 2496720037U;
        ...
        */
        ...
        static const std::string versionMD5() { return "f66b765c11a33908105d5f560b7088fe"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf66b765c11a33908ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x105d5f560b7088feULL;
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::Empty>
    {
    public:
        static bool flat() {return roscpp::Empty::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::Empty::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::Empty & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::Empty & value);

#endif  //  _ROSCPP_EMPTY_H_
