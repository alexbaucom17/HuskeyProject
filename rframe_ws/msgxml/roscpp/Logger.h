...
#ifndef _CODEGEN_ROSCPP_LOGGER_H_
#define _CODEGEN_ROSCPP_LOGGER_H_
...
PREDECLARE_BSON(roscpp::Logger); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::Logger); // see Common.h, macro used for a cleaner header

namespace roscpp
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Logger & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1381512806U;
        ...
        static const unsigned int DATA_VERSION = 460322512U;
        ...
        //        static const char * dataTypeName() { return "Logger"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a8ffe4682410ddde9117664d862cdf9e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa8ffe4682410dddeULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9117664d862cdf9eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Logger * copy() { return new Logger(*this); };

        /** assignment operator(s) */
        Logger & operator=(const Logger & inobj);
        /** equality operator */
        bool operator==(const Logger & inobj) const;
        /** inequality operator */
        bool operator!=(const Logger & inobj) const;
        /** less than operator */
        bool operator<(const Logger & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Logger & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::Logger>
    {
    public:
        static bool flat() {return roscpp::Logger::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::Logger::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::Logger & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::Logger & value);

#endif  //  _ROSCPP_LOGGER_H_
