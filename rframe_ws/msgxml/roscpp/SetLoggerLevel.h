...
#ifndef _CODEGEN_ROSCPP_SETLOGGERLEVEL_H_
#define _CODEGEN_ROSCPP_SETLOGGERLEVEL_H_
...
PREDECLARE_BSON(roscpp::SetLoggerLevel); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::SetLoggerLevel); // see Common.h, macro used for a cleaner header

namespace roscpp
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetLoggerLevel & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetLoggerLevel();
        /** copy constructor */
        SetLoggerLevel(const SetLoggerLevel & inobj);
        /** destructor */
        ~SetLoggerLevel();

        /** allocator, convenience function for bind */
        static SetLoggerLevel * New();
        ...
        static const unsigned int ID = 1381512815U;
        ...
        static const unsigned int DATA_VERSION = 2856723118U;
        ...
        //        static const char * dataTypeName() { return "SetLoggerLevel"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "93b429d4af7565fd69f1797623310047"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x93b429d4af7565fdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x69f1797623310047ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetLoggerLevel * copy() { return new SetLoggerLevel(*this); };

        /** assignment operator(s) */
        SetLoggerLevel & operator=(const SetLoggerLevel & inobj);
        /** equality operator */
        bool operator==(const SetLoggerLevel & inobj) const;
        /** inequality operator */
        bool operator!=(const SetLoggerLevel & inobj) const;
        /** less than operator */
        bool operator<(const SetLoggerLevel & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetLoggerLevel & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::SetLoggerLevel>
    {
    public:
        static bool flat() {return roscpp::SetLoggerLevel::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::SetLoggerLevel::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::SetLoggerLevel & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::SetLoggerLevel & value);

#endif  //  _ROSCPP_SETLOGGERLEVEL_H_
