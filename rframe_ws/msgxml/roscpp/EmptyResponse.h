...
#ifndef _CODEGEN_ROSCPP_EMPTYRESPONSE_H_
#define _CODEGEN_ROSCPP_EMPTYRESPONSE_H_
...
PREDECLARE_BSON(roscpp::EmptyResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::EmptyResponse); // see Common.h, macro used for a cleaner header

namespace roscpp
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, EmptyResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        EmptyResponse();
        /** copy constructor */
        EmptyResponse(const EmptyResponse & inobj);
        /** destructor */
        ~EmptyResponse();

        /** allocator, convenience function for bind */
        static EmptyResponse * New();
        ...
        static const unsigned int ID = 1381512808U;
        ...
        static const unsigned int DATA_VERSION = 4140137097U;
        ...
        //        static const char * dataTypeName() { return "EmptyResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "10f6a8500e9280d1ae0e5c86db3a0c30"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x10f6a8500e9280d1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xae0e5c86db3a0c30ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        EmptyResponse * copy() { return new EmptyResponse(*this); };

        /** assignment operator(s) */
        EmptyResponse & operator=(const EmptyResponse & inobj);
        /** equality operator */
        bool operator==(const EmptyResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const EmptyResponse & inobj) const;
        /** less than operator */
        bool operator<(const EmptyResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, EmptyResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::EmptyResponse>
    {
    public:
        static bool flat() {return roscpp::EmptyResponse::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::EmptyResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::EmptyResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::EmptyResponse & value);

#endif  //  _ROSCPP_EMPTYRESPONSE_H_
