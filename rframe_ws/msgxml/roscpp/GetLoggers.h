...
#ifndef _CODEGEN_ROSCPP_GETLOGGERS_H_
#define _CODEGEN_ROSCPP_GETLOGGERS_H_
...
PREDECLARE_BSON(roscpp::GetLoggers); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::GetLoggers); // see Common.h, macro used for a cleaner header

namespace roscpp
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLoggers & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetLoggers();
        /** copy constructor */
        GetLoggers(const GetLoggers & inobj);
        /** destructor */
        ~GetLoggers();

        /** allocator, convenience function for bind */
        static GetLoggers * New();
        ...
        static const unsigned int ID = 1381512812U;
        ...
        static const unsigned int DATA_VERSION = 1770928788U;
        ...
        //        static const char * dataTypeName() { return "GetLoggers"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "aeeed0905c51306b7912417ffbc1c7a4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xaeeed0905c51306bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7912417ffbc1c7a4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLoggers * copy() { return new GetLoggers(*this); };

        /** assignment operator(s) */
        GetLoggers & operator=(const GetLoggers & inobj);
        /** equality operator */
        bool operator==(const GetLoggers & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLoggers & inobj) const;
        /** less than operator */
        bool operator<(const GetLoggers & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLoggers & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::GetLoggers>
    {
    public:
        static bool flat() {return roscpp::GetLoggers::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::GetLoggers::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::GetLoggers & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::GetLoggers & value);

#endif  //  _ROSCPP_GETLOGGERS_H_
