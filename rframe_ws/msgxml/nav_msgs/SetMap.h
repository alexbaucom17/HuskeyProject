...
#ifndef _CODEGEN_NAV_MSGS_SETMAP_H_
#define _CODEGEN_NAV_MSGS_SETMAP_H_
...
PREDECLARE_BSON(nav_msgs::SetMap); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::SetMap); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetMap & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1589304806U;
        ...
        static const unsigned int DATA_VERSION = 3184627463U;
        ...
        //        static const char * dataTypeName() { return "SetMap"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e484a769e99a20063fc32e093d64a5ec"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe484a769e99a2006ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3fc32e093d64a5ecULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetMap * copy() { return new SetMap(*this); };

        /** assignment operator(s) */
        SetMap & operator=(const SetMap & inobj);
        /** equality operator */
        bool operator==(const SetMap & inobj) const;
        /** inequality operator */
        bool operator!=(const SetMap & inobj) const;
        /** less than operator */
        bool operator<(const SetMap & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetMap & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::SetMap>
    {
    public:
        static bool flat() {return nav_msgs::SetMap::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::SetMap::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::SetMap & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::SetMap & value);

#endif  //  _NAV_MSGS_SETMAP_H_
