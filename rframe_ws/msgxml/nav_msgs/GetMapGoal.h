...
#ifndef _CODEGEN_NAV_MSGS_GETMAPGOAL_H_
#define _CODEGEN_NAV_MSGS_GETMAPGOAL_H_
...
PREDECLARE_BSON(nav_msgs::GetMapGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMapGoal); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapGoal();
        /** copy constructor */
        GetMapGoal(const GetMapGoal & inobj);
        /** destructor */
        ~GetMapGoal();

        /** allocator, convenience function for bind */
        static GetMapGoal * New();
        ...
        static const unsigned int ID = 1589304791U;
        ...
        static const unsigned int DATA_VERSION = 1307239193U;
        ...
        //        static const char * dataTypeName() { return "GetMapGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "790b61c662175e1b51d14f8724391020"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x790b61c662175e1bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x51d14f8724391020ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapGoal * copy() { return new GetMapGoal(*this); };

        /** assignment operator(s) */
        GetMapGoal & operator=(const GetMapGoal & inobj);
        /** equality operator */
        bool operator==(const GetMapGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapGoal & inobj) const;
        /** less than operator */
        bool operator<(const GetMapGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMapGoal>
    {
    public:
        static bool flat() {return nav_msgs::GetMapGoal::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMapGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMapGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMapGoal & value);

#endif  //  _NAV_MSGS_GETMAPGOAL_H_
