...
#ifndef _CODEGEN_NAV_MSGS_GETMAPRESPONSE_H_
#define _CODEGEN_NAV_MSGS_GETMAPRESPONSE_H_
...
PREDECLARE_BSON(nav_msgs::GetMapResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMapResponse); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapResponse();
        /** copy constructor */
        GetMapResponse(const GetMapResponse & inobj);
        /** destructor */
        ~GetMapResponse();

        /** allocator, convenience function for bind */
        static GetMapResponse * New();
        ...
        static const unsigned int ID = 1589304799U;
        ...
        static const unsigned int DATA_VERSION = 2605621605U;
        ...
        //        static const char * dataTypeName() { return "GetMapResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b93d28c07b54e994c2e035cf43fd9889"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb93d28c07b54e994ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc2e035cf43fd9889ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapResponse * copy() { return new GetMapResponse(*this); };

        /** assignment operator(s) */
        GetMapResponse & operator=(const GetMapResponse & inobj);
        /** equality operator */
        bool operator==(const GetMapResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetMapResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMapResponse>
    {
    public:
        static bool flat() {return nav_msgs::GetMapResponse::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMapResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMapResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMapResponse & value);

#endif  //  _NAV_MSGS_GETMAPRESPONSE_H_
