...
#ifndef _CODEGEN_NAV_MSGS_GETMAPFEEDBACK_H_
#define _CODEGEN_NAV_MSGS_GETMAPFEEDBACK_H_
...
PREDECLARE_BSON(nav_msgs::GetMapFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMapFeedback); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapFeedback();
        /** copy constructor */
        GetMapFeedback(const GetMapFeedback & inobj);
        /** destructor */
        ~GetMapFeedback();

        /** allocator, convenience function for bind */
        static GetMapFeedback * New();
        ...
        static const unsigned int ID = 1589304790U;
        ...
        static const unsigned int DATA_VERSION = 742881280U;
        ...
        //        static const char * dataTypeName() { return "GetMapFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "faa79c2af8351a491f991c051116a0de"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfaa79c2af8351a49ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1f991c051116a0deULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapFeedback * copy() { return new GetMapFeedback(*this); };

        /** assignment operator(s) */
        GetMapFeedback & operator=(const GetMapFeedback & inobj);
        /** equality operator */
        bool operator==(const GetMapFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapFeedback & inobj) const;
        /** less than operator */
        bool operator<(const GetMapFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMapFeedback>
    {
    public:
        static bool flat() {return nav_msgs::GetMapFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMapFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMapFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMapFeedback & value);

#endif  //  _NAV_MSGS_GETMAPFEEDBACK_H_
