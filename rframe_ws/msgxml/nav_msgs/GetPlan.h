...
#ifndef _CODEGEN_NAV_MSGS_GETPLAN_H_
#define _CODEGEN_NAV_MSGS_GETPLAN_H_
...
PREDECLARE_BSON(nav_msgs::GetPlan); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetPlan); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPlan & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1589304803U;
        ...
        static const unsigned int DATA_VERSION = 3967838376U;
        ...
        //        static const char * dataTypeName() { return "GetPlan"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6ed56cc3294ece144a474e618c76a1d5"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6ed56cc3294ece14ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4a474e618c76a1d5ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPlan * copy() { return new GetPlan(*this); };

        /** assignment operator(s) */
        GetPlan & operator=(const GetPlan & inobj);
        /** equality operator */
        bool operator==(const GetPlan & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPlan & inobj) const;
        /** less than operator */
        bool operator<(const GetPlan & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPlan & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetPlan>
    {
    public:
        static bool flat() {return nav_msgs::GetPlan::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetPlan::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetPlan & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetPlan & value);

#endif  //  _NAV_MSGS_GETPLAN_H_
