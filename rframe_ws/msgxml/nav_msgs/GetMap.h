...
#ifndef _CODEGEN_NAV_MSGS_GETMAP_H_
#define _CODEGEN_NAV_MSGS_GETMAP_H_
...
PREDECLARE_BSON(nav_msgs::GetMap); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMap); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMap & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1589304800U;
        ...
        static const unsigned int DATA_VERSION = 411563015U;
        ...
        //        static const char * dataTypeName() { return "GetMap"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8dc075210b5f8fedf3dd78ea2b5d22ff"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8dc075210b5f8fedULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf3dd78ea2b5d22ffULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMap * copy() { return new GetMap(*this); };

        /** assignment operator(s) */
        GetMap & operator=(const GetMap & inobj);
        /** equality operator */
        bool operator==(const GetMap & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMap & inobj) const;
        /** less than operator */
        bool operator<(const GetMap & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMap & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMap>
    {
    public:
        static bool flat() {return nav_msgs::GetMap::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMap::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMap & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMap & value);

#endif  //  _NAV_MSGS_GETMAP_H_
