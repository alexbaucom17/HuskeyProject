...
#ifndef _CODEGEN_NAV_MSGS_ODOMETRY_H_
#define _CODEGEN_NAV_MSGS_ODOMETRY_H_
...
PREDECLARE_BSON(nav_msgs::Odometry); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::Odometry); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Odometry & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1589304796U;
        ...
        static const unsigned int DATA_VERSION = 3457727603U;
        ...
        //        static const char * dataTypeName() { return "Odometry"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ed41cd268373a0a1f47c2d1ae26968c0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xed41cd268373a0a1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf47c2d1ae26968c0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Odometry * copy() { return new Odometry(*this); };

        /** assignment operator(s) */
        Odometry & operator=(const Odometry & inobj);
        /** equality operator */
        bool operator==(const Odometry & inobj) const;
        /** inequality operator */
        bool operator!=(const Odometry & inobj) const;
        /** less than operator */
        bool operator<(const Odometry & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Odometry & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::Odometry>
    {
    public:
        static bool flat() {return nav_msgs::Odometry::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::Odometry::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::Odometry & value);
