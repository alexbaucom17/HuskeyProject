...
#ifndef _CODEGEN_NAV_MSGS_MAPMETADATA_H_
#define _CODEGEN_NAV_MSGS_MAPMETADATA_H_
...
PREDECLARE_BSON(nav_msgs::MapMetaData); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::MapMetaData); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MapMetaData & inobj);   
    ...
    */
    ...
    public: 
        ...
        MapMetaData();
        /** copy constructor */
        MapMetaData(const MapMetaData & inobj);
        /** destructor */
        ~MapMetaData();

        /** allocator, convenience function for bind */
        static MapMetaData * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::RosTime  map_load_time; /**< The map resolution [m/cell] */
        float  resolution; /**< Map width [cells] */
        unsigned int  width; /**< Map height [cells] */
        unsigned int  height; /**< The origin of the map [m, m, rad].  This is the real-world pose of the  cell (0,0) in the map. */
        ...
        static const unsigned int ID = 1589304794U;
        ...
        static const unsigned int DATA_VERSION = 4253777953U;
        ...
        //        static const char * dataTypeName() { return "MapMetaData"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "67a0cdc04e6f26dcd6835621489078a4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x67a0cdc04e6f26dcULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd6835621489078a4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MapMetaData * copy() { return new MapMetaData(*this); };

        /** assignment operator(s) */
        MapMetaData & operator=(const MapMetaData & inobj);
        /** equality operator */
        bool operator==(const MapMetaData & inobj) const;
        /** inequality operator */
        bool operator!=(const MapMetaData & inobj) const;
        /** less than operator */
        bool operator<(const MapMetaData & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MapMetaData & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::MapMetaData>
    {
    public:
        static bool flat() {return nav_msgs::MapMetaData::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::MapMetaData::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::MapMetaData & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::MapMetaData & value);

#endif  //  _NAV_MSGS_MAPMETADATA_H_
