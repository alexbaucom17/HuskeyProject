...
#ifndef _CODEGEN_NAV_MSGS_SETMAPREQUEST_H_
#define _CODEGEN_NAV_MSGS_SETMAPREQUEST_H_
...
PREDECLARE_BSON(nav_msgs::SetMapRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::SetMapRequest); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetMapRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetMapRequest();
        /** copy constructor */
        SetMapRequest(const SetMapRequest & inobj);
        /** destructor */
        ~SetMapRequest();

        /** allocator, convenience function for bind */
        static SetMapRequest * New();
        ...
        geometry_msgs::PoseWithCovarianceStamped  initial_pose; /**< no comment provided */
        ...
        static const unsigned int ID = 1589304804U;
        ...
        static const unsigned int DATA_VERSION = 2658804564U;
        ...
        //        static const char * dataTypeName() { return "SetMapRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1c22520fc679fcc1c526725427ec2959"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1c22520fc679fcc1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc526725427ec2959ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetMapRequest * copy() { return new SetMapRequest(*this); };

        /** assignment operator(s) */
        SetMapRequest & operator=(const SetMapRequest & inobj);
        /** equality operator */
        bool operator==(const SetMapRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetMapRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetMapRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetMapRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::SetMapRequest>
    {
    public:
        static bool flat() {return nav_msgs::SetMapRequest::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::SetMapRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::SetMapRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::SetMapRequest & value);

#endif  //  _NAV_MSGS_SETMAPREQUEST_H_
