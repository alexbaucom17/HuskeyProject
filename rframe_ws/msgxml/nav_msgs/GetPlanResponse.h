...
#ifndef _CODEGEN_NAV_MSGS_GETPLANRESPONSE_H_
#define _CODEGEN_NAV_MSGS_GETPLANRESPONSE_H_
...
PREDECLARE_BSON(nav_msgs::GetPlanResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetPlanResponse); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPlanResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetPlanResponse();
        /** copy constructor */
        GetPlanResponse(const GetPlanResponse & inobj);
        /** destructor */
        ~GetPlanResponse();

        /** allocator, convenience function for bind */
        static GetPlanResponse * New();
        ...
        static const unsigned int ID = 1589304802U;
        ...
        static const unsigned int DATA_VERSION = 1046636832U;
        ...
        //        static const char * dataTypeName() { return "GetPlanResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "03fe331a5e73317acfb01c29ccc6eea3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x03fe331a5e73317aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcfb01c29ccc6eea3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPlanResponse * copy() { return new GetPlanResponse(*this); };

        /** assignment operator(s) */
        GetPlanResponse & operator=(const GetPlanResponse & inobj);
        /** equality operator */
        bool operator==(const GetPlanResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPlanResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetPlanResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPlanResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetPlanResponse>
    {
    public:
        static bool flat() {return nav_msgs::GetPlanResponse::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetPlanResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetPlanResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetPlanResponse & value);

#endif  //  _NAV_MSGS_GETPLANRESPONSE_H_
