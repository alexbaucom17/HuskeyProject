...
#ifndef _CODEGEN_NAV_MSGS_GETMAPACTIONRESULT_H_
#define _CODEGEN_NAV_MSGS_GETMAPACTIONRESULT_H_
...
PREDECLARE_BSON(nav_msgs::GetMapActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMapActionResult); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapActionResult();
        /** copy constructor */
        GetMapActionResult(const GetMapActionResult & inobj);
        /** destructor */
        ~GetMapActionResult();

        /** allocator, convenience function for bind */
        static GetMapActionResult * New();
        ...
        static const unsigned int ID = 1589304789U;
        ...
        static const unsigned int DATA_VERSION = 1803900308U;
        ...
        //        static const char * dataTypeName() { return "GetMapActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "67ba2582fdddec9b8228109b6326d6a7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x67ba2582fdddec9bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8228109b6326d6a7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapActionResult * copy() { return new GetMapActionResult(*this); };

        /** assignment operator(s) */
        GetMapActionResult & operator=(const GetMapActionResult & inobj);
        /** equality operator */
        bool operator==(const GetMapActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapActionResult & inobj) const;
        /** less than operator */
        bool operator<(const GetMapActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMapActionResult>
    {
    public:
        static bool flat() {return nav_msgs::GetMapActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMapActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMapActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMapActionResult & value);

#endif  //  _NAV_MSGS_GETMAPACTIONRESULT_H_
