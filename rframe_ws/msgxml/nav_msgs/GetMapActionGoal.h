...
#ifndef _CODEGEN_NAV_MSGS_GETMAPACTIONGOAL_H_
#define _CODEGEN_NAV_MSGS_GETMAPACTIONGOAL_H_
...
PREDECLARE_BSON(nav_msgs::GetMapActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMapActionGoal); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapActionGoal();
        /** copy constructor */
        GetMapActionGoal(const GetMapActionGoal & inobj);
        /** destructor */
        ~GetMapActionGoal();

        /** allocator, convenience function for bind */
        static GetMapActionGoal * New();
        ...
        static const unsigned int ID = 1589304788U;
        ...
        static const unsigned int DATA_VERSION = 241153944U;
        ...
        //        static const char * dataTypeName() { return "GetMapActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d6cb1dc007f46a5c3245578d2f24eaed"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd6cb1dc007f46a5cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3245578d2f24eaedULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapActionGoal * copy() { return new GetMapActionGoal(*this); };

        /** assignment operator(s) */
        GetMapActionGoal & operator=(const GetMapActionGoal & inobj);
        /** equality operator */
        bool operator==(const GetMapActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const GetMapActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMapActionGoal>
    {
    public:
        static bool flat() {return nav_msgs::GetMapActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMapActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMapActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMapActionGoal & value);

#endif  //  _NAV_MSGS_GETMAPACTIONGOAL_H_
