...
#ifndef _CODEGEN_NAV_MSGS_GETMAPREQUEST_H_
#define _CODEGEN_NAV_MSGS_GETMAPREQUEST_H_
...
PREDECLARE_BSON(nav_msgs::GetMapRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMapRequest); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapRequest();
        /** copy constructor */
        GetMapRequest(const GetMapRequest & inobj);
        /** destructor */
        ~GetMapRequest();

        /** allocator, convenience function for bind */
        static GetMapRequest * New();
        ...
        static const unsigned int ID = 1589304798U;
        ...
        static const unsigned int DATA_VERSION = 507475721U;
        ...
        //        static const char * dataTypeName() { return "GetMapRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "924bf6ce972d947a0fe46d2ab25f30b9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x924bf6ce972d947aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0fe46d2ab25f30b9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapRequest * copy() { return new GetMapRequest(*this); };

        /** assignment operator(s) */
        GetMapRequest & operator=(const GetMapRequest & inobj);
        /** equality operator */
        bool operator==(const GetMapRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetMapRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMapRequest>
    {
    public:
        static bool flat() {return nav_msgs::GetMapRequest::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMapRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMapRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMapRequest & value);

#endif  //  _NAV_MSGS_GETMAPREQUEST_H_
