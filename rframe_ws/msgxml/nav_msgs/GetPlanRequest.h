...
#ifndef _CODEGEN_NAV_MSGS_GETPLANREQUEST_H_
#define _CODEGEN_NAV_MSGS_GETPLANREQUEST_H_
...
PREDECLARE_BSON(nav_msgs::GetPlanRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetPlanRequest); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPlanRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetPlanRequest();
        /** copy constructor */
        GetPlanRequest(const GetPlanRequest & inobj);
        /** destructor */
        ~GetPlanRequest();

        /** allocator, convenience function for bind */
        static GetPlanRequest * New();
        ...
        geometry_msgs::PoseStamped  goal; /**< If the goal is obstructed, how many meters the planner can   relax the constraint in x and y before failing. */
        float  tolerance; /**< no comment provided */
        ...
        static const unsigned int ID = 1589304801U;
        ...
        static const unsigned int DATA_VERSION = 1288303782U;
        ...
        //        static const char * dataTypeName() { return "GetPlanRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "518ab4189fa706f3dafc9876b66cd42f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x518ab4189fa706f3ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdafc9876b66cd42fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPlanRequest * copy() { return new GetPlanRequest(*this); };

        /** assignment operator(s) */
        GetPlanRequest & operator=(const GetPlanRequest & inobj);
        /** equality operator */
        bool operator==(const GetPlanRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPlanRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetPlanRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPlanRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetPlanRequest>
    {
    public:
        static bool flat() {return nav_msgs::GetPlanRequest::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetPlanRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetPlanRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetPlanRequest & value);

#endif  //  _NAV_MSGS_GETPLANREQUEST_H_
