...
#ifndef _CODEGEN_NAV_MSGS_GETMAPACTIONFEEDBACK_H_
#define _CODEGEN_NAV_MSGS_GETMAPACTIONFEEDBACK_H_
...
PREDECLARE_BSON(nav_msgs::GetMapActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMapActionFeedback); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetMapActionFeedback(const GetMapActionFeedback & inobj);
        /** destructor */
        ~GetMapActionFeedback();

        /** allocator, convenience function for bind */
        static GetMapActionFeedback * New();
        ...
        static const unsigned int ID = 1589304787U;
        ...
        static const unsigned int DATA_VERSION = 4107910808U;
        ...
        //        static const char * dataTypeName() { return "GetMapActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1e5f55dab772f1b9e6db1cce667549ba"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1e5f55dab772f1b9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe6db1cce667549baULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapActionFeedback * copy() { return new GetMapActionFeedback(*this); };

        /** assignment operator(s) */
        GetMapActionFeedback & operator=(const GetMapActionFeedback & inobj);
        /** equality operator */
        bool operator==(const GetMapActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const GetMapActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMapActionFeedback>
    {
    public:
        static bool flat() {return nav_msgs::GetMapActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMapActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMapActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMapActionFeedback & value);

#endif  //  _NAV_MSGS_GETMAPACTIONFEEDBACK_H_
