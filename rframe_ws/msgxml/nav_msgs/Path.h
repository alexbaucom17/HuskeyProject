...
#ifndef _CODEGEN_NAV_MSGS_PATH_H_
#define _CODEGEN_NAV_MSGS_PATH_H_
...
PREDECLARE_BSON(nav_msgs::Path); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::Path); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Path & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1589304797U;
        ...
        static const unsigned int DATA_VERSION = 2885145944U;
        ...
        //        static const char * dataTypeName() { return "Path"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7fec5c1e8c47bcd37af1e94dc675db4a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7fec5c1e8c47bcd3ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7af1e94dc675db4aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Path * copy() { return new Path(*this); };

        /** assignment operator(s) */
        Path & operator=(const Path & inobj);
        /** equality operator */
        bool operator==(const Path & inobj) const;
        /** inequality operator */
        bool operator!=(const Path & inobj) const;
        /** less than operator */
        bool operator<(const Path & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Path & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::Path>
    {
    public:
        static bool flat() {return nav_msgs::Path::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::Path::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::Path & value);
