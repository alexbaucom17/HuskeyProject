...
#ifndef _CODEGEN_MOVE_BASE_MSGS_MOVEBASEACTIONGOAL_H_
#define _CODEGEN_MOVE_BASE_MSGS_MOVEBASEACTIONGOAL_H_
...
PREDECLARE_BSON(move_base_msgs::MoveBaseActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(move_base_msgs::MoveBaseActionGoal); // see Common.h, macro used for a cleaner header

namespace move_base_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MoveBaseActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        MoveBaseActionGoal();
        /** copy constructor */
        MoveBaseActionGoal(const MoveBaseActionGoal & inobj);
        /** destructor */
        ~MoveBaseActionGoal();

        /** allocator, convenience function for bind */
        static MoveBaseActionGoal * New();
        ...
        static const unsigned int ID = 1344994992U;
        ...
        static const unsigned int DATA_VERSION = 629949992U;
        ...
        //        static const char * dataTypeName() { return "MoveBaseActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b682113112347a212665a1023dca900c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb682113112347a21ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2665a1023dca900cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MoveBaseActionGoal * copy() { return new MoveBaseActionGoal(*this); };

        /** assignment operator(s) */
        MoveBaseActionGoal & operator=(const MoveBaseActionGoal & inobj);
        /** equality operator */
        bool operator==(const MoveBaseActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const MoveBaseActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const MoveBaseActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MoveBaseActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<move_base_msgs::MoveBaseActionGoal>
    {
    public:
        static bool flat() {return move_base_msgs::MoveBaseActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return move_base_msgs::MoveBaseActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const move_base_msgs::MoveBaseActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const move_base_msgs::MoveBaseActionGoal & value);

#endif  //  _MOVE_BASE_MSGS_MOVEBASEACTIONGOAL_H_
