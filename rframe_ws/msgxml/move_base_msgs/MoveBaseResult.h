...
#ifndef _CODEGEN_MOVE_BASE_MSGS_MOVEBASERESULT_H_
#define _CODEGEN_MOVE_BASE_MSGS_MOVEBASERESULT_H_
...
PREDECLARE_BSON(move_base_msgs::MoveBaseResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(move_base_msgs::MoveBaseResult); // see Common.h, macro used for a cleaner header

namespace move_base_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MoveBaseResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        MoveBaseResult();
        /** copy constructor */
        MoveBaseResult(const MoveBaseResult & inobj);
        /** destructor */
        ~MoveBaseResult();

        /** allocator, convenience function for bind */
        static MoveBaseResult * New();
        ...
        static const unsigned int ID = 1344994996U;
        ...
        static const unsigned int DATA_VERSION = 2251512028U;
        ...
        //        static const char * dataTypeName() { return "MoveBaseResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "51ce0f52b25d49b0a67333f5828874c2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x51ce0f52b25d49b0ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa67333f5828874c2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MoveBaseResult * copy() { return new MoveBaseResult(*this); };

        /** assignment operator(s) */
        MoveBaseResult & operator=(const MoveBaseResult & inobj);
        /** equality operator */
        bool operator==(const MoveBaseResult & inobj) const;
        /** inequality operator */
        bool operator!=(const MoveBaseResult & inobj) const;
        /** less than operator */
        bool operator<(const MoveBaseResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MoveBaseResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<move_base_msgs::MoveBaseResult>
    {
    public:
        static bool flat() {return move_base_msgs::MoveBaseResult::dataTypeFlat(); };
        static std::string sourceXML() {return move_base_msgs::MoveBaseResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const move_base_msgs::MoveBaseResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const move_base_msgs::MoveBaseResult & value);

#endif  //  _MOVE_BASE_MSGS_MOVEBASERESULT_H_
