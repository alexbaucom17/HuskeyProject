...
#ifndef _CODEGEN_MOVE_BASE_MSGS_MOVEBASEACTIONRESULT_H_
#define _CODEGEN_MOVE_BASE_MSGS_MOVEBASEACTIONRESULT_H_
...
PREDECLARE_BSON(move_base_msgs::MoveBaseActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(move_base_msgs::MoveBaseActionResult); // see Common.h, macro used for a cleaner header

namespace move_base_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MoveBaseActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        MoveBaseActionResult(const MoveBaseActionResult & inobj);
        /** destructor */
        ~MoveBaseActionResult();

        /** allocator, convenience function for bind */
        static MoveBaseActionResult * New();
        ...
        static const unsigned int ID = 1344994993U;
        ...
        static const unsigned int DATA_VERSION = 4055123403U;
        ...
        //        static const char * dataTypeName() { return "MoveBaseActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8fb9e0da545237542ded2126bbf018b9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8fb9e0da54523754ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2ded2126bbf018b9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MoveBaseActionResult * copy() { return new MoveBaseActionResult(*this); };

        /** assignment operator(s) */
        MoveBaseActionResult & operator=(const MoveBaseActionResult & inobj);
        /** equality operator */
        bool operator==(const MoveBaseActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const MoveBaseActionResult & inobj) const;
        /** less than operator */
        bool operator<(const MoveBaseActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MoveBaseActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<move_base_msgs::MoveBaseActionResult>
    {
    public:
        static bool flat() {return move_base_msgs::MoveBaseActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return move_base_msgs::MoveBaseActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const move_base_msgs::MoveBaseActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const move_base_msgs::MoveBaseActionResult & value);

#endif  //  _MOVE_BASE_MSGS_MOVEBASEACTIONRESULT_H_
