...
#ifndef _CODEGEN_MOVE_BASE_MSGS_MOVEBASEGOAL_H_
#define _CODEGEN_MOVE_BASE_MSGS_MOVEBASEGOAL_H_
...
PREDECLARE_BSON(move_base_msgs::MoveBaseGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(move_base_msgs::MoveBaseGoal); // see Common.h, macro used for a cleaner header

namespace move_base_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MoveBaseGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        MoveBaseGoal();
        /** copy constructor */
        MoveBaseGoal(const MoveBaseGoal & inobj);
        /** destructor */
        ~MoveBaseGoal();

        /** allocator, convenience function for bind */
        static MoveBaseGoal * New();
        ...
        static const unsigned int ID = 1344994995U;
        ...
        static const unsigned int DATA_VERSION = 2337250710U;
        ...
        //        static const char * dataTypeName() { return "MoveBaseGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ff29935c85af493901cd1a4af42d8363"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xff29935c85af4939ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x01cd1a4af42d8363ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MoveBaseGoal * copy() { return new MoveBaseGoal(*this); };

        /** assignment operator(s) */
        MoveBaseGoal & operator=(const MoveBaseGoal & inobj);
        /** equality operator */
        bool operator==(const MoveBaseGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const MoveBaseGoal & inobj) const;
        /** less than operator */
        bool operator<(const MoveBaseGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MoveBaseGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<move_base_msgs::MoveBaseGoal>
    {
    public:
        static bool flat() {return move_base_msgs::MoveBaseGoal::dataTypeFlat(); };
        static std::string sourceXML() {return move_base_msgs::MoveBaseGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const move_base_msgs::MoveBaseGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const move_base_msgs::MoveBaseGoal & value);

#endif  //  _MOVE_BASE_MSGS_MOVEBASEGOAL_H_
