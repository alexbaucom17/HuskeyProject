...
#ifndef _CODEGEN_MOVE_BASE_MSGS_MOVEBASEACTIONFEEDBACK_H_
#define _CODEGEN_MOVE_BASE_MSGS_MOVEBASEACTIONFEEDBACK_H_
...
PREDECLARE_BSON(move_base_msgs::MoveBaseActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(move_base_msgs::MoveBaseActionFeedback); // see Common.h, macro used for a cleaner header

namespace move_base_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MoveBaseActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        MoveBaseActionFeedback(const MoveBaseActionFeedback & inobj);
        /** destructor */
        ~MoveBaseActionFeedback();

        /** allocator, convenience function for bind */
        static MoveBaseActionFeedback * New();
        ...
        static const unsigned int ID = 1344994991U;
        ...
        static const unsigned int DATA_VERSION = 2041423061U;
        ...
        //        static const char * dataTypeName() { return "MoveBaseActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "043328c6b95c74c5536ea4bb12d5628a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x043328c6b95c74c5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x536ea4bb12d5628aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MoveBaseActionFeedback * copy() { return new MoveBaseActionFeedback(*this); };

        /** assignment operator(s) */
        MoveBaseActionFeedback & operator=(const MoveBaseActionFeedback & inobj);
        /** equality operator */
        bool operator==(const MoveBaseActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const MoveBaseActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const MoveBaseActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MoveBaseActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<move_base_msgs::MoveBaseActionFeedback>
    {
    public:
        static bool flat() {return move_base_msgs::MoveBaseActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return move_base_msgs::MoveBaseActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const move_base_msgs::MoveBaseActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const move_base_msgs::MoveBaseActionFeedback & value);

#endif  //  _MOVE_BASE_MSGS_MOVEBASEACTIONFEEDBACK_H_
