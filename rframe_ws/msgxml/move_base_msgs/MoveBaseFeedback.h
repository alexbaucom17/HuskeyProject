...
#ifndef _CODEGEN_MOVE_BASE_MSGS_MOVEBASEFEEDBACK_H_
#define _CODEGEN_MOVE_BASE_MSGS_MOVEBASEFEEDBACK_H_
...
PREDECLARE_BSON(move_base_msgs::MoveBaseFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(move_base_msgs::MoveBaseFeedback); // see Common.h, macro used for a cleaner header

namespace move_base_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MoveBaseFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        MoveBaseFeedback();
        /** copy constructor */
        MoveBaseFeedback(const MoveBaseFeedback & inobj);
        /** destructor */
        ~MoveBaseFeedback();

        /** allocator, convenience function for bind */
        static MoveBaseFeedback * New();
        ...
        static const unsigned int ID = 1344994994U;
        ...
        static const unsigned int DATA_VERSION = 4225802330U;
        ...
        //        static const char * dataTypeName() { return "MoveBaseFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "79d5fd147520de65d574f5f9315f1d06"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x79d5fd147520de65ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd574f5f9315f1d06ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MoveBaseFeedback * copy() { return new MoveBaseFeedback(*this); };

        /** assignment operator(s) */
        MoveBaseFeedback & operator=(const MoveBaseFeedback & inobj);
        /** equality operator */
        bool operator==(const MoveBaseFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const MoveBaseFeedback & inobj) const;
        /** less than operator */
        bool operator<(const MoveBaseFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MoveBaseFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<move_base_msgs::MoveBaseFeedback>
    {
    public:
        static bool flat() {return move_base_msgs::MoveBaseFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return move_base_msgs::MoveBaseFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const move_base_msgs::MoveBaseFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const move_base_msgs::MoveBaseFeedback & value);

#endif  //  _MOVE_BASE_MSGS_MOVEBASEFEEDBACK_H_
