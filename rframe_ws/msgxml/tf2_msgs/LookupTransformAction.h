...
#ifndef _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMACTION_H_
#define _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMACTION_H_
...
PREDECLARE_BSON(tf2_msgs::LookupTransformAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::LookupTransformAction); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LookupTransformAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        LookupTransformAction(const LookupTransformAction & inobj);
        /** destructor */
        ~LookupTransformAction();

        /** allocator, convenience function for bind */
        static LookupTransformAction * New();
        ...
        static const unsigned int ID = 931020957U;
        ...
        static const unsigned int DATA_VERSION = 2729226308U;
        ...
        //        static const char * dataTypeName() { return "LookupTransformAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "364b218d1ba7d3922284e39799e1e383"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x364b218d1ba7d392ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2284e39799e1e383ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LookupTransformAction * copy() { return new LookupTransformAction(*this); };

        /** assignment operator(s) */
        LookupTransformAction & operator=(const LookupTransformAction & inobj);
        /** equality operator */
        bool operator==(const LookupTransformAction & inobj) const;
        /** inequality operator */
        bool operator!=(const LookupTransformAction & inobj) const;
        /** less than operator */
        bool operator<(const LookupTransformAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LookupTransformAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::LookupTransformAction>
    {
    public:
        static bool flat() {return tf2_msgs::LookupTransformAction::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::LookupTransformAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::LookupTransformAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::LookupTransformAction & value);

#endif  //  _TF2_MSGS_LOOKUPTRANSFORMACTION_H_
