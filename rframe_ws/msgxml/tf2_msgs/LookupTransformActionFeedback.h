...
#ifndef _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMACTIONFEEDBACK_H_
#define _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMACTIONFEEDBACK_H_
...
PREDECLARE_BSON(tf2_msgs::LookupTransformActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::LookupTransformActionFeedback); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LookupTransformActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        LookupTransformActionFeedback(const LookupTransformActionFeedback & inobj);
        /** destructor */
        ~LookupTransformActionFeedback();

        /** allocator, convenience function for bind */
        static LookupTransformActionFeedback * New();
        ...
        static const unsigned int ID = 931020958U;
        ...
        static const unsigned int DATA_VERSION = 2092069774U;
        ...
        //        static const char * dataTypeName() { return "LookupTransformActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "879f87d2ae8ce762b382dc39ef92e8aa"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x879f87d2ae8ce762ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb382dc39ef92e8aaULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LookupTransformActionFeedback * copy() { return new LookupTransformActionFeedback(*this); };

        /** assignment operator(s) */
        LookupTransformActionFeedback & operator=(const LookupTransformActionFeedback & inobj);
        /** equality operator */
        bool operator==(const LookupTransformActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const LookupTransformActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const LookupTransformActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LookupTransformActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::LookupTransformActionFeedback>
    {
    public:
        static bool flat() {return tf2_msgs::LookupTransformActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::LookupTransformActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::LookupTransformActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::LookupTransformActionFeedback & value);

#endif  //  _TF2_MSGS_LOOKUPTRANSFORMACTIONFEEDBACK_H_
