...
extern "C"
{
    ...
    {
        return tf2_msgs::registerLibrary();
    };
}
...
namespace tf2_msgs
{
    ...
    static int allocateMessage(rframe::ID_TYPE id, std::shared_ptr<MessageBase> & msg)
    {
        ...
        { 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<LookupTransformAction>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<LookupTransformActionFeedback>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<LookupTransformActionGoal>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<LookupTransformActionResult>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<LookupTransformFeedback>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<LookupTransformGoal>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<LookupTransformResult>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            case TF2Error::ID:
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<TF2Error>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
    ...
    int registerLibrary()
    {
        ...
        LOG_INFO("registering data for library: tf2_msgs_gencpp");
        ...
        if (registered == false)
        {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformAction::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::LookupTransformAction>(
                    // boost::lambda::new_ptr<tf2_msgs::LookupTransformAction>(),
                    [](){ return new tf2_msgs::LookupTransformAction(); },
                                std::bind(allocateMessage,tf2_msgs::LookupTransformAction::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: LookupTransformAction");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformAction::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::LookupTransformAction::DATA_TYPE_NAME,tf2_msgs::LookupTransformAction::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: LookupTransformAction");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformActionFeedback::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::LookupTransformActionFeedback>(
                    // boost::lambda::new_ptr<tf2_msgs::LookupTransformActionFeedback>(),
                    [](){ return new tf2_msgs::LookupTransformActionFeedback(); },
                                std::bind(allocateMessage,tf2_msgs::LookupTransformActionFeedback::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: LookupTransformActionFeedback");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformActionFeedback::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::LookupTransformActionFeedback::DATA_TYPE_NAME,tf2_msgs::LookupTransformActionFeedback::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: LookupTransformActionFeedback");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformActionGoal::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::LookupTransformActionGoal>(
                    // boost::lambda::new_ptr<tf2_msgs::LookupTransformActionGoal>(),
                    [](){ return new tf2_msgs::LookupTransformActionGoal(); },
                                std::bind(allocateMessage,tf2_msgs::LookupTransformActionGoal::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: LookupTransformActionGoal");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformActionGoal::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::LookupTransformActionGoal::DATA_TYPE_NAME,tf2_msgs::LookupTransformActionGoal::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: LookupTransformActionGoal");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformActionResult::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::LookupTransformActionResult>(
                    // boost::lambda::new_ptr<tf2_msgs::LookupTransformActionResult>(),
                    [](){ return new tf2_msgs::LookupTransformActionResult(); },
                                std::bind(allocateMessage,tf2_msgs::LookupTransformActionResult::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: LookupTransformActionResult");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformActionResult::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::LookupTransformActionResult::DATA_TYPE_NAME,tf2_msgs::LookupTransformActionResult::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: LookupTransformActionResult");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformFeedback::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::LookupTransformFeedback>(
                    // boost::lambda::new_ptr<tf2_msgs::LookupTransformFeedback>(),
                    [](){ return new tf2_msgs::LookupTransformFeedback(); },
                                std::bind(allocateMessage,tf2_msgs::LookupTransformFeedback::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: LookupTransformFeedback");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformFeedback::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::LookupTransformFeedback::DATA_TYPE_NAME,tf2_msgs::LookupTransformFeedback::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: LookupTransformFeedback");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformGoal::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::LookupTransformGoal>(
                    // boost::lambda::new_ptr<tf2_msgs::LookupTransformGoal>(),
                    [](){ return new tf2_msgs::LookupTransformGoal(); },
                                std::bind(allocateMessage,tf2_msgs::LookupTransformGoal::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: LookupTransformGoal");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformGoal::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::LookupTransformGoal::DATA_TYPE_NAME,tf2_msgs::LookupTransformGoal::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: LookupTransformGoal");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformResult::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::LookupTransformResult>(
                    // boost::lambda::new_ptr<tf2_msgs::LookupTransformResult>(),
                    [](){ return new tf2_msgs::LookupTransformResult(); },
                                std::bind(allocateMessage,tf2_msgs::LookupTransformResult::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: LookupTransformResult");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::LookupTransformResult::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::LookupTransformResult::DATA_TYPE_NAME,tf2_msgs::LookupTransformResult::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: LookupTransformResult");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::TF2Error::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::TF2Error>(
                    // boost::lambda::new_ptr<tf2_msgs::TF2Error>(),
                    [](){ return new tf2_msgs::TF2Error(); },
                                std::bind(allocateMessage,tf2_msgs::TF2Error::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: TF2Error");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::TF2Error::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::TF2Error::DATA_TYPE_NAME,tf2_msgs::TF2Error::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: TF2Error");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::TFMessage::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::TFMessage>(
                    // boost::lambda::new_ptr<tf2_msgs::TFMessage>(),
                    [](){ return new tf2_msgs::TFMessage(); },
                                std::bind(allocateMessage,tf2_msgs::TFMessage::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::TFMessage::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::TFMessage::DATA_TYPE_NAME,tf2_msgs::TFMessage::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::FrameGraphRequest::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::FrameGraphRequest>(
                    // boost::lambda::new_ptr<tf2_msgs::FrameGraphRequest>(),
                    [](){ return new tf2_msgs::FrameGraphRequest(); },
                                std::bind(allocateMessage,tf2_msgs::FrameGraphRequest::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::FrameGraphRequest::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::FrameGraphRequest::DATA_TYPE_NAME,tf2_msgs::FrameGraphRequest::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::FrameGraphResponse::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::FrameGraphResponse>(
                    // boost::lambda::new_ptr<tf2_msgs::FrameGraphResponse>(),
                    [](){ return new tf2_msgs::FrameGraphResponse(); },
                                std::bind(allocateMessage,tf2_msgs::FrameGraphResponse::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::FrameGraphResponse::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::FrameGraphResponse::DATA_TYPE_NAME,tf2_msgs::FrameGraphResponse::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::FrameGraph::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<tf2_msgs::FrameGraph>(
                    // boost::lambda::new_ptr<tf2_msgs::FrameGraph>(),
                    [](){ return new tf2_msgs::FrameGraph(); },
                                std::bind(allocateMessage,tf2_msgs::FrameGraph::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = tf2_msgs::FrameGraph::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(tf2_msgs::FrameGraph::DATA_TYPE_NAME,tf2_msgs::FrameGraph::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
