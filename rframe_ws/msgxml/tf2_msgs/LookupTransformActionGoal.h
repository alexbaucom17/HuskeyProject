...
#ifndef _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMACTIONGOAL_H_
#define _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMACTIONGOAL_H_
...
PREDECLARE_BSON(tf2_msgs::LookupTransformActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::LookupTransformActionGoal); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LookupTransformActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        LookupTransformActionGoal(const LookupTransformActionGoal & inobj);
        /** destructor */
        ~LookupTransformActionGoal();

        /** allocator, convenience function for bind */
        static LookupTransformActionGoal * New();
        ...
        static const unsigned int ID = 931020959U;
        ...
        static const unsigned int DATA_VERSION = 350643362U;
        ...
        //        static const char * dataTypeName() { return "LookupTransformActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "22aeb14a0264c6a7092034c374efa9dd"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x22aeb14a0264c6a7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x092034c374efa9ddULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LookupTransformActionGoal * copy() { return new LookupTransformActionGoal(*this); };

        /** assignment operator(s) */
        LookupTransformActionGoal & operator=(const LookupTransformActionGoal & inobj);
        /** equality operator */
        bool operator==(const LookupTransformActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const LookupTransformActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const LookupTransformActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LookupTransformActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::LookupTransformActionGoal>
    {
    public:
        static bool flat() {return tf2_msgs::LookupTransformActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::LookupTransformActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::LookupTransformActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::LookupTransformActionGoal & value);

#endif  //  _TF2_MSGS_LOOKUPTRANSFORMACTIONGOAL_H_
