...
#ifndef _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMGOAL_H_
#define _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMGOAL_H_
...
PREDECLARE_BSON(tf2_msgs::LookupTransformGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::LookupTransformGoal); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LookupTransformGoal & inobj);   

    /** 
        \ingroup CodeGen
        ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ====== Simple API
    */
    class LookupTransformGoal
    {
    public: 
        ...
        LookupTransformGoal();
        /** copy constructor */
        LookupTransformGoal(const LookupTransformGoal & inobj);
        /** destructor */
        ~LookupTransformGoal();

        /** allocator, convenience function for bind */
        static LookupTransformGoal * New();
        ...
        std_msgs::RosTime  source_time; /**<  */
        std_msgs::RosDuration  timeout; /**< Advanced API */
        std_msgs::RosTime  target_time; /**<  */
        std::string  fixed_frame; /**< Whether or not to use the advanced API */
        bool  advanced; /**<  */
        ...
        static const unsigned int ID = 931020962U;
        ...
        static const unsigned int DATA_VERSION = 3592579718U;
        ...
        //        static const char * dataTypeName() { return "LookupTransformGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "cd30fd9258e1ca54b0bc98429af110af"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xcd30fd9258e1ca54ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb0bc98429af110afULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LookupTransformGoal * copy() { return new LookupTransformGoal(*this); };

        /** assignment operator(s) */
        LookupTransformGoal & operator=(const LookupTransformGoal & inobj);
        /** equality operator */
        bool operator==(const LookupTransformGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const LookupTransformGoal & inobj) const;
        /** less than operator */
        bool operator<(const LookupTransformGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LookupTransformGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::LookupTransformGoal>
    {
    public:
        static bool flat() {return tf2_msgs::LookupTransformGoal::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::LookupTransformGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::LookupTransformGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::LookupTransformGoal & value);

#endif  //  _TF2_MSGS_LOOKUPTRANSFORMGOAL_H_
