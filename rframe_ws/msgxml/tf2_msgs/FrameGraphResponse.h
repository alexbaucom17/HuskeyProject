...
#ifndef _CODEGEN_TF2_MSGS_FRAMEGRAPHRESPONSE_H_
#define _CODEGEN_TF2_MSGS_FRAMEGRAPHRESPONSE_H_
...
PREDECLARE_BSON(tf2_msgs::FrameGraphResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::FrameGraphResponse); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FrameGraphResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        FrameGraphResponse();
        /** copy constructor */
        FrameGraphResponse(const FrameGraphResponse & inobj);
        /** destructor */
        ~FrameGraphResponse();

        /** allocator, convenience function for bind */
        static FrameGraphResponse * New();
        ...
        static const unsigned int ID = 931020967U;
        ...
        static const unsigned int DATA_VERSION = 3416757068U;
        ...
        //        static const char * dataTypeName() { return "FrameGraphResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "942a11fff12eebdb44876387acf76255"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x942a11fff12eebdbULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x44876387acf76255ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FrameGraphResponse * copy() { return new FrameGraphResponse(*this); };

        /** assignment operator(s) */
        FrameGraphResponse & operator=(const FrameGraphResponse & inobj);
        /** equality operator */
        bool operator==(const FrameGraphResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const FrameGraphResponse & inobj) const;
        /** less than operator */
        bool operator<(const FrameGraphResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FrameGraphResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::FrameGraphResponse>
    {
    public:
        static bool flat() {return tf2_msgs::FrameGraphResponse::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::FrameGraphResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::FrameGraphResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::FrameGraphResponse & value);

#endif  //  _TF2_MSGS_FRAMEGRAPHRESPONSE_H_
