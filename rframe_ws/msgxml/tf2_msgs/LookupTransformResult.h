...
#ifndef _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMRESULT_H_
#define _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMRESULT_H_
...
PREDECLARE_BSON(tf2_msgs::LookupTransformResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::LookupTransformResult); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LookupTransformResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        LookupTransformResult(const LookupTransformResult & inobj);
        /** destructor */
        ~LookupTransformResult();

        /** allocator, convenience function for bind */
        static LookupTransformResult * New();
        ...
        static const unsigned int ID = 931020963U;
        ...
        static const unsigned int DATA_VERSION = 709055069U;
        ...
        //        static const char * dataTypeName() { return "LookupTransformResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "84cf78769176bb52f8bb83363ded4276"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x84cf78769176bb52ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf8bb83363ded4276ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LookupTransformResult * copy() { return new LookupTransformResult(*this); };

        /** assignment operator(s) */
        LookupTransformResult & operator=(const LookupTransformResult & inobj);
        /** equality operator */
        bool operator==(const LookupTransformResult & inobj) const;
        /** inequality operator */
        bool operator!=(const LookupTransformResult & inobj) const;
        /** less than operator */
        bool operator<(const LookupTransformResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LookupTransformResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::LookupTransformResult>
    {
    public:
        static bool flat() {return tf2_msgs::LookupTransformResult::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::LookupTransformResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::LookupTransformResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::LookupTransformResult & value);

#endif  //  _TF2_MSGS_LOOKUPTRANSFORMRESULT_H_
