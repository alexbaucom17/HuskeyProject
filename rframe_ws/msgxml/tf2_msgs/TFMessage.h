...
#ifndef _CODEGEN_TF2_MSGS_TFMESSAGE_H_
#define _CODEGEN_TF2_MSGS_TFMESSAGE_H_
...
PREDECLARE_BSON(tf2_msgs::TFMessage); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::TFMessage); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TFMessage & inobj);   
    ...
    */
    ...
    public: 
        ...
        TFMessage();
        /** copy constructor */
        TFMessage(const TFMessage & inobj);
        /** destructor */
        ~TFMessage();

        /** allocator, convenience function for bind */
        static TFMessage * New();
        ...
        static const unsigned int ID = 931020965U;
        ...
        static const unsigned int DATA_VERSION = 595230943U;
        ...
        //        static const char * dataTypeName() { return "TFMessage"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f916a55f55c08c9f8a56aafc2797451c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf916a55f55c08c9fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8a56aafc2797451cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TFMessage * copy() { return new TFMessage(*this); };

        /** assignment operator(s) */
        TFMessage & operator=(const TFMessage & inobj);
        /** equality operator */
        bool operator==(const TFMessage & inobj) const;
        /** inequality operator */
        bool operator!=(const TFMessage & inobj) const;
        /** less than operator */
        bool operator<(const TFMessage & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TFMessage & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::TFMessage>
    {
    public:
        static bool flat() {return tf2_msgs::TFMessage::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::TFMessage::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::TFMessage & value);
