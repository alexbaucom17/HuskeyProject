...
#ifndef _CODEGEN_TF2_MSGS_TF2ERROR_H_
#define _CODEGEN_TF2_MSGS_TF2ERROR_H_
...
PREDECLARE_BSON(tf2_msgs::TF2Error); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::TF2Error); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TF2Error & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned char NO_ERROR; /**<  (value: 0) */
        static const unsigned char LOOKUP_ERROR; /**<  (value: 1) */
        static const unsigned char CONNECTIVITY_ERROR; /**<  (value: 2) */
        static const unsigned char EXTRAPOLATION_ERROR; /**<  (value: 3) */
        static const unsigned char INVALID_ARGUMENT_ERROR; /**<  (value: 4) */
        static const unsigned char TIMEOUT_ERROR; /**<  (value: 5) */
        static const unsigned char TRANSFORM_ERROR; /**<  (value: 6) */
        ...
        static const unsigned int ID = 931020964U;
        ...
        static const unsigned int DATA_VERSION = 584246557U;
        ...
        //        static const char * dataTypeName() { return "TF2Error"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "17537bdebafe1410d54e88a37b81e737"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x17537bdebafe1410ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd54e88a37b81e737ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TF2Error * copy() { return new TF2Error(*this); };

        /** assignment operator(s) */
        TF2Error & operator=(const TF2Error & inobj);
        /** equality operator */
        bool operator==(const TF2Error & inobj) const;
        /** inequality operator */
        bool operator!=(const TF2Error & inobj) const;
        /** less than operator */
        bool operator<(const TF2Error & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TF2Error & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::TF2Error>
    {
    public:
        static bool flat() {return tf2_msgs::TF2Error::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::TF2Error::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::TF2Error & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::TF2Error & value);

#endif  //  _TF2_MSGS_TF2ERROR_H_
