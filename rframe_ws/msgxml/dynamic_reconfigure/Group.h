...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_GROUP_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_GROUP_H_
...
PREDECLARE_BSON(dynamic_reconfigure::Group); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::Group); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Group & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 535859634U;
        ...
        static const unsigned int DATA_VERSION = 3380321575U;
        ...
        //        static const char * dataTypeName() { return "Group"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "aa49407334c7ca528a7ddd0ed075b9e9"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xaa49407334c7ca52ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8a7ddd0ed075b9e9ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Group * copy() { return new Group(*this); };

        /** assignment operator(s) */
        Group & operator=(const Group & inobj);
        /** equality operator */
        bool operator==(const Group & inobj) const;
        /** inequality operator */
        bool operator!=(const Group & inobj) const;
        /** less than operator */
        bool operator<(const Group & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Group & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::Group>
    {
    public:
        static bool flat() {return dynamic_reconfigure::Group::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::Group::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::Group & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::Group & value);

#endif  //  _DYNAMIC_RECONFIGURE_GROUP_H_
