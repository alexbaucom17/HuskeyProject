...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_RECONFIGURERESPONSE_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_RECONFIGURERESPONSE_H_
...
PREDECLARE_BSON(dynamic_reconfigure::ReconfigureResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::ReconfigureResponse); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ReconfigureResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        ReconfigureResponse();
        /** copy constructor */
        ReconfigureResponse(const ReconfigureResponse & inobj);
        /** destructor */
        ~ReconfigureResponse();

        /** allocator, convenience function for bind */
        static ReconfigureResponse * New();
        ...
        static const unsigned int ID = 535859641U;
        ...
        static const unsigned int DATA_VERSION = 107647708U;
        ...
        //        static const char * dataTypeName() { return "ReconfigureResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f10c0cc6ec3637801e586acf0e444c14"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf10c0cc6ec363780ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1e586acf0e444c14ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ReconfigureResponse * copy() { return new ReconfigureResponse(*this); };

        /** assignment operator(s) */
        ReconfigureResponse & operator=(const ReconfigureResponse & inobj);
        /** equality operator */
        bool operator==(const ReconfigureResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const ReconfigureResponse & inobj) const;
        /** less than operator */
        bool operator<(const ReconfigureResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ReconfigureResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::ReconfigureResponse>
    {
    public:
        static bool flat() {return dynamic_reconfigure::ReconfigureResponse::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::ReconfigureResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::ReconfigureResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::ReconfigureResponse & value);

#endif  //  _DYNAMIC_RECONFIGURE_RECONFIGURERESPONSE_H_
