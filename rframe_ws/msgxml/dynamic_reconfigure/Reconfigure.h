...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_RECONFIGURE_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_RECONFIGURE_H_
...
PREDECLARE_BSON(dynamic_reconfigure::Reconfigure); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::Reconfigure); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Reconfigure & inobj);   
    ...
    */
    ...
    public: 
        ...
        Reconfigure();
        /** copy constructor */
        Reconfigure(const Reconfigure & inobj);
        /** destructor */
        ~Reconfigure();

        /** allocator, convenience function for bind */
        static Reconfigure * New();
        ...
        static const unsigned int ID = 535859642U;
        ...
        static const unsigned int DATA_VERSION = 4074688033U;
        ...
        //        static const char * dataTypeName() { return "Reconfigure"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "22e9be2a70812def2ac1214d4dc834a1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x22e9be2a70812defULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2ac1214d4dc834a1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Reconfigure * copy() { return new Reconfigure(*this); };

        /** assignment operator(s) */
        Reconfigure & operator=(const Reconfigure & inobj);
        /** equality operator */
        bool operator==(const Reconfigure & inobj) const;
        /** inequality operator */
        bool operator!=(const Reconfigure & inobj) const;
        /** less than operator */
        bool operator<(const Reconfigure & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Reconfigure & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::Reconfigure>
    {
    public:
        static bool flat() {return dynamic_reconfigure::Reconfigure::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::Reconfigure::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::Reconfigure & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::Reconfigure & value);

#endif  //  _DYNAMIC_RECONFIGURE_RECONFIGURE_H_
