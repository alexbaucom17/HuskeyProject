...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_PARAMDESCRIPTION_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_PARAMDESCRIPTION_H_
...
PREDECLARE_BSON(dynamic_reconfigure::ParamDescription); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::ParamDescription); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ParamDescription & inobj);   
    ...
    */
    ...
    public: 
        ...
        ParamDescription();
        /** copy constructor */
        ParamDescription(const ParamDescription & inobj);
        /** destructor */
        ~ParamDescription();

        /** allocator, convenience function for bind */
        static ParamDescription * New();
        ...
        static const unsigned int ID = 535859637U;
        ...
        static const unsigned int DATA_VERSION = 1619772469U;
        ...
        //        static const char * dataTypeName() { return "ParamDescription"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e7ee741049d21f8cce27820f4b524ec2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe7ee741049d21f8cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xce27820f4b524ec2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ParamDescription * copy() { return new ParamDescription(*this); };

        /** assignment operator(s) */
        ParamDescription & operator=(const ParamDescription & inobj);
        /** equality operator */
        bool operator==(const ParamDescription & inobj) const;
        /** inequality operator */
        bool operator!=(const ParamDescription & inobj) const;
        /** less than operator */
        bool operator<(const ParamDescription & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ParamDescription & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::ParamDescription>
    {
    public:
        static bool flat() {return dynamic_reconfigure::ParamDescription::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::ParamDescription::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::ParamDescription & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::ParamDescription & value);

#endif  //  _DYNAMIC_RECONFIGURE_PARAMDESCRIPTION_H_
