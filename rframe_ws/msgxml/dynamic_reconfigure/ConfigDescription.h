...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_CONFIGDESCRIPTION_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_CONFIGDESCRIPTION_H_
...
PREDECLARE_BSON(dynamic_reconfigure::ConfigDescription); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::ConfigDescription); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ConfigDescription & inobj);   
    ...
    */
    ...
    public: 
        ...
        ConfigDescription();
        /** copy constructor */
        ConfigDescription(const ConfigDescription & inobj);
        /** destructor */
        ~ConfigDescription();

        /** allocator, convenience function for bind */
        static ConfigDescription * New();
        ...
        static const unsigned int ID = 535859632U;
        ...
        static const unsigned int DATA_VERSION = 511469693U;
        ...
        //        static const char * dataTypeName() { return "ConfigDescription"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1b3132b22cfcc859b8126ebf47228bb5"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1b3132b22cfcc859ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb8126ebf47228bb5ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ConfigDescription * copy() { return new ConfigDescription(*this); };

        /** assignment operator(s) */
        ConfigDescription & operator=(const ConfigDescription & inobj);
        /** equality operator */
        bool operator==(const ConfigDescription & inobj) const;
        /** inequality operator */
        bool operator!=(const ConfigDescription & inobj) const;
        /** less than operator */
        bool operator<(const ConfigDescription & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ConfigDescription & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::ConfigDescription>
    {
    public:
        static bool flat() {return dynamic_reconfigure::ConfigDescription::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::ConfigDescription::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::ConfigDescription & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::ConfigDescription & value);

#endif  //  _DYNAMIC_RECONFIGURE_CONFIGDESCRIPTION_H_
