...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_RECONFIGUREREQUEST_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_RECONFIGUREREQUEST_H_
...
PREDECLARE_BSON(dynamic_reconfigure::ReconfigureRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::ReconfigureRequest); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ReconfigureRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        ReconfigureRequest();
        /** copy constructor */
        ReconfigureRequest(const ReconfigureRequest & inobj);
        /** destructor */
        ~ReconfigureRequest();

        /** allocator, convenience function for bind */
        static ReconfigureRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        Config  config; /**< no comment provided */
        ...
        static const unsigned int ID = 535859640U;
        ...
        static const unsigned int DATA_VERSION = 1383909860U;
        ...
        //        static const char * dataTypeName() { return "ReconfigureRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3afc5fa27734157c8ba2f7cf3f605fba"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3afc5fa27734157cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8ba2f7cf3f605fbaULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ReconfigureRequest * copy() { return new ReconfigureRequest(*this); };

        /** assignment operator(s) */
        ReconfigureRequest & operator=(const ReconfigureRequest & inobj);
        /** equality operator */
        bool operator==(const ReconfigureRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const ReconfigureRequest & inobj) const;
        /** less than operator */
        bool operator<(const ReconfigureRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ReconfigureRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::ReconfigureRequest>
    {
    public:
        static bool flat() {return dynamic_reconfigure::ReconfigureRequest::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::ReconfigureRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::ReconfigureRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::ReconfigureRequest & value);

#endif  //  _DYNAMIC_RECONFIGURE_RECONFIGUREREQUEST_H_
