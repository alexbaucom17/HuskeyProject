...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_BOOLPARAMETER_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_BOOLPARAMETER_H_
...
PREDECLARE_BSON(dynamic_reconfigure::BoolParameter); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::BoolParameter); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, BoolParameter & inobj);   
    ...
    */
    ...
    public: 
        ...
        BoolParameter();
        /** copy constructor */
        BoolParameter(const BoolParameter & inobj);
        /** destructor */
        ~BoolParameter();

        /** allocator, convenience function for bind */
        static BoolParameter * New();
        ...
        static const unsigned int ID = 535859630U;
        ...
        static const unsigned int DATA_VERSION = 3716541064U;
        ...
        //        static const char * dataTypeName() { return "BoolParameter"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "960a93bf6bca287575ca114d7b4dcc5a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x960a93bf6bca2875ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x75ca114d7b4dcc5aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        BoolParameter * copy() { return new BoolParameter(*this); };

        /** assignment operator(s) */
        BoolParameter & operator=(const BoolParameter & inobj);
        /** equality operator */
        bool operator==(const BoolParameter & inobj) const;
        /** inequality operator */
        bool operator!=(const BoolParameter & inobj) const;
        /** less than operator */
        bool operator<(const BoolParameter & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, BoolParameter & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::BoolParameter>
    {
    public:
        static bool flat() {return dynamic_reconfigure::BoolParameter::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::BoolParameter::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::BoolParameter & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::BoolParameter & value);

#endif  //  _DYNAMIC_RECONFIGURE_BOOLPARAMETER_H_
