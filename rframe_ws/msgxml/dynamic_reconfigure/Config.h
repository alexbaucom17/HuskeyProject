...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_CONFIG_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_CONFIG_H_
...
PREDECLARE_BSON(dynamic_reconfigure::Config); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::Config); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Config & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 535859631U;
        ...
        static const unsigned int DATA_VERSION = 2290723523U;
        ...
        //        static const char * dataTypeName() { return "Config"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9dc87569df2ca4f1934dfef0d91322e4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9dc87569df2ca4f1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x934dfef0d91322e4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Config * copy() { return new Config(*this); };

        /** assignment operator(s) */
        Config & operator=(const Config & inobj);
        /** equality operator */
        bool operator==(const Config & inobj) const;
        /** inequality operator */
        bool operator!=(const Config & inobj) const;
        /** less than operator */
        bool operator<(const Config & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Config & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::Config>
    {
    public:
        static bool flat() {return dynamic_reconfigure::Config::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::Config::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::Config & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::Config & value);

#endif  //  _DYNAMIC_RECONFIGURE_CONFIG_H_
