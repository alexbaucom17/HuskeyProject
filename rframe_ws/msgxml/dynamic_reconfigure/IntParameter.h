...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_INTPARAMETER_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_INTPARAMETER_H_
...
PREDECLARE_BSON(dynamic_reconfigure::IntParameter); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::IntParameter); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, IntParameter & inobj);   
    ...
    */
    ...
    public: 
        ...
        IntParameter();
        /** copy constructor */
        IntParameter(const IntParameter & inobj);
        /** destructor */
        ~IntParameter();

        /** allocator, convenience function for bind */
        static IntParameter * New();
        ...
        static const unsigned int ID = 535859636U;
        ...
        static const unsigned int DATA_VERSION = 3548428996U;
        ...
        //        static const char * dataTypeName() { return "IntParameter"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "78f1219693cdc3826ad2c074e7e4acb2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x78f1219693cdc382ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6ad2c074e7e4acb2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        IntParameter * copy() { return new IntParameter(*this); };

        /** assignment operator(s) */
        IntParameter & operator=(const IntParameter & inobj);
        /** equality operator */
        bool operator==(const IntParameter & inobj) const;
        /** inequality operator */
        bool operator!=(const IntParameter & inobj) const;
        /** less than operator */
        bool operator<(const IntParameter & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, IntParameter & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::IntParameter>
    {
    public:
        static bool flat() {return dynamic_reconfigure::IntParameter::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::IntParameter::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::IntParameter & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::IntParameter & value);

#endif  //  _DYNAMIC_RECONFIGURE_INTPARAMETER_H_
