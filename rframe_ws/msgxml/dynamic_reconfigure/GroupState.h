...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_GROUPSTATE_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_GROUPSTATE_H_
...
PREDECLARE_BSON(dynamic_reconfigure::GroupState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::GroupState); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GroupState & inobj);   
    ...
    */
    ...
    public: 
        ...
        GroupState();
        /** copy constructor */
        GroupState(const GroupState & inobj);
        /** destructor */
        ~GroupState();

        /** allocator, convenience function for bind */
        static GroupState * New();
        ...
        static const unsigned int ID = 535859635U;
        ...
        static const unsigned int DATA_VERSION = 465668876U;
        ...
        //        static const char * dataTypeName() { return "GroupState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0ad99a42d0e0aa3e44aa46f46ee71a38"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0ad99a42d0e0aa3eULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x44aa46f46ee71a38ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GroupState * copy() { return new GroupState(*this); };

        /** assignment operator(s) */
        GroupState & operator=(const GroupState & inobj);
        /** equality operator */
        bool operator==(const GroupState & inobj) const;
        /** inequality operator */
        bool operator!=(const GroupState & inobj) const;
        /** less than operator */
        bool operator<(const GroupState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GroupState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::GroupState>
    {
    public:
        static bool flat() {return dynamic_reconfigure::GroupState::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::GroupState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::GroupState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::GroupState & value);

#endif  //  _DYNAMIC_RECONFIGURE_GROUPSTATE_H_
