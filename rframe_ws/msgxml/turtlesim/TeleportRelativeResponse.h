...
#ifndef _CODEGEN_TURTLESIM_TELEPORTRELATIVERESPONSE_H_
#define _CODEGEN_TURTLESIM_TELEPORTRELATIVERESPONSE_H_
...
PREDECLARE_BSON(turtlesim::TeleportRelativeResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::TeleportRelativeResponse); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TeleportRelativeResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TeleportRelativeResponse(const TeleportRelativeResponse & inobj);
        /** destructor */
        ~TeleportRelativeResponse();

        /** allocator, convenience function for bind */
        static TeleportRelativeResponse * New();
        ...
        static const unsigned int ID = 1480782637U;
        ...
        static const unsigned int DATA_VERSION = 479679559U;
        ...
        //        static const char * dataTypeName() { return "TeleportRelativeResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "78196d82ef511cd1ab94e3bfcf24b6e5"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x78196d82ef511cd1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xab94e3bfcf24b6e5ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TeleportRelativeResponse * copy() { return new TeleportRelativeResponse(*this); };

        /** assignment operator(s) */
        TeleportRelativeResponse & operator=(const TeleportRelativeResponse & inobj);
        /** equality operator */
        bool operator==(const TeleportRelativeResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const TeleportRelativeResponse & inobj) const;
        /** less than operator */
        bool operator<(const TeleportRelativeResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TeleportRelativeResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::TeleportRelativeResponse>
    {
    public:
        static bool flat() {return turtlesim::TeleportRelativeResponse::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::TeleportRelativeResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::TeleportRelativeResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::TeleportRelativeResponse & value);

#endif  //  _TURTLESIM_TELEPORTRELATIVERESPONSE_H_
