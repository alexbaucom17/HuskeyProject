...
#ifndef _CODEGEN_TURTLESIM_TELEPORTRELATIVE_H_
#define _CODEGEN_TURTLESIM_TELEPORTRELATIVE_H_
...
PREDECLARE_BSON(turtlesim::TeleportRelative); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::TeleportRelative); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TeleportRelative & inobj);   
    ...
    */
    ...
    public: 
        ...
        TeleportRelative();
        /** copy constructor */
        TeleportRelative(const TeleportRelative & inobj);
        /** destructor */
        ~TeleportRelative();

        /** allocator, convenience function for bind */
        static TeleportRelative * New();
        ...
        static const unsigned int ID = 1480782638U;
        ...
        static const unsigned int DATA_VERSION = 2515169782U;
        ...
        //        static const char * dataTypeName() { return "TeleportRelative"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b1e0cbaa11053a31519126ff727bd97e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb1e0cbaa11053a31ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x519126ff727bd97eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TeleportRelative * copy() { return new TeleportRelative(*this); };

        /** assignment operator(s) */
        TeleportRelative & operator=(const TeleportRelative & inobj);
        /** equality operator */
        bool operator==(const TeleportRelative & inobj) const;
        /** inequality operator */
        bool operator!=(const TeleportRelative & inobj) const;
        /** less than operator */
        bool operator<(const TeleportRelative & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TeleportRelative & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::TeleportRelative>
    {
    public:
        static bool flat() {return turtlesim::TeleportRelative::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::TeleportRelative::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::TeleportRelative & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::TeleportRelative & value);

#endif  //  _TURTLESIM_TELEPORTRELATIVE_H_
