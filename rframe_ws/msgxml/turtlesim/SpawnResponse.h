...
#ifndef _CODEGEN_TURTLESIM_SPAWNRESPONSE_H_
#define _CODEGEN_TURTLESIM_SPAWNRESPONSE_H_
...
PREDECLARE_BSON(turtlesim::SpawnResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::SpawnResponse); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SpawnResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        SpawnResponse();
        /** copy constructor */
        SpawnResponse(const SpawnResponse & inobj);
        /** destructor */
        ~SpawnResponse();

        /** allocator, convenience function for bind */
        static SpawnResponse * New();
        ...
        static const unsigned int ID = 1480782631U;
        ...
        static const unsigned int DATA_VERSION = 774610256U;
        ...
        //        static const char * dataTypeName() { return "SpawnResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b2a0476a4351ac2246e2dbc908b54a2f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb2a0476a4351ac22ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x46e2dbc908b54a2fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SpawnResponse * copy() { return new SpawnResponse(*this); };

        /** assignment operator(s) */
        SpawnResponse & operator=(const SpawnResponse & inobj);
        /** equality operator */
        bool operator==(const SpawnResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SpawnResponse & inobj) const;
        /** less than operator */
        bool operator<(const SpawnResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SpawnResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::SpawnResponse>
    {
    public:
        static bool flat() {return turtlesim::SpawnResponse::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::SpawnResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::SpawnResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::SpawnResponse & value);

#endif  //  _TURTLESIM_SPAWNRESPONSE_H_
