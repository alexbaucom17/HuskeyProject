...
#ifndef _CODEGEN_TURTLESIM_TELEPORTRELATIVEREQUEST_H_
#define _CODEGEN_TURTLESIM_TELEPORTRELATIVEREQUEST_H_
...
PREDECLARE_BSON(turtlesim::TeleportRelativeRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::TeleportRelativeRequest); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TeleportRelativeRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TeleportRelativeRequest(const TeleportRelativeRequest & inobj);
        /** destructor */
        ~TeleportRelativeRequest();

        /** allocator, convenience function for bind */
        static TeleportRelativeRequest * New();
        ...
        float  linear; /**<  */
        float  angular; /**< no comment provided */
        ...
        static const unsigned int ID = 1480782636U;
        ...
        static const unsigned int DATA_VERSION = 2071328167U;
        ...
        //        static const char * dataTypeName() { return "TeleportRelativeRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8cc5b926ac13661d9e1c9c1921d62c5d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8cc5b926ac13661dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9e1c9c1921d62c5dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TeleportRelativeRequest * copy() { return new TeleportRelativeRequest(*this); };

        /** assignment operator(s) */
        TeleportRelativeRequest & operator=(const TeleportRelativeRequest & inobj);
        /** equality operator */
        bool operator==(const TeleportRelativeRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const TeleportRelativeRequest & inobj) const;
        /** less than operator */
        bool operator<(const TeleportRelativeRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TeleportRelativeRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::TeleportRelativeRequest>
    {
    public:
        static bool flat() {return turtlesim::TeleportRelativeRequest::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::TeleportRelativeRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::TeleportRelativeRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::TeleportRelativeRequest & value);

#endif  //  _TURTLESIM_TELEPORTRELATIVEREQUEST_H_
