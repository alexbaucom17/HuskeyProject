...
#ifndef _CODEGEN_TURTLESIM_SPAWN_H_
#define _CODEGEN_TURTLESIM_SPAWN_H_
...
PREDECLARE_BSON(turtlesim::Spawn); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::Spawn); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Spawn & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1480782632U;
        ...
        static const unsigned int DATA_VERSION = 3188957311U;
        ...
        //        static const char * dataTypeName() { return "Spawn"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "4950b64aeef9aeb9e65563feac82e7b2"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x4950b64aeef9aeb9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe65563feac82e7b2ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Spawn * copy() { return new Spawn(*this); };

        /** assignment operator(s) */
        Spawn & operator=(const Spawn & inobj);
        /** equality operator */
        bool operator==(const Spawn & inobj) const;
        /** inequality operator */
        bool operator!=(const Spawn & inobj) const;
        /** less than operator */
        bool operator<(const Spawn & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Spawn & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::Spawn>
    {
    public:
        static bool flat() {return turtlesim::Spawn::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::Spawn::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::Spawn & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::Spawn & value);

#endif  //  _TURTLESIM_SPAWN_H_
