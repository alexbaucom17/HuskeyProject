...
#ifndef _CODEGEN_TURTLESIM_TELEPORTABSOLUTERESPONSE_H_
#define _CODEGEN_TURTLESIM_TELEPORTABSOLUTERESPONSE_H_
...
PREDECLARE_BSON(turtlesim::TeleportAbsoluteResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::TeleportAbsoluteResponse); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TeleportAbsoluteResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TeleportAbsoluteResponse(const TeleportAbsoluteResponse & inobj);
        /** destructor */
        ~TeleportAbsoluteResponse();

        /** allocator, convenience function for bind */
        static TeleportAbsoluteResponse * New();
        ...
        static const unsigned int ID = 1480782634U;
        ...
        static const unsigned int DATA_VERSION = 652451495U;
        ...
        //        static const char * dataTypeName() { return "TeleportAbsoluteResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "da50b554aaf8963726db3e82029e239b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xda50b554aaf89637ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x26db3e82029e239bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TeleportAbsoluteResponse * copy() { return new TeleportAbsoluteResponse(*this); };

        /** assignment operator(s) */
        TeleportAbsoluteResponse & operator=(const TeleportAbsoluteResponse & inobj);
        /** equality operator */
        bool operator==(const TeleportAbsoluteResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const TeleportAbsoluteResponse & inobj) const;
        /** less than operator */
        bool operator<(const TeleportAbsoluteResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TeleportAbsoluteResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::TeleportAbsoluteResponse>
    {
    public:
        static bool flat() {return turtlesim::TeleportAbsoluteResponse::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::TeleportAbsoluteResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::TeleportAbsoluteResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::TeleportAbsoluteResponse & value);

#endif  //  _TURTLESIM_TELEPORTABSOLUTERESPONSE_H_
