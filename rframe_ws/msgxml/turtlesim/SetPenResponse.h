...
#ifndef _CODEGEN_TURTLESIM_SETPENRESPONSE_H_
#define _CODEGEN_TURTLESIM_SETPENRESPONSE_H_
...
PREDECLARE_BSON(turtlesim::SetPenResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::SetPenResponse); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetPenResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetPenResponse();
        /** copy constructor */
        SetPenResponse(const SetPenResponse & inobj);
        /** destructor */
        ~SetPenResponse();

        /** allocator, convenience function for bind */
        static SetPenResponse * New();
        ...
        static const unsigned int ID = 1480782628U;
        ...
        static const unsigned int DATA_VERSION = 1821507270U;
        ...
        //        static const char * dataTypeName() { return "SetPenResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "766842debf55e991a6621c3fb81ff322"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x766842debf55e991ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa6621c3fb81ff322ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetPenResponse * copy() { return new SetPenResponse(*this); };

        /** assignment operator(s) */
        SetPenResponse & operator=(const SetPenResponse & inobj);
        /** equality operator */
        bool operator==(const SetPenResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetPenResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetPenResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetPenResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::SetPenResponse>
    {
    public:
        static bool flat() {return turtlesim::SetPenResponse::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::SetPenResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::SetPenResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::SetPenResponse & value);

#endif  //  _TURTLESIM_SETPENRESPONSE_H_
