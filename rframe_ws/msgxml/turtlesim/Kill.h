...
#ifndef _CODEGEN_TURTLESIM_KILL_H_
#define _CODEGEN_TURTLESIM_KILL_H_
...
PREDECLARE_BSON(turtlesim::Kill); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::Kill); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Kill & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1480782626U;
        ...
        static const unsigned int DATA_VERSION = 3279976286U;
        ...
        //        static const char * dataTypeName() { return "Kill"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "cbc40e5bc827102b1ca3636cf1d0ed85"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xcbc40e5bc827102bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1ca3636cf1d0ed85ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Kill * copy() { return new Kill(*this); };

        /** assignment operator(s) */
        Kill & operator=(const Kill & inobj);
        /** equality operator */
        bool operator==(const Kill & inobj) const;
        /** inequality operator */
        bool operator!=(const Kill & inobj) const;
        /** less than operator */
        bool operator<(const Kill & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Kill & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::Kill>
    {
    public:
        static bool flat() {return turtlesim::Kill::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::Kill::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::Kill & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::Kill & value);

#endif  //  _TURTLESIM_KILL_H_
