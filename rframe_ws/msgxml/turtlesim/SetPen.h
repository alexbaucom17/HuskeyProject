...
#ifndef _CODEGEN_TURTLESIM_SETPEN_H_
#define _CODEGEN_TURTLESIM_SETPEN_H_
...
PREDECLARE_BSON(turtlesim::SetPen); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::SetPen); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetPen & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1480782629U;
        ...
        static const unsigned int DATA_VERSION = 1162283250U;
        ...
        //        static const char * dataTypeName() { return "SetPen"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a7e959b193c17a9a4229d0052568ccd4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa7e959b193c17a9aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4229d0052568ccd4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetPen * copy() { return new SetPen(*this); };

        /** assignment operator(s) */
        SetPen & operator=(const SetPen & inobj);
        /** equality operator */
        bool operator==(const SetPen & inobj) const;
        /** inequality operator */
        bool operator!=(const SetPen & inobj) const;
        /** less than operator */
        bool operator<(const SetPen & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetPen & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::SetPen>
    {
    public:
        static bool flat() {return turtlesim::SetPen::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::SetPen::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::SetPen & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::SetPen & value);

#endif  //  _TURTLESIM_SETPEN_H_
