...
#ifndef _CODEGEN_TURTLESIM_KILLRESPONSE_H_
#define _CODEGEN_TURTLESIM_KILLRESPONSE_H_
...
PREDECLARE_BSON(turtlesim::KillResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::KillResponse); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, KillResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        KillResponse();
        /** copy constructor */
        KillResponse(const KillResponse & inobj);
        /** destructor */
        ~KillResponse();

        /** allocator, convenience function for bind */
        static KillResponse * New();
        ...
        static const unsigned int ID = 1480782625U;
        ...
        static const unsigned int DATA_VERSION = 2804432830U;
        ...
        //        static const char * dataTypeName() { return "KillResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "29146217e0784a2dd7d60f6ffe7d7d48"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x29146217e0784a2dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd7d60f6ffe7d7d48ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        KillResponse * copy() { return new KillResponse(*this); };

        /** assignment operator(s) */
        KillResponse & operator=(const KillResponse & inobj);
        /** equality operator */
        bool operator==(const KillResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const KillResponse & inobj) const;
        /** less than operator */
        bool operator<(const KillResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, KillResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::KillResponse>
    {
    public:
        static bool flat() {return turtlesim::KillResponse::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::KillResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::KillResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::KillResponse & value);

#endif  //  _TURTLESIM_KILLRESPONSE_H_
