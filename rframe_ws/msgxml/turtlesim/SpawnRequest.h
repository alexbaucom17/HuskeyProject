...
#ifndef _CODEGEN_TURTLESIM_SPAWNREQUEST_H_
#define _CODEGEN_TURTLESIM_SPAWNREQUEST_H_
...
PREDECLARE_BSON(turtlesim::SpawnRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::SpawnRequest); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SpawnRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        SpawnRequest();
        /** copy constructor */
        SpawnRequest(const SpawnRequest & inobj);
        /** destructor */
        ~SpawnRequest();

        /** allocator, convenience function for bind */
        static SpawnRequest * New();
        ...
        static const unsigned int ID = 1480782630U;
        ...
        static const unsigned int DATA_VERSION = 948930851U;
        ...
        //        static const char * dataTypeName() { return "SpawnRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6b5885d5539a4db24f826b6e35ca2d31"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6b5885d5539a4db2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4f826b6e35ca2d31ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SpawnRequest * copy() { return new SpawnRequest(*this); };

        /** assignment operator(s) */
        SpawnRequest & operator=(const SpawnRequest & inobj);
        /** equality operator */
        bool operator==(const SpawnRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SpawnRequest & inobj) const;
        /** less than operator */
        bool operator<(const SpawnRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SpawnRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::SpawnRequest>
    {
    public:
        static bool flat() {return turtlesim::SpawnRequest::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::SpawnRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::SpawnRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::SpawnRequest & value);

#endif  //  _TURTLESIM_SPAWNREQUEST_H_
