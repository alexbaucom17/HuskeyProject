...
#ifndef _CODEGEN_TURTLESIM_TELEPORTABSOLUTE_H_
#define _CODEGEN_TURTLESIM_TELEPORTABSOLUTE_H_
...
PREDECLARE_BSON(turtlesim::TeleportAbsolute); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::TeleportAbsolute); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TeleportAbsolute & inobj);   
    ...
    */
    ...
    public: 
        ...
        TeleportAbsolute();
        /** copy constructor */
        TeleportAbsolute(const TeleportAbsolute & inobj);
        /** destructor */
        ~TeleportAbsolute();

        /** allocator, convenience function for bind */
        static TeleportAbsolute * New();
        ...
        static const unsigned int ID = 1480782635U;
        ...
        static const unsigned int DATA_VERSION = 2846105108U;
        ...
        //        static const char * dataTypeName() { return "TeleportAbsolute"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c996d9d94325efcba88f83dd2d924629"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc996d9d94325efcbULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa88f83dd2d924629ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TeleportAbsolute * copy() { return new TeleportAbsolute(*this); };

        /** assignment operator(s) */
        TeleportAbsolute & operator=(const TeleportAbsolute & inobj);
        /** equality operator */
        bool operator==(const TeleportAbsolute & inobj) const;
        /** inequality operator */
        bool operator!=(const TeleportAbsolute & inobj) const;
        /** less than operator */
        bool operator<(const TeleportAbsolute & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TeleportAbsolute & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::TeleportAbsolute>
    {
    public:
        static bool flat() {return turtlesim::TeleportAbsolute::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::TeleportAbsolute::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::TeleportAbsolute & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::TeleportAbsolute & value);

#endif  //  _TURTLESIM_TELEPORTABSOLUTE_H_
