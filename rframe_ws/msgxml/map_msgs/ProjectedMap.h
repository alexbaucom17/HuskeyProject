...
#ifndef _CODEGEN_MAP_MSGS_PROJECTEDMAP_H_
#define _CODEGEN_MAP_MSGS_PROJECTEDMAP_H_
...
PREDECLARE_BSON(map_msgs::ProjectedMap); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::ProjectedMap); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ProjectedMap & inobj);   
    ...
    */
    ...
    public: 
        ...
        ProjectedMap();
        /** copy constructor */
        ProjectedMap(const ProjectedMap & inobj);
        /** destructor */
        ~ProjectedMap();

        /** allocator, convenience function for bind */
        static ProjectedMap * New();
        ...
        static const unsigned int ID = 851292626U;
        ...
        static const unsigned int DATA_VERSION = 3822918620U;
        ...
        //        static const char * dataTypeName() { return "ProjectedMap"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c37058a095d5354683281358bd3ba060"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc37058a095d53546ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x83281358bd3ba060ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ProjectedMap * copy() { return new ProjectedMap(*this); };

        /** assignment operator(s) */
        ProjectedMap & operator=(const ProjectedMap & inobj);
        /** equality operator */
        bool operator==(const ProjectedMap & inobj) const;
        /** inequality operator */
        bool operator!=(const ProjectedMap & inobj) const;
        /** less than operator */
        bool operator<(const ProjectedMap & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ProjectedMap & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::ProjectedMap>
    {
    public:
        static bool flat() {return map_msgs::ProjectedMap::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::ProjectedMap::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::ProjectedMap & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::ProjectedMap & value);

#endif  //  _MAP_MSGS_PROJECTEDMAP_H_
