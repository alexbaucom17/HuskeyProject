...
#ifndef _CODEGEN_MAP_MSGS_OCCUPANCYGRIDUPDATE_H_
#define _CODEGEN_MAP_MSGS_OCCUPANCYGRIDUPDATE_H_
...
PREDECLARE_BSON(map_msgs::OccupancyGridUpdate); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::OccupancyGridUpdate); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, OccupancyGridUpdate & inobj);   
    ...
    */
    ...
    public: 
        ...
        OccupancyGridUpdate();
        /** copy constructor */
        OccupancyGridUpdate(const OccupancyGridUpdate & inobj);
        /** destructor */
        ~OccupancyGridUpdate();

        /** allocator, convenience function for bind */
        static OccupancyGridUpdate * New();
        ...
        static const unsigned int ID = 851292624U;
        ...
        static const unsigned int DATA_VERSION = 1738757822U;
        ...
        //        static const char * dataTypeName() { return "OccupancyGridUpdate"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "95deadd94333b9bdaff38856076d8dea"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x95deadd94333b9bdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xaff38856076d8deaULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        OccupancyGridUpdate * copy() { return new OccupancyGridUpdate(*this); };

        /** assignment operator(s) */
        OccupancyGridUpdate & operator=(const OccupancyGridUpdate & inobj);
        /** equality operator */
        bool operator==(const OccupancyGridUpdate & inobj) const;
        /** inequality operator */
        bool operator!=(const OccupancyGridUpdate & inobj) const;
        /** less than operator */
        bool operator<(const OccupancyGridUpdate & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, OccupancyGridUpdate & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::OccupancyGridUpdate>
    {
    public:
        static bool flat() {return map_msgs::OccupancyGridUpdate::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::OccupancyGridUpdate::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::OccupancyGridUpdate & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::OccupancyGridUpdate & value);

#endif  //  _MAP_MSGS_OCCUPANCYGRIDUPDATE_H_
