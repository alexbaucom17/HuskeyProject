...
#ifndef _CODEGEN_MAP_MSGS_SAVEMAP_H_
#define _CODEGEN_MAP_MSGS_SAVEMAP_H_
...
PREDECLARE_BSON(map_msgs::SaveMap); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::SaveMap); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SaveMap & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 851292638U;
        ...
        static const unsigned int DATA_VERSION = 2928971389U;
        ...
        //        static const char * dataTypeName() { return "SaveMap"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1df40bdc718906057b1002c1ab640833"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1df40bdc71890605ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7b1002c1ab640833ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SaveMap * copy() { return new SaveMap(*this); };

        /** assignment operator(s) */
        SaveMap & operator=(const SaveMap & inobj);
        /** equality operator */
        bool operator==(const SaveMap & inobj) const;
        /** inequality operator */
        bool operator!=(const SaveMap & inobj) const;
        /** less than operator */
        bool operator<(const SaveMap & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SaveMap & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::SaveMap>
    {
    public:
        static bool flat() {return map_msgs::SaveMap::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::SaveMap::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::SaveMap & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::SaveMap & value);

#endif  //  _MAP_MSGS_SAVEMAP_H_
