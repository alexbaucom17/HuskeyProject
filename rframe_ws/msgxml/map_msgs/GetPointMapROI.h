...
#ifndef _CODEGEN_MAP_MSGS_GETPOINTMAPROI_H_
#define _CODEGEN_MAP_MSGS_GETPOINTMAPROI_H_
...
PREDECLARE_BSON(map_msgs::GetPointMapROI); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetPointMapROI); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPointMapROI & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetPointMapROI();
        /** copy constructor */
        GetPointMapROI(const GetPointMapROI & inobj);
        /** destructor */
        ~GetPointMapROI();

        /** allocator, convenience function for bind */
        static GetPointMapROI * New();
        ...
        static const unsigned int ID = 851292636U;
        ...
        static const unsigned int DATA_VERSION = 4283038396U;
        ...
        //        static const char * dataTypeName() { return "GetPointMapROI"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e550cc4fc65fdf53505dc8922087f372"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe550cc4fc65fdf53ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x505dc8922087f372ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPointMapROI * copy() { return new GetPointMapROI(*this); };

        /** assignment operator(s) */
        GetPointMapROI & operator=(const GetPointMapROI & inobj);
        /** equality operator */
        bool operator==(const GetPointMapROI & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPointMapROI & inobj) const;
        /** less than operator */
        bool operator<(const GetPointMapROI & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPointMapROI & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetPointMapROI>
    {
    public:
        static bool flat() {return map_msgs::GetPointMapROI::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetPointMapROI::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetPointMapROI & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetPointMapROI & value);

#endif  //  _MAP_MSGS_GETPOINTMAPROI_H_
