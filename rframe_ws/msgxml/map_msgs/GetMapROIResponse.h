...
#ifndef _CODEGEN_MAP_MSGS_GETMAPROIRESPONSE_H_
#define _CODEGEN_MAP_MSGS_GETMAPROIRESPONSE_H_
...
PREDECLARE_BSON(map_msgs::GetMapROIResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetMapROIResponse); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapROIResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapROIResponse();
        /** copy constructor */
        GetMapROIResponse(const GetMapROIResponse & inobj);
        /** destructor */
        ~GetMapROIResponse();

        /** allocator, convenience function for bind */
        static GetMapROIResponse * New();
        ...
        static const unsigned int ID = 851292629U;
        ...
        static const unsigned int DATA_VERSION = 2472276959U;
        ...
        //        static const char * dataTypeName() { return "GetMapROIResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8ec96b443fa61b3d672c35ca4456cc16"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8ec96b443fa61b3dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x672c35ca4456cc16ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapROIResponse * copy() { return new GetMapROIResponse(*this); };

        /** assignment operator(s) */
        GetMapROIResponse & operator=(const GetMapROIResponse & inobj);
        /** equality operator */
        bool operator==(const GetMapROIResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapROIResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetMapROIResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapROIResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetMapROIResponse>
    {
    public:
        static bool flat() {return map_msgs::GetMapROIResponse::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetMapROIResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetMapROIResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetMapROIResponse & value);

#endif  //  _MAP_MSGS_GETMAPROIRESPONSE_H_
