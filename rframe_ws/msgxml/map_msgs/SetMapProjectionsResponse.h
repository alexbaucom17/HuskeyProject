...
#ifndef _CODEGEN_MAP_MSGS_SETMAPPROJECTIONSRESPONSE_H_
#define _CODEGEN_MAP_MSGS_SETMAPPROJECTIONSRESPONSE_H_
...
PREDECLARE_BSON(map_msgs::SetMapProjectionsResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::SetMapProjectionsResponse); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetMapProjectionsResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetMapProjectionsResponse(const SetMapProjectionsResponse & inobj);
        /** destructor */
        ~SetMapProjectionsResponse();

        /** allocator, convenience function for bind */
        static SetMapProjectionsResponse * New();
        ...
        static const unsigned int ID = 851292640U;
        ...
        static const unsigned int DATA_VERSION = 1348218284U;
        ...
        //        static const char * dataTypeName() { return "SetMapProjectionsResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "596a196f1f4e71168c2648c5ed11db92"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x596a196f1f4e7116ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8c2648c5ed11db92ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetMapProjectionsResponse * copy() { return new SetMapProjectionsResponse(*this); };

        /** assignment operator(s) */
        SetMapProjectionsResponse & operator=(const SetMapProjectionsResponse & inobj);
        /** equality operator */
        bool operator==(const SetMapProjectionsResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetMapProjectionsResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetMapProjectionsResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetMapProjectionsResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::SetMapProjectionsResponse>
    {
    public:
        static bool flat() {return map_msgs::SetMapProjectionsResponse::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::SetMapProjectionsResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::SetMapProjectionsResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::SetMapProjectionsResponse & value);

#endif  //  _MAP_MSGS_SETMAPPROJECTIONSRESPONSE_H_
