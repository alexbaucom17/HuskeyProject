...
#ifndef _CODEGEN_MAP_MSGS_GETPOINTMAPROIREQUEST_H_
#define _CODEGEN_MAP_MSGS_GETPOINTMAPROIREQUEST_H_
...
PREDECLARE_BSON(map_msgs::GetPointMapROIRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetPointMapROIRequest); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPointMapROIRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetPointMapROIRequest(const GetPointMapROIRequest & inobj);
        /** destructor */
        ~GetPointMapROIRequest();

        /** allocator, convenience function for bind */
        static GetPointMapROIRequest * New();
        ...
        double  y; /**<  */
        double  z; /**<  */
        double  r; /**< if != 0, circular ROI of radius r */
        double  l_x; /**< if r == 0, length of AABB on x */
        double  l_y; /**< if r == 0, length of AABB on y */
        double  l_z; /**< no comment provided */
        ...
        static const unsigned int ID = 851292634U;
        ...
        static const unsigned int DATA_VERSION = 1270574132U;
        ...
        //        static const char * dataTypeName() { return "GetPointMapROIRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "60975cccd1f9f23265c37650fc67c86f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x60975cccd1f9f232ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x65c37650fc67c86fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPointMapROIRequest * copy() { return new GetPointMapROIRequest(*this); };

        /** assignment operator(s) */
        GetPointMapROIRequest & operator=(const GetPointMapROIRequest & inobj);
        /** equality operator */
        bool operator==(const GetPointMapROIRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPointMapROIRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetPointMapROIRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPointMapROIRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetPointMapROIRequest>
    {
    public:
        static bool flat() {return map_msgs::GetPointMapROIRequest::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetPointMapROIRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetPointMapROIRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetPointMapROIRequest & value);

#endif  //  _MAP_MSGS_GETPOINTMAPROIREQUEST_H_
