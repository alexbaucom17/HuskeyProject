...
#ifndef _CODEGEN_MAP_MSGS_GETPOINTMAPRESPONSE_H_
#define _CODEGEN_MAP_MSGS_GETPOINTMAPRESPONSE_H_
...
PREDECLARE_BSON(map_msgs::GetPointMapResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetPointMapResponse); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPointMapResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetPointMapResponse();
        /** copy constructor */
        GetPointMapResponse(const GetPointMapResponse & inobj);
        /** destructor */
        ~GetPointMapResponse();

        /** allocator, convenience function for bind */
        static GetPointMapResponse * New();
        ...
        static const unsigned int ID = 851292632U;
        ...
        static const unsigned int DATA_VERSION = 1611117927U;
        ...
        //        static const char * dataTypeName() { return "GetPointMapResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "32fcb18e367cf98dfd91661ce139926b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x32fcb18e367cf98dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfd91661ce139926bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPointMapResponse * copy() { return new GetPointMapResponse(*this); };

        /** assignment operator(s) */
        GetPointMapResponse & operator=(const GetPointMapResponse & inobj);
        /** equality operator */
        bool operator==(const GetPointMapResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPointMapResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetPointMapResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPointMapResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetPointMapResponse>
    {
    public:
        static bool flat() {return map_msgs::GetPointMapResponse::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetPointMapResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetPointMapResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetPointMapResponse & value);

#endif  //  _MAP_MSGS_GETPOINTMAPRESPONSE_H_
