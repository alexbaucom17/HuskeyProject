...
#ifndef _CODEGEN_MAP_MSGS_GETPOINTMAP_H_
#define _CODEGEN_MAP_MSGS_GETPOINTMAP_H_
...
PREDECLARE_BSON(map_msgs::GetPointMap); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetPointMap); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPointMap & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetPointMap();
        /** copy constructor */
        GetPointMap(const GetPointMap & inobj);
        /** destructor */
        ~GetPointMap();

        /** allocator, convenience function for bind */
        static GetPointMap * New();
        ...
        static const unsigned int ID = 851292633U;
        ...
        static const unsigned int DATA_VERSION = 3040867253U;
        ...
        //        static const char * dataTypeName() { return "GetPointMap"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3d0f3cdd671dc538088b02ab2d121f9f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3d0f3cdd671dc538ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x088b02ab2d121f9fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPointMap * copy() { return new GetPointMap(*this); };

        /** assignment operator(s) */
        GetPointMap & operator=(const GetPointMap & inobj);
        /** equality operator */
        bool operator==(const GetPointMap & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPointMap & inobj) const;
        /** less than operator */
        bool operator<(const GetPointMap & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPointMap & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetPointMap>
    {
    public:
        static bool flat() {return map_msgs::GetPointMap::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetPointMap::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetPointMap & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetPointMap & value);

#endif  //  _MAP_MSGS_GETPOINTMAP_H_
