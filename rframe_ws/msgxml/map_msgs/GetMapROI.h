...
#ifndef _CODEGEN_MAP_MSGS_GETMAPROI_H_
#define _CODEGEN_MAP_MSGS_GETMAPROI_H_
...
PREDECLARE_BSON(map_msgs::GetMapROI); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetMapROI); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapROI & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapROI();
        /** copy constructor */
        GetMapROI(const GetMapROI & inobj);
        /** destructor */
        ~GetMapROI();

        /** allocator, convenience function for bind */
        static GetMapROI * New();
        ...
        static const unsigned int ID = 851292630U;
        ...
        static const unsigned int DATA_VERSION = 3792082298U;
        ...
        //        static const char * dataTypeName() { return "GetMapROI"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7d5cffc840f43bdec41fbf3d5decf24e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7d5cffc840f43bdeULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc41fbf3d5decf24eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapROI * copy() { return new GetMapROI(*this); };

        /** assignment operator(s) */
        GetMapROI & operator=(const GetMapROI & inobj);
        /** equality operator */
        bool operator==(const GetMapROI & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapROI & inobj) const;
        /** less than operator */
        bool operator<(const GetMapROI & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapROI & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetMapROI>
    {
    public:
        static bool flat() {return map_msgs::GetMapROI::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetMapROI::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetMapROI & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetMapROI & value);

#endif  //  _MAP_MSGS_GETMAPROI_H_
