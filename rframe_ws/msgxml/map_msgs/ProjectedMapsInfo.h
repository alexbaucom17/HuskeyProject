...
#ifndef _CODEGEN_MAP_MSGS_PROJECTEDMAPSINFO_H_
#define _CODEGEN_MAP_MSGS_PROJECTEDMAPSINFO_H_
...
PREDECLARE_BSON(map_msgs::ProjectedMapsInfo); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::ProjectedMapsInfo); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ProjectedMapsInfo & inobj);   
    ...
    */
    ...
    public: 
        ...
        ProjectedMapsInfo();
        /** copy constructor */
        ProjectedMapsInfo(const ProjectedMapsInfo & inobj);
        /** destructor */
        ~ProjectedMapsInfo();

        /** allocator, convenience function for bind */
        static ProjectedMapsInfo * New();
        ...
        static const unsigned int ID = 851292637U;
        ...
        static const unsigned int DATA_VERSION = 1902235998U;
        ...
        //        static const char * dataTypeName() { return "ProjectedMapsInfo"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6e52fafd0fe079392d02d8bbbd414b7e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6e52fafd0fe07939ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2d02d8bbbd414b7eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ProjectedMapsInfo * copy() { return new ProjectedMapsInfo(*this); };

        /** assignment operator(s) */
        ProjectedMapsInfo & operator=(const ProjectedMapsInfo & inobj);
        /** equality operator */
        bool operator==(const ProjectedMapsInfo & inobj) const;
        /** inequality operator */
        bool operator!=(const ProjectedMapsInfo & inobj) const;
        /** less than operator */
        bool operator<(const ProjectedMapsInfo & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ProjectedMapsInfo & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::ProjectedMapsInfo>
    {
    public:
        static bool flat() {return map_msgs::ProjectedMapsInfo::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::ProjectedMapsInfo::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::ProjectedMapsInfo & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::ProjectedMapsInfo & value);

#endif  //  _MAP_MSGS_PROJECTEDMAPSINFO_H_
