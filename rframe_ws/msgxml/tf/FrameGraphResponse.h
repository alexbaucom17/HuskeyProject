...
#ifndef _CODEGEN_TF_FRAMEGRAPHRESPONSE_H_
#define _CODEGEN_TF_FRAMEGRAPHRESPONSE_H_
...
PREDECLARE_BSON(tf::FrameGraphResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf::FrameGraphResponse); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 905394566U;
        ...
        static const unsigned int DATA_VERSION = 2637856798U;
        ...
        */
        ...
        static const std::string versionMD5() { return "08b3b78f6eaec88c9a255d3b8612a500"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x08b3b78f6eaec88cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9a255d3b8612a500ULL;
...
namespace rframe
{
    template <> class CodeGenTraits<tf::FrameGraphResponse>
    {
    public:
        static bool flat() {return tf::FrameGraphResponse::dataTypeFlat(); };
        static std::string sourceXML() {return tf::FrameGraphResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf::FrameGraphResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf::FrameGraphResponse & value);

#endif  //  _TF_FRAMEGRAPHRESPONSE_H_
