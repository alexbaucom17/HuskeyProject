...
#ifndef _CODEGEN_TF_FRAMEGRAPH_H_
#define _CODEGEN_TF_FRAMEGRAPH_H_
...
PREDECLARE_BSON(tf::FrameGraph); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf::FrameGraph); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 905394567U;
        ...
        static const unsigned int DATA_VERSION = 4175258824U;
        ...
        */
        ...
        static const std::string versionMD5() { return "648ec2efe869555395a67885f5c9c2c6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x648ec2efe8695553ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x95a67885f5c9c2c6ULL;
...
namespace rframe
{
    template <> class CodeGenTraits<tf::FrameGraph>
    {
    public:
        static bool flat() {return tf::FrameGraph::dataTypeFlat(); };
        static std::string sourceXML() {return tf::FrameGraph::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf::FrameGraph & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf::FrameGraph & value);

#endif  //  _TF_FRAMEGRAPH_H_
