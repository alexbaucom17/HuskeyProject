...
#ifndef _CODEGEN_TF_FRAMEGRAPHREQUEST_H_
#define _CODEGEN_TF_FRAMEGRAPHREQUEST_H_
...
PREDECLARE_BSON(tf::FrameGraphRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf::FrameGraphRequest); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 905394565U;
        ...
        static const unsigned int DATA_VERSION = 2149467490U;
        ...
        */
        ...
        static const std::string versionMD5() { return "40734291990335e459f2744c70652f46"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x40734291990335e4ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x59f2744c70652f46ULL;
...
namespace rframe
{
    template <> class CodeGenTraits<tf::FrameGraphRequest>
    {
    public:
        static bool flat() {return tf::FrameGraphRequest::dataTypeFlat(); };
        static std::string sourceXML() {return tf::FrameGraphRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf::FrameGraphRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf::FrameGraphRequest & value);

#endif  //  _TF_FRAMEGRAPHREQUEST_H_
