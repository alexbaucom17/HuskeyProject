...
#ifndef _CODEGEN_TF_TFMESSAGE_H_
#define _CODEGEN_TF_TFMESSAGE_H_
...
PREDECLARE_BSON(tf::tfMessage); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf::tfMessage); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 905394564U;
        ...
        static const unsigned int DATA_VERSION = 3415687380U;
        ...
        */
        ...
        static const std::string versionMD5() { return "6085edcd9996f8ed286c69cabddb8db1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6085edcd9996f8edULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x286c69cabddb8db1ULL;
...
namespace rframe
{
    template <> class CodeGenTraits<tf::tfMessage>
    {
    public:
        static bool flat() {return tf::tfMessage::dataTypeFlat(); };
        static std::string sourceXML() {return tf::tfMessage::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf::tfMessage & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf::tfMessage & value);

#endif  //  _TF_TFMESSAGE_H_
