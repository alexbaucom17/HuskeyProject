...
#ifndef _CODEGEN_VISUALIZATION_MSGS_INTERACTIVEMARKERINIT_H_
#define _CODEGEN_VISUALIZATION_MSGS_INTERACTIVEMARKERINIT_H_
...
PREDECLARE_BSON(visualization_msgs::InteractiveMarkerInit); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(visualization_msgs::InteractiveMarkerInit); // see Common.h, macro used for a cleaner header

namespace visualization_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, InteractiveMarkerInit & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2125420983U;
        ...
        static const unsigned int DATA_VERSION = 3913460121U;
        ...
        //        static const char * dataTypeName() { return "InteractiveMarkerInit"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7b9caf10fef6bf9019b407c1a4a00fa6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7b9caf10fef6bf90ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x19b407c1a4a00fa6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        InteractiveMarkerInit * copy() { return new InteractiveMarkerInit(*this); };

        /** assignment operator(s) */
        InteractiveMarkerInit & operator=(const InteractiveMarkerInit & inobj);
        /** equality operator */
        bool operator==(const InteractiveMarkerInit & inobj) const;
        /** inequality operator */
        bool operator!=(const InteractiveMarkerInit & inobj) const;
        /** less than operator */
        bool operator<(const InteractiveMarkerInit & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, InteractiveMarkerInit & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<visualization_msgs::InteractiveMarkerInit>
    {
    public:
        static bool flat() {return visualization_msgs::InteractiveMarkerInit::dataTypeFlat(); };
        static std::string sourceXML() {return visualization_msgs::InteractiveMarkerInit::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const visualization_msgs::InteractiveMarkerInit & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const visualization_msgs::InteractiveMarkerInit & value);

#endif  //  _VISUALIZATION_MSGS_INTERACTIVEMARKERINIT_H_
