...
#ifndef _CODEGEN_VISUALIZATION_MSGS_INTERACTIVEMARKERPOSE_H_
#define _CODEGEN_VISUALIZATION_MSGS_INTERACTIVEMARKERPOSE_H_
...
PREDECLARE_BSON(visualization_msgs::InteractiveMarkerPose); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(visualization_msgs::InteractiveMarkerPose); // see Common.h, macro used for a cleaner header

namespace visualization_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, InteractiveMarkerPose & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        InteractiveMarkerPose(const InteractiveMarkerPose & inobj);
        /** destructor */
        ~InteractiveMarkerPose();

        /** allocator, convenience function for bind */
        static InteractiveMarkerPose * New();
        ...
        static const unsigned int ID = 2125420984U;
        ...
        static const unsigned int DATA_VERSION = 2689944888U;
        ...
        //        static const char * dataTypeName() { return "InteractiveMarkerPose"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "64eedd9cf10191bceee69de471c1a60a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x64eedd9cf10191bcULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xeee69de471c1a60aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        InteractiveMarkerPose * copy() { return new InteractiveMarkerPose(*this); };

        /** assignment operator(s) */
        InteractiveMarkerPose & operator=(const InteractiveMarkerPose & inobj);
        /** equality operator */
        bool operator==(const InteractiveMarkerPose & inobj) const;
        /** inequality operator */
        bool operator!=(const InteractiveMarkerPose & inobj) const;
        /** less than operator */
        bool operator<(const InteractiveMarkerPose & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, InteractiveMarkerPose & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<visualization_msgs::InteractiveMarkerPose>
    {
    public:
        static bool flat() {return visualization_msgs::InteractiveMarkerPose::dataTypeFlat(); };
        static std::string sourceXML() {return visualization_msgs::InteractiveMarkerPose::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const visualization_msgs::InteractiveMarkerPose & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const visualization_msgs::InteractiveMarkerPose & value);

#endif  //  _VISUALIZATION_MSGS_INTERACTIVEMARKERPOSE_H_
