...
#ifndef _CODEGEN_VISUALIZATION_MSGS_MENUENTRY_H_
#define _CODEGEN_VISUALIZATION_MSGS_MENUENTRY_H_
...
PREDECLARE_BSON(visualization_msgs::MenuEntry); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(visualization_msgs::MenuEntry); // see Common.h, macro used for a cleaner header

namespace visualization_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MenuEntry & inobj);   
    ...
    */
    ...
    public: 
        ...
        MenuEntry();
        /** copy constructor */
        MenuEntry(const MenuEntry & inobj);
        /** destructor */
        ~MenuEntry();

        /** allocator, convenience function for bind */
        static MenuEntry * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        unsigned int  id; /**< ID of the parent of this menu entry, if it is a submenu.  If this  menu entry is a top-level entry, set parent_id to 0. */
        unsigned int  parent_id; /**< menu / entry title */
        std::string  title; /**< Arguments to command indicated by command_type (below) */
        ...
        static const unsigned char FEEDBACK; /**<  (value: 0) */
        static const unsigned char ROSRUN; /**<  (value: 1) */
        static const unsigned char ROSLAUNCH; /**<  (value: 2) */
        ...
        static const unsigned int ID = 2125420988U;
        ...
        static const unsigned int DATA_VERSION = 1703013664U;
        ...
        //        static const char * dataTypeName() { return "MenuEntry"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8671b44d509ea067ce6b61788f392995"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8671b44d509ea067ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xce6b61788f392995ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MenuEntry * copy() { return new MenuEntry(*this); };

        /** assignment operator(s) */
        MenuEntry & operator=(const MenuEntry & inobj);
        /** equality operator */
        bool operator==(const MenuEntry & inobj) const;
        /** inequality operator */
        bool operator!=(const MenuEntry & inobj) const;
        /** less than operator */
        bool operator<(const MenuEntry & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MenuEntry & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<visualization_msgs::MenuEntry>
    {
    public:
        static bool flat() {return visualization_msgs::MenuEntry::dataTypeFlat(); };
        static std::string sourceXML() {return visualization_msgs::MenuEntry::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const visualization_msgs::MenuEntry & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const visualization_msgs::MenuEntry & value);

#endif  //  _VISUALIZATION_MSGS_MENUENTRY_H_
