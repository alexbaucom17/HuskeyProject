...
extern "C"
{
    ...
    {
        return visualization_msgs::registerLibrary();
    };
}
...
namespace visualization_msgs
{
    ...
    static int allocateMessage(rframe::ID_TYPE id, std::shared_ptr<MessageBase> & msg)
    {
        ...
        { 
            case ImageMarker::ID:
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<ImageMarker>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<InteractiveMarker>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<InteractiveMarkerControl>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<InteractiveMarkerFeedback>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<InteractiveMarkerInit>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<InteractiveMarkerPose>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<InteractiveMarkerUpdate>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            case Marker::ID:
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<Marker>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            case MarkerArray::ID:
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<MarkerArray>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
            ...
            case MenuEntry::ID:
            {
                std::shared_ptr<MessageBase> tempMsg(new Message<MenuEntry>(),std::bind(deallocateMessage,std::placeholders::_1));
                if (tempMsg.get() == NULL)
                {
                    retval = rframe::Error::MEMORY_ALLOC;
                } 
    ...
    //int register_visualization_msgs_gencpp()
    int registerLibrary()
    {
        int retval = rframe::Error::SUCCESS;
        ...
        LOG_INFO("registering data for library: visualization_msgs_gencpp");
        ...
        if (registered == false)
        {
            ...
            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::ImageMarker::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::ImageMarker>(
                    // boost::lambda::new_ptr<visualization_msgs::ImageMarker>(),
                    [](){ return new visualization_msgs::ImageMarker(); },
                                std::bind(allocateMessage,visualization_msgs::ImageMarker::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: ImageMarker");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::ImageMarker::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::ImageMarker::DATA_TYPE_NAME,visualization_msgs::ImageMarker::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: ImageMarker");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarker::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::InteractiveMarker>(
                    // boost::lambda::new_ptr<visualization_msgs::InteractiveMarker>(),
                    [](){ return new visualization_msgs::InteractiveMarker(); },
                                std::bind(allocateMessage,visualization_msgs::InteractiveMarker::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: InteractiveMarker");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarker::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::InteractiveMarker::DATA_TYPE_NAME,visualization_msgs::InteractiveMarker::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: InteractiveMarker");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerControl::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::InteractiveMarkerControl>(
                    // boost::lambda::new_ptr<visualization_msgs::InteractiveMarkerControl>(),
                    [](){ return new visualization_msgs::InteractiveMarkerControl(); },
                                std::bind(allocateMessage,visualization_msgs::InteractiveMarkerControl::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: InteractiveMarkerControl");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerControl::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::InteractiveMarkerControl::DATA_TYPE_NAME,visualization_msgs::InteractiveMarkerControl::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: InteractiveMarkerControl");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerFeedback::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::InteractiveMarkerFeedback>(
                    // boost::lambda::new_ptr<visualization_msgs::InteractiveMarkerFeedback>(),
                    [](){ return new visualization_msgs::InteractiveMarkerFeedback(); },
                                std::bind(allocateMessage,visualization_msgs::InteractiveMarkerFeedback::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: InteractiveMarkerFeedback");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerFeedback::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::InteractiveMarkerFeedback::DATA_TYPE_NAME,visualization_msgs::InteractiveMarkerFeedback::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: InteractiveMarkerFeedback");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerInit::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::InteractiveMarkerInit>(
                    // boost::lambda::new_ptr<visualization_msgs::InteractiveMarkerInit>(),
                    [](){ return new visualization_msgs::InteractiveMarkerInit(); },
                                std::bind(allocateMessage,visualization_msgs::InteractiveMarkerInit::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: InteractiveMarkerInit");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerInit::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::InteractiveMarkerInit::DATA_TYPE_NAME,visualization_msgs::InteractiveMarkerInit::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: InteractiveMarkerInit");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerPose::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::InteractiveMarkerPose>(
                    // boost::lambda::new_ptr<visualization_msgs::InteractiveMarkerPose>(),
                    [](){ return new visualization_msgs::InteractiveMarkerPose(); },
                                std::bind(allocateMessage,visualization_msgs::InteractiveMarkerPose::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: InteractiveMarkerPose");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerPose::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::InteractiveMarkerPose::DATA_TYPE_NAME,visualization_msgs::InteractiveMarkerPose::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: InteractiveMarkerPose");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerUpdate::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::InteractiveMarkerUpdate>(
                    // boost::lambda::new_ptr<visualization_msgs::InteractiveMarkerUpdate>(),
                    [](){ return new visualization_msgs::InteractiveMarkerUpdate(); },
                                std::bind(allocateMessage,visualization_msgs::InteractiveMarkerUpdate::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: InteractiveMarkerUpdate");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::InteractiveMarkerUpdate::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::InteractiveMarkerUpdate::DATA_TYPE_NAME,visualization_msgs::InteractiveMarkerUpdate::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: InteractiveMarkerUpdate");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::Marker::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::Marker>(
                    // boost::lambda::new_ptr<visualization_msgs::Marker>(),
                    [](){ return new visualization_msgs::Marker(); },
                                std::bind(allocateMessage,visualization_msgs::Marker::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: Marker");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::Marker::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::Marker::DATA_TYPE_NAME,visualization_msgs::Marker::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: Marker");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::MarkerArray::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::MarkerArray>(
                    // boost::lambda::new_ptr<visualization_msgs::MarkerArray>(),
                    [](){ return new visualization_msgs::MarkerArray(); },
                                std::bind(allocateMessage,visualization_msgs::MarkerArray::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: MarkerArray");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::MarkerArray::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::MarkerArray::DATA_TYPE_NAME,visualization_msgs::MarkerArray::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: MarkerArray");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::MenuEntry::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerType<visualization_msgs::MenuEntry>(
                    // boost::lambda::new_ptr<visualization_msgs::MenuEntry>(),
                    [](){ return new visualization_msgs::MenuEntry(); },
                                std::bind(allocateMessage,visualization_msgs::MenuEntry::ID,
                                          std::placeholders::_1))) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class: MenuEntry");
            }

            if ((retval == rframe::Error::SUCCESS) 
                //  && ((retval = visualization_msgs::MenuEntry::registerType()) != rframe::Error::SUCCESS))
                && ((retval = reg.registerAlias(visualization_msgs::MenuEntry::DATA_TYPE_NAME,visualization_msgs::MenuEntry::DATA_TYPE_FULL_NAME)) != rframe::Error::SUCCESS)
                )
            {
                LOG_CRIT("failed to register class alias to short name: MenuEntry");
            }
...
<!--\
 \
  AUTOGENERATED FILE:   do not edit\
\
  Generated by:         yongbo on yongbo-XPS-15-9550, 2017-01-26 15:57:02 -0500\
