...
#ifndef _CODEGEN_VISUALIZATION_MSGS_INTERACTIVEMARKER_H_
#define _CODEGEN_VISUALIZATION_MSGS_INTERACTIVEMARKER_H_
...
PREDECLARE_BSON(visualization_msgs::InteractiveMarker); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(visualization_msgs::InteractiveMarker); // see Common.h, macro used for a cleaner header

namespace visualization_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, InteractiveMarker & inobj);   
    ...
    */
    ...
    public: 
        ...
        InteractiveMarker();
        /** copy constructor */
        InteractiveMarker(const InteractiveMarker & inobj);
        /** destructor */
        ~InteractiveMarker();

        /** allocator, convenience function for bind */
        static InteractiveMarker * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< Initial pose. Also, defines the pivot point for rotations. */
        geometry_msgs::Pose  pose; /**< Identifying string. Must be globally unique in  the topic that this message is sent through. */
        std::string  name; /**< Short description (< 40 characters). */
        std::string  description; /**< Scale to be used for default controls (default=1). */
        float  scale; /**< All menu and submenu entries associated with this marker. */
        std::vector<MenuEntry >  menu_entries; /**< List of controls displayed for this marker. */
        ...
        static const unsigned int ID = 2125420980U;
        ...
        static const unsigned int DATA_VERSION = 935950079U;
        ...
        //        static const char * dataTypeName() { return "InteractiveMarker"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "66dc0fe21b67bb3b3774adce54a8f7d0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x66dc0fe21b67bb3bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3774adce54a8f7d0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        InteractiveMarker * copy() { return new InteractiveMarker(*this); };

        /** assignment operator(s) */
        InteractiveMarker & operator=(const InteractiveMarker & inobj);
        /** equality operator */
        bool operator==(const InteractiveMarker & inobj) const;
        /** inequality operator */
        bool operator!=(const InteractiveMarker & inobj) const;
        /** less than operator */
        bool operator<(const InteractiveMarker & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, InteractiveMarker & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<visualization_msgs::InteractiveMarker>
    {
    public:
        static bool flat() {return visualization_msgs::InteractiveMarker::dataTypeFlat(); };
        static std::string sourceXML() {return visualization_msgs::InteractiveMarker::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const visualization_msgs::InteractiveMarker & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const visualization_msgs::InteractiveMarker & value);

#endif  //  _VISUALIZATION_MSGS_INTERACTIVEMARKER_H_
