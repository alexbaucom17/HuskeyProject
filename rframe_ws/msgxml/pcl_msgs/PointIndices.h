...
#ifndef _CODEGEN_PCL_MSGS_POINTINDICES_H_
#define _CODEGEN_PCL_MSGS_POINTINDICES_H_
...
PREDECLARE_BSON(pcl_msgs::PointIndices); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(pcl_msgs::PointIndices); // see Common.h, macro used for a cleaner header

namespace pcl_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointIndices & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointIndices();
        /** copy constructor */
        PointIndices(const PointIndices & inobj);
        /** destructor */
        ~PointIndices();

        /** allocator, convenience function for bind */
        static PointIndices * New();
        ...
        static const unsigned int ID = 1418389008U;
        ...
        static const unsigned int DATA_VERSION = 253361733U;
        ...
        //        static const char * dataTypeName() { return "PointIndices"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "065dc0919742570beb1490e95947a341"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x065dc0919742570bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xeb1490e95947a341ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointIndices * copy() { return new PointIndices(*this); };

        /** assignment operator(s) */
        PointIndices & operator=(const PointIndices & inobj);
        /** equality operator */
        bool operator==(const PointIndices & inobj) const;
        /** inequality operator */
        bool operator!=(const PointIndices & inobj) const;
        /** less than operator */
        bool operator<(const PointIndices & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointIndices & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<pcl_msgs::PointIndices>
    {
    public:
        static bool flat() {return pcl_msgs::PointIndices::dataTypeFlat(); };
        static std::string sourceXML() {return pcl_msgs::PointIndices::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const pcl_msgs::PointIndices & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const pcl_msgs::PointIndices & value);

#endif  //  _PCL_MSGS_POINTINDICES_H_
