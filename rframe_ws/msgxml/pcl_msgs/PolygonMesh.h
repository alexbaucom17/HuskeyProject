...
#ifndef _CODEGEN_PCL_MSGS_POLYGONMESH_H_
#define _CODEGEN_PCL_MSGS_POLYGONMESH_H_
...
PREDECLARE_BSON(pcl_msgs::PolygonMesh); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(pcl_msgs::PolygonMesh); // see Common.h, macro used for a cleaner header

namespace pcl_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PolygonMesh & inobj);   
    ...
    */
    ...
    public: 
        ...
        PolygonMesh();
        /** copy constructor */
        PolygonMesh(const PolygonMesh & inobj);
        /** destructor */
        ~PolygonMesh();

        /** allocator, convenience function for bind */
        static PolygonMesh * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< Vertices of the mesh as a point cloud */
        sensor_msgs::PointCloud2  cloud; /**< List of polygons */
        ...
        static const unsigned int ID = 1418389009U;
        ...
        static const unsigned int DATA_VERSION = 1424332296U;
        ...
        //        static const char * dataTypeName() { return "PolygonMesh"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9cbe3f940d94ffa5135b0e7038bf3bc8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9cbe3f940d94ffa5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x135b0e7038bf3bc8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PolygonMesh * copy() { return new PolygonMesh(*this); };

        /** assignment operator(s) */
        PolygonMesh & operator=(const PolygonMesh & inobj);
        /** equality operator */
        bool operator==(const PolygonMesh & inobj) const;
        /** inequality operator */
        bool operator!=(const PolygonMesh & inobj) const;
        /** less than operator */
        bool operator<(const PolygonMesh & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PolygonMesh & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<pcl_msgs::PolygonMesh>
    {
    public:
        static bool flat() {return pcl_msgs::PolygonMesh::dataTypeFlat(); };
        static std::string sourceXML() {return pcl_msgs::PolygonMesh::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const pcl_msgs::PolygonMesh & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const pcl_msgs::PolygonMesh & value);

#endif  //  _PCL_MSGS_POLYGONMESH_H_
