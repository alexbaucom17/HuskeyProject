...
#ifndef _CODEGEN_PCL_MSGS_MODELCOEFFICIENTS_H_
#define _CODEGEN_PCL_MSGS_MODELCOEFFICIENTS_H_
...
PREDECLARE_BSON(pcl_msgs::ModelCoefficients); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(pcl_msgs::ModelCoefficients); // see Common.h, macro used for a cleaner header

namespace pcl_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ModelCoefficients & inobj);   
    ...
    */
    ...
    public: 
        ...
        ModelCoefficients();
        /** copy constructor */
        ModelCoefficients(const ModelCoefficients & inobj);
        /** destructor */
        ~ModelCoefficients();

        /** allocator, convenience function for bind */
        static ModelCoefficients * New();
        ...
        static const unsigned int ID = 1418389007U;
        ...
        static const unsigned int DATA_VERSION = 313963375U;
        ...
        //        static const char * dataTypeName() { return "ModelCoefficients"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "53d76904b6306a605982c7763ca56ce7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x53d76904b6306a60ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5982c7763ca56ce7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ModelCoefficients * copy() { return new ModelCoefficients(*this); };

        /** assignment operator(s) */
        ModelCoefficients & operator=(const ModelCoefficients & inobj);
        /** equality operator */
        bool operator==(const ModelCoefficients & inobj) const;
        /** inequality operator */
        bool operator!=(const ModelCoefficients & inobj) const;
        /** less than operator */
        bool operator<(const ModelCoefficients & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ModelCoefficients & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<pcl_msgs::ModelCoefficients>
    {
    public:
        static bool flat() {return pcl_msgs::ModelCoefficients::dataTypeFlat(); };
        static std::string sourceXML() {return pcl_msgs::ModelCoefficients::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const pcl_msgs::ModelCoefficients & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const pcl_msgs::ModelCoefficients & value);

#endif  //  _PCL_MSGS_MODELCOEFFICIENTS_H_
