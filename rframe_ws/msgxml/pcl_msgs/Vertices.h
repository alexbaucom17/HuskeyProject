...
#ifndef _CODEGEN_PCL_MSGS_VERTICES_H_
#define _CODEGEN_PCL_MSGS_VERTICES_H_
...
PREDECLARE_BSON(pcl_msgs::Vertices); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(pcl_msgs::Vertices); // see Common.h, macro used for a cleaner header

namespace pcl_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Vertices & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1418389010U;
        ...
        static const unsigned int DATA_VERSION = 2211659220U;
        ...
        //        static const char * dataTypeName() { return "Vertices"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "39cf8a3d349c948be6611e570b5cdc3c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x39cf8a3d349c948bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe6611e570b5cdc3cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Vertices * copy() { return new Vertices(*this); };

        /** assignment operator(s) */
        Vertices & operator=(const Vertices & inobj);
        /** equality operator */
        bool operator==(const Vertices & inobj) const;
        /** inequality operator */
        bool operator!=(const Vertices & inobj) const;
        /** less than operator */
        bool operator<(const Vertices & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Vertices & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<pcl_msgs::Vertices>
    {
    public:
        static bool flat() {return pcl_msgs::Vertices::dataTypeFlat(); };
        static std::string sourceXML() {return pcl_msgs::Vertices::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const pcl_msgs::Vertices & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const pcl_msgs::Vertices & value);

#endif  //  _PCL_MSGS_VERTICES_H_
