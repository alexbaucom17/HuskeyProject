...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIACTIONFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIACTIONFEEDBACK_H_
...
PREDECLARE_BSON(actionlib_tutorials::FibonacciActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::FibonacciActionFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FibonacciActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        FibonacciActionFeedback(const FibonacciActionFeedback & inobj);
        /** destructor */
        ~FibonacciActionFeedback();

        /** allocator, convenience function for bind */
        static FibonacciActionFeedback * New();
        ...
        static const unsigned int ID = 1868636219U;
        ...
        static const unsigned int DATA_VERSION = 1213412981U;
        ...
        //        static const char * dataTypeName() { return "FibonacciActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "09a2cdad632b66b138056ac5abecebdc"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x09a2cdad632b66b1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x38056ac5abecebdcULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FibonacciActionFeedback * copy() { return new FibonacciActionFeedback(*this); };

        /** assignment operator(s) */
        FibonacciActionFeedback & operator=(const FibonacciActionFeedback & inobj);
        /** equality operator */
        bool operator==(const FibonacciActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const FibonacciActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const FibonacciActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FibonacciActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::FibonacciActionFeedback>
    {
    public:
        static bool flat() {return actionlib_tutorials::FibonacciActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::FibonacciActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::FibonacciActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::FibonacciActionFeedback & value);

#endif  //  _ACTIONLIB_TUTORIALS_FIBONACCIACTIONFEEDBACK_H_
