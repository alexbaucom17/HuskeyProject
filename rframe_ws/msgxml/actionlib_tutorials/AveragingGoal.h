...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGGOAL_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGGOAL_H_
...
PREDECLARE_BSON(actionlib_tutorials::AveragingGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::AveragingGoal); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AveragingGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        AveragingGoal();
        /** copy constructor */
        AveragingGoal(const AveragingGoal & inobj);
        /** destructor */
        ~AveragingGoal();

        /** allocator, convenience function for bind */
        static AveragingGoal * New();
        ...
        static const unsigned int ID = 1868636216U;
        ...
        static const unsigned int DATA_VERSION = 4196718350U;
        ...
        //        static const char * dataTypeName() { return "AveragingGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0efb5750596f755a76c9b802dabe0594"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0efb5750596f755aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x76c9b802dabe0594ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AveragingGoal * copy() { return new AveragingGoal(*this); };

        /** assignment operator(s) */
        AveragingGoal & operator=(const AveragingGoal & inobj);
        /** equality operator */
        bool operator==(const AveragingGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const AveragingGoal & inobj) const;
        /** less than operator */
        bool operator<(const AveragingGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AveragingGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::AveragingGoal>
    {
    public:
        static bool flat() {return actionlib_tutorials::AveragingGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::AveragingGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::AveragingGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::AveragingGoal & value);

#endif  //  _ACTIONLIB_TUTORIALS_AVERAGINGGOAL_H_
