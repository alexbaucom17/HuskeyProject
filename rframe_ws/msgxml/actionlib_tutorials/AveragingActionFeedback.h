...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGACTIONFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGACTIONFEEDBACK_H_
...
PREDECLARE_BSON(actionlib_tutorials::AveragingActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::AveragingActionFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AveragingActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        AveragingActionFeedback(const AveragingActionFeedback & inobj);
        /** destructor */
        ~AveragingActionFeedback();

        /** allocator, convenience function for bind */
        static AveragingActionFeedback * New();
        ...
        static const unsigned int ID = 1868636212U;
        ...
        static const unsigned int DATA_VERSION = 3028385998U;
        ...
        //        static const char * dataTypeName() { return "AveragingActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f713c47c03892138c819879f161b0c7b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf713c47c03892138ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc819879f161b0c7bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AveragingActionFeedback * copy() { return new AveragingActionFeedback(*this); };

        /** assignment operator(s) */
        AveragingActionFeedback & operator=(const AveragingActionFeedback & inobj);
        /** equality operator */
        bool operator==(const AveragingActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const AveragingActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const AveragingActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AveragingActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::AveragingActionFeedback>
    {
    public:
        static bool flat() {return actionlib_tutorials::AveragingActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::AveragingActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::AveragingActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::AveragingActionFeedback & value);

#endif  //  _ACTIONLIB_TUTORIALS_AVERAGINGACTIONFEEDBACK_H_
