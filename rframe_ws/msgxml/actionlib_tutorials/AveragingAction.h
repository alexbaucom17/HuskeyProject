...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGACTION_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGACTION_H_
...
PREDECLARE_BSON(actionlib_tutorials::AveragingAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::AveragingAction); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AveragingAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        AveragingAction();
        /** copy constructor */
        AveragingAction(const AveragingAction & inobj);
        /** destructor */
        ~AveragingAction();

        /** allocator, convenience function for bind */
        static AveragingAction * New();
        ...
        static const unsigned int ID = 1868636211U;
        ...
        static const unsigned int DATA_VERSION = 2609663913U;
        ...
        //        static const char * dataTypeName() { return "AveragingAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "fe86e403b8f00dce0d03a710d770365c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfe86e403b8f00dceULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0d03a710d770365cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AveragingAction * copy() { return new AveragingAction(*this); };

        /** assignment operator(s) */
        AveragingAction & operator=(const AveragingAction & inobj);
        /** equality operator */
        bool operator==(const AveragingAction & inobj) const;
        /** inequality operator */
        bool operator!=(const AveragingAction & inobj) const;
        /** less than operator */
        bool operator<(const AveragingAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AveragingAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::AveragingAction>
    {
    public:
        static bool flat() {return actionlib_tutorials::AveragingAction::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::AveragingAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::AveragingAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::AveragingAction & value);

#endif  //  _ACTIONLIB_TUTORIALS_AVERAGINGACTION_H_
