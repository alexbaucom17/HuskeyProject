...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIACTION_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIACTION_H_
...
PREDECLARE_BSON(actionlib_tutorials::FibonacciAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::FibonacciAction); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FibonacciAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        FibonacciAction();
        /** copy constructor */
        FibonacciAction(const FibonacciAction & inobj);
        /** destructor */
        ~FibonacciAction();

        /** allocator, convenience function for bind */
        static FibonacciAction * New();
        ...
        static const unsigned int ID = 1868636218U;
        ...
        static const unsigned int DATA_VERSION = 2216274993U;
        ...
        //        static const char * dataTypeName() { return "FibonacciAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2db8f6f177db1a8894e64156f3d23ed1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2db8f6f177db1a88ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x94e64156f3d23ed1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FibonacciAction * copy() { return new FibonacciAction(*this); };

        /** assignment operator(s) */
        FibonacciAction & operator=(const FibonacciAction & inobj);
        /** equality operator */
        bool operator==(const FibonacciAction & inobj) const;
        /** inequality operator */
        bool operator!=(const FibonacciAction & inobj) const;
        /** less than operator */
        bool operator<(const FibonacciAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FibonacciAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::FibonacciAction>
    {
    public:
        static bool flat() {return actionlib_tutorials::FibonacciAction::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::FibonacciAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::FibonacciAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::FibonacciAction & value);

#endif  //  _ACTIONLIB_TUTORIALS_FIBONACCIACTION_H_
