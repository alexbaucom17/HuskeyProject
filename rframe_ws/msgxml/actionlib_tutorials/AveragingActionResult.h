...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGACTIONRESULT_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGACTIONRESULT_H_
...
PREDECLARE_BSON(actionlib_tutorials::AveragingActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::AveragingActionResult); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AveragingActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        AveragingActionResult(const AveragingActionResult & inobj);
        /** destructor */
        ~AveragingActionResult();

        /** allocator, convenience function for bind */
        static AveragingActionResult * New();
        ...
        static const unsigned int ID = 1868636214U;
        ...
        static const unsigned int DATA_VERSION = 3941384079U;
        ...
        //        static const char * dataTypeName() { return "AveragingActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "50a876a9b8e52c61e49607123302968f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x50a876a9b8e52c61ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe49607123302968fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AveragingActionResult * copy() { return new AveragingActionResult(*this); };

        /** assignment operator(s) */
        AveragingActionResult & operator=(const AveragingActionResult & inobj);
        /** equality operator */
        bool operator==(const AveragingActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const AveragingActionResult & inobj) const;
        /** less than operator */
        bool operator<(const AveragingActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AveragingActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::AveragingActionResult>
    {
    public:
        static bool flat() {return actionlib_tutorials::AveragingActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::AveragingActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::AveragingActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::AveragingActionResult & value);

#endif  //  _ACTIONLIB_TUTORIALS_AVERAGINGACTIONRESULT_H_
