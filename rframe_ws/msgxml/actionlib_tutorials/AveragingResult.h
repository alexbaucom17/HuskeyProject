...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGRESULT_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGRESULT_H_
...
PREDECLARE_BSON(actionlib_tutorials::AveragingResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::AveragingResult); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AveragingResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        AveragingResult();
        /** copy constructor */
        AveragingResult(const AveragingResult & inobj);
        /** destructor */
        ~AveragingResult();

        /** allocator, convenience function for bind */
        static AveragingResult * New();
        ...
        static const unsigned int ID = 1868636217U;
        ...
        static const unsigned int DATA_VERSION = 765376311U;
        ...
        //        static const char * dataTypeName() { return "AveragingResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bfd4284a7a7e01df1c73f7964968a0b3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbfd4284a7a7e01dfULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1c73f7964968a0b3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AveragingResult * copy() { return new AveragingResult(*this); };

        /** assignment operator(s) */
        AveragingResult & operator=(const AveragingResult & inobj);
        /** equality operator */
        bool operator==(const AveragingResult & inobj) const;
        /** inequality operator */
        bool operator!=(const AveragingResult & inobj) const;
        /** less than operator */
        bool operator<(const AveragingResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AveragingResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::AveragingResult>
    {
    public:
        static bool flat() {return actionlib_tutorials::AveragingResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::AveragingResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::AveragingResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::AveragingResult & value);

#endif  //  _ACTIONLIB_TUTORIALS_AVERAGINGRESULT_H_
