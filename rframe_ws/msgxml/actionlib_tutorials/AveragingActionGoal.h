...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGACTIONGOAL_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGACTIONGOAL_H_
...
PREDECLARE_BSON(actionlib_tutorials::AveragingActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::AveragingActionGoal); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AveragingActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        AveragingActionGoal();
        /** copy constructor */
        AveragingActionGoal(const AveragingActionGoal & inobj);
        /** destructor */
        ~AveragingActionGoal();

        /** allocator, convenience function for bind */
        static AveragingActionGoal * New();
        ...
        static const unsigned int ID = 1868636213U;
        ...
        static const unsigned int DATA_VERSION = 860974873U;
        ...
        //        static const char * dataTypeName() { return "AveragingActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "31a32f142580bf4d16f8233e245ba09d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x31a32f142580bf4dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x16f8233e245ba09dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AveragingActionGoal * copy() { return new AveragingActionGoal(*this); };

        /** assignment operator(s) */
        AveragingActionGoal & operator=(const AveragingActionGoal & inobj);
        /** equality operator */
        bool operator==(const AveragingActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const AveragingActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const AveragingActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AveragingActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::AveragingActionGoal>
    {
    public:
        static bool flat() {return actionlib_tutorials::AveragingActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::AveragingActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::AveragingActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::AveragingActionGoal & value);

#endif  //  _ACTIONLIB_TUTORIALS_AVERAGINGACTIONGOAL_H_
