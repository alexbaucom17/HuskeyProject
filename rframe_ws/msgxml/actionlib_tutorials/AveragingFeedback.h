...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_AVERAGINGFEEDBACK_H_
...
PREDECLARE_BSON(actionlib_tutorials::AveragingFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::AveragingFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AveragingFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        AveragingFeedback();
        /** copy constructor */
        AveragingFeedback(const AveragingFeedback & inobj);
        /** destructor */
        ~AveragingFeedback();

        /** allocator, convenience function for bind */
        static AveragingFeedback * New();
        ...
        static const unsigned int ID = 1868636215U;
        ...
        static const unsigned int DATA_VERSION = 2300658139U;
        ...
        //        static const char * dataTypeName() { return "AveragingFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bc09c66baea0acd54dbcb316ddedb885"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbc09c66baea0acd5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4dbcb316ddedb885ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AveragingFeedback * copy() { return new AveragingFeedback(*this); };

        /** assignment operator(s) */
        AveragingFeedback & operator=(const AveragingFeedback & inobj);
        /** equality operator */
        bool operator==(const AveragingFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const AveragingFeedback & inobj) const;
        /** less than operator */
        bool operator<(const AveragingFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AveragingFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::AveragingFeedback>
    {
    public:
        static bool flat() {return actionlib_tutorials::AveragingFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::AveragingFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::AveragingFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::AveragingFeedback & value);

#endif  //  _ACTIONLIB_TUTORIALS_AVERAGINGFEEDBACK_H_
