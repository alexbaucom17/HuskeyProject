...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIGOAL_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIGOAL_H_
...
PREDECLARE_BSON(actionlib_tutorials::FibonacciGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::FibonacciGoal); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FibonacciGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        FibonacciGoal();
        /** copy constructor */
        FibonacciGoal(const FibonacciGoal & inobj);
        /** destructor */
        ~FibonacciGoal();

        /** allocator, convenience function for bind */
        static FibonacciGoal * New();
        ...
        static const unsigned int ID = 1868636223U;
        ...
        static const unsigned int DATA_VERSION = 3198349816U;
        ...
        //        static const char * dataTypeName() { return "FibonacciGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6f45fb0e2cef1b80448865175433e7dc"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6f45fb0e2cef1b80ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x448865175433e7dcULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FibonacciGoal * copy() { return new FibonacciGoal(*this); };

        /** assignment operator(s) */
        FibonacciGoal & operator=(const FibonacciGoal & inobj);
        /** equality operator */
        bool operator==(const FibonacciGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const FibonacciGoal & inobj) const;
        /** less than operator */
        bool operator<(const FibonacciGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FibonacciGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::FibonacciGoal>
    {
    public:
        static bool flat() {return actionlib_tutorials::FibonacciGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::FibonacciGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::FibonacciGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::FibonacciGoal & value);

#endif  //  _ACTIONLIB_TUTORIALS_FIBONACCIGOAL_H_
