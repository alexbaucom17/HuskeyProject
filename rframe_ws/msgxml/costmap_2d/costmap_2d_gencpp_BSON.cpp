...
template <> int rframe::bson_io::encode(rframe::bson_io::BsonObj & b, const costmap_2d::VoxelGrid & inobj, const char * name)
{
    ...
    if (retval == Error::SUCCESS) retval = rframe::bson_io::encode(*doc,inobj.resolutions,"resolutions");
    if (retval == Error::SUCCESS) retval = rframe::bson_io::encode(*doc,inobj.size_x,"size_x");
    if (retval == Error::SUCCESS) retval = rframe::bson_io::encode(*doc,inobj.size_y,"size_y");
    if (retval == Error::SUCCESS) retval = rframe::bson_io::encode(*doc,inobj.size_z,"size_z");
...
template <> int rframe::bson_io::decode(costmap_2d::VoxelGrid & t, rframe::bson_io::BsonIterator &it, const char * name, bool lookupFields)
{
    int retval = rframe::Error::SUCCESS;

    if (rframe::bson_io::bsonDebug == true) cout << "bsoncodegen decode of VoxelGrid, lookup fields: " << lookupFields << endl;
    ...
    if (lookupFields == false)
    {
        ...
        // decode of member resolutions
        if ((retval == Error::NOT_FOUND) || (retval == Error::SUCCESS))
        {
            if (rframe::bson_io::bsonDebug == true) cout << "bsoncodegen decode of member resolutions" << endl;
            retval = rframe::bson_io::decode(t.resolutions,*tempIt,"resolutions",lookupFields);
            if (rframe::bson_io::bsonDebug == true) cout << "  field retval is " << std::dec << retval << endl;
        }    

        // decode of member size_x
        if ((retval == Error::NOT_FOUND) || (retval == Error::SUCCESS))
        {
            if (rframe::bson_io::bsonDebug == true) cout << "bsoncodegen decode of member size_x" << endl;
            retval = rframe::bson_io::decode(t.size_x,*tempIt,"size_x",lookupFields);
            if (rframe::bson_io::bsonDebug == true) cout << "  field retval is " << std::dec << retval << endl;
        }    

        // decode of member size_y
        if ((retval == Error::NOT_FOUND) || (retval == Error::SUCCESS))
        {
            if (rframe::bson_io::bsonDebug == true) cout << "bsoncodegen decode of member size_y" << endl;
            retval = rframe::bson_io::decode(t.size_y,*tempIt,"size_y",lookupFields);
            if (rframe::bson_io::bsonDebug == true) cout << "  field retval is " << std::dec << retval << endl;
        }    

        // decode of member size_z
        if ((retval == Error::NOT_FOUND) || (retval == Error::SUCCESS))
        {
            if (rframe::bson_io::bsonDebug == true) cout << "bsoncodegen decode of member size_z" << endl;
            retval = rframe::bson_io::decode(t.size_z,*tempIt,"size_z",lookupFields);
            if (rframe::bson_io::bsonDebug == true) cout << "  field retval is " << std::dec << retval << endl;
        }    
    ...
    else
    {
        ...
        {            
            ...
            {
                retval = rframe::bson_io::decode(t.resolutions,it2,"resolutions",lookupFields);
                if (rframe::bson_io::bsonDebug == true) cout << "  field retval is " << std::dec << retval << endl;
              if ((retval == rframe::Error::SUCCESS) && (storedIter.iter().off < it2.iter().off))
              {
                  storedIter = it2;
        ...
        {            
            ...
            {
                retval = rframe::bson_io::decode(t.size_x,it2,"size_x",lookupFields);
                if (rframe::bson_io::bsonDebug == true) cout << "  field retval is " << std::dec << retval << endl;
              if ((retval == rframe::Error::SUCCESS) && (storedIter.iter().off < it2.iter().off))
              {
                  storedIter = it2;
        ...
        {            
            ...
            {
                retval = rframe::bson_io::decode(t.size_y,it2,"size_y",lookupFields);
                if (rframe::bson_io::bsonDebug == true) cout << "  field retval is " << std::dec << retval << endl;
              if ((retval == rframe::Error::SUCCESS) && (storedIter.iter().off < it2.iter().off))
              {
                  storedIter = it2;
        ...
        {            
            ...
            {
                retval = rframe::bson_io::decode(t.size_z,it2,"size_z",lookupFields);
                if (rframe::bson_io::bsonDebug == true) cout << "  field retval is " << std::dec << retval << endl;
              if ((retval == rframe::Error::SUCCESS) && (storedIter.iter().off < it2.iter().off))
              {
                  storedIter = it2;
