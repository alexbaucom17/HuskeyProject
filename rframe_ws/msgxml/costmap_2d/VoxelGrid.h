...
#ifndef _CODEGEN_COSTMAP_2D_VOXELGRID_H_
#define _CODEGEN_COSTMAP_2D_VOXELGRID_H_
...
PREDECLARE_BSON(costmap_2d::VoxelGrid); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(costmap_2d::VoxelGrid); // see Common.h, macro used for a cleaner header

namespace costmap_2d
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, VoxelGrid & inobj);   
    ...
    */
    ...
    public: 
        ...
        VoxelGrid();
        /** copy constructor */
        VoxelGrid(const VoxelGrid & inobj);
        /** destructor */
        ~VoxelGrid();

        /** allocator, convenience function for bind */
        static VoxelGrid * New();
        ...
        static const unsigned int ID = 166564990U;
        ...
        static const unsigned int DATA_VERSION = 244776824U;
        ...
        //        static const char * dataTypeName() { return "VoxelGrid"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5179d66b9ecf258a94faa420210d68fb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5179d66b9ecf258aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x94faa420210d68fbULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        VoxelGrid * copy() { return new VoxelGrid(*this); };

        /** assignment operator(s) */
        VoxelGrid & operator=(const VoxelGrid & inobj);
        /** equality operator */
        bool operator==(const VoxelGrid & inobj) const;
        /** inequality operator */
        bool operator!=(const VoxelGrid & inobj) const;
        /** less than operator */
        bool operator<(const VoxelGrid & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, VoxelGrid & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<costmap_2d::VoxelGrid>
    {
    public:
        static bool flat() {return costmap_2d::VoxelGrid::dataTypeFlat(); };
        static std::string sourceXML() {return costmap_2d::VoxelGrid::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const costmap_2d::VoxelGrid & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const costmap_2d::VoxelGrid & value);

#endif  //  _COSTMAP_2D_VOXELGRID_H_
