...
#ifndef _CODEGEN_SHAPE_MSGS_PLANE_H_
#define _CODEGEN_SHAPE_MSGS_PLANE_H_
...
PREDECLARE_BSON(shape_msgs::Plane); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(shape_msgs::Plane); // see Common.h, macro used for a cleaner header

namespace shape_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Plane & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** definition of max size of array for coef */
        static const unsigned int COEF_MAX = 4;
        /** shorthand definition for array of coef */
        typedef std::array<double,COEF_MAX> CoefArray;
        ...
        static const unsigned int ID = 2077658563U;
        ...
        static const unsigned int DATA_VERSION = 3085157603U;
        ...
        //        static const char * dataTypeName() { return "Plane"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "509493124fdc15dd661df8ea458b923c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x509493124fdc15ddULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x661df8ea458b923cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Plane * copy() { return new Plane(*this); };

        /** assignment operator(s) */
        Plane & operator=(const Plane & inobj);
        /** equality operator */
        bool operator==(const Plane & inobj) const;
        /** inequality operator */
        bool operator!=(const Plane & inobj) const;
        /** less than operator */
        bool operator<(const Plane & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Plane & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<shape_msgs::Plane>
    {
    public:
        static bool flat() {return shape_msgs::Plane::dataTypeFlat(); };
        static std::string sourceXML() {return shape_msgs::Plane::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const shape_msgs::Plane & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const shape_msgs::Plane & value);

#endif  //  _SHAPE_MSGS_PLANE_H_
