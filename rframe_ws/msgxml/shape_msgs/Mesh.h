...
#ifndef _CODEGEN_SHAPE_MSGS_MESH_H_
#define _CODEGEN_SHAPE_MSGS_MESH_H_
...
PREDECLARE_BSON(shape_msgs::Mesh); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(shape_msgs::Mesh); // see Common.h, macro used for a cleaner header

namespace shape_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Mesh & inobj);   
    ...
    */
    ...
    public: 
        ...
        std::vector<MeshTriangle >  triangles; /**< the actual vertices that make up the mesh */
        ...
        static const unsigned int ID = 2077658561U;
        ...
        static const unsigned int DATA_VERSION = 3490035471U;
        ...
        //        static const char * dataTypeName() { return "Mesh"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1386a2ae7b7af539d9578fbe07e419a1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1386a2ae7b7af539ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd9578fbe07e419a1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Mesh * copy() { return new Mesh(*this); };

        /** assignment operator(s) */
        Mesh & operator=(const Mesh & inobj);
        /** equality operator */
        bool operator==(const Mesh & inobj) const;
        /** inequality operator */
        bool operator!=(const Mesh & inobj) const;
        /** less than operator */
        bool operator<(const Mesh & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Mesh & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<shape_msgs::Mesh>
    {
    public:
        static bool flat() {return shape_msgs::Mesh::dataTypeFlat(); };
        static std::string sourceXML() {return shape_msgs::Mesh::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const shape_msgs::Mesh & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const shape_msgs::Mesh & value);

#endif  //  _SHAPE_MSGS_MESH_H_
