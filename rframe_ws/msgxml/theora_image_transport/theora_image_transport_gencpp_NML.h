...
#ifndef _CODEGEN_THEORA_IMAGE_TRANSPORT_GENCPPNML_H_
#define _CODEGEN_THEORA_IMAGE_TRANSPORT_GENCPPNML_H_

#include <messaging/nml/NMLMessageFactory.h>
//#include <DataTypeInfo.h>
#include <messaging/Message.h>

#include "theora_image_transport_gencpp_NMLSupport.h"
...
namespace theora_image_transport {
    ...
    class theora_image_transport_gencppNMLMessageFactory : public NMLMessageFactory
    {
    public:
        /** constructor */
        theora_image_transport_gencppNMLMessageFactory();
        /** destructor */
        virtual ~theora_image_transport_gencppNMLMessageFactory();
    ...
    NMLMessageFactory * allocate_theora_image_transport_gencpp();

    /** NML interface for Packet 

    */
    class PacketNML : public NMLmsg
    {
    public:
        ...
        /** assignment operator */
        PacketNML & operator=(const PacketNML &inobj);
        /** assignment operator for base data class */
        PacketNML & operator=(const Packet &inobj);
        ...
        /** set payload */
        void payload(const Packet &data) 
        {
            nmlPayload = data;
        };

        /** set payload from shared_ptr */
        void payload(std::shared_ptr<Packet> & data)
        {
            nmlPayload = *data.get();
        };

        /** \return pointer to nml payload */
        Packet * payload() { return & nmlPayload; };

    //     std::shared_ptr<Packet> nmlPayload; reminder that nmlPayload used to be a pointer
    ...
    void nmlupdate(CMS *cms, theora_image_transport::Packet & inobj);

    /** nml format function */
    int theora_image_transport_gencpp_format(NMLTYPE type, void * buffer, CMS* cms);

}; // end namespace theora_image_transport

#endif // _THEORA_IMAGE_TRANSPORT_GENCPPNML_H_
