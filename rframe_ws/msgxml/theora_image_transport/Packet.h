...
#ifndef _CODEGEN_THEORA_IMAGE_TRANSPORT_PACKET_H_
#define _CODEGEN_THEORA_IMAGE_TRANSPORT_PACKET_H_
...
PREDECLARE_BSON(theora_image_transport::Packet); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(theora_image_transport::Packet); // see Common.h, macro used for a cleaner header

namespace theora_image_transport
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Packet & inobj);   
    ...
    */
    ...
    public: 
        ...
        std::vector<unsigned char >  data; /**< Raw Theora packet data (combines packet and bytes fields from ogg_packet) */
        int  b_o_s; /**< Flag indicating whether this packet begins a logical bitstream */
        int  e_o_s; /**< Flag indicating whether this packet ends a bitstream */
        long long int  granulepos; /**< A number indicating the position of this packet in the decoded data */
        long long int  packetno; /**< Sequential number of this packet in the ogg bitstream */
        ...
        static const unsigned int ID = 1125733595U;
        ...
        static const unsigned int DATA_VERSION = 2301479670U;
        ...
        //        static const char * dataTypeName() { return "Packet"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1bfd489efb319c781dbaadbb1df96c7d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1bfd489efb319c78ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1dbaadbb1df96c7dULL;
        ...
        Packet & operator=(const Packet & inobj);
        /** equality operator */
        bool operator==(const Packet & inobj) const;
        /** inequality operator */
        bool operator!=(const Packet & inobj) const;
        /** less than operator */
        bool operator<(const Packet & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Packet & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<theora_image_transport::Packet>
    {
    public:
        static bool flat() {return theora_image_transport::Packet::dataTypeFlat(); };
        static std::string sourceXML() {return theora_image_transport::Packet::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const theora_image_transport::Packet & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const theora_image_transport::Packet & value);

#endif  //  _THEORA_IMAGE_TRANSPORT_PACKET_H_
