...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIACTIONGOAL_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIACTIONGOAL_H_
...
PREDECLARE_BSON(actionlib_tutorials::FibonacciActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::FibonacciActionGoal); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FibonacciActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        FibonacciActionGoal();
        /** copy constructor */
        FibonacciActionGoal(const FibonacciActionGoal & inobj);
        /** destructor */
        ~FibonacciActionGoal();

        /** allocator, convenience function for bind */
        static FibonacciActionGoal * New();
        ...
        static const unsigned int ID = 1868636220U;
        ...
        static const unsigned int DATA_VERSION = 1637983568U;
        ...
        //        static const char * dataTypeName() { return "FibonacciActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b549a6be92c29023c41d14accf92b4ea"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb549a6be92c29023ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc41d14accf92b4eaULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FibonacciActionGoal * copy() { return new FibonacciActionGoal(*this); };

        /** assignment operator(s) */
        FibonacciActionGoal & operator=(const FibonacciActionGoal & inobj);
        /** equality operator */
        bool operator==(const FibonacciActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const FibonacciActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const FibonacciActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FibonacciActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::FibonacciActionGoal>
    {
    public:
        static bool flat() {return actionlib_tutorials::FibonacciActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::FibonacciActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::FibonacciActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::FibonacciActionGoal & value);

#endif  //  _ACTIONLIB_TUTORIALS_FIBONACCIACTIONGOAL_H_
