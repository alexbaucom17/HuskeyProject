...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIFEEDBACK_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIFEEDBACK_H_
...
PREDECLARE_BSON(actionlib_tutorials::FibonacciFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::FibonacciFeedback); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FibonacciFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        FibonacciFeedback();
        /** copy constructor */
        FibonacciFeedback(const FibonacciFeedback & inobj);
        /** destructor */
        ~FibonacciFeedback();

        /** allocator, convenience function for bind */
        static FibonacciFeedback * New();
        ...
        static const unsigned int ID = 1868636222U;
        ...
        static const unsigned int DATA_VERSION = 619142207U;
        ...
        //        static const char * dataTypeName() { return "FibonacciFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a9197b2ae1ec6b21b14571ec275f111a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa9197b2ae1ec6b21ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb14571ec275f111aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FibonacciFeedback * copy() { return new FibonacciFeedback(*this); };

        /** assignment operator(s) */
        FibonacciFeedback & operator=(const FibonacciFeedback & inobj);
        /** equality operator */
        bool operator==(const FibonacciFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const FibonacciFeedback & inobj) const;
        /** less than operator */
        bool operator<(const FibonacciFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FibonacciFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::FibonacciFeedback>
    {
    public:
        static bool flat() {return actionlib_tutorials::FibonacciFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::FibonacciFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::FibonacciFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::FibonacciFeedback & value);

#endif  //  _ACTIONLIB_TUTORIALS_FIBONACCIFEEDBACK_H_
