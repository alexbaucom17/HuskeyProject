...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIRESULT_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIRESULT_H_
...
PREDECLARE_BSON(actionlib_tutorials::FibonacciResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::FibonacciResult); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FibonacciResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        FibonacciResult();
        /** copy constructor */
        FibonacciResult(const FibonacciResult & inobj);
        /** destructor */
        ~FibonacciResult();

        /** allocator, convenience function for bind */
        static FibonacciResult * New();
        ...
        static const unsigned int ID = 1868636224U;
        ...
        static const unsigned int DATA_VERSION = 2219944217U;
        ...
        //        static const char * dataTypeName() { return "FibonacciResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1e150a81542bf979c30de0fc5e629766"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1e150a81542bf979ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc30de0fc5e629766ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FibonacciResult * copy() { return new FibonacciResult(*this); };

        /** assignment operator(s) */
        FibonacciResult & operator=(const FibonacciResult & inobj);
        /** equality operator */
        bool operator==(const FibonacciResult & inobj) const;
        /** inequality operator */
        bool operator!=(const FibonacciResult & inobj) const;
        /** less than operator */
        bool operator<(const FibonacciResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FibonacciResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::FibonacciResult>
    {
    public:
        static bool flat() {return actionlib_tutorials::FibonacciResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::FibonacciResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::FibonacciResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::FibonacciResult & value);

#endif  //  _ACTIONLIB_TUTORIALS_FIBONACCIRESULT_H_
