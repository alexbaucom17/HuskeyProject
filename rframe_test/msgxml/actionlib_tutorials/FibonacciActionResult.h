...
#ifndef _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIACTIONRESULT_H_
#define _CODEGEN_ACTIONLIB_TUTORIALS_FIBONACCIACTIONRESULT_H_
...
PREDECLARE_BSON(actionlib_tutorials::FibonacciActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib_tutorials::FibonacciActionResult); // see Common.h, macro used for a cleaner header

namespace actionlib_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FibonacciActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        FibonacciActionResult(const FibonacciActionResult & inobj);
        /** destructor */
        ~FibonacciActionResult();

        /** allocator, convenience function for bind */
        static FibonacciActionResult * New();
        ...
        static const unsigned int ID = 1868636221U;
        ...
        static const unsigned int DATA_VERSION = 2422294412U;
        ...
        //        static const char * dataTypeName() { return "FibonacciActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1cf514da684cfda5eac1a4398e18ccd6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1cf514da684cfda5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xeac1a4398e18ccd6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FibonacciActionResult * copy() { return new FibonacciActionResult(*this); };

        /** assignment operator(s) */
        FibonacciActionResult & operator=(const FibonacciActionResult & inobj);
        /** equality operator */
        bool operator==(const FibonacciActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const FibonacciActionResult & inobj) const;
        /** less than operator */
        bool operator<(const FibonacciActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FibonacciActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib_tutorials::FibonacciActionResult>
    {
    public:
        static bool flat() {return actionlib_tutorials::FibonacciActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib_tutorials::FibonacciActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib_tutorials::FibonacciActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib_tutorials::FibonacciActionResult & value);

#endif  //  _ACTIONLIB_TUTORIALS_FIBONACCIACTIONRESULT_H_
