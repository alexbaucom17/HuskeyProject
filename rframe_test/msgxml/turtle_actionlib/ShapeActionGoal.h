...
#ifndef _CODEGEN_TURTLE_ACTIONLIB_SHAPEACTIONGOAL_H_
#define _CODEGEN_TURTLE_ACTIONLIB_SHAPEACTIONGOAL_H_
...
PREDECLARE_BSON(turtle_actionlib::ShapeActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtle_actionlib::ShapeActionGoal); // see Common.h, macro used for a cleaner header

namespace turtle_actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ShapeActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        ShapeActionGoal();
        /** copy constructor */
        ShapeActionGoal(const ShapeActionGoal & inobj);
        /** destructor */
        ~ShapeActionGoal();

        /** allocator, convenience function for bind */
        static ShapeActionGoal * New();
        ...
        static const unsigned int ID = 1300583012U;
        ...
        static const unsigned int DATA_VERSION = 2947556511U;
        ...
        //        static const char * dataTypeName() { return "ShapeActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b88c7ecb5a9c67046eb085fbc263938a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb88c7ecb5a9c6704ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6eb085fbc263938aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ShapeActionGoal * copy() { return new ShapeActionGoal(*this); };

        /** assignment operator(s) */
        ShapeActionGoal & operator=(const ShapeActionGoal & inobj);
        /** equality operator */
        bool operator==(const ShapeActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const ShapeActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const ShapeActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ShapeActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtle_actionlib::ShapeActionGoal>
    {
    public:
        static bool flat() {return turtle_actionlib::ShapeActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return turtle_actionlib::ShapeActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtle_actionlib::ShapeActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtle_actionlib::ShapeActionGoal & value);

#endif  //  _TURTLE_ACTIONLIB_SHAPEACTIONGOAL_H_
