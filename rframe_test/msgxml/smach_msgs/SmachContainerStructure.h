...
#ifndef _CODEGEN_SMACH_MSGS_SMACHCONTAINERSTRUCTURE_H_
#define _CODEGEN_SMACH_MSGS_SMACHCONTAINERSTRUCTURE_H_
...
PREDECLARE_BSON(smach_msgs::SmachContainerStructure); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(smach_msgs::SmachContainerStructure); // see Common.h, macro used for a cleaner header

namespace smach_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SmachContainerStructure & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SmachContainerStructure(const SmachContainerStructure & inobj);
        /** destructor */
        ~SmachContainerStructure();

        /** allocator, convenience function for bind */
        static SmachContainerStructure * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< The path to this node in the server */
        std::string  path; /**< The children of this node */
        std::vector<std::string >  children; /**< The outcome edges  Each index across these arrays denote one edge */
        std::vector<std::string >  internal_outcomes; /**<  */
        std::vector<std::string >  outcomes_from; /**<  */
        std::vector<std::string >  outcomes_to; /**< The potential outcomes from this container */
        std::vector<std::string >  container_outcomes; /**<  */
        ...
        { 
            ...
            DAQ_1_PATH,
            DAQ_2_CHILDREN,
            DAQ_3_INTERNAL_OUTCOMES,
            DAQ_4_OUTCOMES_FROM,
            DAQ_5_OUTCOMES_TO,
            DAQ_6_CONTAINER_OUTCOMES,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 326898368U;
        ...
        static const unsigned int DATA_VERSION = 2661788159U;
        ...
        //        static const char * dataTypeName() { return "SmachContainerStructure"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "39872d656eccc3266405051e64c3509f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x39872d656eccc326ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6405051e64c3509fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SmachContainerStructure * copy() { return new SmachContainerStructure(*this); };

        /** assignment operator(s) */
        SmachContainerStructure & operator=(const SmachContainerStructure & inobj);
        /** equality operator */
        bool operator==(const SmachContainerStructure & inobj) const;
        /** inequality operator */
        bool operator!=(const SmachContainerStructure & inobj) const;
        /** less than operator */
        bool operator<(const SmachContainerStructure & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SmachContainerStructure & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<smach_msgs::SmachContainerStructure>
    {
    public:
        static bool flat() {return smach_msgs::SmachContainerStructure::dataTypeFlat(); };
        static std::string sourceXML() {return smach_msgs::SmachContainerStructure::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const smach_msgs::SmachContainerStructure & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const smach_msgs::SmachContainerStructure & value);

#endif  //  _SMACH_MSGS_SMACHCONTAINERSTRUCTURE_H_
