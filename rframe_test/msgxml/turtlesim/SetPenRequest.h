...
#ifndef _CODEGEN_TURTLESIM_SETPENREQUEST_H_
#define _CODEGEN_TURTLESIM_SETPENREQUEST_H_
...
PREDECLARE_BSON(turtlesim::SetPenRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::SetPenRequest); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetPenRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetPenRequest();
        /** copy constructor */
        SetPenRequest(const SetPenRequest & inobj);
        /** destructor */
        ~SetPenRequest();

        /** allocator, convenience function for bind */
        static SetPenRequest * New();
        ...
        unsigned char  b; /**<  */
        unsigned char  width; /**<  */
        unsigned char  off; /**< no comment provided */
        ...
        static const unsigned int ID = 1480782627U;
        ...
        static const unsigned int DATA_VERSION = 188063856U;
        ...
        //        static const char * dataTypeName() { return "SetPenRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "eed541a50021398d12c91891a6ea1a8b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xeed541a50021398dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x12c91891a6ea1a8bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetPenRequest * copy() { return new SetPenRequest(*this); };

        /** assignment operator(s) */
        SetPenRequest & operator=(const SetPenRequest & inobj);
        /** equality operator */
        bool operator==(const SetPenRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetPenRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetPenRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetPenRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::SetPenRequest>
    {
    public:
        static bool flat() {return turtlesim::SetPenRequest::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::SetPenRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::SetPenRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::SetPenRequest & value);

#endif  //  _TURTLESIM_SETPENREQUEST_H_
