...
#ifndef _CODEGEN_TURTLESIM_POSE_H_
#define _CODEGEN_TURTLESIM_POSE_H_
...
PREDECLARE_BSON(turtlesim::Pose); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::Pose); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Pose & inobj);   
    ...
    */
    ...
    public: 
        ...
        { 
            ...
            DAQ_1_Y,
            DAQ_2_THETA,
            DAQ_3_LINEAR_VELOCITY,
            DAQ_4_ANGULAR_VELOCITY,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1480782623U;
        ...
        static const unsigned int DATA_VERSION = 3945848097U;
        ...
        //        static const char * dataTypeName() { return "Pose"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2c319eeeb9184353dd86cf644cc9f23b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2c319eeeb9184353ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdd86cf644cc9f23bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Pose * copy() { return new Pose(*this); };

        /** assignment operator(s) */
        Pose & operator=(const Pose & inobj);
        /** equality operator */
        bool operator==(const Pose & inobj) const;
        /** inequality operator */
        bool operator!=(const Pose & inobj) const;
        /** less than operator */
        bool operator<(const Pose & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Pose & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::Pose>
    {
    public:
        static bool flat() {return turtlesim::Pose::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::Pose::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::Pose & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::Pose & value);

#endif  //  _TURTLESIM_POSE_H_
