...
#ifndef _CODEGEN_TURTLESIM_KILLREQUEST_H_
#define _CODEGEN_TURTLESIM_KILLREQUEST_H_
...
PREDECLARE_BSON(turtlesim::KillRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::KillRequest); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, KillRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        KillRequest();
        /** copy constructor */
        KillRequest(const KillRequest & inobj);
        /** destructor */
        ~KillRequest();

        /** allocator, convenience function for bind */
        static KillRequest * New();
        ...
        static const unsigned int ID = 1480782624U;
        ...
        static const unsigned int DATA_VERSION = 3084789918U;
        ...
        //        static const char * dataTypeName() { return "KillRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d064750f558fc4dad78334414c02953c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd064750f558fc4daULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd78334414c02953cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        KillRequest * copy() { return new KillRequest(*this); };

        /** assignment operator(s) */
        KillRequest & operator=(const KillRequest & inobj);
        /** equality operator */
        bool operator==(const KillRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const KillRequest & inobj) const;
        /** less than operator */
        bool operator<(const KillRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, KillRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::KillRequest>
    {
    public:
        static bool flat() {return turtlesim::KillRequest::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::KillRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::KillRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::KillRequest & value);

#endif  //  _TURTLESIM_KILLREQUEST_H_
