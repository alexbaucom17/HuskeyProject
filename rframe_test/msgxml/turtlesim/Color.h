...
#ifndef _CODEGEN_TURTLESIM_COLOR_H_
#define _CODEGEN_TURTLESIM_COLOR_H_
...
PREDECLARE_BSON(turtlesim::Color); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::Color); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Color & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1480782622U;
        ...
        static const unsigned int DATA_VERSION = 3064676476U;
        ...
        //        static const char * dataTypeName() { return "Color"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c65afa2ac3496a0b0199f090cf4e94a6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc65afa2ac3496a0bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0199f090cf4e94a6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Color * copy() { return new Color(*this); };

        /** assignment operator(s) */
        Color & operator=(const Color & inobj);
        /** equality operator */
        bool operator==(const Color & inobj) const;
        /** inequality operator */
        bool operator!=(const Color & inobj) const;
        /** less than operator */
        bool operator<(const Color & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Color & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::Color>
    {
    public:
        static bool flat() {return turtlesim::Color::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::Color::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::Color & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::Color & value);

#endif  //  _TURTLESIM_COLOR_H_
