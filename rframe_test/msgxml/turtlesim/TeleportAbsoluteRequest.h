...
#ifndef _CODEGEN_TURTLESIM_TELEPORTABSOLUTEREQUEST_H_
#define _CODEGEN_TURTLESIM_TELEPORTABSOLUTEREQUEST_H_
...
PREDECLARE_BSON(turtlesim::TeleportAbsoluteRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(turtlesim::TeleportAbsoluteRequest); // see Common.h, macro used for a cleaner header

namespace turtlesim
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TeleportAbsoluteRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TeleportAbsoluteRequest(const TeleportAbsoluteRequest & inobj);
        /** destructor */
        ~TeleportAbsoluteRequest();

        /** allocator, convenience function for bind */
        static TeleportAbsoluteRequest * New();
        ...
        float  x; /**<  */
        float  y; /**<  */
        float  theta; /**< no comment provided */
        ...
        static const unsigned int ID = 1480782633U;
        ...
        static const unsigned int DATA_VERSION = 2941150253U;
        ...
        //        static const char * dataTypeName() { return "TeleportAbsoluteRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "99f89335d32bb5031cc5142dc296d892"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x99f89335d32bb503ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1cc5142dc296d892ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TeleportAbsoluteRequest * copy() { return new TeleportAbsoluteRequest(*this); };

        /** assignment operator(s) */
        TeleportAbsoluteRequest & operator=(const TeleportAbsoluteRequest & inobj);
        /** equality operator */
        bool operator==(const TeleportAbsoluteRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const TeleportAbsoluteRequest & inobj) const;
        /** less than operator */
        bool operator<(const TeleportAbsoluteRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TeleportAbsoluteRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<turtlesim::TeleportAbsoluteRequest>
    {
    public:
        static bool flat() {return turtlesim::TeleportAbsoluteRequest::dataTypeFlat(); };
        static std::string sourceXML() {return turtlesim::TeleportAbsoluteRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const turtlesim::TeleportAbsoluteRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const turtlesim::TeleportAbsoluteRequest & value);

#endif  //  _TURTLESIM_TELEPORTABSOLUTEREQUEST_H_
