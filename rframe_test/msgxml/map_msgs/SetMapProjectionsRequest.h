...
#ifndef _CODEGEN_MAP_MSGS_SETMAPPROJECTIONSREQUEST_H_
#define _CODEGEN_MAP_MSGS_SETMAPPROJECTIONSREQUEST_H_
...
PREDECLARE_BSON(map_msgs::SetMapProjectionsRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::SetMapProjectionsRequest); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetMapProjectionsRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetMapProjectionsRequest(const SetMapProjectionsRequest & inobj);
        /** destructor */
        ~SetMapProjectionsRequest();

        /** allocator, convenience function for bind */
        static SetMapProjectionsRequest * New();
        ...
        static const unsigned int ID = 851292639U;
        ...
        static const unsigned int DATA_VERSION = 3401333976U;
        ...
        //        static const char * dataTypeName() { return "SetMapProjectionsRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "f0875780294162bae25e8c7c98f82caa"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xf0875780294162baULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe25e8c7c98f82caaULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetMapProjectionsRequest * copy() { return new SetMapProjectionsRequest(*this); };

        /** assignment operator(s) */
        SetMapProjectionsRequest & operator=(const SetMapProjectionsRequest & inobj);
        /** equality operator */
        bool operator==(const SetMapProjectionsRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetMapProjectionsRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetMapProjectionsRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetMapProjectionsRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::SetMapProjectionsRequest>
    {
    public:
        static bool flat() {return map_msgs::SetMapProjectionsRequest::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::SetMapProjectionsRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::SetMapProjectionsRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::SetMapProjectionsRequest & value);

#endif  //  _MAP_MSGS_SETMAPPROJECTIONSREQUEST_H_
