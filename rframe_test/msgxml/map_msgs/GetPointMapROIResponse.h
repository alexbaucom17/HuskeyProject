...
#ifndef _CODEGEN_MAP_MSGS_GETPOINTMAPROIRESPONSE_H_
#define _CODEGEN_MAP_MSGS_GETPOINTMAPROIRESPONSE_H_
...
PREDECLARE_BSON(map_msgs::GetPointMapROIResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetPointMapROIResponse); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPointMapROIResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetPointMapROIResponse(const GetPointMapROIResponse & inobj);
        /** destructor */
        ~GetPointMapROIResponse();

        /** allocator, convenience function for bind */
        static GetPointMapROIResponse * New();
        ...
        static const unsigned int ID = 851292635U;
        ...
        static const unsigned int DATA_VERSION = 3434085927U;
        ...
        //        static const char * dataTypeName() { return "GetPointMapROIResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "263415ad24859fa440c77ce8653013de"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x263415ad24859fa4ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x40c77ce8653013deULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPointMapROIResponse * copy() { return new GetPointMapROIResponse(*this); };

        /** assignment operator(s) */
        GetPointMapROIResponse & operator=(const GetPointMapROIResponse & inobj);
        /** equality operator */
        bool operator==(const GetPointMapROIResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPointMapROIResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetPointMapROIResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPointMapROIResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetPointMapROIResponse>
    {
    public:
        static bool flat() {return map_msgs::GetPointMapROIResponse::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetPointMapROIResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetPointMapROIResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetPointMapROIResponse & value);

#endif  //  _MAP_MSGS_GETPOINTMAPROIRESPONSE_H_
