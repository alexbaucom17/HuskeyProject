...
#ifndef _CODEGEN_MAP_MSGS_GETPOINTMAPREQUEST_H_
#define _CODEGEN_MAP_MSGS_GETPOINTMAPREQUEST_H_
...
PREDECLARE_BSON(map_msgs::GetPointMapRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetPointMapRequest); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPointMapRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetPointMapRequest();
        /** copy constructor */
        GetPointMapRequest(const GetPointMapRequest & inobj);
        /** destructor */
        ~GetPointMapRequest();

        /** allocator, convenience function for bind */
        static GetPointMapRequest * New();
        ...
        static const unsigned int ID = 851292631U;
        ...
        static const unsigned int DATA_VERSION = 3049048851U;
        ...
        //        static const char * dataTypeName() { return "GetPointMapRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9f38f0ee2ff6ace0bc68a0901ec3778a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9f38f0ee2ff6ace0ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbc68a0901ec3778aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPointMapRequest * copy() { return new GetPointMapRequest(*this); };

        /** assignment operator(s) */
        GetPointMapRequest & operator=(const GetPointMapRequest & inobj);
        /** equality operator */
        bool operator==(const GetPointMapRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPointMapRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetPointMapRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPointMapRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetPointMapRequest>
    {
    public:
        static bool flat() {return map_msgs::GetPointMapRequest::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetPointMapRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetPointMapRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetPointMapRequest & value);

#endif  //  _MAP_MSGS_GETPOINTMAPREQUEST_H_
