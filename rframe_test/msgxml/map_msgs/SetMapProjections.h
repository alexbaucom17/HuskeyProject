...
#ifndef _CODEGEN_MAP_MSGS_SETMAPPROJECTIONS_H_
#define _CODEGEN_MAP_MSGS_SETMAPPROJECTIONS_H_
...
PREDECLARE_BSON(map_msgs::SetMapProjections); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::SetMapProjections); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetMapProjections & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetMapProjections();
        /** copy constructor */
        SetMapProjections(const SetMapProjections & inobj);
        /** destructor */
        ~SetMapProjections();

        /** allocator, convenience function for bind */
        static SetMapProjections * New();
        ...
        static const unsigned int ID = 851292641U;
        ...
        static const unsigned int DATA_VERSION = 1916203870U;
        ...
        //        static const char * dataTypeName() { return "SetMapProjections"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a8a83c394c2409fedda6ce059cfdd624"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa8a83c394c2409feULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdda6ce059cfdd624ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetMapProjections * copy() { return new SetMapProjections(*this); };

        /** assignment operator(s) */
        SetMapProjections & operator=(const SetMapProjections & inobj);
        /** equality operator */
        bool operator==(const SetMapProjections & inobj) const;
        /** inequality operator */
        bool operator!=(const SetMapProjections & inobj) const;
        /** less than operator */
        bool operator<(const SetMapProjections & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetMapProjections & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::SetMapProjections>
    {
    public:
        static bool flat() {return map_msgs::SetMapProjections::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::SetMapProjections::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::SetMapProjections & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::SetMapProjections & value);

#endif  //  _MAP_MSGS_SETMAPPROJECTIONS_H_
