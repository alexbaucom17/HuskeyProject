...
#ifndef _CODEGEN_MAP_MSGS_GETMAPROIREQUEST_H_
#define _CODEGEN_MAP_MSGS_GETMAPROIREQUEST_H_
...
PREDECLARE_BSON(map_msgs::GetMapROIRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::GetMapROIRequest); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapROIRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapROIRequest();
        /** copy constructor */
        GetMapROIRequest(const GetMapROIRequest & inobj);
        /** destructor */
        ~GetMapROIRequest();

        /** allocator, convenience function for bind */
        static GetMapROIRequest * New();
        ...
        double  y; /**<  */
        double  l_x; /**<  */
        double  l_y; /**< no comment provided */
        ...
        static const unsigned int ID = 851292628U;
        ...
        static const unsigned int DATA_VERSION = 2356227957U;
        ...
        //        static const char * dataTypeName() { return "GetMapROIRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6bbcb05d179bab483f87c16b70da7509"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6bbcb05d179bab48ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3f87c16b70da7509ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapROIRequest * copy() { return new GetMapROIRequest(*this); };

        /** assignment operator(s) */
        GetMapROIRequest & operator=(const GetMapROIRequest & inobj);
        /** equality operator */
        bool operator==(const GetMapROIRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapROIRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetMapROIRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapROIRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::GetMapROIRequest>
    {
    public:
        static bool flat() {return map_msgs::GetMapROIRequest::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::GetMapROIRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::GetMapROIRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::GetMapROIRequest & value);

#endif  //  _MAP_MSGS_GETMAPROIREQUEST_H_
