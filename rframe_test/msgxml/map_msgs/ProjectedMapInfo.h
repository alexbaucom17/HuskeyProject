...
#ifndef _CODEGEN_MAP_MSGS_PROJECTEDMAPINFO_H_
#define _CODEGEN_MAP_MSGS_PROJECTEDMAPINFO_H_
...
PREDECLARE_BSON(map_msgs::ProjectedMapInfo); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(map_msgs::ProjectedMapInfo); // see Common.h, macro used for a cleaner header

namespace map_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ProjectedMapInfo & inobj);   
    ...
    */
    ...
    public: 
        ...
        ProjectedMapInfo();
        /** copy constructor */
        ProjectedMapInfo(const ProjectedMapInfo & inobj);
        /** destructor */
        ~ProjectedMapInfo();

        /** allocator, convenience function for bind */
        static ProjectedMapInfo * New();
        ...
        static const unsigned int ID = 851292627U;
        ...
        static const unsigned int DATA_VERSION = 1417232412U;
        ...
        //        static const char * dataTypeName() { return "ProjectedMapInfo"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "406a93aec81fd9f503eb1f118326c268"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x406a93aec81fd9f5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x03eb1f118326c268ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ProjectedMapInfo * copy() { return new ProjectedMapInfo(*this); };

        /** assignment operator(s) */
        ProjectedMapInfo & operator=(const ProjectedMapInfo & inobj);
        /** equality operator */
        bool operator==(const ProjectedMapInfo & inobj) const;
        /** inequality operator */
        bool operator!=(const ProjectedMapInfo & inobj) const;
        /** less than operator */
        bool operator<(const ProjectedMapInfo & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ProjectedMapInfo & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<map_msgs::ProjectedMapInfo>
    {
    public:
        static bool flat() {return map_msgs::ProjectedMapInfo::dataTypeFlat(); };
        static std::string sourceXML() {return map_msgs::ProjectedMapInfo::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const map_msgs::ProjectedMapInfo & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const map_msgs::ProjectedMapInfo & value);

#endif  //  _MAP_MSGS_PROJECTEDMAPINFO_H_
