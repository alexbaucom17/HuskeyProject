...
#ifndef _CODEGEN_GAZEBO_MSGS_GETLINKPROPERTIESREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_GETLINKPROPERTIESREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::GetLinkPropertiesRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetLinkPropertiesRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLinkPropertiesRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetLinkPropertiesRequest(const GetLinkPropertiesRequest & inobj);
        /** destructor */
        ~GetLinkPropertiesRequest();

        /** allocator, convenience function for bind */
        static GetLinkPropertiesRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  link_name; /**< no comment provided */
        ...
        static const unsigned int ID = 1781288137U;
        ...
        static const unsigned int DATA_VERSION = 4221663141U;
        ...
        //        static const char * dataTypeName() { return "GetLinkPropertiesRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "2dc76e2406d47169bbedb1a53b754503"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x2dc76e2406d47169ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbbedb1a53b754503ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLinkPropertiesRequest * copy() { return new GetLinkPropertiesRequest(*this); };

        /** assignment operator(s) */
        GetLinkPropertiesRequest & operator=(const GetLinkPropertiesRequest & inobj);
        /** equality operator */
        bool operator==(const GetLinkPropertiesRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLinkPropertiesRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetLinkPropertiesRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLinkPropertiesRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetLinkPropertiesRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::GetLinkPropertiesRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetLinkPropertiesRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetLinkPropertiesRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetLinkPropertiesRequest & value);

#endif  //  _GAZEBO_MSGS_GETLINKPROPERTIESREQUEST_H_
