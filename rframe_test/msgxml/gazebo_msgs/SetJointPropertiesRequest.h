...
#ifndef _CODEGEN_GAZEBO_MSGS_SETJOINTPROPERTIESREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_SETJOINTPROPERTIESREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::SetJointPropertiesRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetJointPropertiesRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetJointPropertiesRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetJointPropertiesRequest(const SetJointPropertiesRequest & inobj);
        /** destructor */
        ~SetJointPropertiesRequest();

        /** allocator, convenience function for bind */
        static SetJointPropertiesRequest * New();
        ...
        gazebo_msgs::ODEJointProperties  ode_joint_config; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_JOINT_NAME,
            DAQ_1_ODE_JOINT_CONFIG,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288158U;
        ...
        static const unsigned int DATA_VERSION = 1039399510U;
        ...
        //        static const char * dataTypeName() { return "SetJointPropertiesRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b35a46b5f24abe2fe488a0de5ad96695"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb35a46b5f24abe2fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe488a0de5ad96695ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetJointPropertiesRequest * copy() { return new SetJointPropertiesRequest(*this); };

        /** assignment operator(s) */
        SetJointPropertiesRequest & operator=(const SetJointPropertiesRequest & inobj);
        /** equality operator */
        bool operator==(const SetJointPropertiesRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetJointPropertiesRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetJointPropertiesRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetJointPropertiesRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetJointPropertiesRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::SetJointPropertiesRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetJointPropertiesRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetJointPropertiesRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetJointPropertiesRequest & value);

#endif  //  _GAZEBO_MSGS_SETJOINTPROPERTIESREQUEST_H_
