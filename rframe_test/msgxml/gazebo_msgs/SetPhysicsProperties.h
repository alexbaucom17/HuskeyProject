...
#ifndef _CODEGEN_GAZEBO_MSGS_SETPHYSICSPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_SETPHYSICSPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::SetPhysicsProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetPhysicsProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetPhysicsProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetPhysicsProperties(const SetPhysicsProperties & inobj);
        /** destructor */
        ~SetPhysicsProperties();

        /** allocator, convenience function for bind */
        static SetPhysicsProperties * New();
        ...
        static const unsigned int ID = 1781288178U;
        ...
        static const unsigned int DATA_VERSION = 1007345869U;
        ...
        //        static const char * dataTypeName() { return "SetPhysicsProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "54079aff872c666d5b103f66dcc8759c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x54079aff872c666dULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5b103f66dcc8759cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetPhysicsProperties * copy() { return new SetPhysicsProperties(*this); };

        /** assignment operator(s) */
        SetPhysicsProperties & operator=(const SetPhysicsProperties & inobj);
        /** equality operator */
        bool operator==(const SetPhysicsProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const SetPhysicsProperties & inobj) const;
        /** less than operator */
        bool operator<(const SetPhysicsProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetPhysicsProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetPhysicsProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::SetPhysicsProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetPhysicsProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetPhysicsProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetPhysicsProperties & value);

#endif  //  _GAZEBO_MSGS_SETPHYSICSPROPERTIES_H_
