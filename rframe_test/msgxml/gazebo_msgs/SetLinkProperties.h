...
#ifndef _CODEGEN_GAZEBO_MSGS_SETLINKPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_SETLINKPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::SetLinkProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetLinkProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetLinkProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetLinkProperties();
        /** copy constructor */
        SetLinkProperties(const SetLinkProperties & inobj);
        /** destructor */
        ~SetLinkProperties();

        /** allocator, convenience function for bind */
        static SetLinkProperties * New();
        ...
        static const unsigned int ID = 1781288166U;
        ...
        static const unsigned int DATA_VERSION = 512148580U;
        ...
        //        static const char * dataTypeName() { return "SetLinkProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "12f16477f487fb3cc080cac5c010fc63"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x12f16477f487fb3cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc080cac5c010fc63ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetLinkProperties * copy() { return new SetLinkProperties(*this); };

        /** assignment operator(s) */
        SetLinkProperties & operator=(const SetLinkProperties & inobj);
        /** equality operator */
        bool operator==(const SetLinkProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const SetLinkProperties & inobj) const;
        /** less than operator */
        bool operator<(const SetLinkProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetLinkProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetLinkProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::SetLinkProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetLinkProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetLinkProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetLinkProperties & value);

#endif  //  _GAZEBO_MSGS_SETLINKPROPERTIES_H_
