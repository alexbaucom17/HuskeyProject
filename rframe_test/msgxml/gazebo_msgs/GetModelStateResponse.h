...
#ifndef _CODEGEN_GAZEBO_MSGS_GETMODELSTATERESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_GETMODELSTATERESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::GetModelStateResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetModelStateResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetModelStateResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetModelStateResponse(const GetModelStateResponse & inobj);
        /** destructor */
        ~GetModelStateResponse();

        /** allocator, convenience function for bind */
        static GetModelStateResponse * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< Standard metadata for higher-level stamped data types.  * header.seq holds the number of requests since the plugin started  * header.stamp timestamp related to the pose  * header.frame_id not used but currently filled with the relative_entity_name */
        ...
        static const unsigned int ID = 1781288147U;
        ...
        static const unsigned int DATA_VERSION = 2522414584U;
        ...
        //        static const char * dataTypeName() { return "GetModelStateResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d91b0f105d1d49e125302f4d5b3c8073"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd91b0f105d1d49e1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x25302f4d5b3c8073ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetModelStateResponse * copy() { return new GetModelStateResponse(*this); };

        /** assignment operator(s) */
        GetModelStateResponse & operator=(const GetModelStateResponse & inobj);
        /** equality operator */
        bool operator==(const GetModelStateResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetModelStateResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetModelStateResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetModelStateResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetModelStateResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::GetModelStateResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetModelStateResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetModelStateResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetModelStateResponse & value);

#endif  //  _GAZEBO_MSGS_GETMODELSTATERESPONSE_H_
