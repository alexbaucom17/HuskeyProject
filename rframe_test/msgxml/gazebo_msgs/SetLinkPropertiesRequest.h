...
#ifndef _CODEGEN_GAZEBO_MSGS_SETLINKPROPERTIESREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_SETLINKPROPERTIESREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::SetLinkPropertiesRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetLinkPropertiesRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetLinkPropertiesRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetLinkPropertiesRequest(const SetLinkPropertiesRequest & inobj);
        /** destructor */
        ~SetLinkPropertiesRequest();

        /** allocator, convenience function for bind */
        static SetLinkPropertiesRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  link_name; /**< name of link  link names are prefixed by model name, e.g. pr2::base_link */
        geometry_msgs::Pose  com; /**< center of mass location in link frame  and orientation of the moment of inertias  relative to the link frame */
        bool  gravity_mode; /**< set gravity mode on/off */
        double  mass; /**< linear mass of link */
        double  ixx; /**< moment of inertia */
        double  ixy; /**< moment of inertia */
        double  ixz; /**< moment of inertia */
        double  iyy; /**< moment of inertia */
        double  iyz; /**< moment of inertia */
        double  izz; /**< no comment provided */
        ...
        static const unsigned int ID = 1781288164U;
        ...
        static const unsigned int DATA_VERSION = 2046400602U;
        ...
        //        static const char * dataTypeName() { return "SetLinkPropertiesRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "10504936b2c8e190501ae91cc4b8dd83"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x10504936b2c8e190ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x501ae91cc4b8dd83ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetLinkPropertiesRequest * copy() { return new SetLinkPropertiesRequest(*this); };

        /** assignment operator(s) */
        SetLinkPropertiesRequest & operator=(const SetLinkPropertiesRequest & inobj);
        /** equality operator */
        bool operator==(const SetLinkPropertiesRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetLinkPropertiesRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetLinkPropertiesRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetLinkPropertiesRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetLinkPropertiesRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::SetLinkPropertiesRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetLinkPropertiesRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetLinkPropertiesRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetLinkPropertiesRequest & value);

#endif  //  _GAZEBO_MSGS_SETLINKPROPERTIESREQUEST_H_
