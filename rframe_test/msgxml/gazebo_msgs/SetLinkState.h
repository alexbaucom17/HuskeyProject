...
#ifndef _CODEGEN_GAZEBO_MSGS_SETLINKSTATE_H_
#define _CODEGEN_GAZEBO_MSGS_SETLINKSTATE_H_
...
PREDECLARE_BSON(gazebo_msgs::SetLinkState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetLinkState); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetLinkState & inobj);   
    ...
    */
    ...
    public: 
        ...
        SetLinkState();
        /** copy constructor */
        SetLinkState(const SetLinkState & inobj);
        /** destructor */
        ~SetLinkState();

        /** allocator, convenience function for bind */
        static SetLinkState * New();
        ...
        static const unsigned int ID = 1781288169U;
        ...
        static const unsigned int DATA_VERSION = 2022436700U;
        ...
        //        static const char * dataTypeName() { return "SetLinkState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8d46aa5b7383fd1347616482fdf1d5de"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8d46aa5b7383fd13ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x47616482fdf1d5deULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetLinkState * copy() { return new SetLinkState(*this); };

        /** assignment operator(s) */
        SetLinkState & operator=(const SetLinkState & inobj);
        /** equality operator */
        bool operator==(const SetLinkState & inobj) const;
        /** inequality operator */
        bool operator!=(const SetLinkState & inobj) const;
        /** less than operator */
        bool operator<(const SetLinkState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetLinkState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetLinkState>
    {
    public:
        static bool flat() {return gazebo_msgs::SetLinkState::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetLinkState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetLinkState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetLinkState & value);

#endif  //  _GAZEBO_MSGS_SETLINKSTATE_H_
