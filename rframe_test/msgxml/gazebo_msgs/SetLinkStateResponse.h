...
#ifndef _CODEGEN_GAZEBO_MSGS_SETLINKSTATERESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_SETLINKSTATERESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::SetLinkStateResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetLinkStateResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetLinkStateResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetLinkStateResponse(const SetLinkStateResponse & inobj);
        /** destructor */
        ~SetLinkStateResponse();

        /** allocator, convenience function for bind */
        static SetLinkStateResponse * New();
        ...
        static const unsigned int ID = 1781288168U;
        ...
        static const unsigned int DATA_VERSION = 3555592359U;
        ...
        //        static const char * dataTypeName() { return "SetLinkStateResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c490d4824b48390c43b9efc1a076ac98"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc490d4824b48390cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x43b9efc1a076ac98ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetLinkStateResponse * copy() { return new SetLinkStateResponse(*this); };

        /** assignment operator(s) */
        SetLinkStateResponse & operator=(const SetLinkStateResponse & inobj);
        /** equality operator */
        bool operator==(const SetLinkStateResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetLinkStateResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetLinkStateResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetLinkStateResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetLinkStateResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::SetLinkStateResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetLinkStateResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetLinkStateResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetLinkStateResponse & value);

#endif  //  _GAZEBO_MSGS_SETLINKSTATERESPONSE_H_
