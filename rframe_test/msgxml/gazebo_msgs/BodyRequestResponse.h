...
#ifndef _CODEGEN_GAZEBO_MSGS_BODYREQUESTRESPONSE_H_
#define _CODEGEN_GAZEBO_MSGS_BODYREQUESTRESPONSE_H_
...
PREDECLARE_BSON(gazebo_msgs::BodyRequestResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::BodyRequestResponse); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, BodyRequestResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        BodyRequestResponse();
        /** copy constructor */
        BodyRequestResponse(const BodyRequestResponse & inobj);
        /** destructor */
        ~BodyRequestResponse();

        /** allocator, convenience function for bind */
        static BodyRequestResponse * New();
        ...
        static const unsigned int ID = 1781288129U;
        ...
        static const unsigned int DATA_VERSION = 1283272236U;
        ...
        //        static const char * dataTypeName() { return "BodyRequestResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3d99ee3cea6d27ff93aa404e7d30c81c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3d99ee3cea6d27ffULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x93aa404e7d30c81cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        BodyRequestResponse * copy() { return new BodyRequestResponse(*this); };

        /** assignment operator(s) */
        BodyRequestResponse & operator=(const BodyRequestResponse & inobj);
        /** equality operator */
        bool operator==(const BodyRequestResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const BodyRequestResponse & inobj) const;
        /** less than operator */
        bool operator<(const BodyRequestResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, BodyRequestResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::BodyRequestResponse>
    {
    public:
        static bool flat() {return gazebo_msgs::BodyRequestResponse::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::BodyRequestResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::BodyRequestResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::BodyRequestResponse & value);

#endif  //  _GAZEBO_MSGS_BODYREQUESTRESPONSE_H_
