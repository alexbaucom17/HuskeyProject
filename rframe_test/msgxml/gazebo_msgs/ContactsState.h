...
#ifndef _CODEGEN_GAZEBO_MSGS_CONTACTSSTATE_H_
#define _CODEGEN_GAZEBO_MSGS_CONTACTSSTATE_H_
...
PREDECLARE_BSON(gazebo_msgs::ContactsState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ContactsState); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ContactsState & inobj);   
    ...
    */
    ...
    public: 
        ...
        ContactsState();
        /** copy constructor */
        ContactsState(const ContactsState & inobj);
        /** destructor */
        ~ContactsState();

        /** allocator, convenience function for bind */
        static ContactsState * New();
        ...
        std::vector<gazebo_msgs::ContactState >  states; /**< array of geom pairs in contact */
        ...
        static const unsigned int ID = 1781288114U;
        ...
        static const unsigned int DATA_VERSION = 3162482536U;
        ...
        //        static const char * dataTypeName() { return "ContactsState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d362cd32b8c19f979cfd9b00d82f814d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd362cd32b8c19f97ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9cfd9b00d82f814dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ContactsState * copy() { return new ContactsState(*this); };

        /** assignment operator(s) */
        ContactsState & operator=(const ContactsState & inobj);
        /** equality operator */
        bool operator==(const ContactsState & inobj) const;
        /** inequality operator */
        bool operator!=(const ContactsState & inobj) const;
        /** less than operator */
        bool operator<(const ContactsState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ContactsState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ContactsState>
    {
    public:
        static bool flat() {return gazebo_msgs::ContactsState::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ContactsState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ContactsState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ContactsState & value);

#endif  //  _GAZEBO_MSGS_CONTACTSSTATE_H_
