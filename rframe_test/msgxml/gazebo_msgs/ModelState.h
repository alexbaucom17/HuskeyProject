...
#ifndef _CODEGEN_GAZEBO_MSGS_MODELSTATE_H_
#define _CODEGEN_GAZEBO_MSGS_MODELSTATE_H_
...
PREDECLARE_BSON(gazebo_msgs::ModelState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ModelState); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ModelState & inobj);   
    ...
    */
    ...
    public: 
        ...
        ModelState();
        /** copy constructor */
        ModelState(const ModelState & inobj);
        /** destructor */
        ~ModelState();

        /** allocator, convenience function for bind */
        static ModelState * New();
        ...
        std::string  reference_frame; /**< set pose/twist relative to the frame of this entity (Body/Model)  leave empty or "world" or "map" defaults to world-frame */
        ...
        static const unsigned int ID = 1781288117U;
        ...
        static const unsigned int DATA_VERSION = 2358208124U;
        ...
        //        static const char * dataTypeName() { return "ModelState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "32029e24c7c6d5c6747ffc8cebc60a83"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x32029e24c7c6d5c6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x747ffc8cebc60a83ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ModelState * copy() { return new ModelState(*this); };

        /** assignment operator(s) */
        ModelState & operator=(const ModelState & inobj);
        /** equality operator */
        bool operator==(const ModelState & inobj) const;
        /** inequality operator */
        bool operator!=(const ModelState & inobj) const;
        /** less than operator */
        bool operator<(const ModelState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ModelState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ModelState>
    {
    public:
        static bool flat() {return gazebo_msgs::ModelState::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ModelState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ModelState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ModelState & value);

#endif  //  _GAZEBO_MSGS_MODELSTATE_H_
