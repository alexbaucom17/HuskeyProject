...
#ifndef _CODEGEN_GAZEBO_MSGS_JOINTREQUESTREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_JOINTREQUESTREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::JointRequestRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::JointRequestRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointRequestRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        JointRequestRequest();
        /** copy constructor */
        JointRequestRequest(const JointRequestRequest & inobj);
        /** destructor */
        ~JointRequestRequest();

        /** allocator, convenience function for bind */
        static JointRequestRequest * New();
        ...
        static const unsigned int ID = 1781288155U;
        ...
        static const unsigned int DATA_VERSION = 4170607410U;
        ...
        //        static const char * dataTypeName() { return "JointRequestRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "943e866c1d931f6bf3f9d28f99d17350"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x943e866c1d931f6bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf3f9d28f99d17350ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointRequestRequest * copy() { return new JointRequestRequest(*this); };

        /** assignment operator(s) */
        JointRequestRequest & operator=(const JointRequestRequest & inobj);
        /** equality operator */
        bool operator==(const JointRequestRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const JointRequestRequest & inobj) const;
        /** less than operator */
        bool operator<(const JointRequestRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointRequestRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::JointRequestRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::JointRequestRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::JointRequestRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::JointRequestRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::JointRequestRequest & value);

#endif  //  _GAZEBO_MSGS_JOINTREQUESTREQUEST_H_
