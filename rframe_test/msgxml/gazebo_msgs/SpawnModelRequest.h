...
#ifndef _CODEGEN_GAZEBO_MSGS_SPAWNMODELREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_SPAWNMODELREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::SpawnModelRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SpawnModelRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SpawnModelRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        SpawnModelRequest();
        /** copy constructor */
        SpawnModelRequest(const SpawnModelRequest & inobj);
        /** destructor */
        ~SpawnModelRequest();

        /** allocator, convenience function for bind */
        static SpawnModelRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  model_name; /**< name of the model to be spawn */
        std::string  model_xml; /**< this should be an urdf or gazebo xml */
        std::string  robot_namespace; /**< spawn robot and all ROS interfaces under this namespace */
        geometry_msgs::Pose  initial_pose; /**< only applied to canonical body */
        std::string  reference_frame; /**< no comment provided */
        ...
        { 
            DAQ_0_MODEL_NAME,
            DAQ_1_MODEL_XML,
            DAQ_2_ROBOT_NAMESPACE,
            DAQ_3_INITIAL_POSE,
            DAQ_4_REFERENCE_FRAME,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288179U;
        ...
        static const unsigned int DATA_VERSION = 3561186199U;
        ...
        //        static const char * dataTypeName() { return "SpawnModelRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "14e2386a961942ca68ba13770524dce3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x14e2386a961942caULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x68ba13770524dce3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SpawnModelRequest * copy() { return new SpawnModelRequest(*this); };

        /** assignment operator(s) */
        SpawnModelRequest & operator=(const SpawnModelRequest & inobj);
        /** equality operator */
        bool operator==(const SpawnModelRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SpawnModelRequest & inobj) const;
        /** less than operator */
        bool operator<(const SpawnModelRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SpawnModelRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SpawnModelRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::SpawnModelRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SpawnModelRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SpawnModelRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SpawnModelRequest & value);

#endif  //  _GAZEBO_MSGS_SPAWNMODELREQUEST_H_
