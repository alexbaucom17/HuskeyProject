...
#ifndef _CODEGEN_GAZEBO_MSGS_SETMODELCONFIGURATIONREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_SETMODELCONFIGURATIONREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::SetModelConfigurationRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetModelConfigurationRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetModelConfigurationRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetModelConfigurationRequest(const SetModelConfigurationRequest & inobj);
        /** destructor */
        ~SetModelConfigurationRequest();

        /** allocator, convenience function for bind */
        static SetModelConfigurationRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::string  model_name; /**< model to set state (pose and twist) */
        std::string  urdf_param_name; /**< parameter name that contains the urdf XML. */
        std::vector<std::string >  joint_names; /**< list of joints to set positions.  if joint is not listed here, preserve current position. */
        std::vector<double >  joint_positions; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_MODEL_NAME,
            DAQ_1_URDF_PARAM_NAME,
            DAQ_2_JOINT_NAMES,
            DAQ_3_JOINT_POSITIONS,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288170U;
        ...
        static const unsigned int DATA_VERSION = 2848078810U;
        ...
        //        static const char * dataTypeName() { return "SetModelConfigurationRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "607cd8597d933b92b869d2e279345e40"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x607cd8597d933b92ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb869d2e279345e40ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetModelConfigurationRequest * copy() { return new SetModelConfigurationRequest(*this); };

        /** assignment operator(s) */
        SetModelConfigurationRequest & operator=(const SetModelConfigurationRequest & inobj);
        /** equality operator */
        bool operator==(const SetModelConfigurationRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetModelConfigurationRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetModelConfigurationRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetModelConfigurationRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetModelConfigurationRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::SetModelConfigurationRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetModelConfigurationRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetModelConfigurationRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetModelConfigurationRequest & value);

#endif  //  _GAZEBO_MSGS_SETMODELCONFIGURATIONREQUEST_H_
