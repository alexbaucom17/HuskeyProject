...
#ifndef _CODEGEN_GAZEBO_MSGS_SETPHYSICSPROPERTIESREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_SETPHYSICSPROPERTIESREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::SetPhysicsPropertiesRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::SetPhysicsPropertiesRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetPhysicsPropertiesRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetPhysicsPropertiesRequest(const SetPhysicsPropertiesRequest & inobj);
        /** destructor */
        ~SetPhysicsPropertiesRequest();

        /** allocator, convenience function for bind */
        static SetPhysicsPropertiesRequest * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        double  time_step; /**< dt in seconds */
        double  max_update_rate; /**< throttle maximum physics update rate */
        geometry_msgs::Vector3  gravity; /**< gravity vector (e.g. earth ~[0,0,-9.81]) */
        gazebo_msgs::ODEPhysics  ode_config; /**< no comment provided */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_TIME_STEP,
            DAQ_1_MAX_UPDATE_RATE,
            DAQ_2_GRAVITY,
            DAQ_3_ODE_CONFIG,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 1781288176U;
        ...
        static const unsigned int DATA_VERSION = 3289778547U;
        ...
        //        static const char * dataTypeName() { return "SetPhysicsPropertiesRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "671b8325409c285ca5581809f47bd62a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x671b8325409c285cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa5581809f47bd62aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetPhysicsPropertiesRequest * copy() { return new SetPhysicsPropertiesRequest(*this); };

        /** assignment operator(s) */
        SetPhysicsPropertiesRequest & operator=(const SetPhysicsPropertiesRequest & inobj);
        /** equality operator */
        bool operator==(const SetPhysicsPropertiesRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetPhysicsPropertiesRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetPhysicsPropertiesRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetPhysicsPropertiesRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::SetPhysicsPropertiesRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::SetPhysicsPropertiesRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::SetPhysicsPropertiesRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::SetPhysicsPropertiesRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::SetPhysicsPropertiesRequest & value);

#endif  //  _GAZEBO_MSGS_SETPHYSICSPROPERTIESREQUEST_H_
