...
#ifndef _CODEGEN_GAZEBO_MSGS_APPLYJOINTEFFORT_H_
#define _CODEGEN_GAZEBO_MSGS_APPLYJOINTEFFORT_H_
...
PREDECLARE_BSON(gazebo_msgs::ApplyJointEffort); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::ApplyJointEffort); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ApplyJointEffort & inobj);   
    ...
    */
    ...
    public: 
        ...
        ApplyJointEffort();
        /** copy constructor */
        ApplyJointEffort(const ApplyJointEffort & inobj);
        /** destructor */
        ~ApplyJointEffort();

        /** allocator, convenience function for bind */
        static ApplyJointEffort * New();
        ...
        static const unsigned int ID = 1781288127U;
        ...
        static const unsigned int DATA_VERSION = 3986813593U;
        ...
        //        static const char * dataTypeName() { return "ApplyJointEffort"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "500877d8ce98fa24836af95be9e70e97"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x500877d8ce98fa24ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x836af95be9e70e97ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ApplyJointEffort * copy() { return new ApplyJointEffort(*this); };

        /** assignment operator(s) */
        ApplyJointEffort & operator=(const ApplyJointEffort & inobj);
        /** equality operator */
        bool operator==(const ApplyJointEffort & inobj) const;
        /** inequality operator */
        bool operator!=(const ApplyJointEffort & inobj) const;
        /** less than operator */
        bool operator<(const ApplyJointEffort & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ApplyJointEffort & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::ApplyJointEffort>
    {
    public:
        static bool flat() {return gazebo_msgs::ApplyJointEffort::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::ApplyJointEffort::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::ApplyJointEffort & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::ApplyJointEffort & value);

#endif  //  _GAZEBO_MSGS_APPLYJOINTEFFORT_H_
