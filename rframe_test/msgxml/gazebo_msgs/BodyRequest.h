...
#ifndef _CODEGEN_GAZEBO_MSGS_BODYREQUEST_H_
#define _CODEGEN_GAZEBO_MSGS_BODYREQUEST_H_
...
PREDECLARE_BSON(gazebo_msgs::BodyRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::BodyRequest); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, BodyRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        BodyRequest();
        /** copy constructor */
        BodyRequest(const BodyRequest & inobj);
        /** destructor */
        ~BodyRequest();

        /** allocator, convenience function for bind */
        static BodyRequest * New();
        ...
        static const unsigned int ID = 1781288130U;
        ...
        static const unsigned int DATA_VERSION = 2226703706U;
        ...
        //        static const char * dataTypeName() { return "BodyRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a21dc9e2ec6e7471f1b57e108d7c1bfe"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa21dc9e2ec6e7471ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf1b57e108d7c1bfeULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        BodyRequest * copy() { return new BodyRequest(*this); };

        /** assignment operator(s) */
        BodyRequest & operator=(const BodyRequest & inobj);
        /** equality operator */
        bool operator==(const BodyRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const BodyRequest & inobj) const;
        /** less than operator */
        bool operator<(const BodyRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, BodyRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::BodyRequest>
    {
    public:
        static bool flat() {return gazebo_msgs::BodyRequest::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::BodyRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::BodyRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::BodyRequest & value);

#endif  //  _GAZEBO_MSGS_BODYREQUEST_H_
