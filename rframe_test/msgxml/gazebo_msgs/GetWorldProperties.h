...
#ifndef _CODEGEN_GAZEBO_MSGS_GETWORLDPROPERTIES_H_
#define _CODEGEN_GAZEBO_MSGS_GETWORLDPROPERTIES_H_
...
PREDECLARE_BSON(gazebo_msgs::GetWorldProperties); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(gazebo_msgs::GetWorldProperties); // see Common.h, macro used for a cleaner header

namespace gazebo_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetWorldProperties & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetWorldProperties();
        /** copy constructor */
        GetWorldProperties(const GetWorldProperties & inobj);
        /** destructor */
        ~GetWorldProperties();

        /** allocator, convenience function for bind */
        static GetWorldProperties * New();
        ...
        static const unsigned int ID = 1781288154U;
        ...
        static const unsigned int DATA_VERSION = 3631974869U;
        ...
        //        static const char * dataTypeName() { return "GetWorldProperties"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "57063a6b4cf407a24eabbfba0497ed11"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x57063a6b4cf407a2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4eabbfba0497ed11ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetWorldProperties * copy() { return new GetWorldProperties(*this); };

        /** assignment operator(s) */
        GetWorldProperties & operator=(const GetWorldProperties & inobj);
        /** equality operator */
        bool operator==(const GetWorldProperties & inobj) const;
        /** inequality operator */
        bool operator!=(const GetWorldProperties & inobj) const;
        /** less than operator */
        bool operator<(const GetWorldProperties & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetWorldProperties & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<gazebo_msgs::GetWorldProperties>
    {
    public:
        static bool flat() {return gazebo_msgs::GetWorldProperties::dataTypeFlat(); };
        static std::string sourceXML() {return gazebo_msgs::GetWorldProperties::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const gazebo_msgs::GetWorldProperties & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const gazebo_msgs::GetWorldProperties & value);

#endif  //  _GAZEBO_MSGS_GETWORLDPROPERTIES_H_
