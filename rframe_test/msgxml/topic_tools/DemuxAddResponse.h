...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXADDRESPONSE_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXADDRESPONSE_H_
...
PREDECLARE_BSON(topic_tools::DemuxAddResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxAddResponse); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxAddResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxAddResponse();
        /** copy constructor */
        DemuxAddResponse(const DemuxAddResponse & inobj);
        /** destructor */
        ~DemuxAddResponse();

        /** allocator, convenience function for bind */
        static DemuxAddResponse * New();
        ...
        static const unsigned int ID = 104324627U;
        ...
        static const unsigned int DATA_VERSION = 2319197834U;
        ...
        //        static const char * dataTypeName() { return "DemuxAddResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d61206d4d941ab6f592c02dd4eba906b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd61206d4d941ab6fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x592c02dd4eba906bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxAddResponse * copy() { return new DemuxAddResponse(*this); };

        /** assignment operator(s) */
        DemuxAddResponse & operator=(const DemuxAddResponse & inobj);
        /** equality operator */
        bool operator==(const DemuxAddResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxAddResponse & inobj) const;
        /** less than operator */
        bool operator<(const DemuxAddResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxAddResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxAddResponse>
    {
    public:
        static bool flat() {return topic_tools::DemuxAddResponse::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxAddResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxAddResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxAddResponse & value);

#endif  //  _TOPIC_TOOLS_DEMUXADDRESPONSE_H_
