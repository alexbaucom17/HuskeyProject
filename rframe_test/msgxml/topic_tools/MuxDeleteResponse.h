...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXDELETERESPONSE_H_
#define _CODEGEN_TOPIC_TOOLS_MUXDELETERESPONSE_H_
...
PREDECLARE_BSON(topic_tools::MuxDeleteResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxDeleteResponse); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxDeleteResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxDeleteResponse();
        /** copy constructor */
        MuxDeleteResponse(const MuxDeleteResponse & inobj);
        /** destructor */
        ~MuxDeleteResponse();

        /** allocator, convenience function for bind */
        static MuxDeleteResponse * New();
        ...
        static const unsigned int ID = 104324642U;
        ...
        static const unsigned int DATA_VERSION = 2670277162U;
        ...
        //        static const char * dataTypeName() { return "MuxDeleteResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a10a8349d19648281f8ad3b21420f326"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa10a8349d1964828ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x1f8ad3b21420f326ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxDeleteResponse * copy() { return new MuxDeleteResponse(*this); };

        /** assignment operator(s) */
        MuxDeleteResponse & operator=(const MuxDeleteResponse & inobj);
        /** equality operator */
        bool operator==(const MuxDeleteResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxDeleteResponse & inobj) const;
        /** less than operator */
        bool operator<(const MuxDeleteResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxDeleteResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxDeleteResponse>
    {
    public:
        static bool flat() {return topic_tools::MuxDeleteResponse::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxDeleteResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxDeleteResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxDeleteResponse & value);

#endif  //  _TOPIC_TOOLS_MUXDELETERESPONSE_H_
