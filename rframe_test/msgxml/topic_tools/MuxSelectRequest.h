...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXSELECTREQUEST_H_
#define _CODEGEN_TOPIC_TOOLS_MUXSELECTREQUEST_H_
...
PREDECLARE_BSON(topic_tools::MuxSelectRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxSelectRequest); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxSelectRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxSelectRequest();
        /** copy constructor */
        MuxSelectRequest(const MuxSelectRequest & inobj);
        /** destructor */
        ~MuxSelectRequest();

        /** allocator, convenience function for bind */
        static MuxSelectRequest * New();
        ...
        static const unsigned int ID = 104324647U;
        ...
        static const unsigned int DATA_VERSION = 3713990205U;
        ...
        //        static const char * dataTypeName() { return "MuxSelectRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b447ff4556d8cb600edef4ac32425768"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb447ff4556d8cb60ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0edef4ac32425768ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxSelectRequest * copy() { return new MuxSelectRequest(*this); };

        /** assignment operator(s) */
        MuxSelectRequest & operator=(const MuxSelectRequest & inobj);
        /** equality operator */
        bool operator==(const MuxSelectRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxSelectRequest & inobj) const;
        /** less than operator */
        bool operator<(const MuxSelectRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxSelectRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxSelectRequest>
    {
    public:
        static bool flat() {return topic_tools::MuxSelectRequest::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxSelectRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxSelectRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxSelectRequest & value);

#endif  //  _TOPIC_TOOLS_MUXSELECTREQUEST_H_
