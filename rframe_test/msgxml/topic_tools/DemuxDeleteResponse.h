...
#ifndef _CODEGEN_TOPIC_TOOLS_DEMUXDELETERESPONSE_H_
#define _CODEGEN_TOPIC_TOOLS_DEMUXDELETERESPONSE_H_
...
PREDECLARE_BSON(topic_tools::DemuxDeleteResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::DemuxDeleteResponse); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DemuxDeleteResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        DemuxDeleteResponse();
        /** copy constructor */
        DemuxDeleteResponse(const DemuxDeleteResponse & inobj);
        /** destructor */
        ~DemuxDeleteResponse();

        /** allocator, convenience function for bind */
        static DemuxDeleteResponse * New();
        ...
        static const unsigned int ID = 104324630U;
        ...
        static const unsigned int DATA_VERSION = 2564460813U;
        ...
        //        static const char * dataTypeName() { return "DemuxDeleteResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bc4bfce3e5000d415ab8b71f4fc9f2e3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbc4bfce3e5000d41ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5ab8b71f4fc9f2e3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DemuxDeleteResponse * copy() { return new DemuxDeleteResponse(*this); };

        /** assignment operator(s) */
        DemuxDeleteResponse & operator=(const DemuxDeleteResponse & inobj);
        /** equality operator */
        bool operator==(const DemuxDeleteResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const DemuxDeleteResponse & inobj) const;
        /** less than operator */
        bool operator<(const DemuxDeleteResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DemuxDeleteResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::DemuxDeleteResponse>
    {
    public:
        static bool flat() {return topic_tools::DemuxDeleteResponse::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::DemuxDeleteResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::DemuxDeleteResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::DemuxDeleteResponse & value);

#endif  //  _TOPIC_TOOLS_DEMUXDELETERESPONSE_H_
