...
#ifndef _CODEGEN_TOPIC_TOOLS_MUXDELETE_H_
#define _CODEGEN_TOPIC_TOOLS_MUXDELETE_H_
...
PREDECLARE_BSON(topic_tools::MuxDelete); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(topic_tools::MuxDelete); // see Common.h, macro used for a cleaner header

namespace topic_tools
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MuxDelete & inobj);   
    ...
    */
    ...
    public: 
        ...
        MuxDelete();
        /** copy constructor */
        MuxDelete(const MuxDelete & inobj);
        /** destructor */
        ~MuxDelete();

        /** allocator, convenience function for bind */
        static MuxDelete * New();
        ...
        static const unsigned int ID = 104324643U;
        ...
        static const unsigned int DATA_VERSION = 221822133U;
        ...
        //        static const char * dataTypeName() { return "MuxDelete"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0fe66785619d4c26b3c5392d66049994"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0fe66785619d4c26ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb3c5392d66049994ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MuxDelete * copy() { return new MuxDelete(*this); };

        /** assignment operator(s) */
        MuxDelete & operator=(const MuxDelete & inobj);
        /** equality operator */
        bool operator==(const MuxDelete & inobj) const;
        /** inequality operator */
        bool operator!=(const MuxDelete & inobj) const;
        /** less than operator */
        bool operator<(const MuxDelete & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MuxDelete & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<topic_tools::MuxDelete>
    {
    public:
        static bool flat() {return topic_tools::MuxDelete::dataTypeFlat(); };
        static std::string sourceXML() {return topic_tools::MuxDelete::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const topic_tools::MuxDelete & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const topic_tools::MuxDelete & value);

#endif  //  _TOPIC_TOOLS_MUXDELETE_H_
