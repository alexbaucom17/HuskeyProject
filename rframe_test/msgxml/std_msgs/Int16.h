...
#ifndef _CODEGEN_STD_MSGS_INT16_H_
#define _CODEGEN_STD_MSGS_INT16_H_
...
PREDECLARE_BSON(std_msgs::Int16); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Int16); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Int16 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109276U;
        ...
        static const unsigned int DATA_VERSION = 2611634574U;
        ...
        //        static const char * dataTypeName() { return "Int16"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3aecede1284528dc4f07875704f848e4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3aecede1284528dcULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x4f07875704f848e4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Int16 * copy() { return new Int16(*this); };

        /** assignment operator(s) */
        Int16 & operator=(const Int16 & inobj);
        /** equality operator */
        bool operator==(const Int16 & inobj) const;
        /** inequality operator */
        bool operator!=(const Int16 & inobj) const;
        /** less than operator */
        bool operator<(const Int16 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Int16 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Int16>
    {
    public:
        static bool flat() {return std_msgs::Int16::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Int16::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Int16 & value);
