...
#ifndef _CODEGEN_STD_MSGS_MULTIARRAYDIMENSION_H_
#define _CODEGEN_STD_MSGS_MULTIARRAYDIMENSION_H_
...
PREDECLARE_BSON(std_msgs::MultiArrayDimension); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::MultiArrayDimension); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MultiArrayDimension & inobj);   
    ...
    */
    ...
    public: 
        ...
        MultiArrayDimension();
        /** copy constructor */
        MultiArrayDimension(const MultiArrayDimension & inobj);
        /** destructor */
        ~MultiArrayDimension();

        /** allocator, convenience function for bind */
        static MultiArrayDimension * New();
        ...
        unsigned int  size; /**< size of given dimension (in type units) */
        unsigned int  stride; /**< stride of given dimension */
        ...
        static const unsigned int ID = 2068109284U;
        ...
        static const unsigned int DATA_VERSION = 3166706331U;
        ...
        //        static const char * dataTypeName() { return "MultiArrayDimension"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "dd403bc64ee1a6fdfac8f73b584044c6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xdd403bc64ee1a6fdULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfac8f73b584044c6ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MultiArrayDimension * copy() { return new MultiArrayDimension(*this); };

        /** assignment operator(s) */
        MultiArrayDimension & operator=(const MultiArrayDimension & inobj);
        /** equality operator */
        bool operator==(const MultiArrayDimension & inobj) const;
        /** inequality operator */
        bool operator!=(const MultiArrayDimension & inobj) const;
        /** less than operator */
        bool operator<(const MultiArrayDimension & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MultiArrayDimension & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::MultiArrayDimension>
    {
    public:
        static bool flat() {return std_msgs::MultiArrayDimension::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::MultiArrayDimension::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::MultiArrayDimension & value);
