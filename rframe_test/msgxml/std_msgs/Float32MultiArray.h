...
#ifndef _CODEGEN_STD_MSGS_FLOAT32MULTIARRAY_H_
#define _CODEGEN_STD_MSGS_FLOAT32MULTIARRAY_H_
...
PREDECLARE_BSON(std_msgs::Float32MultiArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Float32MultiArray); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Float32MultiArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        Float32MultiArray();
        /** copy constructor */
        Float32MultiArray(const Float32MultiArray & inobj);
        /** destructor */
        ~Float32MultiArray();

        /** allocator, convenience function for bind */
        static Float32MultiArray * New();
        ...
        static const unsigned int ID = 2068109272U;
        ...
        static const unsigned int DATA_VERSION = 665005604U;
        ...
        //        static const char * dataTypeName() { return "Float32MultiArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e75c4f0012b4fa8cfa48c4312f16e947"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe75c4f0012b4fa8cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfa48c4312f16e947ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Float32MultiArray * copy() { return new Float32MultiArray(*this); };

        /** assignment operator(s) */
        Float32MultiArray & operator=(const Float32MultiArray & inobj);
        /** equality operator */
        bool operator==(const Float32MultiArray & inobj) const;
        /** inequality operator */
        bool operator!=(const Float32MultiArray & inobj) const;
        /** less than operator */
        bool operator<(const Float32MultiArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Float32MultiArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Float32MultiArray>
    {
    public:
        static bool flat() {return std_msgs::Float32MultiArray::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Float32MultiArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Float32MultiArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::Float32MultiArray & value);

#endif  //  _STD_MSGS_FLOAT32MULTIARRAY_H_
