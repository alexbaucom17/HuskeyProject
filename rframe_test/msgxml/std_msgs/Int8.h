...
#ifndef _CODEGEN_STD_MSGS_INT8_H_
#define _CODEGEN_STD_MSGS_INT8_H_
...
PREDECLARE_BSON(std_msgs::Int8); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Int8); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Int8 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109282U;
        ...
        static const unsigned int DATA_VERSION = 2133096268U;
        ...
        //        static const char * dataTypeName() { return "Int8"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0cc6b2342f9efcc7b1a339a3500f0020"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0cc6b2342f9efcc7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xb1a339a3500f0020ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Int8 * copy() { return new Int8(*this); };

        /** assignment operator(s) */
        Int8 & operator=(const Int8 & inobj);
        /** equality operator */
        bool operator==(const Int8 & inobj) const;
        /** inequality operator */
        bool operator!=(const Int8 & inobj) const;
        /** less than operator */
        bool operator<(const Int8 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Int8 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Int8>
    {
    public:
        static bool flat() {return std_msgs::Int8::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Int8::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Int8 & value);
