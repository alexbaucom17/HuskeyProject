...
#ifndef _CODEGEN_STD_MSGS_COLORRGBA_H_
#define _CODEGEN_STD_MSGS_COLORRGBA_H_
...
PREDECLARE_BSON(std_msgs::ColorRGBA); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::ColorRGBA); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ColorRGBA & inobj);   
    ...
    */
    ...
    public: 
        ...
        ColorRGBA();
        /** copy constructor */
        ColorRGBA(const ColorRGBA & inobj);
        /** destructor */
        ~ColorRGBA();

        /** allocator, convenience function for bind */
        static ColorRGBA * New();
        ...
        static const unsigned int ID = 2068109268U;
        ...
        static const unsigned int DATA_VERSION = 271503227U;
        ...
        //        static const char * dataTypeName() { return "ColorRGBA"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "4041defc89a028f6d63f1be589652bc7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x4041defc89a028f6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd63f1be589652bc7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ColorRGBA * copy() { return new ColorRGBA(*this); };

        /** assignment operator(s) */
        ColorRGBA & operator=(const ColorRGBA & inobj);
        /** equality operator */
        bool operator==(const ColorRGBA & inobj) const;
        /** inequality operator */
        bool operator!=(const ColorRGBA & inobj) const;
        /** less than operator */
        bool operator<(const ColorRGBA & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ColorRGBA & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::ColorRGBA>
    {
    public:
        static bool flat() {return std_msgs::ColorRGBA::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::ColorRGBA::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::ColorRGBA & value);
