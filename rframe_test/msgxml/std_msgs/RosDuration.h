...
#ifndef _CODEGEN_STD_MSGS_ROSDURATION_H_
#define _CODEGEN_STD_MSGS_ROSDURATION_H_
...
PREDECLARE_BSON(std_msgs::RosDuration); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::RosDuration); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, RosDuration & inobj);   

    /** 
        \ingroup CodeGen
        core of ros time representation
    */
    class RosDuration
    {
    public: 
        ...
        RosDuration();
        /** copy constructor */
        RosDuration(const RosDuration & inobj);
        /** destructor */
        ~RosDuration();

        /** allocator, convenience function for bind */
        static RosDuration * New();
        ...
        static const unsigned int ID = 2068109262U;
        ...
        static const unsigned int DATA_VERSION = 2602593862U;
        ...
        //        static const char * dataTypeName() { return "RosDuration"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a8494d042ec14e205e981814727cd8ed"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa8494d042ec14e20ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5e981814727cd8edULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        RosDuration * copy() { return new RosDuration(*this); };

        /** assignment operator(s) */
        RosDuration & operator=(const RosDuration & inobj);
        /** equality operator */
        bool operator==(const RosDuration & inobj) const;
        /** inequality operator */
        bool operator!=(const RosDuration & inobj) const;
        /** less than operator */
        bool operator<(const RosDuration & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, RosDuration & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::RosDuration>
    {
    public:
        static bool flat() {return std_msgs::RosDuration::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::RosDuration::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::RosDuration & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_msgs::RosDuration & value);

#endif  //  _STD_MSGS_ROSDURATION_H_
