...
#ifndef _CODEGEN_STD_MSGS_INT64_H_
#define _CODEGEN_STD_MSGS_INT64_H_
...
PREDECLARE_BSON(std_msgs::Int64); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_msgs::Int64); // see Common.h, macro used for a cleaner header

namespace std_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Int64 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 2068109280U;
        ...
        static const unsigned int DATA_VERSION = 1500849533U;
        ...
        //        static const char * dataTypeName() { return "Int64"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "263bd8608c480de8a363e65332bb7e41"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x263bd8608c480de8ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa363e65332bb7e41ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Int64 * copy() { return new Int64(*this); };

        /** assignment operator(s) */
        Int64 & operator=(const Int64 & inobj);
        /** equality operator */
        bool operator==(const Int64 & inobj) const;
        /** inequality operator */
        bool operator!=(const Int64 & inobj) const;
        /** less than operator */
        bool operator<(const Int64 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Int64 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_msgs::Int64>
    {
    public:
        static bool flat() {return std_msgs::Int64::dataTypeFlat(); };
        static std::string sourceXML() {return std_msgs::Int64::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_msgs::Int64 & value);
