...
#ifndef _CODEGEN_ACTIONLIB_TESTREQUESTACTION_H_
#define _CODEGEN_ACTIONLIB_TESTREQUESTACTION_H_
...
PREDECLARE_BSON(actionlib::TestRequestAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestRequestAction); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestRequestAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestRequestAction();
        /** copy constructor */
        TestRequestAction(const TestRequestAction & inobj);
        /** destructor */
        ~TestRequestAction();

        /** allocator, convenience function for bind */
        static TestRequestAction * New();
        ...
        static const unsigned int ID = 1134863283U;
        ...
        static const unsigned int DATA_VERSION = 192402447U;
        ...
        //        static const char * dataTypeName() { return "TestRequestAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6e3d19455ca7445918f686762d2a8435"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6e3d19455ca74459ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x18f686762d2a8435ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestRequestAction * copy() { return new TestRequestAction(*this); };

        /** assignment operator(s) */
        TestRequestAction & operator=(const TestRequestAction & inobj);
        /** equality operator */
        bool operator==(const TestRequestAction & inobj) const;
        /** inequality operator */
        bool operator!=(const TestRequestAction & inobj) const;
        /** less than operator */
        bool operator<(const TestRequestAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestRequestAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestRequestAction>
    {
    public:
        static bool flat() {return actionlib::TestRequestAction::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestRequestAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestRequestAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestRequestAction & value);

#endif  //  _ACTIONLIB_TESTREQUESTACTION_H_
