...
#ifndef _CODEGEN_ACTIONLIB_TESTREQUESTACTIONRESULT_H_
#define _CODEGEN_ACTIONLIB_TESTREQUESTACTIONRESULT_H_
...
PREDECLARE_BSON(actionlib::TestRequestActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestRequestActionResult); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestRequestActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TestRequestActionResult(const TestRequestActionResult & inobj);
        /** destructor */
        ~TestRequestActionResult();

        /** allocator, convenience function for bind */
        static TestRequestActionResult * New();
        ...
        static const unsigned int ID = 1134863286U;
        ...
        static const unsigned int DATA_VERSION = 3949548U;
        ...
        //        static const char * dataTypeName() { return "TestRequestActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "d00e0f3a6469a397a5b0e0ca51e7c857"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xd00e0f3a6469a397ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa5b0e0ca51e7c857ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestRequestActionResult * copy() { return new TestRequestActionResult(*this); };

        /** assignment operator(s) */
        TestRequestActionResult & operator=(const TestRequestActionResult & inobj);
        /** equality operator */
        bool operator==(const TestRequestActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const TestRequestActionResult & inobj) const;
        /** less than operator */
        bool operator<(const TestRequestActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestRequestActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestRequestActionResult>
    {
    public:
        static bool flat() {return actionlib::TestRequestActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestRequestActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestRequestActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestRequestActionResult & value);

#endif  //  _ACTIONLIB_TESTREQUESTACTIONRESULT_H_
