...
#ifndef _CODEGEN_ACTIONLIB_TWOINTSACTION_H_
#define _CODEGEN_ACTIONLIB_TWOINTSACTION_H_
...
PREDECLARE_BSON(actionlib::TwoIntsAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TwoIntsAction); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwoIntsAction();
        /** copy constructor */
        TwoIntsAction(const TwoIntsAction & inobj);
        /** destructor */
        ~TwoIntsAction();

        /** allocator, convenience function for bind */
        static TwoIntsAction * New();
        ...
        static const unsigned int ID = 1134863291U;
        ...
        static const unsigned int DATA_VERSION = 1642025785U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ec6866ed788923e05293ec225921fba1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xec6866ed788923e0ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x5293ec225921fba1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsAction * copy() { return new TwoIntsAction(*this); };

        /** assignment operator(s) */
        TwoIntsAction & operator=(const TwoIntsAction & inobj);
        /** equality operator */
        bool operator==(const TwoIntsAction & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsAction & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TwoIntsAction>
    {
    public:
        static bool flat() {return actionlib::TwoIntsAction::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TwoIntsAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TwoIntsAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TwoIntsAction & value);

#endif  //  _ACTIONLIB_TWOINTSACTION_H_
