...
#ifndef _CODEGEN_ACTIONLIB_TESTREQUESTACTIONGOAL_H_
#define _CODEGEN_ACTIONLIB_TESTREQUESTACTIONGOAL_H_
...
PREDECLARE_BSON(actionlib::TestRequestActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestRequestActionGoal); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestRequestActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        TestRequestActionGoal(const TestRequestActionGoal & inobj);
        /** destructor */
        ~TestRequestActionGoal();

        /** allocator, convenience function for bind */
        static TestRequestActionGoal * New();
        ...
        static const unsigned int ID = 1134863285U;
        ...
        static const unsigned int DATA_VERSION = 3509598587U;
        ...
        //        static const char * dataTypeName() { return "TestRequestActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "109ad9100dd250c8e53787a95e1c188f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x109ad9100dd250c8ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe53787a95e1c188fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestRequestActionGoal * copy() { return new TestRequestActionGoal(*this); };

        /** assignment operator(s) */
        TestRequestActionGoal & operator=(const TestRequestActionGoal & inobj);
        /** equality operator */
        bool operator==(const TestRequestActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const TestRequestActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const TestRequestActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestRequestActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestRequestActionGoal>
    {
    public:
        static bool flat() {return actionlib::TestRequestActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestRequestActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestRequestActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestRequestActionGoal & value);

#endif  //  _ACTIONLIB_TESTREQUESTACTIONGOAL_H_
