...
#ifndef _CODEGEN_ACTIONLIB_TESTACTION_H_
#define _CODEGEN_ACTIONLIB_TESTACTION_H_
...
PREDECLARE_BSON(actionlib::TestAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TestAction); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TestAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        TestAction();
        /** copy constructor */
        TestAction(const TestAction & inobj);
        /** destructor */
        ~TestAction();

        /** allocator, convenience function for bind */
        static TestAction * New();
        ...
        static const unsigned int ID = 1134863277U;
        ...
        static const unsigned int DATA_VERSION = 1454467975U;
        ...
        //        static const char * dataTypeName() { return "TestAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8940bb6654b126f89bcb186bb2aa758c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8940bb6654b126f8ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9bcb186bb2aa758cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TestAction * copy() { return new TestAction(*this); };

        /** assignment operator(s) */
        TestAction & operator=(const TestAction & inobj);
        /** equality operator */
        bool operator==(const TestAction & inobj) const;
        /** inequality operator */
        bool operator!=(const TestAction & inobj) const;
        /** less than operator */
        bool operator<(const TestAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TestAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TestAction>
    {
    public:
        static bool flat() {return actionlib::TestAction::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TestAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TestAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TestAction & value);

#endif  //  _ACTIONLIB_TESTACTION_H_
