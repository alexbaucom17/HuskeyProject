...
#ifndef _CODEGEN_ACTIONLIB_TWOINTSGOAL_H_
#define _CODEGEN_ACTIONLIB_TWOINTSGOAL_H_
...
PREDECLARE_BSON(actionlib::TwoIntsGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(actionlib::TwoIntsGoal); // see Common.h, macro used for a cleaner header

namespace actionlib
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TwoIntsGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        TwoIntsGoal();
        /** copy constructor */
        TwoIntsGoal(const TwoIntsGoal & inobj);
        /** destructor */
        ~TwoIntsGoal();

        /** allocator, convenience function for bind */
        static TwoIntsGoal * New();
        ...
        static const unsigned int ID = 1134863296U;
        ...
        static const unsigned int DATA_VERSION = 21952806U;
        ...
        //        static const char * dataTypeName() { return "TwoIntsGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9425ae9fdc63502fc018c18c10219a51"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9425ae9fdc63502fULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc018c18c10219a51ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TwoIntsGoal * copy() { return new TwoIntsGoal(*this); };

        /** assignment operator(s) */
        TwoIntsGoal & operator=(const TwoIntsGoal & inobj);
        /** equality operator */
        bool operator==(const TwoIntsGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const TwoIntsGoal & inobj) const;
        /** less than operator */
        bool operator<(const TwoIntsGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TwoIntsGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<actionlib::TwoIntsGoal>
    {
    public:
        static bool flat() {return actionlib::TwoIntsGoal::dataTypeFlat(); };
        static std::string sourceXML() {return actionlib::TwoIntsGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const actionlib::TwoIntsGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const actionlib::TwoIntsGoal & value);

#endif  //  _ACTIONLIB_TWOINTSGOAL_H_
