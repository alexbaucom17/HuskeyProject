...
#ifndef _CODEGEN_STD_SRVS_TRIGGER_H_
#define _CODEGEN_STD_SRVS_TRIGGER_H_
...
PREDECLARE_BSON(std_srvs::Trigger); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::Trigger); // see Common.h, macro used for a cleaner header

namespace std_srvs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Trigger & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1986463665U;
        ...
        static const unsigned int DATA_VERSION = 139567252U;
        ...
        //        static const char * dataTypeName() { return "Trigger"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "5d6e2d4a2c97dc40f22dfe20adc7cc4e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x5d6e2d4a2c97dc40ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf22dfe20adc7cc4eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Trigger * copy() { return new Trigger(*this); };

        /** assignment operator(s) */
        Trigger & operator=(const Trigger & inobj);
        /** equality operator */
        bool operator==(const Trigger & inobj) const;
        /** inequality operator */
        bool operator!=(const Trigger & inobj) const;
        /** less than operator */
        bool operator<(const Trigger & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Trigger & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::Trigger>
    {
    public:
        static bool flat() {return std_srvs::Trigger::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::Trigger::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::Trigger & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::Trigger & value);

#endif  //  _STD_SRVS_TRIGGER_H_
