...
#ifndef _CODEGEN_STD_SRVS_EMPTY_H_
#define _CODEGEN_STD_SRVS_EMPTY_H_
...
PREDECLARE_BSON(std_srvs::Empty); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::Empty); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1986463659U;
        ...
        static const unsigned int DATA_VERSION = 2656132796U;
        ...
        */
        ...
        static const std::string versionMD5() { return "e94b684ee03f6a7a906bb03afb1d1ed6"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe94b684ee03f6a7aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x906bb03afb1d1ed6ULL;
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::Empty>
    {
    public:
        static bool flat() {return std_srvs::Empty::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::Empty::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::Empty & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::Empty & value);

#endif  //  _STD_SRVS_EMPTY_H_
