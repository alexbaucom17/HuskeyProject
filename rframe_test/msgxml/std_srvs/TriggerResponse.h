...
#ifndef _CODEGEN_STD_SRVS_TRIGGERRESPONSE_H_
#define _CODEGEN_STD_SRVS_TRIGGERRESPONSE_H_
...
PREDECLARE_BSON(std_srvs::TriggerResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(std_srvs::TriggerResponse); // see Common.h, macro used for a cleaner header

namespace std_srvs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, TriggerResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        TriggerResponse();
        /** copy constructor */
        TriggerResponse(const TriggerResponse & inobj);
        /** destructor */
        ~TriggerResponse();

        /** allocator, convenience function for bind */
        static TriggerResponse * New();
        ...
        static const unsigned int ID = 1986463664U;
        ...
        static const unsigned int DATA_VERSION = 3006352403U;
        ...
        //        static const char * dataTypeName() { return "TriggerResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bdb998d90181ec6351ff0ab90a4830f3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbdb998d90181ec63ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x51ff0ab90a4830f3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        TriggerResponse * copy() { return new TriggerResponse(*this); };

        /** assignment operator(s) */
        TriggerResponse & operator=(const TriggerResponse & inobj);
        /** equality operator */
        bool operator==(const TriggerResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const TriggerResponse & inobj) const;
        /** less than operator */
        bool operator<(const TriggerResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, TriggerResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<std_srvs::TriggerResponse>
    {
    public:
        static bool flat() {return std_srvs::TriggerResponse::dataTypeFlat(); };
        static std::string sourceXML() {return std_srvs::TriggerResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const std_srvs::TriggerResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const std_srvs::TriggerResponse & value);

#endif  //  _STD_SRVS_TRIGGERRESPONSE_H_
