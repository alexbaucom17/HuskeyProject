...
#ifndef _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONFEEDBACK_H_
...
namespace control_msgs{ 
    class FollowJointTrajectoryActionFeedback; 
}; 

PREDECLARE_BSON(control_msgs::FollowJointTrajectoryActionFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::FollowJointTrajectoryActionFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FollowJointTrajectoryActionFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        FollowJointTrajectoryActionFeedback(const FollowJointTrajectoryActionFeedback & inobj);
        /** destructor */
        ~FollowJointTrajectoryActionFeedback();

        /** allocator, convenience function for bind */
        static FollowJointTrajectoryActionFeedback * New();
        ...
        static const unsigned int ID = 1246705430U;
        ...
        static const unsigned int DATA_VERSION = 3547716337U;
        ...
        //        static const char * dataTypeName() { return "FollowJointTrajectoryActionFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "56bff5905d8fb248ea1efa81f1a2d2eb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x56bff5905d8fb248ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xea1efa81f1a2d2ebULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FollowJointTrajectoryActionFeedback * copy() { return new FollowJointTrajectoryActionFeedback(*this); };

        /** assignment operator(s) */
        FollowJointTrajectoryActionFeedback & operator=(const FollowJointTrajectoryActionFeedback & inobj);
        /** equality operator */
        bool operator==(const FollowJointTrajectoryActionFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const FollowJointTrajectoryActionFeedback & inobj) const;
        /** less than operator */
        bool operator<(const FollowJointTrajectoryActionFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FollowJointTrajectoryActionFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::FollowJointTrajectoryActionFeedback>
    {
    public:
        static bool flat() {return control_msgs::FollowJointTrajectoryActionFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::FollowJointTrajectoryActionFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::FollowJointTrajectoryActionFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::FollowJointTrajectoryActionFeedback & value);

#endif  //  _CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONFEEDBACK_H_
