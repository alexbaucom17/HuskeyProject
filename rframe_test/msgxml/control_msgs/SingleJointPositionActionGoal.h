...
#ifndef _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONGOAL_H_
#define _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONGOAL_H_
...
PREDECLARE_BSON(control_msgs::SingleJointPositionActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::SingleJointPositionActionGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SingleJointPositionActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SingleJointPositionActionGoal(const SingleJointPositionActionGoal & inobj);
        /** destructor */
        ~SingleJointPositionActionGoal();

        /** allocator, convenience function for bind */
        static SingleJointPositionActionGoal * New();
        ...
        static const unsigned int ID = 1246705463U;
        ...
        static const unsigned int DATA_VERSION = 179610212U;
        ...
        //        static const char * dataTypeName() { return "SingleJointPositionActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "95dd920032f0c6370688df2f7f749469"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x95dd920032f0c637ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0688df2f7f749469ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SingleJointPositionActionGoal * copy() { return new SingleJointPositionActionGoal(*this); };

        /** assignment operator(s) */
        SingleJointPositionActionGoal & operator=(const SingleJointPositionActionGoal & inobj);
        /** equality operator */
        bool operator==(const SingleJointPositionActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const SingleJointPositionActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const SingleJointPositionActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SingleJointPositionActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::SingleJointPositionActionGoal>
    {
    public:
        static bool flat() {return control_msgs::SingleJointPositionActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::SingleJointPositionActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::SingleJointPositionActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::SingleJointPositionActionGoal & value);

#endif  //  _CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONGOAL_H_
