...
#ifndef _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDACTIONGOAL_H_
#define _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDACTIONGOAL_H_
...
PREDECLARE_BSON(control_msgs::GripperCommandActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::GripperCommandActionGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GripperCommandActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GripperCommandActionGoal(const GripperCommandActionGoal & inobj);
        /** destructor */
        ~GripperCommandActionGoal();

        /** allocator, convenience function for bind */
        static GripperCommandActionGoal * New();
        ...
        static const unsigned int ID = 1246705439U;
        ...
        static const unsigned int DATA_VERSION = 891541071U;
        ...
        //        static const char * dataTypeName() { return "GripperCommandActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "91e6665ce8fe1ce56bd1acde77a4c393"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x91e6665ce8fe1ce5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x6bd1acde77a4c393ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GripperCommandActionGoal * copy() { return new GripperCommandActionGoal(*this); };

        /** assignment operator(s) */
        GripperCommandActionGoal & operator=(const GripperCommandActionGoal & inobj);
        /** equality operator */
        bool operator==(const GripperCommandActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const GripperCommandActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const GripperCommandActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GripperCommandActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::GripperCommandActionGoal>
    {
    public:
        static bool flat() {return control_msgs::GripperCommandActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::GripperCommandActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::GripperCommandActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::GripperCommandActionGoal & value);

#endif  //  _CONTROL_MSGS_GRIPPERCOMMANDACTIONGOAL_H_
