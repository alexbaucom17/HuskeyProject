...
#ifndef _CODEGEN_CONTROL_MSGS_POINTHEADFEEDBACK_H_
#define _CODEGEN_CONTROL_MSGS_POINTHEADFEEDBACK_H_
...
PREDECLARE_BSON(control_msgs::PointHeadFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::PointHeadFeedback); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointHeadFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointHeadFeedback();
        /** copy constructor */
        PointHeadFeedback(const PointHeadFeedback & inobj);
        /** destructor */
        ~PointHeadFeedback();

        /** allocator, convenience function for bind */
        static PointHeadFeedback * New();
        ...
        static const unsigned int ID = 1246705458U;
        ...
        static const unsigned int DATA_VERSION = 512659297U;
        ...
        //        static const char * dataTypeName() { return "PointHeadFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1a9239f663b8cd56c92a1f90795dd631"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1a9239f663b8cd56ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc92a1f90795dd631ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointHeadFeedback * copy() { return new PointHeadFeedback(*this); };

        /** assignment operator(s) */
        PointHeadFeedback & operator=(const PointHeadFeedback & inobj);
        /** equality operator */
        bool operator==(const PointHeadFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const PointHeadFeedback & inobj) const;
        /** less than operator */
        bool operator<(const PointHeadFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointHeadFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::PointHeadFeedback>
    {
    public:
        static bool flat() {return control_msgs::PointHeadFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::PointHeadFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::PointHeadFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::PointHeadFeedback & value);

#endif  //  _CONTROL_MSGS_POINTHEADFEEDBACK_H_
