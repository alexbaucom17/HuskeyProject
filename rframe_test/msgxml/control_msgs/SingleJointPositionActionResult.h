...
#ifndef _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONRESULT_H_
#define _CODEGEN_CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONRESULT_H_
...
PREDECLARE_BSON(control_msgs::SingleJointPositionActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::SingleJointPositionActionResult); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SingleJointPositionActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SingleJointPositionActionResult(const SingleJointPositionActionResult & inobj);
        /** destructor */
        ~SingleJointPositionActionResult();

        /** allocator, convenience function for bind */
        static SingleJointPositionActionResult * New();
        ...
        static const unsigned int ID = 1246705464U;
        ...
        static const unsigned int DATA_VERSION = 2543135707U;
        ...
        //        static const char * dataTypeName() { return "SingleJointPositionActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c0db896e3000a9d93799d7f730ea961a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc0db896e3000a9d9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3799d7f730ea961aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SingleJointPositionActionResult * copy() { return new SingleJointPositionActionResult(*this); };

        /** assignment operator(s) */
        SingleJointPositionActionResult & operator=(const SingleJointPositionActionResult & inobj);
        /** equality operator */
        bool operator==(const SingleJointPositionActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const SingleJointPositionActionResult & inobj) const;
        /** less than operator */
        bool operator<(const SingleJointPositionActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SingleJointPositionActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::SingleJointPositionActionResult>
    {
    public:
        static bool flat() {return control_msgs::SingleJointPositionActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::SingleJointPositionActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::SingleJointPositionActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::SingleJointPositionActionResult & value);

#endif  //  _CONTROL_MSGS_SINGLEJOINTPOSITIONACTIONRESULT_H_
