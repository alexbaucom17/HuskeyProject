...
#ifndef _CODEGEN_CONTROL_MSGS_POINTHEADGOAL_H_
#define _CODEGEN_CONTROL_MSGS_POINTHEADGOAL_H_
...
PREDECLARE_BSON(control_msgs::PointHeadGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::PointHeadGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointHeadGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointHeadGoal();
        /** copy constructor */
        PointHeadGoal(const PointHeadGoal & inobj);
        /** destructor */
        ~PointHeadGoal();

        /** allocator, convenience function for bind */
        static PointHeadGoal * New();
        ...
        static const unsigned int ID = 1246705459U;
        ...
        static const unsigned int DATA_VERSION = 888365073U;
        ...
        //        static const char * dataTypeName() { return "PointHeadGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "dfb1fa5d4bb94cc9cec3afcc1a08525d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xdfb1fa5d4bb94cc9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcec3afcc1a08525dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointHeadGoal * copy() { return new PointHeadGoal(*this); };

        /** assignment operator(s) */
        PointHeadGoal & operator=(const PointHeadGoal & inobj);
        /** equality operator */
        bool operator==(const PointHeadGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const PointHeadGoal & inobj) const;
        /** less than operator */
        bool operator<(const PointHeadGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointHeadGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::PointHeadGoal>
    {
    public:
        static bool flat() {return control_msgs::PointHeadGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::PointHeadGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::PointHeadGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::PointHeadGoal & value);

#endif  //  _CONTROL_MSGS_POINTHEADGOAL_H_
