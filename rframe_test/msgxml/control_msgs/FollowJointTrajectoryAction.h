...
#ifndef _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTION_H_
#define _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTION_H_
...
PREDECLARE_BSON(control_msgs::FollowJointTrajectoryAction); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::FollowJointTrajectoryAction); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FollowJointTrajectoryAction & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        FollowJointTrajectoryAction(const FollowJointTrajectoryAction & inobj);
        /** destructor */
        ~FollowJointTrajectoryAction();

        /** allocator, convenience function for bind */
        static FollowJointTrajectoryAction * New();
        ...
        static const unsigned int ID = 1246705429U;
        ...
        static const unsigned int DATA_VERSION = 702000967U;
        ...
        //        static const char * dataTypeName() { return "FollowJointTrajectoryAction"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "341659b365f60f9cfb220f0e8e773d46"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x341659b365f60f9cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfb220f0e8e773d46ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FollowJointTrajectoryAction * copy() { return new FollowJointTrajectoryAction(*this); };

        /** assignment operator(s) */
        FollowJointTrajectoryAction & operator=(const FollowJointTrajectoryAction & inobj);
        /** equality operator */
        bool operator==(const FollowJointTrajectoryAction & inobj) const;
        /** inequality operator */
        bool operator!=(const FollowJointTrajectoryAction & inobj) const;
        /** less than operator */
        bool operator<(const FollowJointTrajectoryAction & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FollowJointTrajectoryAction & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::FollowJointTrajectoryAction>
    {
    public:
        static bool flat() {return control_msgs::FollowJointTrajectoryAction::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::FollowJointTrajectoryAction::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::FollowJointTrajectoryAction & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::FollowJointTrajectoryAction & value);

#endif  //  _CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTION_H_
