...
#ifndef _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDACTIONRESULT_H_
#define _CODEGEN_CONTROL_MSGS_GRIPPERCOMMANDACTIONRESULT_H_
...
PREDECLARE_BSON(control_msgs::GripperCommandActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::GripperCommandActionResult); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GripperCommandActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GripperCommandActionResult(const GripperCommandActionResult & inobj);
        /** destructor */
        ~GripperCommandActionResult();

        /** allocator, convenience function for bind */
        static GripperCommandActionResult * New();
        ...
        static const unsigned int ID = 1246705440U;
        ...
        static const unsigned int DATA_VERSION = 320150985U;
        ...
        //        static const char * dataTypeName() { return "GripperCommandActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bcfe41cda882b78bd46b047aa6da2acd"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbcfe41cda882b78bULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd46b047aa6da2acdULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GripperCommandActionResult * copy() { return new GripperCommandActionResult(*this); };

        /** assignment operator(s) */
        GripperCommandActionResult & operator=(const GripperCommandActionResult & inobj);
        /** equality operator */
        bool operator==(const GripperCommandActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const GripperCommandActionResult & inobj) const;
        /** less than operator */
        bool operator<(const GripperCommandActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GripperCommandActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::GripperCommandActionResult>
    {
    public:
        static bool flat() {return control_msgs::GripperCommandActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::GripperCommandActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::GripperCommandActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::GripperCommandActionResult & value);

#endif  //  _CONTROL_MSGS_GRIPPERCOMMANDACTIONRESULT_H_
