...
#ifndef _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYCONTROLLERSTATE_H_
#define _CODEGEN_CONTROL_MSGS_JOINTTRAJECTORYCONTROLLERSTATE_H_
...
PREDECLARE_BSON(control_msgs::JointTrajectoryControllerState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::JointTrajectoryControllerState); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointTrajectoryControllerState & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        JointTrajectoryControllerState(const JointTrajectoryControllerState & inobj);
        /** destructor */
        ~JointTrajectoryControllerState();

        /** allocator, convenience function for bind */
        static JointTrajectoryControllerState * New();
        ...
        static const unsigned int ID = 1246705450U;
        ...
        static const unsigned int DATA_VERSION = 2949611860U;
        ...
        //        static const char * dataTypeName() { return "JointTrajectoryControllerState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "08185c99026e95b7215df14d953f3633"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x08185c99026e95b7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x215df14d953f3633ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointTrajectoryControllerState * copy() { return new JointTrajectoryControllerState(*this); };

        /** assignment operator(s) */
        JointTrajectoryControllerState & operator=(const JointTrajectoryControllerState & inobj);
        /** equality operator */
        bool operator==(const JointTrajectoryControllerState & inobj) const;
        /** inequality operator */
        bool operator!=(const JointTrajectoryControllerState & inobj) const;
        /** less than operator */
        bool operator<(const JointTrajectoryControllerState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointTrajectoryControllerState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::JointTrajectoryControllerState>
    {
    public:
        static bool flat() {return control_msgs::JointTrajectoryControllerState::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::JointTrajectoryControllerState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::JointTrajectoryControllerState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::JointTrajectoryControllerState & value);

#endif  //  _CONTROL_MSGS_JOINTTRAJECTORYCONTROLLERSTATE_H_
