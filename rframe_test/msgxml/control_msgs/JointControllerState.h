...
#ifndef _CODEGEN_CONTROL_MSGS_JOINTCONTROLLERSTATE_H_
#define _CODEGEN_CONTROL_MSGS_JOINTCONTROLLERSTATE_H_
...
PREDECLARE_BSON(control_msgs::JointControllerState); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::JointControllerState); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointControllerState & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        JointControllerState(const JointControllerState & inobj);
        /** destructor */
        ~JointControllerState();

        /** allocator, convenience function for bind */
        static JointControllerState * New();
        ...
        static const unsigned int ID = 1246705444U;
        ...
        static const unsigned int DATA_VERSION = 2006894693U;
        ...
        //        static const char * dataTypeName() { return "JointControllerState"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8896b6623cad2c95454a39b2692ff107"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8896b6623cad2c95ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x454a39b2692ff107ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointControllerState * copy() { return new JointControllerState(*this); };

        /** assignment operator(s) */
        JointControllerState & operator=(const JointControllerState & inobj);
        /** equality operator */
        bool operator==(const JointControllerState & inobj) const;
        /** inequality operator */
        bool operator!=(const JointControllerState & inobj) const;
        /** less than operator */
        bool operator<(const JointControllerState & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointControllerState & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::JointControllerState>
    {
    public:
        static bool flat() {return control_msgs::JointControllerState::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::JointControllerState::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::JointControllerState & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::JointControllerState & value);

#endif  //  _CONTROL_MSGS_JOINTCONTROLLERSTATE_H_
