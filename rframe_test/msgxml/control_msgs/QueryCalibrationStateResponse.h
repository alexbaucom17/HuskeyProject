...
#ifndef _CODEGEN_CONTROL_MSGS_QUERYCALIBRATIONSTATERESPONSE_H_
#define _CODEGEN_CONTROL_MSGS_QUERYCALIBRATIONSTATERESPONSE_H_
...
PREDECLARE_BSON(control_msgs::QueryCalibrationStateResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::QueryCalibrationStateResponse); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, QueryCalibrationStateResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        QueryCalibrationStateResponse(const QueryCalibrationStateResponse & inobj);
        /** destructor */
        ~QueryCalibrationStateResponse();

        /** allocator, convenience function for bind */
        static QueryCalibrationStateResponse * New();
        ...
        static const unsigned int ID = 1246705469U;
        ...
        static const unsigned int DATA_VERSION = 3562733447U;
        ...
        //        static const char * dataTypeName() { return "QueryCalibrationStateResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0939fd4cc74f5a21127ca34c0bbb4864"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0939fd4cc74f5a21ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x127ca34c0bbb4864ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        QueryCalibrationStateResponse * copy() { return new QueryCalibrationStateResponse(*this); };

        /** assignment operator(s) */
        QueryCalibrationStateResponse & operator=(const QueryCalibrationStateResponse & inobj);
        /** equality operator */
        bool operator==(const QueryCalibrationStateResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const QueryCalibrationStateResponse & inobj) const;
        /** less than operator */
        bool operator<(const QueryCalibrationStateResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, QueryCalibrationStateResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::QueryCalibrationStateResponse>
    {
    public:
        static bool flat() {return control_msgs::QueryCalibrationStateResponse::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::QueryCalibrationStateResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::QueryCalibrationStateResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::QueryCalibrationStateResponse & value);

#endif  //  _CONTROL_MSGS_QUERYCALIBRATIONSTATERESPONSE_H_
