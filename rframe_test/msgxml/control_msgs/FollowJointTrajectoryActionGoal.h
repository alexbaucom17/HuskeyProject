...
#ifndef _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONGOAL_H_
#define _CODEGEN_CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONGOAL_H_
...
PREDECLARE_BSON(control_msgs::FollowJointTrajectoryActionGoal); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::FollowJointTrajectoryActionGoal); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FollowJointTrajectoryActionGoal & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        FollowJointTrajectoryActionGoal(const FollowJointTrajectoryActionGoal & inobj);
        /** destructor */
        ~FollowJointTrajectoryActionGoal();

        /** allocator, convenience function for bind */
        static FollowJointTrajectoryActionGoal * New();
        ...
        static const unsigned int ID = 1246705431U;
        ...
        static const unsigned int DATA_VERSION = 2346073725U;
        ...
        //        static const char * dataTypeName() { return "FollowJointTrajectoryActionGoal"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "c285933231e94c2a7d8d9287bb4a097d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xc285933231e94c2aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7d8d9287bb4a097dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FollowJointTrajectoryActionGoal * copy() { return new FollowJointTrajectoryActionGoal(*this); };

        /** assignment operator(s) */
        FollowJointTrajectoryActionGoal & operator=(const FollowJointTrajectoryActionGoal & inobj);
        /** equality operator */
        bool operator==(const FollowJointTrajectoryActionGoal & inobj) const;
        /** inequality operator */
        bool operator!=(const FollowJointTrajectoryActionGoal & inobj) const;
        /** less than operator */
        bool operator<(const FollowJointTrajectoryActionGoal & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FollowJointTrajectoryActionGoal & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::FollowJointTrajectoryActionGoal>
    {
    public:
        static bool flat() {return control_msgs::FollowJointTrajectoryActionGoal::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::FollowJointTrajectoryActionGoal::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::FollowJointTrajectoryActionGoal & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::FollowJointTrajectoryActionGoal & value);

#endif  //  _CONTROL_MSGS_FOLLOWJOINTTRAJECTORYACTIONGOAL_H_
