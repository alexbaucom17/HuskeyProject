...
#ifndef _CODEGEN_CONTROL_MSGS_GRIPPERCOMMAND_H_
#define _CODEGEN_CONTROL_MSGS_GRIPPERCOMMAND_H_
...
PREDECLARE_BSON(control_msgs::GripperCommand); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(control_msgs::GripperCommand); // see Common.h, macro used for a cleaner header

namespace control_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GripperCommand & inobj);   
    ...
    */
    ...
    public: 
        ...
        GripperCommand();
        /** copy constructor */
        GripperCommand(const GripperCommand & inobj);
        /** destructor */
        ~GripperCommand();

        /** allocator, convenience function for bind */
        static GripperCommand * New();
        ...
        static const unsigned int ID = 1246705436U;
        ...
        static const unsigned int DATA_VERSION = 4131965917U;
        ...
        //        static const char * dataTypeName() { return "GripperCommand"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "bc8308160a0162f636d607bc809d2c3c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbc8308160a0162f6ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x36d607bc809d2c3cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GripperCommand * copy() { return new GripperCommand(*this); };

        /** assignment operator(s) */
        GripperCommand & operator=(const GripperCommand & inobj);
        /** equality operator */
        bool operator==(const GripperCommand & inobj) const;
        /** inequality operator */
        bool operator!=(const GripperCommand & inobj) const;
        /** less than operator */
        bool operator<(const GripperCommand & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GripperCommand & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<control_msgs::GripperCommand>
    {
    public:
        static bool flat() {return control_msgs::GripperCommand::dataTypeFlat(); };
        static std::string sourceXML() {return control_msgs::GripperCommand::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const control_msgs::GripperCommand & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const control_msgs::GripperCommand & value);

#endif  //  _CONTROL_MSGS_GRIPPERCOMMAND_H_
