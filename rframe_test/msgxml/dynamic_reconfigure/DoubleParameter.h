...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_DOUBLEPARAMETER_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_DOUBLEPARAMETER_H_
...
PREDECLARE_BSON(dynamic_reconfigure::DoubleParameter); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::DoubleParameter); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, DoubleParameter & inobj);   
    ...
    */
    ...
    public: 
        ...
        DoubleParameter();
        /** copy constructor */
        DoubleParameter(const DoubleParameter & inobj);
        /** destructor */
        ~DoubleParameter();

        /** allocator, convenience function for bind */
        static DoubleParameter * New();
        ...
        static const unsigned int ID = 535859633U;
        ...
        static const unsigned int DATA_VERSION = 4212470586U;
        ...
        //        static const char * dataTypeName() { return "DoubleParameter"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "71318dbc1a251832e9f914c4960e6ec1"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x71318dbc1a251832ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe9f914c4960e6ec1ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        DoubleParameter * copy() { return new DoubleParameter(*this); };

        /** assignment operator(s) */
        DoubleParameter & operator=(const DoubleParameter & inobj);
        /** equality operator */
        bool operator==(const DoubleParameter & inobj) const;
        /** inequality operator */
        bool operator!=(const DoubleParameter & inobj) const;
        /** less than operator */
        bool operator<(const DoubleParameter & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, DoubleParameter & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::DoubleParameter>
    {
    public:
        static bool flat() {return dynamic_reconfigure::DoubleParameter::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::DoubleParameter::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::DoubleParameter & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::DoubleParameter & value);

#endif  //  _DYNAMIC_RECONFIGURE_DOUBLEPARAMETER_H_
