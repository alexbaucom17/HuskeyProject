...
#ifndef _CODEGEN_DYNAMIC_RECONFIGURE_STRPARAMETER_H_
#define _CODEGEN_DYNAMIC_RECONFIGURE_STRPARAMETER_H_
...
PREDECLARE_BSON(dynamic_reconfigure::StrParameter); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(dynamic_reconfigure::StrParameter); // see Common.h, macro used for a cleaner header

namespace dynamic_reconfigure
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, StrParameter & inobj);   
    ...
    */
    ...
    public: 
        ...
        StrParameter();
        /** copy constructor */
        StrParameter(const StrParameter & inobj);
        /** destructor */
        ~StrParameter();

        /** allocator, convenience function for bind */
        static StrParameter * New();
        ...
        static const unsigned int ID = 535859639U;
        ...
        static const unsigned int DATA_VERSION = 4154663066U;
        ...
        //        static const char * dataTypeName() { return "StrParameter"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a7e6bf87fb5a02b9fbf3afafc012dbfe"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa7e6bf87fb5a02b9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xfbf3afafc012dbfeULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        StrParameter * copy() { return new StrParameter(*this); };

        /** assignment operator(s) */
        StrParameter & operator=(const StrParameter & inobj);
        /** equality operator */
        bool operator==(const StrParameter & inobj) const;
        /** inequality operator */
        bool operator!=(const StrParameter & inobj) const;
        /** less than operator */
        bool operator<(const StrParameter & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, StrParameter & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<dynamic_reconfigure::StrParameter>
    {
    public:
        static bool flat() {return dynamic_reconfigure::StrParameter::dataTypeFlat(); };
        static std::string sourceXML() {return dynamic_reconfigure::StrParameter::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const dynamic_reconfigure::StrParameter & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const dynamic_reconfigure::StrParameter & value);

#endif  //  _DYNAMIC_RECONFIGURE_STRPARAMETER_H_
