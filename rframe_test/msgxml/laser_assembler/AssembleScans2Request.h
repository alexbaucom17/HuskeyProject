...
#ifndef _CODEGEN_LASER_ASSEMBLER_ASSEMBLESCANS2REQUEST_H_
#define _CODEGEN_LASER_ASSEMBLER_ASSEMBLESCANS2REQUEST_H_
...
PREDECLARE_BSON(laser_assembler::AssembleScans2Request); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(laser_assembler::AssembleScans2Request); // see Common.h, macro used for a cleaner header

namespace laser_assembler
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AssembleScans2Request & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        AssembleScans2Request(const AssembleScans2Request & inobj);
        /** destructor */
        ~AssembleScans2Request();

        /** allocator, convenience function for bind */
        static AssembleScans2Request * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::RosTime  begin; /**< The end of the interval on which we want to assemble scans or clouds */
        std_msgs::RosTime  end; /**< no comment provided */
        ...
        static const unsigned int ID = 1126634656U;
        ...
        static const unsigned int DATA_VERSION = 3336895506U;
        ...
        //        static const char * dataTypeName() { return "AssembleScans2Request"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8e951d554daa1043e8cfddb3182225fb"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8e951d554daa1043ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe8cfddb3182225fbULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AssembleScans2Request * copy() { return new AssembleScans2Request(*this); };

        /** assignment operator(s) */
        AssembleScans2Request & operator=(const AssembleScans2Request & inobj);
        /** equality operator */
        bool operator==(const AssembleScans2Request & inobj) const;
        /** inequality operator */
        bool operator!=(const AssembleScans2Request & inobj) const;
        /** less than operator */
        bool operator<(const AssembleScans2Request & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AssembleScans2Request & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<laser_assembler::AssembleScans2Request>
    {
    public:
        static bool flat() {return laser_assembler::AssembleScans2Request::dataTypeFlat(); };
        static std::string sourceXML() {return laser_assembler::AssembleScans2Request::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const laser_assembler::AssembleScans2Request & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const laser_assembler::AssembleScans2Request & value);

#endif  //  _LASER_ASSEMBLER_ASSEMBLESCANS2REQUEST_H_
