...
#ifndef _CODEGEN_ROSPY_TUTORIALS_ADDTWOINTSREQUEST_H_
#define _CODEGEN_ROSPY_TUTORIALS_ADDTWOINTSREQUEST_H_
...
PREDECLARE_BSON(rospy_tutorials::AddTwoIntsRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(rospy_tutorials::AddTwoIntsRequest); // see Common.h, macro used for a cleaner header

namespace rospy_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, AddTwoIntsRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        AddTwoIntsRequest();
        /** copy constructor */
        AddTwoIntsRequest(const AddTwoIntsRequest & inobj);
        /** destructor */
        ~AddTwoIntsRequest();

        /** allocator, convenience function for bind */
        static AddTwoIntsRequest * New();
        ...
        static const unsigned int ID = 862848161U;
        ...
        static const unsigned int DATA_VERSION = 1441176015U;
        ...
        //        static const char * dataTypeName() { return "AddTwoIntsRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "26a02fcf5060e2e506ce0b9e448ce353"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x26a02fcf5060e2e5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x06ce0b9e448ce353ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        AddTwoIntsRequest * copy() { return new AddTwoIntsRequest(*this); };

        /** assignment operator(s) */
        AddTwoIntsRequest & operator=(const AddTwoIntsRequest & inobj);
        /** equality operator */
        bool operator==(const AddTwoIntsRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const AddTwoIntsRequest & inobj) const;
        /** less than operator */
        bool operator<(const AddTwoIntsRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, AddTwoIntsRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<rospy_tutorials::AddTwoIntsRequest>
    {
    public:
        static bool flat() {return rospy_tutorials::AddTwoIntsRequest::dataTypeFlat(); };
        static std::string sourceXML() {return rospy_tutorials::AddTwoIntsRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const rospy_tutorials::AddTwoIntsRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const rospy_tutorials::AddTwoIntsRequest & value);

#endif  //  _ROSPY_TUTORIALS_ADDTWOINTSREQUEST_H_
