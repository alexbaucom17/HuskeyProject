...
#ifndef _CODEGEN_ROSPY_TUTORIALS_BADTWOINTS_H_
#define _CODEGEN_ROSPY_TUTORIALS_BADTWOINTS_H_
...
PREDECLARE_BSON(rospy_tutorials::BadTwoInts); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(rospy_tutorials::BadTwoInts); // see Common.h, macro used for a cleaner header

namespace rospy_tutorials
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, BadTwoInts & inobj);   
    ...
    */
    ...
    public: 
        ...
        BadTwoInts();
        /** copy constructor */
        BadTwoInts(const BadTwoInts & inobj);
        /** destructor */
        ~BadTwoInts();

        /** allocator, convenience function for bind */
        static BadTwoInts * New();
        ...
        static const unsigned int ID = 862848166U;
        ...
        static const unsigned int DATA_VERSION = 3196280418U;
        ...
        //        static const char * dataTypeName() { return "BadTwoInts"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7e01d1a6112ebbadd2bbe50e8aea0684"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7e01d1a6112ebbadULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd2bbe50e8aea0684ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        BadTwoInts * copy() { return new BadTwoInts(*this); };

        /** assignment operator(s) */
        BadTwoInts & operator=(const BadTwoInts & inobj);
        /** equality operator */
        bool operator==(const BadTwoInts & inobj) const;
        /** inequality operator */
        bool operator!=(const BadTwoInts & inobj) const;
        /** less than operator */
        bool operator<(const BadTwoInts & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, BadTwoInts & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<rospy_tutorials::BadTwoInts>
    {
    public:
        static bool flat() {return rospy_tutorials::BadTwoInts::dataTypeFlat(); };
        static std::string sourceXML() {return rospy_tutorials::BadTwoInts::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const rospy_tutorials::BadTwoInts & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const rospy_tutorials::BadTwoInts & value);

#endif  //  _ROSPY_TUTORIALS_BADTWOINTS_H_
