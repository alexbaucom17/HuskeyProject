...
#ifndef _CODEGEN_SENSOR_MSGS_POINTCLOUD_H_
#define _CODEGEN_SENSOR_MSGS_POINTCLOUD_H_
...
PREDECLARE_BSON(sensor_msgs::PointCloud); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::PointCloud); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PointCloud & inobj);   
    ...
    */
    ...
    public: 
        ...
        PointCloud();
        /** copy constructor */
        PointCloud(const PointCloud & inobj);
        /** destructor */
        ~PointCloud();

        /** allocator, convenience function for bind */
        static PointCloud * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< Array of 3d points. Each Point32 should be interpreted as a 3d point  in the frame given in the header. */
        std::vector<geometry_msgs::Point32 >  points; /**< Each channel should have the same number of elements as points array,  and the data in each channel should correspond 1:1 with each point.  Channel names in common practice are listed in ChannelFloat32.msg. */
        ...
        static const unsigned int ID = 237354229U;
        ...
        static const unsigned int DATA_VERSION = 521218040U;
        ...
        //        static const char * dataTypeName() { return "PointCloud"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "afacf9a1aa27a7aca7370c20a4e440b3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xafacf9a1aa27a7acULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa7370c20a4e440b3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PointCloud * copy() { return new PointCloud(*this); };

        /** assignment operator(s) */
        PointCloud & operator=(const PointCloud & inobj);
        /** equality operator */
        bool operator==(const PointCloud & inobj) const;
        /** inequality operator */
        bool operator!=(const PointCloud & inobj) const;
        /** less than operator */
        bool operator<(const PointCloud & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PointCloud & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::PointCloud>
    {
    public:
        static bool flat() {return sensor_msgs::PointCloud::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::PointCloud::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::PointCloud & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::PointCloud & value);

#endif  //  _SENSOR_MSGS_POINTCLOUD_H_
