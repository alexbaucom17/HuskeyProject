...
#ifndef _CODEGEN_SENSOR_MSGS_REGIONOFINTEREST_H_
#define _CODEGEN_SENSOR_MSGS_REGIONOFINTEREST_H_
...
PREDECLARE_BSON(sensor_msgs::RegionOfInterest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::RegionOfInterest); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, RegionOfInterest & inobj);   
    ...
    */
    ...
    public: 
        ...
        RegionOfInterest();
        /** copy constructor */
        RegionOfInterest(const RegionOfInterest & inobj);
        /** destructor */
        ~RegionOfInterest();
        ...
        unsigned int  x_offset; /**< Leftmost pixel of the ROI  (0 if the ROI includes the left edge of the image) */
        unsigned int  y_offset; /**< Topmost pixel of the ROI  (0 if the ROI includes the top edge of the image) */
        unsigned int  height; /**< Height of ROI */
        unsigned int  width; /**< Width of ROI  True if a distinct rectified ROI should be calculated from the "raw"  ROI in this message. Typically this should be False if the full image  is captured (ROI not used), and True if a subwindow is captured (ROI  used). */
        bool  do_rectify; /**<  */
        ...
        static const unsigned int ID = 237354233U;
        ...
        static const unsigned int DATA_VERSION = 1309846692U;
        ...
        //        static const char * dataTypeName() { return "RegionOfInterest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "18932c0daf49f2de0618500e784e94fa"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x18932c0daf49f2deULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x0618500e784e94faULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        RegionOfInterest * copy() { return new RegionOfInterest(*this); };

        /** assignment operator(s) */
        RegionOfInterest & operator=(const RegionOfInterest & inobj);
        /** equality operator */
        bool operator==(const RegionOfInterest & inobj) const;
        /** inequality operator */
        bool operator!=(const RegionOfInterest & inobj) const;
        /** less than operator */
        bool operator<(const RegionOfInterest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, RegionOfInterest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::RegionOfInterest>
    {
    public:
        static bool flat() {return sensor_msgs::RegionOfInterest::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::RegionOfInterest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::RegionOfInterest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::RegionOfInterest & value);

#endif  //  _SENSOR_MSGS_REGIONOFINTEREST_H_
