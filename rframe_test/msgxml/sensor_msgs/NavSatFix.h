...
#ifndef _CODEGEN_SENSOR_MSGS_NAVSATFIX_H_
#define _CODEGEN_SENSOR_MSGS_NAVSATFIX_H_
...
PREDECLARE_BSON(sensor_msgs::NavSatFix); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::NavSatFix); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NavSatFix & inobj);   

    /** 
        \ingroup CodeGen
        Navigation Satellite fix for any Global Navigation Satellite System   Specified using the WGS 84 reference ellipsoid
    */
    class NavSatFix
    {
    public: 
        ...
        NavSatFix();
        /** copy constructor */
        NavSatFix(const NavSatFix & inobj);
        /** destructor */
        ~NavSatFix();

        /** allocator, convenience function for bind */
        static NavSatFix * New();

        /* shorthand definitions for constant sized arrays */
        /** definition of max size of array for position_covariance */
        static const unsigned int POSITION_COVARIANCE_MAX = 9;
        /** shorthand definition for array of position_covariance */
        typedef std::array<double,POSITION_COVARIANCE_MAX> Position_covarianceArray;

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< satellite fix status information */
        NavSatStatus  status; /**< Latitude [degrees]. Positive is north of equator; negative is south. */
        double  latitude; /**< Longitude [degrees]. Positive is east of prime meridian; negative is west. */
        double  longitude; /**< Altitude [m]. Positive is above the WGS 84 ellipsoid  (quiet NaN if no altitude is available). */
        double  altitude; /**< Position covariance [m^2] defined relative to a tangential plane  through the reported position. The components are East, North, and  Up (ENU), in row-major order.   Beware: this coordinate system exhibits singularities at the poles. */
        std::array<double,9>  position_covariance; /**< If the covariance of the fix is known, fill it in completely. If the  GPS receiver provides the variance of each measurement, put them  along the diagonal. If only Dilution of Precision is available,  estimate an approximate covariance from that. */
        unsigned char  position_covariance_type; /**<  */

        static const unsigned char COVARIANCE_TYPE_UNKNOWN; /**<  (value: 0) */
        static const unsigned char COVARIANCE_TYPE_APPROXIMATED; /**<  (value: 1) */
        static const unsigned char COVARIANCE_TYPE_DIAGONAL_KNOWN; /**<  (value: 2) */
        static const unsigned char COVARIANCE_TYPE_KNOWN; /**<  (value: 3) */
        ...
        { 
            ...
            DAQ_3_LONGITUDE,
            DAQ_4_ALTITUDE,
            DAQ_5_POSITION_COVARIANCE,
            DAQ_6_POSITION_COVARIANCE_TYPE,
            DAQ_MAX_
        } DAQEnum;
        ...
        static const unsigned int ID = 237354227U;
        ...
        static const unsigned int DATA_VERSION = 3031499645U;
        ...
        //        static const char * dataTypeName() { return "NavSatFix"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7cbce13b38aae566425fc17edce01428"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7cbce13b38aae566ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x425fc17edce01428ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NavSatFix * copy() { return new NavSatFix(*this); };

        /** assignment operator(s) */
        NavSatFix & operator=(const NavSatFix & inobj);
        /** equality operator */
        bool operator==(const NavSatFix & inobj) const;
        /** inequality operator */
        bool operator!=(const NavSatFix & inobj) const;
        /** less than operator */
        bool operator<(const NavSatFix & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NavSatFix & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::NavSatFix>
    {
    public:
        static bool flat() {return sensor_msgs::NavSatFix::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::NavSatFix::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::NavSatFix & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::NavSatFix & value);

#endif  //  _SENSOR_MSGS_NAVSATFIX_H_
