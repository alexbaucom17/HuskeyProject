...
#ifndef _CODEGEN_SENSOR_MSGS_RANGE_H_
#define _CODEGEN_SENSOR_MSGS_RANGE_H_
...
PREDECLARE_BSON(sensor_msgs::Range); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::Range); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Range & inobj);   
    ...
    */
    ...
    public: 
        ...
        std_msgs::Header  header; /**< timestamp in the header is the time the ranger  returned the distance reading  Radiation type enums  If you want a value added to this list, send an email to the ros-users list */
        unsigned char  radiation_type; /**< the type of radiation used by the sensor  (sound, IR, etc) [enum] */
        float  field_of_view; /**< the size of the arc that the distance reading is  valid for [rad]  the object causing the range reading may have  been anywhere within -field_of_view/2 and  field_of_view/2 at the measured range.   0 angle corresponds to the x-axis of the sensor. */
        float  min_range; /**< minimum range value [m] */
        float  max_range; /**< maximum range value [m]  Fixed distance rangers require min_range==max_range */
        float  range; /**< range data [m]  (Note: values < range_min or > range_max  should be discarded)  Fixed distance rangers only output -Inf or +Inf.  -Inf represents a detection within fixed distance.  (Detection too close to the sensor to quantify)  +Inf represents no detection within the fixed distance.  (Object out of range) */

        static const unsigned char ULTRASOUND; /**<  (value: 0) */
        static const unsigned char INFRARED; /**<  (value: 1) */

        /** DAQ enumeration not sure how to use it yet. here for proof of concept. */
        typedef enum
        { 
            DAQ_0_HEADER,
            DAQ_1_RADIATION_TYPE,
            DAQ_2_FIELD_OF_VIEW,
            DAQ_3_MIN_RANGE,
            DAQ_4_MAX_RANGE,
            DAQ_5_RANGE,
        ...
        static const unsigned int ID = 237354232U;
        ...
        static const unsigned int DATA_VERSION = 4187597254U;
        ...
        //        static const char * dataTypeName() { return "Range"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a9c659b93e66b1f79a7866b79159199e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa9c659b93e66b1f7ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9a7866b79159199eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Range * copy() { return new Range(*this); };

        /** assignment operator(s) */
        Range & operator=(const Range & inobj);
        /** equality operator */
        bool operator==(const Range & inobj) const;
        /** inequality operator */
        bool operator!=(const Range & inobj) const;
        /** less than operator */
        bool operator<(const Range & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Range & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::Range>
    {
    public:
        static bool flat() {return sensor_msgs::Range::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::Range::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::Range & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::Range & value);

#endif  //  _SENSOR_MSGS_RANGE_H_
