...
#ifndef _CODEGEN_SENSOR_MSGS_FLUIDPRESSURE_H_
#define _CODEGEN_SENSOR_MSGS_FLUIDPRESSURE_H_
...
PREDECLARE_BSON(sensor_msgs::FluidPressure); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::FluidPressure); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FluidPressure & inobj);   
    ...
    */
    ...
    public: 
        ...
        FluidPressure();
        /** copy constructor */
        FluidPressure(const FluidPressure & inobj);
        /** destructor */
        ~FluidPressure();

        /** allocator, convenience function for bind */
        static FluidPressure * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< timestamp of the measurement  frame_id is the location of the pressure sensor */
        ...
        static const unsigned int ID = 237354214U;
        ...
        static const unsigned int DATA_VERSION = 2518871790U;
        ...
        //        static const char * dataTypeName() { return "FluidPressure"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "acadd0049d2c97907557bc3790a1b311"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xacadd0049d2c9790ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7557bc3790a1b311ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FluidPressure * copy() { return new FluidPressure(*this); };

        /** assignment operator(s) */
        FluidPressure & operator=(const FluidPressure & inobj);
        /** equality operator */
        bool operator==(const FluidPressure & inobj) const;
        /** inequality operator */
        bool operator!=(const FluidPressure & inobj) const;
        /** less than operator */
        bool operator<(const FluidPressure & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FluidPressure & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::FluidPressure>
    {
    public:
        static bool flat() {return sensor_msgs::FluidPressure::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::FluidPressure::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::FluidPressure & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::FluidPressure & value);

#endif  //  _SENSOR_MSGS_FLUIDPRESSURE_H_
