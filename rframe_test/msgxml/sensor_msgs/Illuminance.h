...
#ifndef _CODEGEN_SENSOR_MSGS_ILLUMINANCE_H_
#define _CODEGEN_SENSOR_MSGS_ILLUMINANCE_H_
...
PREDECLARE_BSON(sensor_msgs::Illuminance); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(sensor_msgs::Illuminance); // see Common.h, macro used for a cleaner header

namespace sensor_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Illuminance & inobj);   
    ...
    */
    ...
    public: 
        ...
        Illuminance();
        /** copy constructor */
        Illuminance(const Illuminance & inobj);
        /** destructor */
        ~Illuminance();

        /** allocator, convenience function for bind */
        static Illuminance * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< timestamp is the time the illuminance was measured  frame_id is the location and direction of the reading */
        ...
        static const unsigned int ID = 237354215U;
        ...
        static const unsigned int DATA_VERSION = 208035839U;
        ...
        //        static const char * dataTypeName() { return "Illuminance"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "246080c0ab3e316cc9e1c6d0cbc91ff8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x246080c0ab3e316cULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xc9e1c6d0cbc91ff8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Illuminance * copy() { return new Illuminance(*this); };

        /** assignment operator(s) */
        Illuminance & operator=(const Illuminance & inobj);
        /** equality operator */
        bool operator==(const Illuminance & inobj) const;
        /** inequality operator */
        bool operator!=(const Illuminance & inobj) const;
        /** less than operator */
        bool operator<(const Illuminance & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Illuminance & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<sensor_msgs::Illuminance>
    {
    public:
        static bool flat() {return sensor_msgs::Illuminance::dataTypeFlat(); };
        static std::string sourceXML() {return sensor_msgs::Illuminance::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const sensor_msgs::Illuminance & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const sensor_msgs::Illuminance & value);

#endif  //  _SENSOR_MSGS_ILLUMINANCE_H_
