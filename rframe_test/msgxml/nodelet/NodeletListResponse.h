...
#ifndef _CODEGEN_NODELET_NODELETLISTRESPONSE_H_
#define _CODEGEN_NODELET_NODELETLISTRESPONSE_H_
...
PREDECLARE_BSON(nodelet::NodeletListResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nodelet::NodeletListResponse); // see Common.h, macro used for a cleaner header

namespace nodelet
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, NodeletListResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        NodeletListResponse();
        /** copy constructor */
        NodeletListResponse(const NodeletListResponse & inobj);
        /** destructor */
        ~NodeletListResponse();

        /** allocator, convenience function for bind */
        static NodeletListResponse * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::vector<std::string >  nodelets; /**<  */
        ...
        static const unsigned int ID = 1210331546U;
        ...
        static const unsigned int DATA_VERSION = 1912228576U;
        ...
        //        static const char * dataTypeName() { return "NodeletListResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b6672c998cfc06a914fec755ebc2c33a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb6672c998cfc06a9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x14fec755ebc2c33aULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        NodeletListResponse * copy() { return new NodeletListResponse(*this); };

        /** assignment operator(s) */
        NodeletListResponse & operator=(const NodeletListResponse & inobj);
        /** equality operator */
        bool operator==(const NodeletListResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const NodeletListResponse & inobj) const;
        /** less than operator */
        bool operator<(const NodeletListResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, NodeletListResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nodelet::NodeletListResponse>
    {
    public:
        static bool flat() {return nodelet::NodeletListResponse::dataTypeFlat(); };
        static std::string sourceXML() {return nodelet::NodeletListResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nodelet::NodeletListResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nodelet::NodeletListResponse & value);

#endif  //  _NODELET_NODELETLISTRESPONSE_H_
