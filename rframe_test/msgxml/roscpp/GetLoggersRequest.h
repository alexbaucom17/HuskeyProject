...
#ifndef _CODEGEN_ROSCPP_GETLOGGERSREQUEST_H_
#define _CODEGEN_ROSCPP_GETLOGGERSREQUEST_H_
...
PREDECLARE_BSON(roscpp::GetLoggersRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::GetLoggersRequest); // see Common.h, macro used for a cleaner header

namespace roscpp
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLoggersRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetLoggersRequest();
        /** copy constructor */
        GetLoggersRequest(const GetLoggersRequest & inobj);
        /** destructor */
        ~GetLoggersRequest();

        /** allocator, convenience function for bind */
        static GetLoggersRequest * New();
        ...
        static const unsigned int ID = 1381512810U;
        ...
        static const unsigned int DATA_VERSION = 1102898508U;
        ...
        //        static const char * dataTypeName() { return "GetLoggersRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b105f5a7d936bcedbdf317e1d48c6459"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb105f5a7d936bcedULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xbdf317e1d48c6459ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLoggersRequest * copy() { return new GetLoggersRequest(*this); };

        /** assignment operator(s) */
        GetLoggersRequest & operator=(const GetLoggersRequest & inobj);
        /** equality operator */
        bool operator==(const GetLoggersRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLoggersRequest & inobj) const;
        /** less than operator */
        bool operator<(const GetLoggersRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLoggersRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::GetLoggersRequest>
    {
    public:
        static bool flat() {return roscpp::GetLoggersRequest::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::GetLoggersRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::GetLoggersRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::GetLoggersRequest & value);

#endif  //  _ROSCPP_GETLOGGERSREQUEST_H_
