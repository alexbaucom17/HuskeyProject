...
#ifndef _CODEGEN_ROSCPP_SETLOGGERLEVELRESPONSE_H_
#define _CODEGEN_ROSCPP_SETLOGGERLEVELRESPONSE_H_
...
PREDECLARE_BSON(roscpp::SetLoggerLevelResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::SetLoggerLevelResponse); // see Common.h, macro used for a cleaner header

namespace roscpp
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetLoggerLevelResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetLoggerLevelResponse(const SetLoggerLevelResponse & inobj);
        /** destructor */
        ~SetLoggerLevelResponse();

        /** allocator, convenience function for bind */
        static SetLoggerLevelResponse * New();
        ...
        static const unsigned int ID = 1381512814U;
        ...
        static const unsigned int DATA_VERSION = 1357735265U;
        ...
        //        static const char * dataTypeName() { return "SetLoggerLevelResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "3e2656ce06bd1b297d6cc7425a3cf64c"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3e2656ce06bd1b29ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7d6cc7425a3cf64cULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetLoggerLevelResponse * copy() { return new SetLoggerLevelResponse(*this); };

        /** assignment operator(s) */
        SetLoggerLevelResponse & operator=(const SetLoggerLevelResponse & inobj);
        /** equality operator */
        bool operator==(const SetLoggerLevelResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const SetLoggerLevelResponse & inobj) const;
        /** less than operator */
        bool operator<(const SetLoggerLevelResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetLoggerLevelResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::SetLoggerLevelResponse>
    {
    public:
        static bool flat() {return roscpp::SetLoggerLevelResponse::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::SetLoggerLevelResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::SetLoggerLevelResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::SetLoggerLevelResponse & value);

#endif  //  _ROSCPP_SETLOGGERLEVELRESPONSE_H_
