...
#ifndef _CODEGEN_ROSCPP_SETLOGGERLEVELREQUEST_H_
#define _CODEGEN_ROSCPP_SETLOGGERLEVELREQUEST_H_
...
PREDECLARE_BSON(roscpp::SetLoggerLevelRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::SetLoggerLevelRequest); // see Common.h, macro used for a cleaner header

namespace roscpp
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SetLoggerLevelRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        SetLoggerLevelRequest(const SetLoggerLevelRequest & inobj);
        /** destructor */
        ~SetLoggerLevelRequest();

        /** allocator, convenience function for bind */
        static SetLoggerLevelRequest * New();
        ...
        std::string  logger; /**<  */
        std::string  level; /**< no comment provided */
        ...
        static const unsigned int ID = 1381512813U;
        ...
        static const unsigned int DATA_VERSION = 1985908388U;
        ...
        //        static const char * dataTypeName() { return "SetLoggerLevelRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "9456b63599ebb22ad65c284bb06a72cc"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x9456b63599ebb22aULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd65c284bb06a72ccULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SetLoggerLevelRequest * copy() { return new SetLoggerLevelRequest(*this); };

        /** assignment operator(s) */
        SetLoggerLevelRequest & operator=(const SetLoggerLevelRequest & inobj);
        /** equality operator */
        bool operator==(const SetLoggerLevelRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SetLoggerLevelRequest & inobj) const;
        /** less than operator */
        bool operator<(const SetLoggerLevelRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SetLoggerLevelRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::SetLoggerLevelRequest>
    {
    public:
        static bool flat() {return roscpp::SetLoggerLevelRequest::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::SetLoggerLevelRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::SetLoggerLevelRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::SetLoggerLevelRequest & value);

#endif  //  _ROSCPP_SETLOGGERLEVELREQUEST_H_
