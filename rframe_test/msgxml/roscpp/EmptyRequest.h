...
#ifndef _CODEGEN_ROSCPP_EMPTYREQUEST_H_
#define _CODEGEN_ROSCPP_EMPTYREQUEST_H_
...
PREDECLARE_BSON(roscpp::EmptyRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::EmptyRequest); // see Common.h, macro used for a cleaner header
...
{  
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1381512807U;
        ...
        static const unsigned int DATA_VERSION = 2622706863U;
        ...
        */
        ...
        static const std::string versionMD5() { return "3f0809b14e6597e5a9aad04b5213476a"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x3f0809b14e6597e5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa9aad04b5213476aULL;
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::EmptyRequest>
    {
    public:
        static bool flat() {return roscpp::EmptyRequest::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::EmptyRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::EmptyRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::EmptyRequest & value);

#endif  //  _ROSCPP_EMPTYREQUEST_H_
