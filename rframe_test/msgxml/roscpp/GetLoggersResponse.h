...
#ifndef _CODEGEN_ROSCPP_GETLOGGERSRESPONSE_H_
#define _CODEGEN_ROSCPP_GETLOGGERSRESPONSE_H_
...
PREDECLARE_BSON(roscpp::GetLoggersResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(roscpp::GetLoggersResponse); // see Common.h, macro used for a cleaner header

namespace roscpp
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetLoggersResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetLoggersResponse();
        /** copy constructor */
        GetLoggersResponse(const GetLoggersResponse & inobj);
        /** destructor */
        ~GetLoggersResponse();

        /** allocator, convenience function for bind */
        static GetLoggersResponse * New();
        ...
        static const unsigned int ID = 1381512811U;
        ...
        static const unsigned int DATA_VERSION = 3331038091U;
        ...
        //        static const char * dataTypeName() { return "GetLoggersResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "6efe6941d73b5fc9e612653c9dfdeab3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x6efe6941d73b5fc9ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe612653c9dfdeab3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetLoggersResponse * copy() { return new GetLoggersResponse(*this); };

        /** assignment operator(s) */
        GetLoggersResponse & operator=(const GetLoggersResponse & inobj);
        /** equality operator */
        bool operator==(const GetLoggersResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetLoggersResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetLoggersResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetLoggersResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<roscpp::GetLoggersResponse>
    {
    public:
        static bool flat() {return roscpp::GetLoggersResponse::dataTypeFlat(); };
        static std::string sourceXML() {return roscpp::GetLoggersResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const roscpp::GetLoggersResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const roscpp::GetLoggersResponse & value);

#endif  //  _ROSCPP_GETLOGGERSRESPONSE_H_
