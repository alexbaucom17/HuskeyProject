...
#ifndef _CODEGEN_DRIVER_BASE_CONFIGVALUE_H_
#define _CODEGEN_DRIVER_BASE_CONFIGVALUE_H_
...
PREDECLARE_BSON(driver_base::ConfigValue); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(driver_base::ConfigValue); // see Common.h, macro used for a cleaner header

namespace driver_base
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, ConfigValue & inobj);   
    ...
    */
    ...
    public: 
        ...
        ConfigValue();
        /** copy constructor */
        ConfigValue(const ConfigValue & inobj);
        /** destructor */
        ~ConfigValue();

        /** allocator, convenience function for bind */
        static ConfigValue * New();
        ...
        static const unsigned int ID = 1748765325U;
        ...
        static const unsigned int DATA_VERSION = 2844265683U;
        ...
        //        static const char * dataTypeName() { return "ConfigValue"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "10941451067ceba3919bd7d02e76f8f0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x10941451067ceba3ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x919bd7d02e76f8f0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        ConfigValue * copy() { return new ConfigValue(*this); };

        /** assignment operator(s) */
        ConfigValue & operator=(const ConfigValue & inobj);
        /** equality operator */
        bool operator==(const ConfigValue & inobj) const;
        /** inequality operator */
        bool operator!=(const ConfigValue & inobj) const;
        /** less than operator */
        bool operator<(const ConfigValue & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, ConfigValue & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<driver_base::ConfigValue>
    {
    public:
        static bool flat() {return driver_base::ConfigValue::dataTypeFlat(); };
        static std::string sourceXML() {return driver_base::ConfigValue::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const driver_base::ConfigValue & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const driver_base::ConfigValue & value);

#endif  //  _DRIVER_BASE_CONFIGVALUE_H_
