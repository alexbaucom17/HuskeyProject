...
#ifndef _CODEGEN_GEOMETRY_MSGS_INERTIASTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_INERTIASTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::InertiaStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::InertiaStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, InertiaStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        InertiaStamped();
        /** copy constructor */
        InertiaStamped(const InertiaStamped & inobj);
        /** destructor */
        ~InertiaStamped();

        /** allocator, convenience function for bind */
        static InertiaStamped * New();
        ...
        static const unsigned int ID = 1901327795U;
        ...
        static const unsigned int DATA_VERSION = 1144760024U;
        ...
        //        static const char * dataTypeName() { return "InertiaStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "8d2232cb721271d1d0599799dca44c96"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x8d2232cb721271d1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xd0599799dca44c96ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        InertiaStamped * copy() { return new InertiaStamped(*this); };

        /** assignment operator(s) */
        InertiaStamped & operator=(const InertiaStamped & inobj);
        /** equality operator */
        bool operator==(const InertiaStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const InertiaStamped & inobj) const;
        /** less than operator */
        bool operator<(const InertiaStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, InertiaStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::InertiaStamped>
    {
    public:
        static bool flat() {return geometry_msgs::InertiaStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::InertiaStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::InertiaStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::InertiaStamped & value);

#endif  //  _GEOMETRY_MSGS_INERTIASTAMPED_H_
