...
#ifndef _CODEGEN_GEOMETRY_MSGS_QUATERNIONSTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_QUATERNIONSTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::QuaternionStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::QuaternionStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, QuaternionStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        QuaternionStamped();
        /** copy constructor */
        QuaternionStamped(const QuaternionStamped & inobj);
        /** destructor */
        ~QuaternionStamped();

        /** allocator, convenience function for bind */
        static QuaternionStamped * New();
        ...
        static const unsigned int ID = 1901327808U;
        ...
        static const unsigned int DATA_VERSION = 560929413U;
        ...
        //        static const char * dataTypeName() { return "QuaternionStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "70bac33c004c511939347ce898b3876b"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x70bac33c004c5119ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x39347ce898b3876bULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        QuaternionStamped * copy() { return new QuaternionStamped(*this); };

        /** assignment operator(s) */
        QuaternionStamped & operator=(const QuaternionStamped & inobj);
        /** equality operator */
        bool operator==(const QuaternionStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const QuaternionStamped & inobj) const;
        /** less than operator */
        bool operator<(const QuaternionStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, QuaternionStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::QuaternionStamped>
    {
    public:
        static bool flat() {return geometry_msgs::QuaternionStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::QuaternionStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::QuaternionStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::QuaternionStamped & value);

#endif  //  _GEOMETRY_MSGS_QUATERNIONSTAMPED_H_
