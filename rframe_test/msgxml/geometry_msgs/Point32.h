...
#ifndef _CODEGEN_GEOMETRY_MSGS_POINT32_H_
#define _CODEGEN_GEOMETRY_MSGS_POINT32_H_
...
PREDECLARE_BSON(geometry_msgs::Point32); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Point32); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Point32 & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327797U;
        ...
        static const unsigned int DATA_VERSION = 1684732748U;
        ...
        //        static const char * dataTypeName() { return "Point32"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "cbe4550ef5353ec045ec0babfd13d235"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xcbe4550ef5353ec0ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x45ec0babfd13d235ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Point32 * copy() { return new Point32(*this); };

        /** assignment operator(s) */
        Point32 & operator=(const Point32 & inobj);
        /** equality operator */
        bool operator==(const Point32 & inobj) const;
        /** inequality operator */
        bool operator!=(const Point32 & inobj) const;
        /** less than operator */
        bool operator<(const Point32 & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Point32 & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Point32>
    {
    public:
        static bool flat() {return geometry_msgs::Point32::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Point32::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Point32 & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::Point32 & value);

#endif  //  _GEOMETRY_MSGS_POINT32_H_
