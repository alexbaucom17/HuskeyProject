...
#ifndef _CODEGEN_GEOMETRY_MSGS_POSEWITHCOVARIANCESTAMPED_H_
#define _CODEGEN_GEOMETRY_MSGS_POSEWITHCOVARIANCESTAMPED_H_
...
PREDECLARE_BSON(geometry_msgs::PoseWithCovarianceStamped); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::PoseWithCovarianceStamped); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, PoseWithCovarianceStamped & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        PoseWithCovarianceStamped(const PoseWithCovarianceStamped & inobj);
        /** destructor */
        ~PoseWithCovarianceStamped();

        /** allocator, convenience function for bind */
        static PoseWithCovarianceStamped * New();
        ...
        static const unsigned int ID = 1901327806U;
        ...
        static const unsigned int DATA_VERSION = 2904167021U;
        ...
        //        static const char * dataTypeName() { return "PoseWithCovarianceStamped"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "0a02545c97df84559d7ed43ca96a345d"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x0a02545c97df8455ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x9d7ed43ca96a345dULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        PoseWithCovarianceStamped * copy() { return new PoseWithCovarianceStamped(*this); };

        /** assignment operator(s) */
        PoseWithCovarianceStamped & operator=(const PoseWithCovarianceStamped & inobj);
        /** equality operator */
        bool operator==(const PoseWithCovarianceStamped & inobj) const;
        /** inequality operator */
        bool operator!=(const PoseWithCovarianceStamped & inobj) const;
        /** less than operator */
        bool operator<(const PoseWithCovarianceStamped & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, PoseWithCovarianceStamped & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::PoseWithCovarianceStamped>
    {
    public:
        static bool flat() {return geometry_msgs::PoseWithCovarianceStamped::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::PoseWithCovarianceStamped::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::PoseWithCovarianceStamped & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const geometry_msgs::PoseWithCovarianceStamped & value);

#endif  //  _GEOMETRY_MSGS_POSEWITHCOVARIANCESTAMPED_H_
