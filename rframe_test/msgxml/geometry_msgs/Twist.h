...
#ifndef _CODEGEN_GEOMETRY_MSGS_TWIST_H_
#define _CODEGEN_GEOMETRY_MSGS_TWIST_H_
...
PREDECLARE_BSON(geometry_msgs::Twist); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(geometry_msgs::Twist); // see Common.h, macro used for a cleaner header

namespace geometry_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, Twist & inobj);   
    ...
    */
    ...
    public: 
        ...
        static const unsigned int ID = 1901327811U;
        ...
        static const unsigned int DATA_VERSION = 667891808U;
        ...
        //        static const char * dataTypeName() { return "Twist"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "107708992eae5081dd3263d9f4b8aeee"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x107708992eae5081ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xdd3263d9f4b8aeeeULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        Twist * copy() { return new Twist(*this); };

        /** assignment operator(s) */
        Twist & operator=(const Twist & inobj);
        /** equality operator */
        bool operator==(const Twist & inobj) const;
        /** inequality operator */
        bool operator!=(const Twist & inobj) const;
        /** less than operator */
        bool operator<(const Twist & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, Twist & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<geometry_msgs::Twist>
    {
    public:
        static bool flat() {return geometry_msgs::Twist::dataTypeFlat(); };
        static std::string sourceXML() {return geometry_msgs::Twist::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const geometry_msgs::Twist & value);
