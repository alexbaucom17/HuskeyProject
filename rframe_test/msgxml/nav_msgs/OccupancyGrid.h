...
#ifndef _CODEGEN_NAV_MSGS_OCCUPANCYGRID_H_
#define _CODEGEN_NAV_MSGS_OCCUPANCYGRID_H_
...
PREDECLARE_BSON(nav_msgs::OccupancyGrid); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::OccupancyGrid); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, OccupancyGrid & inobj);   
    ...
    */
    ...
    public: 
        ...
        OccupancyGrid();
        /** copy constructor */
        OccupancyGrid(const OccupancyGrid & inobj);
        /** destructor */
        ~OccupancyGrid();

        /** allocator, convenience function for bind */
        static OccupancyGrid * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< MetaData for the map */
        MapMetaData  info; /**< The map data, in row-major order, starting with (0,0).  Occupancy  probabilities are in the range [0,100].  Unknown is -1. */
        ...
        static const unsigned int ID = 1589304795U;
        ...
        static const unsigned int DATA_VERSION = 1209901329U;
        ...
        //        static const char * dataTypeName() { return "OccupancyGrid"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "4e84a98fbbd67ba5f17ac2b77d3ab345"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x4e84a98fbbd67ba5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf17ac2b77d3ab345ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        OccupancyGrid * copy() { return new OccupancyGrid(*this); };

        /** assignment operator(s) */
        OccupancyGrid & operator=(const OccupancyGrid & inobj);
        /** equality operator */
        bool operator==(const OccupancyGrid & inobj) const;
        /** inequality operator */
        bool operator!=(const OccupancyGrid & inobj) const;
        /** less than operator */
        bool operator<(const OccupancyGrid & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, OccupancyGrid & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::OccupancyGrid>
    {
    public:
        static bool flat() {return nav_msgs::OccupancyGrid::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::OccupancyGrid::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::OccupancyGrid & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::OccupancyGrid & value);

#endif  //  _NAV_MSGS_OCCUPANCYGRID_H_
