...
#ifndef _CODEGEN_NAV_MSGS_GRIDCELLS_H_
#define _CODEGEN_NAV_MSGS_GRIDCELLS_H_
...
PREDECLARE_BSON(nav_msgs::GridCells); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GridCells); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GridCells & inobj);   
    ...
    */
    ...
    public: 
        ...
        GridCells();
        /** copy constructor */
        GridCells(const GridCells & inobj);
        /** destructor */
        ~GridCells();

        /** allocator, convenience function for bind */
        static GridCells * New();
        ...
        static const unsigned int ID = 1589304793U;
        ...
        static const unsigned int DATA_VERSION = 941806909U;
        ...
        //        static const char * dataTypeName() { return "GridCells"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "451113574bd345b167a66b179a1bc6b8"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x451113574bd345b1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x67a66b179a1bc6b8ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GridCells * copy() { return new GridCells(*this); };

        /** assignment operator(s) */
        GridCells & operator=(const GridCells & inobj);
        /** equality operator */
        bool operator==(const GridCells & inobj) const;
        /** inequality operator */
        bool operator!=(const GridCells & inobj) const;
        /** less than operator */
        bool operator<(const GridCells & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GridCells & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GridCells>
    {
    public:
        static bool flat() {return nav_msgs::GridCells::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GridCells::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GridCells & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GridCells & value);

#endif  //  _NAV_MSGS_GRIDCELLS_H_
