...
#ifndef _CODEGEN_NAV_MSGS_GETMAPRESULT_H_
#define _CODEGEN_NAV_MSGS_GETMAPRESULT_H_
...
PREDECLARE_BSON(nav_msgs::GetMapResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(nav_msgs::GetMapResult); // see Common.h, macro used for a cleaner header

namespace nav_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetMapResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        GetMapResult();
        /** copy constructor */
        GetMapResult(const GetMapResult & inobj);
        /** destructor */
        ~GetMapResult();

        /** allocator, convenience function for bind */
        static GetMapResult * New();
        ...
        static const unsigned int ID = 1589304792U;
        ...
        static const unsigned int DATA_VERSION = 3039182639U;
        ...
        //        static const char * dataTypeName() { return "GetMapResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "02e4a3900a7ec4e18bd7d870e4228542"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x02e4a3900a7ec4e1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x8bd7d870e4228542ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetMapResult * copy() { return new GetMapResult(*this); };

        /** assignment operator(s) */
        GetMapResult & operator=(const GetMapResult & inobj);
        /** equality operator */
        bool operator==(const GetMapResult & inobj) const;
        /** inequality operator */
        bool operator!=(const GetMapResult & inobj) const;
        /** less than operator */
        bool operator<(const GetMapResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetMapResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<nav_msgs::GetMapResult>
    {
    public:
        static bool flat() {return nav_msgs::GetMapResult::dataTypeFlat(); };
        static std::string sourceXML() {return nav_msgs::GetMapResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const nav_msgs::GetMapResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const nav_msgs::GetMapResult & value);

#endif  //  _NAV_MSGS_GETMAPRESULT_H_
