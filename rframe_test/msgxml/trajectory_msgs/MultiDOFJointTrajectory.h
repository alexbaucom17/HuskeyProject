...
#ifndef _CODEGEN_TRAJECTORY_MSGS_MULTIDOFJOINTTRAJECTORY_H_
#define _CODEGEN_TRAJECTORY_MSGS_MULTIDOFJOINTTRAJECTORY_H_
...
PREDECLARE_BSON(trajectory_msgs::MultiDOFJointTrajectory); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(trajectory_msgs::MultiDOFJointTrajectory); // see Common.h, macro used for a cleaner header

namespace trajectory_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MultiDOFJointTrajectory & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        MultiDOFJointTrajectory(const MultiDOFJointTrajectory & inobj);
        /** destructor */
        ~MultiDOFJointTrajectory();

        /** allocator, convenience function for bind */
        static MultiDOFJointTrajectory * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std_msgs::Header  header; /**< A representation of a multi-dof joint trajectory (each point is a transformation)  Each point along the trajectory will include an array of positions/velocities/accelerations  that has the same length as the array of joint names, and has the same order of joints as   the joint names array. */
        ...
        static const unsigned int ID = 109236942U;
        ...
        static const unsigned int DATA_VERSION = 3789730490U;
        ...
        //        static const char * dataTypeName() { return "MultiDOFJointTrajectory"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "df7767b410cc52d8e2ed79f12f12b83e"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xdf7767b410cc52d8ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xe2ed79f12f12b83eULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MultiDOFJointTrajectory * copy() { return new MultiDOFJointTrajectory(*this); };

        /** assignment operator(s) */
        MultiDOFJointTrajectory & operator=(const MultiDOFJointTrajectory & inobj);
        /** equality operator */
        bool operator==(const MultiDOFJointTrajectory & inobj) const;
        /** inequality operator */
        bool operator!=(const MultiDOFJointTrajectory & inobj) const;
        /** less than operator */
        bool operator<(const MultiDOFJointTrajectory & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MultiDOFJointTrajectory & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<trajectory_msgs::MultiDOFJointTrajectory>
    {
    public:
        static bool flat() {return trajectory_msgs::MultiDOFJointTrajectory::dataTypeFlat(); };
        static std::string sourceXML() {return trajectory_msgs::MultiDOFJointTrajectory::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const trajectory_msgs::MultiDOFJointTrajectory & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const trajectory_msgs::MultiDOFJointTrajectory & value);

#endif  //  _TRAJECTORY_MSGS_MULTIDOFJOINTTRAJECTORY_H_
