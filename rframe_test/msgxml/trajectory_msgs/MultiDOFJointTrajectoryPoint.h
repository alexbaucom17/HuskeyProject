...
#ifndef _CODEGEN_TRAJECTORY_MSGS_MULTIDOFJOINTTRAJECTORYPOINT_H_
#define _CODEGEN_TRAJECTORY_MSGS_MULTIDOFJOINTTRAJECTORYPOINT_H_
...
PREDECLARE_BSON(trajectory_msgs::MultiDOFJointTrajectoryPoint); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(trajectory_msgs::MultiDOFJointTrajectoryPoint); // see Common.h, macro used for a cleaner header

namespace trajectory_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MultiDOFJointTrajectoryPoint & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        MultiDOFJointTrajectoryPoint(const MultiDOFJointTrajectoryPoint & inobj);
        /** destructor */
        ~MultiDOFJointTrajectoryPoint();

        /** allocator, convenience function for bind */
        static MultiDOFJointTrajectoryPoint * New();

        // PUBLIC_POST_PROCESS_INSERT_TAG
        /** definitions */

        /* data member definition */ 
        std::vector<geometry_msgs::Transform >  transforms; /**< There can be a velocity specified for the origin of the joint */
        std::vector<geometry_msgs::Twist >  velocities; /**< There can be an acceleration specified for the origin of the joint */
        std::vector<geometry_msgs::Twist >  accelerations; /**<  */
        std_msgs::RosDuration  time_from_start; /**<  */
        ...
        static const unsigned int ID = 109236943U;
        ...
        static const unsigned int DATA_VERSION = 1774595947U;
        ...
        //        static const char * dataTypeName() { return "MultiDOFJointTrajectoryPoint"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "b4a0fe9f47ebcde23a4615f634c7aab7"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xb4a0fe9f47ebcde2ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3a4615f634c7aab7ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MultiDOFJointTrajectoryPoint * copy() { return new MultiDOFJointTrajectoryPoint(*this); };

        /** assignment operator(s) */
        MultiDOFJointTrajectoryPoint & operator=(const MultiDOFJointTrajectoryPoint & inobj);
        /** equality operator */
        bool operator==(const MultiDOFJointTrajectoryPoint & inobj) const;
        /** inequality operator */
        bool operator!=(const MultiDOFJointTrajectoryPoint & inobj) const;
        /** less than operator */
        bool operator<(const MultiDOFJointTrajectoryPoint & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MultiDOFJointTrajectoryPoint & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<trajectory_msgs::MultiDOFJointTrajectoryPoint>
    {
    public:
        static bool flat() {return trajectory_msgs::MultiDOFJointTrajectoryPoint::dataTypeFlat(); };
        static std::string sourceXML() {return trajectory_msgs::MultiDOFJointTrajectoryPoint::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const trajectory_msgs::MultiDOFJointTrajectoryPoint & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const trajectory_msgs::MultiDOFJointTrajectoryPoint & value);

#endif  //  _TRAJECTORY_MSGS_MULTIDOFJOINTTRAJECTORYPOINT_H_
