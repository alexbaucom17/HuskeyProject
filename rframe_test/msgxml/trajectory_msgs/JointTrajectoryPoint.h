...
#ifndef _CODEGEN_TRAJECTORY_MSGS_JOINTTRAJECTORYPOINT_H_
#define _CODEGEN_TRAJECTORY_MSGS_JOINTTRAJECTORYPOINT_H_
...
PREDECLARE_BSON(trajectory_msgs::JointTrajectoryPoint); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(trajectory_msgs::JointTrajectoryPoint); // see Common.h, macro used for a cleaner header

namespace trajectory_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, JointTrajectoryPoint & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        JointTrajectoryPoint(const JointTrajectoryPoint & inobj);
        /** destructor */
        ~JointTrajectoryPoint();

        /** allocator, convenience function for bind */
        static JointTrajectoryPoint * New();
        ...
        static const unsigned int ID = 109236941U;
        ...
        static const unsigned int DATA_VERSION = 1654327806U;
        ...
        //        static const char * dataTypeName() { return "JointTrajectoryPoint"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "e2d8808af9224f952cb422606dbf58be"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xe2d8808af9224f95ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x2cb422606dbf58beULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        JointTrajectoryPoint * copy() { return new JointTrajectoryPoint(*this); };

        /** assignment operator(s) */
        JointTrajectoryPoint & operator=(const JointTrajectoryPoint & inobj);
        /** equality operator */
        bool operator==(const JointTrajectoryPoint & inobj) const;
        /** inequality operator */
        bool operator!=(const JointTrajectoryPoint & inobj) const;
        /** less than operator */
        bool operator<(const JointTrajectoryPoint & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, JointTrajectoryPoint & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<trajectory_msgs::JointTrajectoryPoint>
    {
    public:
        static bool flat() {return trajectory_msgs::JointTrajectoryPoint::dataTypeFlat(); };
        static std::string sourceXML() {return trajectory_msgs::JointTrajectoryPoint::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const trajectory_msgs::JointTrajectoryPoint & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const trajectory_msgs::JointTrajectoryPoint & value);

#endif  //  _TRAJECTORY_MSGS_JOINTTRAJECTORYPOINT_H_
