...
#ifndef _CODEGEN_VISUALIZATION_MSGS_MARKERARRAY_H_
#define _CODEGEN_VISUALIZATION_MSGS_MARKERARRAY_H_
...
PREDECLARE_BSON(visualization_msgs::MarkerArray); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(visualization_msgs::MarkerArray); // see Common.h, macro used for a cleaner header

namespace visualization_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MarkerArray & inobj);   
    ...
    */
    ...
    public: 
        ...
        MarkerArray();
        /** copy constructor */
        MarkerArray(const MarkerArray & inobj);
        /** destructor */
        ~MarkerArray();

        /** allocator, convenience function for bind */
        static MarkerArray * New();
        ...
        static const unsigned int ID = 2125420987U;
        ...
        static const unsigned int DATA_VERSION = 3407792184U;
        ...
        //        static const char * dataTypeName() { return "MarkerArray"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a61d1c951f4cf03ecb3eaad55d380ce0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa61d1c951f4cf03eULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xcb3eaad55d380ce0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MarkerArray * copy() { return new MarkerArray(*this); };

        /** assignment operator(s) */
        MarkerArray & operator=(const MarkerArray & inobj);
        /** equality operator */
        bool operator==(const MarkerArray & inobj) const;
        /** inequality operator */
        bool operator!=(const MarkerArray & inobj) const;
        /** less than operator */
        bool operator<(const MarkerArray & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MarkerArray & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<visualization_msgs::MarkerArray>
    {
    public:
        static bool flat() {return visualization_msgs::MarkerArray::dataTypeFlat(); };
        static std::string sourceXML() {return visualization_msgs::MarkerArray::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const visualization_msgs::MarkerArray & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const visualization_msgs::MarkerArray & value);

#endif  //  _VISUALIZATION_MSGS_MARKERARRAY_H_
