...
#ifndef _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMFEEDBACK_H_
#define _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMFEEDBACK_H_
...
PREDECLARE_BSON(tf2_msgs::LookupTransformFeedback); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::LookupTransformFeedback); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LookupTransformFeedback & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        LookupTransformFeedback(const LookupTransformFeedback & inobj);
        /** destructor */
        ~LookupTransformFeedback();

        /** allocator, convenience function for bind */
        static LookupTransformFeedback * New();
        ...
        static const unsigned int ID = 931020961U;
        ...
        static const unsigned int DATA_VERSION = 2688637141U;
        ...
        //        static const char * dataTypeName() { return "LookupTransformFeedback"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "7842ab492a290b453177eb070fdcdc8f"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x7842ab492a290b45ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x3177eb070fdcdc8fULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LookupTransformFeedback * copy() { return new LookupTransformFeedback(*this); };

        /** assignment operator(s) */
        LookupTransformFeedback & operator=(const LookupTransformFeedback & inobj);
        /** equality operator */
        bool operator==(const LookupTransformFeedback & inobj) const;
        /** inequality operator */
        bool operator!=(const LookupTransformFeedback & inobj) const;
        /** less than operator */
        bool operator<(const LookupTransformFeedback & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LookupTransformFeedback & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::LookupTransformFeedback>
    {
    public:
        static bool flat() {return tf2_msgs::LookupTransformFeedback::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::LookupTransformFeedback::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::LookupTransformFeedback & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::LookupTransformFeedback & value);

#endif  //  _TF2_MSGS_LOOKUPTRANSFORMFEEDBACK_H_
