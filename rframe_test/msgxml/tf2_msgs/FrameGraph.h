...
#ifndef _CODEGEN_TF2_MSGS_FRAMEGRAPH_H_
#define _CODEGEN_TF2_MSGS_FRAMEGRAPH_H_
...
PREDECLARE_BSON(tf2_msgs::FrameGraph); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::FrameGraph); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FrameGraph & inobj);   
    ...
    */
    ...
    public: 
        ...
        FrameGraph();
        /** copy constructor */
        FrameGraph(const FrameGraph & inobj);
        /** destructor */
        ~FrameGraph();

        /** allocator, convenience function for bind */
        static FrameGraph * New();
        ...
        static const unsigned int ID = 931020968U;
        ...
        static const unsigned int DATA_VERSION = 3181541596U;
        ...
        //        static const char * dataTypeName() { return "FrameGraph"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "1588d5a998aaae15f2e28fc4d627b5b4"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x1588d5a998aaae15ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf2e28fc4d627b5b4ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FrameGraph * copy() { return new FrameGraph(*this); };

        /** assignment operator(s) */
        FrameGraph & operator=(const FrameGraph & inobj);
        /** equality operator */
        bool operator==(const FrameGraph & inobj) const;
        /** inequality operator */
        bool operator!=(const FrameGraph & inobj) const;
        /** less than operator */
        bool operator<(const FrameGraph & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FrameGraph & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::FrameGraph>
    {
    public:
        static bool flat() {return tf2_msgs::FrameGraph::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::FrameGraph::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::FrameGraph & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::FrameGraph & value);

#endif  //  _TF2_MSGS_FRAMEGRAPH_H_
