...
#ifndef _CODEGEN_TF2_MSGS_FRAMEGRAPHREQUEST_H_
#define _CODEGEN_TF2_MSGS_FRAMEGRAPHREQUEST_H_
...
PREDECLARE_BSON(tf2_msgs::FrameGraphRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::FrameGraphRequest); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, FrameGraphRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        FrameGraphRequest();
        /** copy constructor */
        FrameGraphRequest(const FrameGraphRequest & inobj);
        /** destructor */
        ~FrameGraphRequest();

        /** allocator, convenience function for bind */
        static FrameGraphRequest * New();
        ...
        static const unsigned int ID = 931020966U;
        ...
        static const unsigned int DATA_VERSION = 2967292134U;
        ...
        //        static const char * dataTypeName() { return "FrameGraphRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "a2019a9c23af2ad57807470b0fc32042"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xa2019a9c23af2ad5ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x7807470b0fc32042ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        FrameGraphRequest * copy() { return new FrameGraphRequest(*this); };

        /** assignment operator(s) */
        FrameGraphRequest & operator=(const FrameGraphRequest & inobj);
        /** equality operator */
        bool operator==(const FrameGraphRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const FrameGraphRequest & inobj) const;
        /** less than operator */
        bool operator<(const FrameGraphRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, FrameGraphRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::FrameGraphRequest>
    {
    public:
        static bool flat() {return tf2_msgs::FrameGraphRequest::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::FrameGraphRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::FrameGraphRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::FrameGraphRequest & value);

#endif  //  _TF2_MSGS_FRAMEGRAPHREQUEST_H_
