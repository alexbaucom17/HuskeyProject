...
#ifndef _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMACTIONRESULT_H_
#define _CODEGEN_TF2_MSGS_LOOKUPTRANSFORMACTIONRESULT_H_
...
PREDECLARE_BSON(tf2_msgs::LookupTransformActionResult); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(tf2_msgs::LookupTransformActionResult); // see Common.h, macro used for a cleaner header

namespace tf2_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, LookupTransformActionResult & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        LookupTransformActionResult(const LookupTransformActionResult & inobj);
        /** destructor */
        ~LookupTransformActionResult();

        /** allocator, convenience function for bind */
        static LookupTransformActionResult * New();
        ...
        static const unsigned int ID = 931020960U;
        ...
        static const unsigned int DATA_VERSION = 956027867U;
        ...
        //        static const char * dataTypeName() { return "LookupTransformActionResult"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "ad3bfd409ec7c522f80e9dd9956d6ce3"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xad3bfd409ec7c522ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xf80e9dd9956d6ce3ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        LookupTransformActionResult * copy() { return new LookupTransformActionResult(*this); };

        /** assignment operator(s) */
        LookupTransformActionResult & operator=(const LookupTransformActionResult & inobj);
        /** equality operator */
        bool operator==(const LookupTransformActionResult & inobj) const;
        /** inequality operator */
        bool operator!=(const LookupTransformActionResult & inobj) const;
        /** less than operator */
        bool operator<(const LookupTransformActionResult & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, LookupTransformActionResult & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<tf2_msgs::LookupTransformActionResult>
    {
    public:
        static bool flat() {return tf2_msgs::LookupTransformActionResult::dataTypeFlat(); };
        static std::string sourceXML() {return tf2_msgs::LookupTransformActionResult::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const tf2_msgs::LookupTransformActionResult & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const tf2_msgs::LookupTransformActionResult & value);

#endif  //  _TF2_MSGS_LOOKUPTRANSFORMACTIONRESULT_H_
