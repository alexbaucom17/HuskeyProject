...
#ifndef _CODEGEN_POLLED_CAMERA_GETPOLLEDIMAGERESPONSE_H_
#define _CODEGEN_POLLED_CAMERA_GETPOLLEDIMAGERESPONSE_H_
...
PREDECLARE_BSON(polled_camera::GetPolledImageResponse); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(polled_camera::GetPolledImageResponse); // see Common.h, macro used for a cleaner header

namespace polled_camera
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, GetPolledImageResponse & inobj);   
    ...
    */
    ...
    public: 
        ...
        /** copy constructor */
        GetPolledImageResponse(const GetPolledImageResponse & inobj);
        /** destructor */
        ~GetPolledImageResponse();

        /** allocator, convenience function for bind */
        static GetPolledImageResponse * New();
        ...
        std::string  status_message; /**< Error message in case of failure */
        std_msgs::RosTime  stamp; /**< Timestamp of the captured image. Can be matched  against incoming sensor_msgs/Image header. */
        ...
        static const unsigned int ID = 324220285U;
        ...
        static const unsigned int DATA_VERSION = 2991364881U;
        ...
        //        static const char * dataTypeName() { return "GetPolledImageResponse"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "be01c942f915d274a121917b045ece73"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xbe01c942f915d274ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa121917b045ece73ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        GetPolledImageResponse * copy() { return new GetPolledImageResponse(*this); };

        /** assignment operator(s) */
        GetPolledImageResponse & operator=(const GetPolledImageResponse & inobj);
        /** equality operator */
        bool operator==(const GetPolledImageResponse & inobj) const;
        /** inequality operator */
        bool operator!=(const GetPolledImageResponse & inobj) const;
        /** less than operator */
        bool operator<(const GetPolledImageResponse & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, GetPolledImageResponse & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<polled_camera::GetPolledImageResponse>
    {
    public:
        static bool flat() {return polled_camera::GetPolledImageResponse::dataTypeFlat(); };
        static std::string sourceXML() {return polled_camera::GetPolledImageResponse::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const polled_camera::GetPolledImageResponse & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const polled_camera::GetPolledImageResponse & value);

#endif  //  _POLLED_CAMERA_GETPOLLEDIMAGERESPONSE_H_
