...
#ifndef _CODEGEN_DIAGNOSTIC_MSGS_SELFTESTREQUEST_H_
#define _CODEGEN_DIAGNOSTIC_MSGS_SELFTESTREQUEST_H_
...
PREDECLARE_BSON(diagnostic_msgs::SelfTestRequest); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(diagnostic_msgs::SelfTestRequest); // see Common.h, macro used for a cleaner header

namespace diagnostic_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, SelfTestRequest & inobj);   
    ...
    */
    ...
    public: 
        ...
        SelfTestRequest();
        /** copy constructor */
        SelfTestRequest(const SelfTestRequest & inobj);
        /** destructor */
        ~SelfTestRequest();

        /** allocator, convenience function for bind */
        static SelfTestRequest * New();
        ...
        static const unsigned int ID = 1097138113U;
        ...
        static const unsigned int DATA_VERSION = 2000110622U;
        ...
        //        static const char * dataTypeName() { return "SelfTestRequest"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "fd14c2108e06800785139de07e399fc0"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0xfd14c2108e068007ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0x85139de07e399fc0ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        SelfTestRequest * copy() { return new SelfTestRequest(*this); };

        /** assignment operator(s) */
        SelfTestRequest & operator=(const SelfTestRequest & inobj);
        /** equality operator */
        bool operator==(const SelfTestRequest & inobj) const;
        /** inequality operator */
        bool operator!=(const SelfTestRequest & inobj) const;
        /** less than operator */
        bool operator<(const SelfTestRequest & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, SelfTestRequest & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<diagnostic_msgs::SelfTestRequest>
    {
    public:
        static bool flat() {return diagnostic_msgs::SelfTestRequest::dataTypeFlat(); };
        static std::string sourceXML() {return diagnostic_msgs::SelfTestRequest::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const diagnostic_msgs::SelfTestRequest & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const diagnostic_msgs::SelfTestRequest & value);

#endif  //  _DIAGNOSTIC_MSGS_SELFTESTREQUEST_H_
