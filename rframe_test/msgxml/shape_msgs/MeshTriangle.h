...
#ifndef _CODEGEN_SHAPE_MSGS_MESHTRIANGLE_H_
#define _CODEGEN_SHAPE_MSGS_MESHTRIANGLE_H_
...
PREDECLARE_BSON(shape_msgs::MeshTriangle); // see Common.h, macro used for a cleaner header
PREDECLARE_JSON(shape_msgs::MeshTriangle); // see Common.h, macro used for a cleaner header

namespace shape_msgs
{  

    // definition of nml serialization function for this class, necessary for friend'ing below.
    void nmlupdate(CMS * cms, MeshTriangle & inobj);   
    ...
    */
    ...
    public: 
        ...
        MeshTriangle();
        /** copy constructor */
        MeshTriangle(const MeshTriangle & inobj);
        /** destructor */
        ~MeshTriangle();

        /** allocator, convenience function for bind */
        static MeshTriangle * New();

        /* shorthand definitions for constant sized arrays */
        /** definition of max size of array for vertex_indices */
        static const unsigned int VERTEX_INDICES_MAX = 3;
        /** shorthand definition for array of vertex_indices */
        typedef std::array<unsigned int,VERTEX_INDICES_MAX> Vertex_indicesArray;
        ...
        static const unsigned int ID = 2077658562U;
        ...
        static const unsigned int DATA_VERSION = 3009333471U;
        ...
        //        static const char * dataTypeName() { return "MeshTriangle"; };
        /** name of this data type */
        ...
        */
        ...
        static const std::string versionMD5() { return "05e1a5fd967769b1a2d685b110e5f571"; };
        /** md5 version of this data type */
        static const std::string VERSION_MD5;
        /** top 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_TOP = 0x05e1a5fd967769b1ULL;
        /** lower 8 bytes of md5 in binary */
        static const unsigned long long VERSION_MD5_BOTTOM = 0xa2d685b110e5f571ULL;

        /** register this data type with the global type registry */
        //        static int registerType();

        /** \return a copy of this instance.  */
        MeshTriangle * copy() { return new MeshTriangle(*this); };

        /** assignment operator(s) */
        MeshTriangle & operator=(const MeshTriangle & inobj);
        /** equality operator */
        bool operator==(const MeshTriangle & inobj) const;
        /** inequality operator */
        bool operator!=(const MeshTriangle & inobj) const;
        /** less than operator */
        bool operator<(const MeshTriangle & inobj) const;
    ...
    private:
        ...
        friend void nmlupdate(CMS * cms, MeshTriangle & inobj);
...
namespace rframe
{
    template <> class CodeGenTraits<shape_msgs::MeshTriangle>
    {
    public:
        static bool flat() {return shape_msgs::MeshTriangle::dataTypeFlat(); };
        static std::string sourceXML() {return shape_msgs::MeshTriangle::XML_SOURCE; };
...
/** ostream operator */
//std::ostream& operator<<(std::ostream &s, const shape_msgs::MeshTriangle & value);
std::basic_ostream<char>& operator<<(std::basic_ostream<char> &s, const shape_msgs::MeshTriangle & value);

#endif  //  _SHAPE_MSGS_MESHTRIANGLE_H_
